...
- Wishsanity
- Bucketsanity (or make this kinda like Chrono Trigger and FF6 where items can be found randomly in bookshelves as well)
...
- plando
- Land's end whirlpool gating: disable the whirlpool NPCs and despawn the ants
...
- Bean Valley gating: block the entrance and exit pipe. Use vines as the blocker if you can
    - Unlock condition options:
        ...
        - Defeat Culex 1
        - Clear Sealed Door 1
- booster tower entry requires elder key + room key (maybe... not sure how i feel yet)
