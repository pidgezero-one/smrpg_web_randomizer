...
def main():
    ...
    output_path = Path(settings.BASE_DIR) / "repeated_sequences_report.txt"
...
class Command(BaseCommand):
    help = ("Analyze battle animation scripts to find repeated command sequences "
            "that could be extracted to subroutines. Writes repeated_sequences_report.txt.")
