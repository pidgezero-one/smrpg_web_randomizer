...
from randomizer.management.disassembler_common import (byte, use_table_name)
from randomizer.helpers.roomobjecttables import (room_table, partition_space_table, partition_buffer_table)
