...
from randomizer.data.npcmodeltables import sprite_name_table, vram_store_table, shadow_size_table
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        file = open("randomizer/data/npcmodels.py", "w")
        ...
        writeline(file, 'from randomizer.data.npcmodeltables import SpriteName, VramStore, ShadowSize')
