...
script = [
    ...
    },
    {
        ...
        "subscript": [
            {
                "identifier": 'EVENT_1702_action_queue_sync_1_SUBSCRIPT_visibility_off_0',
    ...
    {
        "identifier": 'EVENT_1702_run_dialog_25',
        "command": 'run_dialog',
        "args": [1057, AreaObjects.NPC_12, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC, _0x60Flags.MULTILINE]]
    },
    {
