...
script = [
    ...
    },
    {
        ...
        "subscript": [
            ...
            },
            {
                ...
                "args": [0, 6, [_0x08Flags.READ_AS_MOLD, _0x08Flags.READ_AS_SEQUENCE]]
            },
            {
    ...
    {
        "identifier": 'EVENT_637_pause_36',
        "command": 'pause',
        "args": [30]
    },
    {
        "identifier": 'EVENT_637_run_dialog_37',
        "command": 'run_dialog',
        "args": [2070, AreaObjects.NPC_14, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC, _0x60Flags.MULTILINE]]
    },
    {
        "identifier": 'EVENT_637_pause_38',
        "command": 'pause',
        "args": [10]
    },
    {
        "identifier": 'EVENT_637_run_dialog_39',
        "command": 'run_dialog',
        "args": [2071, AreaObjects.NPC_14, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC, _0x60Flags.MULTILINE]]
    },
    {
        "identifier": 'EVENT_637_pause_40',
        "command": 'pause',
        "args": [30]
    },
    {
        "identifier": 'EVENT_637_run_dialog_41',
        "command": 'run_dialog',
        "args": [2072, AreaObjects.NPC_14, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC, _0x60Flags.MULTILINE]]
    },
    {
    ...
    {
        "identifier": 'EVENT_637_play_sound_43',
        "command": 'play_sound',
        "args": [Sounds._016_OPEN_DOOR, 6]
    },
    {
        "identifier": 'EVENT_637_apply_tile_mod_44',
        "command": 'apply_tile_mod',
        "args": [Rooms._153_MARRYMORE_CHAPEL_ENTRANCE_TO_SANCTUARY, 0, []]
    },
    {
        "identifier": 'EVENT_637_apply_solidity_mod_45',
        "command": 'apply_solidity_mod',
        "args": [Rooms._152_MARRYMORE_CHAPEL_MAIN_HALL, 0, [_0x6BFlags.PERMANENT]]
    },
    {
        "identifier": 'EVENT_637_enable_controls_46',
        "command": 'enable_controls',
        "args": [[ControllerDirections.LEFT, ControllerDirections.RIGHT, ControllerDirections.DOWN, ControllerDirections.UP, ControllerDirections.X, ControllerDirections.A, ControllerDirections.Y, ControllerDirections.B]]
    },
    {
        "identifier": 'EVENT_637_action_queue_async_47',
        "command": 'action_queue_async',
        "args": [AreaObjects.MARIO],
        "subscript": [
            {
                "identifier": 'EVENT_637_action_queue_async_47_SUBSCRIPT_face_south_0',
                "command": 'face_south'
            }
        ]
    },
    {
        "identifier": 'EVENT_637_ret_48',
        "command": 'ret'
    }
]
