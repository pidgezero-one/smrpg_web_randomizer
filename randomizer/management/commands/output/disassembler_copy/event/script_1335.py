...
script = [
    ...
    {
        "identifier": 'EVENT_1335_run_event_as_subroutine_49',
        "command": 'run_event_as_subroutine',
        "args": [3828]
    },
    {
        "identifier": 'EVENT_1335_action_queue_async_50',
        "command": 'action_queue_async',
        "args": [AreaObjects.MARIO],
        "subscript": [
            {
                "identifier": 'EVENT_1335_action_queue_async_50_SUBSCRIPT_reset_properties_0',
                "command": 'reset_properties'
            },
            {
                "identifier": 'EVENT_1335_action_queue_async_50_SUBSCRIPT_face_south_1',
                "command": 'face_south'
            }
        ]
    },
    {
        "identifier": 'EVENT_1335_set_bit_51',
        "command": 'set_bit',
        "args": [0x7043, 5]
    },
    {
