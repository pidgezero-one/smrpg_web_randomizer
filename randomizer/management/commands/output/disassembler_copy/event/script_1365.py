...
script = [
    ...
    },
    {
        ...
        "args": [0x7043, 2, 'EVENT_1365_move_script_to_main_thread_115']
    },
    {
    ...
    },
    {
        ...
        "command": 'jmp_if_bit_set',
        "args": [0x7043, 3, 'EVENT_1365_move_script_to_main_thread_115']
    },
    {
    ...
    },
    {
        ...
        "command": 'jmp_if_bit_set',
        "args": [0x7043, 1, 'EVENT_1365_move_script_to_main_thread_115']
    },
    {
    ...
    },
    {
        ...
        "command": 'jmp_if_bit_set',
        "args": [0x7043, 0, 'EVENT_1365_move_script_to_main_thread_115']
    },
    {
    ...
    {
        "identifier": 'EVENT_1365_run_dialog_111',
        "command": 'run_dialog',
        "args": [2785, AreaObjects.NPC_14, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC, _0x60Flags.MULTILINE]]
    },
    {
        "identifier": 'EVENT_1365_pause_112',
        "command": 'pause',
        "args": [15]
    },
    {
        "identifier": 'EVENT_1365_run_dialog_113',
        "command": 'run_dialog',
        "args": [2786, AreaObjects.NPC_12, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC, _0x60Flags.MULTILINE]]
    },
    {
        "identifier": 'EVENT_1365_jmp_114',
        "command": 'jmp',
        "args": ['EVENT_1366_pause_action_script_0']
    },
    {
        "identifier": 'EVENT_1365_move_script_to_main_thread_115',
        "command": 'move_script_to_main_thread'
    },
    {
        "identifier": 'EVENT_1365_enable_controls_until_return_116',
        "command": 'enable_controls_until_return',
        "args": [[]]
    },
    {
        "identifier": 'EVENT_1365_stop_music_FDA2_117',
        "command": 'stop_music_FDA2'
    },
    {
        "identifier": 'EVENT_1365_action_queue_sync_118',
        "command": 'action_queue_sync',
        "args": [AreaObjects.MARIO],
        "subscript": [
            {
                "identifier": 'EVENT_1365_action_queue_sync_118_SUBSCRIPT_pause_0',
                "command": 'pause',
                "args": [1]
            },
            {
                "identifier": 'EVENT_1365_action_queue_sync_118_SUBSCRIPT_set_sprite_sequence_1',
                "command": 'set_sprite_sequence',
    ...
    {
        "identifier": 'EVENT_1365_action_queue_async_119',
        "command": 'action_queue_async',
        "args": [AreaObjects.NPC_1],
        "subscript": [
            {
                "identifier": 'EVENT_1365_action_queue_async_119_SUBSCRIPT_fixed_f_coord_on_0',
                "command": 'fixed_f_coord_on'
            },
            {
                "identifier": 'EVENT_1365_action_queue_async_119_SUBSCRIPT_set_animation_speed_1',
                "command": 'set_animation_speed',
                "args": [SequenceSpeeds.VERY_FAST, [_0x10Flags.WALKING]]
            },
            {
                "identifier": 'EVENT_1365_action_queue_async_119_SUBSCRIPT_shift_southeast_steps_2',
    ...
    {
        "identifier": 'EVENT_1365_pause_120',
        "command": 'pause',
        "args": [30]
    },
    {
        "identifier": 'EVENT_1365_action_queue_sync_121',
        "command": 'action_queue_sync',
        "args": [AreaObjects.NPC_0],
        "subscript": [
            {
                "identifier": 'EVENT_1365_action_queue_sync_121_SUBSCRIPT_fixed_f_coord_off_0',
                "command": 'fixed_f_coord_off'
            },
            {
                "identifier": 'EVENT_1365_action_queue_sync_121_SUBSCRIPT_face_northwest_1',
                "command": 'face_northwest'
            },
            {
                "identifier": 'EVENT_1365_action_queue_sync_121_SUBSCRIPT_pause_2',
                "command": 'pause',
                "args": [10]
            },
            {
                "identifier": 'EVENT_1365_action_queue_sync_121_SUBSCRIPT_jump_to_height_3',
    ...
    {
        "identifier": 'EVENT_1365_action_queue_async_123',
        "command": 'action_queue_async',
        "args": [AreaObjects.NPC_3],
        "subscript": [
            {
                "identifier": 'EVENT_1365_action_queue_async_123_SUBSCRIPT_fixed_f_coord_off_0',
                "command": 'fixed_f_coord_off'
            },
            {
                "identifier": 'EVENT_1365_action_queue_async_123_SUBSCRIPT_face_northwest_1',
                "command": 'face_northwest'
            },
            {
                "identifier": 'EVENT_1365_action_queue_async_123_SUBSCRIPT_pause_2',
                "command": 'pause',
                "args": [10]
            },
            {
                "identifier": 'EVENT_1365_action_queue_async_123_SUBSCRIPT_jump_to_height_3',
                "command": 'jump_to_height',
                "args": [50]
            }
        ]
    ...
    {
        "identifier": 'EVENT_1365_jmp_124',
        "command": 'jmp',
        "args": ['EVENT_1370_jmp_if_var_equals_short_0']
    },
    {
        "identifier": 'EVENT_1365_ret_125',
        "command": 'ret'
    }
]
