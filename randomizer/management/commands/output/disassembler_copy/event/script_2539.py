...
script = [
    ...
    {
        "identifier": 'EVENT_2539_action_queue_async_2',
        ...
        "subscript": [
            ...
            {
                "identifier": 'EVENT_2539_action_queue_async_2_SUBSCRIPT_shadow_on_3',
                "command": 'shadow_on'
            },
            {
            ...
            {
                "identifier": 'EVENT_2539_action_queue_async_2_SUBSCRIPT_shift_south_pixels_5',
    ...
    },
    {
        ...
        "subscript": [
            {
                "identifier": 'EVENT_2539_action_queue_sync_5_SUBSCRIPT_pause_0',
                "command": 'pause',
                "args": [4]
            },
            {
                "identifier": 'EVENT_2539_action_queue_sync_5_SUBSCRIPT_db_1',
                "command": 'db',
                "args": [0x20, 0x04]
            },
            {
                "identifier": 'EVENT_2539_action_queue_sync_5_SUBSCRIPT_db_2',
                "command": 'db',
                "args": [0x25, 0x00, 0x0f, 0xf0, 0xff]
            },
            {
                "identifier": 'EVENT_2539_action_queue_sync_5_SUBSCRIPT_pause_3',
                "command": 'pause',
                "args": [48]
            },
            {
