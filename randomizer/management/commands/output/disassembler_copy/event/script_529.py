...
script = [
    ...
    },
    {
        ...
        "command": 'jmp_to_subroutine',
        "args": ['EVENT_529_action_queue_async_169']
    },
    {
    ...
    {
        "identifier": 'EVENT_529_action_queue_async_169',
        "command": 'action_queue_async',
        "args": [AreaObjects.MEM_70A9],
        "subscript": [
            {
                "identifier": 'EVENT_529_action_queue_async_169_SUBSCRIPT_walk_1_step_northwest_0',
                "command": 'walk_1_step_northwest'
            }
        ]
    },
    {
        "identifier": 'EVENT_529_jmp_if_bit_set_170',
        "command": 'jmp_if_bit_set',
        "args": [0x7061, 4, 'EVENT_529_remove_from_current_level_174']
    },
    {
        "identifier": 'EVENT_529_remove_from_current_level_171',
        "command": 'remove_from_current_level',
        "args": [AreaObjects.NPC_1]
    },
    {
        "identifier": 'EVENT_529_remove_from_level_172',
        "command": 'remove_from_level',
        "args": [AreaObjects.NPC_1, Rooms._083_ROSE_TOWN_DURING_BOWYER_OUTSIDE]
    },
    {
        "identifier": 'EVENT_529_ret_173',
        "command": 'ret'
    },
    {
        "identifier": 'EVENT_529_remove_from_current_level_174',
        "command": 'remove_from_current_level',
