...
script = [
    ...
    },
    {
        ...
        "subscript": [
            {
                "identifier": 'EVENT_1107_action_queue_async_12_SUBSCRIPT_shadow_off_0',
                "command": 'shadow_off'
            },
            {
            ...
            {
                "identifier": 'EVENT_1107_action_queue_async_12_SUBSCRIPT_shadow_on_7',
                "command": 'shadow_on'
            },
            {
    ...
    },
    {
        ...
        "subscript": [
            ...
            {
                "identifier": 'EVENT_1107_action_queue_async_14_SUBSCRIPT_shadow_off_2',
                "command": 'shadow_off'
            },
            {
            ...
            {
                "identifier": 'EVENT_1107_action_queue_async_14_SUBSCRIPT_shadow_on_10',
                "command": 'shadow_on'
            },
            {
    ...
    },
    {
        ...
        "subscript": [
            {
                "identifier": 'EVENT_1107_action_queue_async_18_SUBSCRIPT_shadow_off_0',
                "command": 'shadow_off'
            },
            {
            ...
            {
                "identifier": 'EVENT_1107_action_queue_async_18_SUBSCRIPT_shadow_on_3',
                "command": 'shadow_on'
            }
        ]
    },
    ...
    },
    {
        ...
        "subscript": [
            {
                "identifier": 'EVENT_1107_action_queue_async_21_SUBSCRIPT_shadow_off_0',
                "command": 'shadow_off'
            },
            {
    ...
    },
    {
        ...
        "args": [0x7051, 0, 'EVENT_1110_pause_0']
    },
    {
        ...
        "subscript": [
            {
                "identifier": 'EVENT_1107_action_queue_sync_23_SUBSCRIPT_shadow_off_0',
                "command": 'shadow_off'
            },
            {
