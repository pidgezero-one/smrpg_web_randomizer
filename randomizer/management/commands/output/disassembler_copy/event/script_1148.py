...
script = [
    ...
    },
    {
        ...
        "args": [0x704a, 4, 'EVENT_1148_jmp_if_bit_set_8']
    },
    {
        "identifier": 'EVENT_1148_jmp_if_bit_clear_2',
        "command": 'jmp_if_bit_clear',
        "args": [0x704a, 5, 'EVENT_1148_jmp_if_bit_set_8']
    },
    {
        "identifier": 'EVENT_1148_jmp_if_bit_clear_3',
        "command": 'jmp_if_bit_clear',
        "args": [0x704a, 6, 'EVENT_1148_jmp_if_bit_set_8']
    },
    {
        "identifier": 'EVENT_1148_jmp_if_bit_clear_4',
        "command": 'jmp_if_bit_clear',
        "args": [0x704a, 7, 'EVENT_1148_jmp_if_bit_set_8']
    },
    {
        "identifier": 'EVENT_1148_jmp_if_bit_clear_5',
        "command": 'jmp_if_bit_clear',
        "args": [0x704b, 0, 'EVENT_1148_jmp_if_bit_set_8']
    },
    {
