...
script = [
    ...
    {
        "identifier": 'EVENT_1147_inc_45',
        "command": 'inc',
        "args": [0x70d5]
    },
    {
        "identifier": 'EVENT_1147_action_queue_sync_46',
        "command": 'action_queue_sync',
        "args": [AreaObjects.SCREEN_FOCUS],
        "subscript": [
            {
                "identifier": 'EVENT_1147_action_queue_sync_46_SUBSCRIPT_set_animation_speed_0',
                "command": 'set_animation_speed',
                "args": [SequenceSpeeds.FASTEST, [_0x10Flags.WALKING]]
            },
            {
                "identifier": 'EVENT_1147_action_queue_sync_46_SUBSCRIPT_walk_to_xy_coords_1',
    ...
    },
    {
        ...
        "subscript": [
            {
                "identifier": 'EVENT_1147_action_queue_sync_47_SUBSCRIPT_shirt_to_xy_coords_0',
                "command": 'shirt_to_xy_coords',
                "args": [4, 22]
            },
            {
                "identifier": 'EVENT_1147_action_queue_sync_47_SUBSCRIPT_set_sprite_sequence_1',
                "command": 'set_sprite_sequence',
    ...
    {
        "identifier": 'EVENT_1147_action_queue_async_48',
        "command": 'action_queue_async',
        "args": [AreaObjects.NPC_2],
        "subscript": [
            {
                "identifier": 'EVENT_1147_action_queue_async_48_SUBSCRIPT_shirt_to_xy_coords_0',
                "command": 'shirt_to_xy_coords',
                "args": [4, 20]
            },
            {
                "identifier": 'EVENT_1147_action_queue_async_48_SUBSCRIPT_visibility_on_1',
                "command": 'visibility_on'
            },
            {
                "identifier": 'EVENT_1147_action_queue_async_48_SUBSCRIPT_set_sprite_sequence_2',
                "command": 'set_sprite_sequence',
                "args": [2, 0, [_0x08Flags.READ_AS_SEQUENCE]]
            },
            {
                "identifier": 'EVENT_1147_action_queue_async_48_SUBSCRIPT_shift_north_steps_3',
                "command": 'shift_north_steps',
                "args": [1]
            },
            {
                "identifier": 'EVENT_1147_action_queue_async_48_SUBSCRIPT_shift_north_pixels_4',
    ...
    {
        "identifier": 'EVENT_1147_pause_50',
        "command": 'pause',
        "args": [90]
    },
    {
        "identifier": 'EVENT_1147_action_queue_sync_51',
        "command": 'action_queue_sync',
        "args": [AreaObjects.MARIO],
        "subscript": [
            {
                "identifier": 'EVENT_1147_action_queue_sync_51_SUBSCRIPT_face_south_0',
                "command": 'face_south'
            },
            {
                "identifier": 'EVENT_1147_action_queue_sync_51_SUBSCRIPT_reset_properties_1',
                "command": 'reset_properties'
            }
        ]
    },
    {
        "identifier": 'EVENT_1147_action_queue_async_52',
        "command": 'action_queue_async',
        "args": [AreaObjects.NPC_2],
        "subscript": [
            {
                "identifier": 'EVENT_1147_action_queue_async_52_SUBSCRIPT_visibility_off_0',
                "command": 'visibility_off'
            }
        ]
    },
    {
        "identifier": 'EVENT_1147_pause_53',
        "command": 'pause',
        "args": [30]
    },
    {
        "identifier": 'EVENT_1147_db_54',
        "command": 'db',
        "args": [0xfd, 0x8e, 0x80, 0x07, 0x01]
    },
    {
        "identifier": 'EVENT_1147_pause_script_until_effect_done_55',
        "command": 'pause_script_until_effect_done'
    },
    {
        "identifier": 'EVENT_1147_remember_last_object_56',
        "command": 'remember_last_object'
    },
    {
        "identifier": 'EVENT_1147_run_dialog_57',
        "command": 'run_dialog',
        "args": [3443, AreaObjects.BOWSER, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC, _0x60Flags.MULTILINE]]
    },
    {
    ...
    },
    {
        ...
        "subscript": [
            ...
            {
                "identifier": 'EVENT_1147_action_queue_async_59_SUBSCRIPT_set_sprite_sequence_6',
                "command": 'set_sprite_sequence',
                "args": [10, 2, [_0x08Flags.LOOPING_OFF, _0x08Flags.READ_AS_SEQUENCE]]
            },
            {
                "identifier": 'EVENT_1147_action_queue_async_59_SUBSCRIPT_pause_7',
                "command": 'pause',
                "args": [30]
            },
            {
                "identifier": 'EVENT_1147_action_queue_async_59_SUBSCRIPT_play_sound_8',
                "command": 'play_sound',
                "args": [Sounds._013_COIN, 6]
            },
            {
                "identifier": 'EVENT_1147_action_queue_async_59_SUBSCRIPT_pause_9',
                "command": 'pause',
                "args": [30]
            },
            {
                "identifier": 'EVENT_1147_action_queue_async_59_SUBSCRIPT_reset_properties_10',
                "command": 'reset_properties'
            },
            {
                "identifier": 'EVENT_1147_action_queue_async_59_SUBSCRIPT_face_south_11',
                "command": 'face_south'
            },
            {
                "identifier": 'EVENT_1147_action_queue_async_59_SUBSCRIPT_fixed_f_coord_on_12',
                "command": 'fixed_f_coord_on'
            },
            {
                "identifier": 'EVENT_1147_action_queue_async_59_SUBSCRIPT_sequence_playback_off_13',
