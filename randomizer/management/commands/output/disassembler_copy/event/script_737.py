...
script = [
        ...
        "subscript": [
            {
                ...
                "command": 'set_sprite_sequence',
                "args": [1, 2, [_0x08Flags.READ_AS_SEQUENCE, _0x08Flags.MIRROR_SPRITE]]
            }
        ]
    },
    {
    ...
    {
        "identifier": 'EVENT_737_set_action_script_sync_25',
        "command": 'set_action_script_sync',
        "args": [AreaObjects.NPC_3, 263]
    },
    {
        "identifier": 'EVENT_737_set_action_script_sync_26',
        "command": 'set_action_script_sync',
        "args": [AreaObjects.NPC_4, 263]
    },
    {
        "identifier": 'EVENT_737_set_action_script_sync_27',
        "command": 'set_action_script_sync',
        "args": [AreaObjects.NPC_5, 263]
    },
    {
        "identifier": 'EVENT_737_unsync_action_script_28',
        "command": 'unsync_action_script',
        "args": [AreaObjects.NPC_3]
    },
    {
        "identifier": 'EVENT_737_action_queue_async_29',
        "command": 'action_queue_async',
        "args": [AreaObjects.NPC_3],
        "subscript": [
            {
                "identifier": 'EVENT_737_action_queue_async_29_SUBSCRIPT_transfer_to_xyzf_0',
                "command": 'transfer_to_xyzf',
                "args": [6, 22, 0, RadialDirections.EAST]
            },
            {
                "identifier": 'EVENT_737_action_queue_async_29_SUBSCRIPT_transfer_xyzf_pixels_1',
    ...
    {
        "identifier": 'EVENT_737_fade_in_from_black_async_30',
        "command": 'fade_in_from_black_async'
    },
    {
        "identifier": 'EVENT_737_ret_31',
        "command": 'ret'
    }
]
