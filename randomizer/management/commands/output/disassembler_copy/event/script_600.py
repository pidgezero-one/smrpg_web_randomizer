...
script = [
    ...
    {
        "identifier": 'EVENT_600_action_queue_sync_4',
        "command": 'action_queue_sync',
        "args": [AreaObjects.NPC_14],
        "subscript": [
            {
                "identifier": 'EVENT_600_action_queue_sync_4_SUBSCRIPT_set_sprite_sequence_0',
    ...
    {
        "identifier": 'EVENT_600_action_queue_sync_5',
        "command": 'action_queue_sync',
        "args": [AreaObjects.NPC_5],
        "subscript": [
            {
                "identifier": 'EVENT_600_action_queue_sync_5_SUBSCRIPT_set_sprite_sequence_0',
                "command": 'set_sprite_sequence',
                "args": [2, 0, [_0x08Flags.READ_AS_SEQUENCE]]
            },
            {
                "identifier": 'EVENT_600_action_queue_sync_5_SUBSCRIPT_set_priority_1',
                "command": 'set_priority',
                "args": [2]
            },
            {
                "identifier": 'EVENT_600_action_queue_sync_5_SUBSCRIPT_set_vram_priority_2',
