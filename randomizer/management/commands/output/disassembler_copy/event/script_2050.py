...
script = [
    ...
    },
    {
        ...
        "args": [0x70bd, 1, 'EVENT_2050_run_dialog_13']
    },
    {
        "identifier": 'EVENT_2050_jmp_if_var_equals_byte_8',
        "command": 'jmp_if_var_equals_byte',
        "args": [0x70bd, 2, 'EVENT_2050_run_dialog_15']
    },
    {
        "identifier": 'EVENT_2050_jmp_if_var_equals_byte_9',
        "command": 'jmp_if_var_equals_byte',
        "args": [0x70bd, 3, 'EVENT_2050_run_dialog_17']
    },
    {
        "identifier": 'EVENT_2050_jmp_if_var_equals_byte_10',
        "command": 'jmp_if_var_equals_byte',
        "args": [0x70bd, 7, 'EVENT_2050_run_dialog_19']
    },
    {
        "identifier": 'EVENT_2050_run_dialog_11',
        "command": 'run_dialog',
        "args": [2963, AreaObjects.MARIO, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC, _0x60Flags.MULTILINE]]
    },
    {
        "identifier": 'EVENT_2050_ret_12',
        "command": 'ret'
    },
    {
        "identifier": 'EVENT_2050_run_dialog_13',
        "command": 'run_dialog',
        "args": [2960, AreaObjects.MARIO, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC, _0x60Flags.MULTILINE]]
    },
    {
        "identifier": 'EVENT_2050_ret_14',
        "command": 'ret'
    },
    {
        "identifier": 'EVENT_2050_run_dialog_15',
        "command": 'run_dialog',
        "args": [2961, AreaObjects.MARIO, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC, _0x60Flags.MULTILINE]]
    },
    {
        "identifier": 'EVENT_2050_ret_16',
        "command": 'ret'
    },
    {
        "identifier": 'EVENT_2050_run_dialog_17',
        "command": 'run_dialog',
        "args": [2962, AreaObjects.MARIO, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC, _0x60Flags.MULTILINE]]
    },
    {
        "identifier": 'EVENT_2050_ret_18',
        "command": 'ret'
    },
    {
        "identifier": 'EVENT_2050_run_dialog_19',
        "command": 'run_dialog',
        "args": [2963, AreaObjects.MARIO, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC, _0x60Flags.MULTILINE]]
    },
    {
        "identifier": 'EVENT_2050_set_bit_20',
        "command": 'set_bit',
        "args": [0x7088, 6]
    },
    {
        "identifier": 'EVENT_2050_ret_21',
        "command": 'ret'
    }
]
