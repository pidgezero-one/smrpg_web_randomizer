...
script = [
    ...
    },
    {
        ...
        "subscript": [
            {
                "identifier": 'EVENT_376_action_queue_async_4_SUBSCRIPT_shadow_on_0',
                "command": 'shadow_on'
            },
            {
    ...
    },
    {
        ...
        "subscript": [
            {
                "identifier": 'EVENT_376_action_queue_async_8_SUBSCRIPT_shadow_on_0',
                "command": 'shadow_on'
            },
            {
    ...
    },
    {
        ...
        "subscript": [
            {
                "identifier": 'EVENT_376_action_queue_async_11_SUBSCRIPT_shadow_on_0',
                "command": 'shadow_on'
            },
            {
