...
script = [
    {
        ...
        "args": [0x7051, 1, 'EVENT_1109_action_queue_sync_0']
    },
    {
    ...
    },
    {
        ...
        "subscript": [
            {
                "identifier": 'EVENT_1105_action_queue_async_7_SUBSCRIPT_shadow_on_0',
                "command": 'shadow_on'
            },
            {
    ...
    },
    {
        ...
        "subscript": [
            {
                "identifier": 'EVENT_1105_action_queue_sync_49_SUBSCRIPT_shadow_off_0',
                "command": 'shadow_off'
            },
            {
