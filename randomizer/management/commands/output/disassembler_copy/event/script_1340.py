...
script = [
    {
        "identifier": 'EVENT_1340_jmp_if_bit_set_0',
        "command": 'jmp_if_bit_set',
        "args": [0x7054, 0, 'EVENT_1340_pause_3']
    },
    {
        "identifier": 'EVENT_1340_run_dialog_1',
        "command": 'run_dialog',
        "args": [2801, AreaObjects.BOWSER, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC]]
    },
    {
        "identifier": 'EVENT_1340_ret_2',
        "command": 'ret'
    },
    {
    ...
    {
        "identifier": 'EVENT_1340_pause_9',
        "command": 'pause',
        "args": [5]
    },
    {
        "identifier": 'EVENT_1340_remove_one_from_inventory_10',
        "command": 'remove_one_from_inventory',
        "args": [items.ElderKey]
    },
    {
        "identifier": 'EVENT_1340_ret_11',
        "command": 'ret'
    }
]
