...
script = [
    {
        "identifier": 'EVENT_669_jmp_if_bit_clear_0',
        "command": 'jmp_if_bit_clear',
        "args": [0x704c, 6, 'EVENT_256_ret_0']
    },
    {
        "identifier": 'EVENT_669_jmp_if_bit_set_1',
        "command": 'jmp_if_bit_set',
        "args": [0x705d, 0, 'EVENT_669_enter_area_4']
    },
    {
        "identifier": 'EVENT_669_enter_area_2',
        "command": 'enter_area',
