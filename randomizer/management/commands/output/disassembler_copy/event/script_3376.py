...
script = [
    ...
    {
        "identifier": 'EVENT_3376_jmp_if_var_equals_byte_23',
        "command": 'jmp_if_var_equals_byte',
        "args": [0x70b6, 0, 'EVENT_3376_run_event_as_subroutine_26']
    },
    {
        "identifier": 'EVENT_3376_run_event_as_subroutine_24',
        "command": 'run_event_as_subroutine',
        "args": [15]
    },
    {
        "identifier": 'EVENT_3376_ret_25',
        "command": 'ret'
    },
    {
        "identifier": 'EVENT_3376_run_event_as_subroutine_26',
        "command": 'run_event_as_subroutine',
        "args": [15]
    },
    {
        "identifier": 'EVENT_3376_action_queue_async_27',
        "command": 'action_queue_async',
        "args": [AreaObjects.SCREEN_FOCUS],
        "subscript": [
            {
                "identifier": 'EVENT_3376_action_queue_async_27_SUBSCRIPT_shift_northeast_steps_0',
                "command": 'shift_northeast_steps',
                "args": [5]
            },
            {
                "identifier": 'EVENT_3376_action_queue_async_27_SUBSCRIPT_walk_1_step_east_1',
                "command": 'walk_1_step_east'
            }
        ]
    },
    {
        "identifier": 'EVENT_3376_run_dialog_28',
        "command": 'run_dialog',
        "args": [1944, AreaObjects.BOWSER, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC, _0x60Flags.MULTILINE]]
    },
    {
        "identifier": 'EVENT_3376_jmp_if_dialog_option_b_29',
        "command": 'jmp_if_dialog_option_b',
        "args": ['EVENT_3376_action_queue_async_50']
    },
    {
        "identifier": 'EVENT_3376_run_dialog_30',
        "command": 'run_dialog',
        "args": [1945, AreaObjects.BOWSER, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC, _0x60Flags.MULTILINE]]
    },
    {
        "identifier": 'EVENT_3376_enter_area_31',
        "command": 'enter_area',
        "args": [Rooms._321_BOWSERS_KEEP_6DOOR_ACTION_ROOM_2A_SLOW_ELEVATING_PLATFORMS, RadialDirections.NORTHEAST, 4, 58, 5, []]
    },
    {
        "identifier": 'EVENT_3376_remove_from_current_level_32',
        "command": 'remove_from_current_level',
        "args": [AreaObjects.MARIO]
    },
    {
        "identifier": 'EVENT_3376_fade_in_from_black_sync_33',
        "command": 'fade_in_from_black_sync'
    },
    {
        "identifier": 'EVENT_3376_action_queue_sync_34',
        "command": 'action_queue_sync',
        "args": [AreaObjects.SCREEN_FOCUS],
        "subscript": [
            {
                "identifier": 'EVENT_3376_action_queue_sync_34_SUBSCRIPT_set_animation_speed_0',
                "command": 'set_animation_speed',
                "args": [SequenceSpeeds.SLOW, [_0x10Flags.WALKING]]
            },
            {
                "identifier": 'EVENT_3376_action_queue_sync_34_SUBSCRIPT_shift_northeast_steps_1',
                "command": 'shift_northeast_steps',
                "args": [6]
            }
        ]
    ...
    {
        "identifier": 'EVENT_3376_run_dialog_35',
        "command": 'run_dialog',
        "args": [1946, AreaObjects.BOWSER, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC, _0x60Flags.MULTILINE]]
    },
    {
        "identifier": 'EVENT_3376_enter_area_36',
        "command": 'enter_area',
        "args": [Rooms._459_BOWSERS_KEEP_6DOOR_BATTLE_ROOM_1A_1ST_FIGHT_TERRA_COTTA, RadialDirections.NORTHEAST, 2, 63, 0, []]
    },
    {
        "identifier": 'EVENT_3376_remove_from_current_level_37',
        "command": 'remove_from_current_level',
        "args": [AreaObjects.MARIO]
    },
    {
        "identifier": 'EVENT_3376_fade_in_from_black_sync_38',
        "command": 'fade_in_from_black_sync'
    },
    {
        "identifier": 'EVENT_3376_action_queue_sync_39',
        "command": 'action_queue_sync',
        "args": [AreaObjects.SCREEN_FOCUS],
        "subscript": [
            {
                "identifier": 'EVENT_3376_action_queue_sync_39_SUBSCRIPT_set_animation_speed_0',
                "command": 'set_animation_speed',
                "args": [SequenceSpeeds.SLOW, [_0x10Flags.WALKING]]
            },
            {
                "identifier": 'EVENT_3376_action_queue_sync_39_SUBSCRIPT_shift_northeast_steps_1',
                "command": 'shift_northeast_steps',
                "args": [6]
            }
        ]
    ...
    {
        "identifier": 'EVENT_3376_run_dialog_40',
        "command": 'run_dialog',
        "args": [1947, AreaObjects.BOWSER, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC, _0x60Flags.MULTILINE]]
    },
    {
        "identifier": 'EVENT_3376_enter_area_41',
        "command": 'enter_area',
        "args": [Rooms._464_BOWSERS_KEEP_6DOOR_PUZZLE_ROOM_1A_QUIZ, RadialDirections.NORTHEAST, 3, 106, 0, []]
    },
    {
        "identifier": 'EVENT_3376_remove_from_current_level_42',
        "command": 'remove_from_current_level',
        "args": [AreaObjects.MARIO]
    },
    {
        "identifier": 'EVENT_3376_fade_in_from_black_sync_43',
        "command": 'fade_in_from_black_sync'
    },
    {
        "identifier": 'EVENT_3376_action_queue_sync_44',
        "command": 'action_queue_sync',
        "args": [AreaObjects.SCREEN_FOCUS],
        "subscript": [
            {
                "identifier": 'EVENT_3376_action_queue_sync_44_SUBSCRIPT_set_animation_speed_0',
                "command": 'set_animation_speed',
                "args": [SequenceSpeeds.SLOW, [_0x10Flags.WALKING]]
            },
            {
                "identifier": 'EVENT_3376_action_queue_sync_44_SUBSCRIPT_shift_northeast_steps_1',
                "command": 'shift_northeast_steps',
                "args": [6]
            }
        ]
    ...
    {
        "identifier": 'EVENT_3376_run_dialog_45',
        "command": 'run_dialog',
        "args": [1948, AreaObjects.BOWSER, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC, _0x60Flags.MULTILINE]]
    },
    {
        "identifier": 'EVENT_3376_enter_area_46',
        "command": 'enter_area',
        "args": [Rooms._454_BOWSERS_KEEP_AREA_08_ROOM_WITH_6_DOORS, RadialDirections.NORTHEAST, 6, 33, 0, []]
    },
    {
        "identifier": 'EVENT_3376_action_queue_sync_47',
        "command": 'action_queue_sync',
        "args": [AreaObjects.MARIO],
        "subscript": [
            {
                "identifier": 'EVENT_3376_action_queue_sync_47_SUBSCRIPT_shirt_to_xy_coords_0',
                "command": 'shirt_to_xy_coords',
                "args": [2, 39]
            },
            {
                "identifier": 'EVENT_3376_action_queue_sync_47_SUBSCRIPT_face_northeast_1',
                "command": 'face_northeast'
            },
            {
                "identifier": 'EVENT_3376_action_queue_sync_47_SUBSCRIPT_pause_2',
                "command": 'pause',
                "args": [1]
            }
        ]
    ...
    {
        "identifier": 'EVENT_3376_fade_in_from_black_async_48',
    ...
    {
        "identifier": 'EVENT_3376_action_queue_async_50',
        "command": 'action_queue_async',
        "args": [AreaObjects.SCREEN_FOCUS],
        "subscript": [
            {
                "identifier": 'EVENT_3376_action_queue_async_50_SUBSCRIPT_walk_1_step_west_0',
                "command": 'walk_1_step_west'
            },
            {
                "identifier": 'EVENT_3376_action_queue_async_50_SUBSCRIPT_shift_southwest_steps_1',
    ...
    {
        "identifier": 'EVENT_3376_ret_51',
        "command": 'ret'
    },
    {
        "identifier": 'EVENT_3376_mem_7000_and_const_52',
