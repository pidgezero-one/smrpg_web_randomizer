...
script = [
    ...
    {
        "identifier": 'EVENT_1713_run_dialog_14',
        "command": 'run_dialog',
        "args": [1058, AreaObjects.NPC_12, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC, _0x60Flags.MULTILINE]]
    },
    {
        "identifier": 'EVENT_1713_set_action_script_sync_15',
        "command": 'set_action_script_sync',
        "args": [AreaObjects.NPC_8, 162]
    },
    {
        "identifier": 'EVENT_1713_ret_16',
        "command": 'ret'
    }
]
