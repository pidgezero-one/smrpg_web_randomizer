...
script = [
    ...
    {
        "identifier": 'EVENT_378_run_dialog_12',
        "command": 'run_dialog',
        "args": [2558, AreaObjects.MEM_70A8, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC, _0x60Flags.MULTILINE, _0x60Flags.USE_BACKGROUND]]
    },
    {
        "identifier": 'EVENT_378_action_queue_async_13',
        "command": 'action_queue_async',
        "args": [AreaObjects.NPC_5],
        "subscript": [
            {
                "identifier": 'EVENT_378_action_queue_async_13_SUBSCRIPT_set_animation_speed_0',
                "command": 'set_animation_speed',
                "args": [SequenceSpeeds.NORMAL, [_0x10Flags.WALKING]]
            },
            {
                "identifier": 'EVENT_378_action_queue_async_13_SUBSCRIPT_shift_northwest_steps_1',
                "command": 'shift_northwest_steps',
                "args": [2]
            },
            {
                "identifier": 'EVENT_378_action_queue_async_13_SUBSCRIPT_visibility_off_2',
    ...
    {
        "identifier": 'EVENT_378_remove_from_level_15',
        "command": 'remove_from_level',
