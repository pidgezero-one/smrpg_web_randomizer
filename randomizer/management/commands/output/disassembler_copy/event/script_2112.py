...
script = [
    ...
    {
        "identifier": 'EVENT_2112_palette_set_7',
        "command": 'palette_set',
        "args": [111, 1, [3]]
    },
    {
        "identifier": 'EVENT_2112_action_queue_sync_8',
        "command": 'action_queue_sync',
        "args": [AreaObjects.MARIO],
        "subscript": [
            {
                "identifier": 'EVENT_2112_action_queue_sync_8_SUBSCRIPT_transfer_to_xyzf_0',
                "command": 'transfer_to_xyzf',
                "args": [6, 68, 2, RadialDirections.EAST]
            },
            {
                "identifier": 'EVENT_2112_action_queue_sync_8_SUBSCRIPT_face_northeast_1',
                "command": 'face_northeast'
            }
        ]
    },
    {
        ...
        "subscript": [
            ...
            {
                "identifier": 'EVENT_2112_action_queue_sync_9_SUBSCRIPT_visibility_on_1',
                "command": 'visibility_on'
            },
            {
                "identifier": 'EVENT_2112_action_queue_sync_9_SUBSCRIPT_shift_southwest_pixels_2',
                "command": 'shift_southwest_pixels',
                "args": [9]
            },
            {
                "identifier": 'EVENT_2112_action_queue_sync_9_SUBSCRIPT_sequence_looping_on_3',
    ...
    },
    {
        ...
        "subscript": [
            {
                "identifier": 'EVENT_2112_action_queue_sync_10_SUBSCRIPT_shift_northeast_pixels_0',
    ...
    {
        "identifier": 'EVENT_2112_action_queue_async_11',
        "command": 'action_queue_async',
        "args": [AreaObjects.SCREEN_FOCUS],
        "subscript": [
            {
                "identifier": 'EVENT_2112_action_queue_async_11_SUBSCRIPT_set_animation_speed_0',
                "command": 'set_animation_speed',
                "args": [SequenceSpeeds.VERY_FAST, [_0x10Flags.WALKING]]
            },
            {
                "identifier": 'EVENT_2112_action_queue_async_11_SUBSCRIPT_walk_to_xy_coords_1',
    ...
    {
        "identifier": 'EVENT_2112_jmp_12',
        "command": 'jmp',
        "args": ['EVENT_2113_fade_in_from_black_sync_duration_0']
    },
    {
