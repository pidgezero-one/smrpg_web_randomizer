...
script = [
    ...
    },
    {
        ...
        "args": [0x7043, 1, 'EVENT_3479_run_dialog_96']
    },
    {
    ...
    },
    {
        ...
        "command": 'jmp_if_comparison_result_is_lesser',
        "args": ['EVENT_3479_set_70A0_short_mem_to_7000_78']
    },
    {
    ...
    },
    {
        ...
        "args": [0, 'EVENT_3479_jmp_if_bit_set_85']
    },
    {
        "identifier": 'EVENT_3479_run_dialog_75',
        "command": 'run_dialog',
        "args": [1041, AreaObjects.NPC_12, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC, _0x60Flags.MULTILINE]]
    },
    {
        "identifier": 'EVENT_3479_play_sound_76',
        "command": 'play_sound',
        "args": [Sounds._055_LOSE_COINS_COIN_FOUNTAIN, 6]
    },
    {
        "identifier": 'EVENT_3479_jmp_77',
        "command": 'jmp',
        "args": ['EVENT_3479_jmp_if_bit_set_85']
    },
    {
        "identifier": 'EVENT_3479_set_70A0_short_mem_to_7000_78',
        "command": 'set_70A0_short_mem_to_7000',
        "args": [0x70d4]
    },
    {
        "identifier": 'EVENT_3479_run_dialog_duration_79',
        "command": 'run_dialog_duration',
        "args": [1042, DialogDurations.SHORT, [_0x60Flags.ASYNC]]
    },
    {
        "identifier": 'EVENT_3479_play_sound_80',
        "command": 'play_sound',
        "args": [Sounds._055_LOSE_COINS_COIN_FOUNTAIN, 6]
    },
    {
        "identifier": 'EVENT_3479_jmp_if_bit_clear_81',
        "command": 'jmp_if_bit_clear',
        "args": [0x7043, 3, 'EVENT_3479_jmp_if_bit_set_85']
    },
    {
        "identifier": 'EVENT_3479_run_dialog_82',
        "command": 'run_dialog',
        "args": [1038, AreaObjects.NPC_12, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC, _0x60Flags.MULTILINE]]
    },
    {
        "identifier": 'EVENT_3479_set_short_83',
        "command": 'set_short',
        "args": [0x7028, 0x0005]
    },
    {
        "identifier": 'EVENT_3479_jmp_to_subroutine_84',
        "command": 'jmp_to_subroutine',
        "args": ['EVENT_3479_action_queue_sync_137']
    },
    {
        ...
        "command": 'jmp_if_bit_set',
        "args": [0x704e, 0, 'EVENT_3479_jmp_if_bit_set_91']
    },
    {
        "identifier": 'EVENT_3479_run_dialog_86',
        "command": 'run_dialog',
        "args": [1071, AreaObjects.MEM_70A8, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC, _0x60Flags.MULTILINE, _0x60Flags.USE_BACKGROUND]]
    },
    {
        "identifier": 'EVENT_3479_set_87',
        "command": 'set',
        "args": [0x70a7, 7]
    },
    {
    ...
    {
        "identifier": 'EVENT_3479_run_event_as_subroutine_89',
        "command": 'run_event_as_subroutine',
        "args": [3828]
    },
    {
        "identifier": 'EVENT_3479_set_bit_90',
        "command": 'set_bit',
        "args": [0x704e, 0]
    },
    {
        "identifier": 'EVENT_3479_jmp_if_bit_set_91',
        "command": 'jmp_if_bit_set',
        "args": [0x7043, 1, 'EVENT_3479_action_queue_async_93']
    },
    {
        "identifier": 'EVENT_3479_ret_92',
        "command": 'ret'
    },
    {
        "identifier": 'EVENT_3479_action_queue_async_93',
        "command": 'action_queue_async',
        "args": [AreaObjects.NPC_3],
        "subscript": [
            {
                "identifier": 'EVENT_3479_action_queue_async_93_SUBSCRIPT_set_animation_speed_0',
                "command": 'set_animation_speed',
                "args": [SequenceSpeeds.FAST, [_0x10Flags.WALKING, _0x10Flags.SEQUENCE]]
            },
            {
                "identifier": 'EVENT_3479_action_queue_async_93_SUBSCRIPT_shift_southwest_steps_1',
                "command": 'shift_southwest_steps',
                "args": [4]
            },
            {
                "identifier": 'EVENT_3479_action_queue_async_93_SUBSCRIPT_walk_1_step_southeast_2',
                "command": 'walk_1_step_southeast'
            },
            {
                "identifier": 'EVENT_3479_action_queue_async_93_SUBSCRIPT_set_animation_speed_3',
                "command": 'set_animation_speed',
    ...
    {
        "identifier": 'EVENT_3479_clear_bit_94',
        "command": 'clear_bit',
        "args": [0x7043, 1]
    },
    {
        "identifier": 'EVENT_3479_ret_95',
        "command": 'ret'
    },
    {
        "identifier": 'EVENT_3479_run_dialog_96',
        "command": 'run_dialog',
        "args": [1077, AreaObjects.NPC_12, [_0x60Flags.ASYNC, _0x60Flags.MULTILINE]]
    },
    {
        "identifier": 'EVENT_3479_jmp_if_bit_set_97',
        "command": 'jmp_if_bit_set',
        "args": [0x7043, 1, 'EVENT_3479_run_dialog_duration_102']
    },
    {
        "identifier": 'EVENT_3479_set_7000_to_70A0_short_mem_98',
        "command": 'set_7000_to_70A0_short_mem',
        "args": [0x70d4]
    },
    {
        "identifier": 'EVENT_3479_set_7000_short_mem_to_7000_99',
        "command": 'set_7000_short_mem_to_7000',
        "args": [0x7024]
    },
    {
        "identifier": 'EVENT_3479_set_7000_to_70A0_short_mem_100',
        "command": 'set_7000_to_70A0_short_mem',
        "args": [0x70b3]
    },
    {
        "identifier": 'EVENT_3479_run_dialog_duration_101',
        "command": 'run_dialog_duration',
    ...
    {
        "identifier": 'EVENT_3479_jmp_if_dialog_option_b_103',
        "command": 'jmp_if_dialog_option_b',
        "args": ['EVENT_3479_pause_130']
    },
    {
        "identifier": 'EVENT_3479_pause_104',
        "command": 'pause',
        "args": [10]
    },
    {
        "identifier": 'EVENT_3479_set_action_script_async_105',
        "command": 'set_action_script_async',
        "args": [AreaObjects.MARIO, 670]
    },
    {
        "identifier": 'EVENT_3479_store_coin_amount_7000_106',
        "command": 'store_coin_amount_7000'
    },
    {
        "identifier": 'EVENT_3479_mem_compare_val_107',
        "command": 'mem_compare_val',
        "args": [30]
    },
    {
        "identifier": 'EVENT_3479_jmp_if_comparison_result_is_greater_or_equal_108',
        "command": 'jmp_if_comparison_result_is_greater_or_equal',
        "args": ['EVENT_3479_set_123']
    },
    {
        "identifier": 'EVENT_3479_run_dialog_109',
        "command": 'run_dialog',
        "args": [1081, AreaObjects.NPC_12, [_0x60Flags.ASYNC, _0x60Flags.MULTILINE]]
    },
    {
        "identifier": 'EVENT_3479_set_7000_to_70A0_short_mem_110',
        "command": 'set_7000_to_70A0_short_mem',
        "args": [0x70d4]
    },
    {
        "identifier": 'EVENT_3479_mem_compare_val_111',
        "command": 'mem_compare_val',
        "args": [30]
    },
    {
        "identifier": 'EVENT_3479_jmp_if_comparison_result_is_lesser_112',
        "command": 'jmp_if_comparison_result_is_lesser',
        "args": ['EVENT_3479_run_dialog_duration_121']
    },
    {
        "identifier": 'EVENT_3479_run_dialog_duration_113',
        "command": 'run_dialog_duration',
        "args": [1040, DialogDurations.SHORT, [_0x60Flags.ASYNC]]
    },
    {
        "identifier": 'EVENT_3479_jmp_if_dialog_option_b_114',
        "command": 'jmp_if_dialog_option_b',
        "args": ['EVENT_3479_pause_130']
    },
    {
        "identifier": 'EVENT_3479_pause_115',
        "command": 'pause',
        "args": [10]
    },
    {
    ...
    },
    {
        ...
        "subscript": [
            ...
            {
                "identifier": 'EVENT_3479_action_queue_async_139_SUBSCRIPT_shadow_on_1',
                "command": 'shadow_on'
            },
            {
