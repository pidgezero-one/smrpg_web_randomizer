...
script = [
    ...
    },
    {
        ...
        "command": 'jmp_if_var_equals_short',
        "args": [0x7026, 1, 'EVENT_1370_run_dialog_19']
    },
    {
        "identifier": 'EVENT_1370_run_dialog_16',
        "command": 'run_dialog',
        "args": [2818, AreaObjects.NPC_12, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC, _0x60Flags.MULTILINE]]
    },
    {
        "identifier": 'EVENT_1370_inc_short_17',
        "command": 'inc_short',
        "args": [0x7026]
    },
    {
        "identifier": 'EVENT_1370_jmp_18',
        "command": 'jmp',
        "args": ['EVENT_1358_action_queue_sync_60']
    },
    {
        "identifier": 'EVENT_1370_run_dialog_19',
        "command": 'run_dialog',
        "args": [2819, AreaObjects.NPC_12, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC, _0x60Flags.MULTILINE]]
    },
    {
        "identifier": 'EVENT_1370_inc_short_20',
        "command": 'inc_short',
        "args": [0x7026]
    },
    {
        "identifier": 'EVENT_1370_jmp_21',
        "command": 'jmp',
        "args": ['EVENT_1358_action_queue_sync_60']
    }
]
