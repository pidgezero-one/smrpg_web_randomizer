...
script = [
    ...
    },
    {
        ...
        "args": [0x704c, 4, 'EVENT_3595_jmp_to_subroutine_11']
    },
    {
    ...
    {
        "identifier": 'EVENT_3595_run_dialog_4',
        "command": 'run_dialog',
        "args": [2497, AreaObjects.MEM_70A8, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC, _0x60Flags.MULTILINE, _0x60Flags.USE_BACKGROUND]]
    },
    {
        "identifier": 'EVENT_3595_play_sound_5',
        "command": 'play_sound',
        "args": [Sounds._027_FOUND_AN_ITEM, 6]
    },
    {
        "identifier": 'EVENT_3595_run_dialog_6',
        "command": 'run_dialog',
        "args": [2097, AreaObjects.BOWSER, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC]]
    },
    {
        "identifier": 'EVENT_3595_inc_7',
        "command": 'inc',
        "args": [0x70af]
    },
    {
        "identifier": 'EVENT_3595_unfreeze_all_npcs_8',
        "command": 'unfreeze_all_npcs'
    },
    {
        "identifier": 'EVENT_3595_set_bit_9',
        "command": 'set_bit',
        "args": [0x704c, 4]
    },
    {
        "identifier": 'EVENT_3595_ret_10',
        "command": 'ret'
    },
    {
        "identifier": 'EVENT_3595_jmp_to_subroutine_11',
        "command": 'jmp_to_subroutine',
        "args": ['EVENT_3593_pause_16']
    },
    {
        "identifier": 'EVENT_3595_freeze_all_npcs_until_return_12',
        "command": 'freeze_all_npcs_until_return'
    },
    {
        "identifier": 'EVENT_3595_set_13',
        "command": 'set',
        "args": [0x7000, 3]
    },
    {
