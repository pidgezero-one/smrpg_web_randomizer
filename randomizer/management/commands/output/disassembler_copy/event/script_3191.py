...
script = [
    {
        ...
        "args": [0x7057, 4, 'EVENT_3191_ret_6']
    },
    {
        ...
        "subscript": [
            ...
            {
                "identifier": 'EVENT_3191_action_queue_sync_1_SUBSCRIPT_pause_2',
                "command": 'pause',
                "args": [30]
            },
            {
                "identifier": 'EVENT_3191_action_queue_sync_1_SUBSCRIPT_face_southeast_3',
                "command": 'face_southeast'
            },
            {
                "identifier": 'EVENT_3191_action_queue_sync_1_SUBSCRIPT_reset_properties_4',
                "command": 'reset_properties'
            }
        ]
    },
    {
        "identifier": 'EVENT_3191_run_dialog_2',
        "command": 'run_dialog',
        "args": [1655, AreaObjects.MEM_70A8, [_0x60Flags.CLOSABLE, _0x60Flags.MULTILINE, _0x60Flags.USE_BACKGROUND]]
    },
    {
