...
script = [
    ...
    {
        "identifier": 'EVENT_3708_jmp_if_bit_set_1',
        "command": 'jmp_if_bit_set',
        "args": [0x705f, 6, 'EVENT_3708_play_sound_5']
    },
    {
        "identifier": 'EVENT_3708_run_dialog_2',
        "command": 'run_dialog',
        "args": [3600, AreaObjects.BOWSER, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC]]
    },
    {
        "identifier": 'EVENT_3708_unfreeze_all_npcs_3',
        "command": 'unfreeze_all_npcs'
    },
    {
        "identifier": 'EVENT_3708_ret_4',
        "command": 'ret'
    },
    {
        "identifier": 'EVENT_3708_play_sound_5',
        "command": 'play_sound',
        "args": [Sounds._005_BLOCK_SWITCH, 6]
    },
    {
        "identifier": 'EVENT_3708_pause_6',
        "command": 'pause',
        "args": [8]
    },
    {
        "identifier": 'EVENT_3708_play_sound_7',
        "command": 'play_sound',
        "args": [Sounds._005_BLOCK_SWITCH, 6]
    },
    {
        "identifier": 'EVENT_3708_pause_8',
        "command": 'pause',
        "args": [8]
    },
    {
