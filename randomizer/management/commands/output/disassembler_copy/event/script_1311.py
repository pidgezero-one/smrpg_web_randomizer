...
script = [
    {
        "identifier": 'EVENT_1311_jmp_if_bit_set_0',
        "command": 'jmp_if_bit_set',
        "args": [0x7054, 2, 'EVENT_1311_pause_3']
    },
    {
        "identifier": 'EVENT_1311_run_dialog_1',
        "command": 'run_dialog',
        "args": [2801, AreaObjects.BOWSER, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC]]
    },
    {
        "identifier": 'EVENT_1311_ret_2',
        "command": 'ret'
    },
    {
        "identifier": 'EVENT_1311_pause_3',
        "command": 'pause',
        "args": [5]
    },
    {
        "identifier": 'EVENT_1311_play_sound_4',
        "command": 'play_sound',
    ...
    {
        "identifier": 'EVENT_1311_pause_9',
        "command": 'pause',
        "args": [5]
    },
    {
        "identifier": 'EVENT_1311_remove_one_from_inventory_10',
        "command": 'remove_one_from_inventory',
        "args": [items.RoomKey]
    },
    {
        "identifier": 'EVENT_1311_ret_11',
        "command": 'ret'
    }
]
