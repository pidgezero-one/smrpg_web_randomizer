...
script = [
    ...
    },
    {
        ...
        "command": 'jmp_if_bit_set',
        "args": [0x7040, 0, 'EVENT_1422_reset_and_choose_game_34']
    },
    {
    ...
    {
        "identifier": 'EVENT_1422_run_dialog_22',
        "command": 'run_dialog',
        "args": [2747, AreaObjects.NPC_14, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC, _0x60Flags.MULTILINE]]
    },
    {
    ...
    {
        "identifier": 'EVENT_1422_set_24',
        "command": 'set',
        "args": [0x7000, 2737]
    },
    {
        "identifier": 'EVENT_1422_run_event_as_subroutine_25',
        "command": 'run_event_as_subroutine',
        "args": [3828]
    },
    {
        "identifier": 'EVENT_1422_pause_26',
        "command": 'pause',
        "args": [15]
    },
    {
        "identifier": 'EVENT_1422_action_queue_async_27',
        "command": 'action_queue_async',
        "args": [AreaObjects.NPC_7],
        "subscript": [
            {
                "identifier": 'EVENT_1422_action_queue_async_27_SUBSCRIPT_set_animation_speed_0',
                "command": 'set_animation_speed',
                "args": [SequenceSpeeds.FASTER, [_0x10Flags.WALKING, _0x10Flags.SEQUENCE]]
            },
            {
                "identifier": 'EVENT_1422_action_queue_async_27_SUBSCRIPT_shift_southeast_steps_1',
                "command": 'shift_southeast_steps',
                "args": [3]
            },
            {
                "identifier": 'EVENT_1422_action_queue_async_27_SUBSCRIPT_jump_to_height_2',
                "command": 'jump_to_height',
                "args": [112]
            },
            {
                "identifier": 'EVENT_1422_action_queue_async_27_SUBSCRIPT_shift_southeast_steps_3',
                "command": 'shift_southeast_steps',
                "args": [11]
            },
            {
                "identifier": 'EVENT_1422_action_queue_async_27_SUBSCRIPT_visibility_off_4',
                "command": 'visibility_off'
            }
        ]
    },
    {
        "identifier": 'EVENT_1422_remove_from_current_level_28',
        "command": 'remove_from_current_level',
        "args": [AreaObjects.NPC_7]
    },
    {
        "identifier": 'EVENT_1422_remove_from_level_29',
        "command": 'remove_from_level',
        "args": [AreaObjects.NPC_7, Rooms._204_MUSHROOM_WAY_AREA_02]
    },
    {
        "identifier": 'EVENT_1422_summon_to_level_30',
        "command": 'summon_to_level',
        "args": [AreaObjects.NPC_5, Rooms._205_MUSHROOM_WAY_AREA_03]
    },
    {
        "identifier": 'EVENT_1422_set_bit_31',
        "command": 'set_bit',
        "args": [0x7052, 5]
    },
    {
        "identifier": 'EVENT_1422_unfreeze_all_npcs_32',
        "command": 'unfreeze_all_npcs'
    },
    {
        "identifier": 'EVENT_1422_ret_33',
        "command": 'ret'
    },
    {
        "identifier": 'EVENT_1422_reset_and_choose_game_34',
        "command": 'reset_and_choose_game'
    },
    {
        "identifier": 'EVENT_1422_ret_35',
        "command": 'ret'
    }
]
