...
script = [
    {
        ...
        "subscript": [
            {
                "identifier": 'EVENT_1698_action_queue_sync_0_SUBSCRIPT_shadow_on_0',
                "command": 'shadow_on'
            }
        ]
    },
    {
        ...
        "subscript": [
            {
                "identifier": 'EVENT_1698_action_queue_sync_1_SUBSCRIPT_shadow_on_0',
                "command": 'shadow_on'
            }
        ]
    },
    ...
    },
    {
        ...
        "subscript": [
            ...
            {
                "identifier": 'EVENT_1698_action_queue_async_16_SUBSCRIPT_set_7000_short_mem_to_700C_2',
    ...
    },
    {
        ...
        "subscript": [
            {
                "identifier": 'EVENT_1698_action_queue_sync_37_SUBSCRIPT_shadow_on_0',
                "command": 'shadow_on'
            },
            {
    ...
    },
    {
        ...
        "subscript": [
            ...
            {
                "identifier": 'EVENT_1698_action_queue_async_46_SUBSCRIPT_shadow_off_5',
                "command": 'shadow_off'
            },
            {
    ...
    {
        "identifier": 'EVENT_1698_action_queue_async_47',
        "command": 'action_queue_async',
        "args": [AreaObjects.NPC_12],
        "subscript": [
            {
                "identifier": 'EVENT_1698_action_queue_async_47_SUBSCRIPT_pause_0',
                "command": 'pause',
                "args": [20]
            },
            {
                "identifier": 'EVENT_1698_action_queue_async_47_SUBSCRIPT_face_southeast_1',
                "command": 'face_southeast'
            },
            {
                "identifier": 'EVENT_1698_action_queue_async_47_SUBSCRIPT_pause_2',
                "command": 'pause',
                "args": [8]
            },
            {
                "identifier": 'EVENT_1698_action_queue_async_47_SUBSCRIPT_face_southwest_3',
                "command": 'face_southwest'
            },
            {
                "identifier": 'EVENT_1698_action_queue_async_47_SUBSCRIPT_pause_4',
                "command": 'pause',
                "args": [20]
            },
            {
                "identifier": 'EVENT_1698_action_queue_async_47_SUBSCRIPT_shift_southwest_steps_5',
                "command": 'shift_southwest_steps',
                "args": [3]
            },
            {
                "identifier": 'EVENT_1698_action_queue_async_47_SUBSCRIPT_set_animation_speed_6',
                "command": 'set_animation_speed',
    ...
    {
        "identifier": 'EVENT_1698_run_dialog_48',
        "command": 'run_dialog',
        "args": [1059, AreaObjects.NPC_12, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC, _0x60Flags.MULTILINE]]
    },
    {
        ...
        "subscript": [
            ...
            {
                "identifier": 'EVENT_1698_action_queue_async_49_SUBSCRIPT_shift_northeast_steps_1',
                "command": 'shift_northeast_steps',
                "args": [3]
            },
            {
                "identifier": 'EVENT_1698_action_queue_async_49_SUBSCRIPT_face_southeast_2',
                "command": 'face_southeast'
            },
            {
                "identifier": 'EVENT_1698_action_queue_async_49_SUBSCRIPT_pause_3',
                "command": 'pause',
                "args": [30]
            },
            {
                "identifier": 'EVENT_1698_action_queue_async_49_SUBSCRIPT_play_sound_4',
                "command": 'play_sound',
                "args": [Sounds._033_JUMPING_BOUNCING_FISH, 4]
            },
            {
                "identifier": 'EVENT_1698_action_queue_async_49_SUBSCRIPT_jump_to_height_5',
                "command": 'jump_to_height',
                "args": [112]
            },
            {
                "identifier": 'EVENT_1698_action_queue_async_49_SUBSCRIPT_fixed_f_coord_on_6',
                "command": 'fixed_f_coord_on'
            },
            {
                "identifier": 'EVENT_1698_action_queue_async_49_SUBSCRIPT_shift_east_steps_7',
                "command": 'shift_east_steps',
                "args": [4]
            },
            {
                "identifier": 'EVENT_1698_action_queue_async_49_SUBSCRIPT_visibility_off_8',
