...
from randomizer.types.enemy_attacks import EnemyAttack
...
from randomizer.types.monster_scripts.arguments.types import CommandType, Target
from randomizer.types.monster_scripts.ids import TOTAL_ATTACKS
from .types import (
