...
BOWSER = AreaObject(0x02)
GENO = AreaObject(0x03)
MALLOW = AreaObject(0x04)
DUMMY_0X05 = AreaObject(0x05)
DUMMY_0X06 = AreaObject(0x06)
DUMMY_0X07 = AreaObject(0x07)
CHARACTER_IN_SLOT_1 = AreaObject(0x08)
CHARACTER_IN_SLOT_2 = AreaObject(0x09)
CHARACTER_IN_SLOT_3 = AreaObject(0x0A)
DUMMY_0X0B = AreaObject(0x0B)
