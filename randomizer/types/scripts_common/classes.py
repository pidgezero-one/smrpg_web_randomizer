...
class Script(Generic[TScriptCommand]):
    ...
    def set_contents(self, script: List[TScriptCommand] = []) -> None:
        self._contents = deepcopy(script)

    def __init__(self, script: List[TScriptCommand] = []) -> None:
