...
from randomizer.types.overworld_scripts.arguments.variables import PRIMARY_TEMP_700C
...
from randomizer.types.overworld_scripts.ids import TOTAL_ROOMS, TOTAL_SOUNDS
from randomizer.types.overworld_scripts.arguments import COORD_F
