...
class SetVarToConst(ActionScriptCommand):
    ...
    def render(self) -> bytearray:
        ...
        elif self.address == PRIMARY_TEMP_700C:
...
class CopyVarToVar(ActionScriptCommand):
    ...
    def set_addresses(self, from_var=None, to_var=None):
        ...
        if self.from_var != PRIMARY_TEMP_700C and self.to_var != PRIMARY_TEMP_700C:
            self._size = 3
        else:
            self._size = 2
    ...
    def render(self) -> bytearray:
        ...
        elif self.from_var == PRIMARY_TEMP_700C and isinstance(self.to_var, ByteVar):
            return super().render(0xB5, self.to_var)
        elif self.to_var == PRIMARY_TEMP_700C and isinstance(self.from_var, ShortVar):
            return super().render(0xBA, self.from_var)
        elif self.from_var == PRIMARY_TEMP_700C and isinstance(self.to_var, ShortVar):
