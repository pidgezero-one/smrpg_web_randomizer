...
class ActionQueueSubscript(Subscript):
    ...
    def __init__(self, sync: bool, script: List[ActionScriptCommand] = []) -> None:
        self.set_sync(sync)
...
class ActionQueuePrototype(EventScriptCommandActionScriptContainer):
    ...
    def __init__(
        ...
        target: AreaObject,
        sync: bool = False,
        subscript: List[ActionScriptCommand] = [],
        identifier: Optional[str] = None,
    ) -> None:
        super().__init__(identifier)
        self._subscript = ActionQueueSubscript(sync)
...
class EventScript(Script[EventScriptCommand]):
    ...
    def set_contents(self, script: List[EventScriptCommand] = []) -> None:
        super().set_contents(script)

    def __init__(self, script: List[EventScriptCommand] = []) -> None:
        super().__init__(script)
...
class EventScriptBank(ScriptBank[EventScript]):
    ...
    def set_contents(self, scripts: List[EventScript] = []) -> None:
