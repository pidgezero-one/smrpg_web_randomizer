...
from randomizer.types.overworld_scripts.constants.layers import (
    LAYER_L1,
    LAYER_L2,
    LAYER_L3,
    LAYER_L4,
...
class JmpIfRandom2of3(EventScriptCommandWithJmps):
...
class JmpIfRandom1of2(EventScriptCommandWithJmps):
...
class ActionQueueAsync(ActionQueuePrototype):
...
class ActionQueueSync(ActionQueuePrototype):
    """The specified NPC performs the given set of action script commands.
...
class StartAsyncEmbeddedActionScript(StartEmbeddedActionScriptPrototype):
    """The specified NPC performs the given set of action script commands.
    The included action script must complete before the parent event script
    is allowed to continue.\n
...
class StartSyncEmbeddedActionScript(StartEmbeddedActionScriptPrototype):
    """The specified NPC performs the given set of action script commands.
    The included action script does not need to achieve completion in order
    for the parent event script to continue.\n
...
class EnableTriggerOfObjectAt70A8InCurrentLevel(EventScriptCommandNoArgs):
    """The NPC whose relative ID is stored at $70A8 (usually the most recent NPC the player
