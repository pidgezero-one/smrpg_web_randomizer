...
JMP_TO_START_OF_THIS_SCRIPT: EventScriptCommandName = "jmp_to_start_of_this_script"  # F9
JMP_TO_START_OF_THIS_SCRIPT_FA: EventScriptCommandName = "jmp_to_start_of_this_script_FA"  # FA
JMP_TO_SUBROUTINE: EventScriptCommandName = "jmp_to_subroutine"
MOVE_SCRIPT_TO_MAIN_THREAD: EventScriptCommandName = "move_script_to_main_thread"  # FD 40
...
RUN_BACKGROUND_EVENT_WITH_PAUSE: EventScriptCommandName = "run_background_event_with_pause"  # 44
...
STOP_ALL_BACKGROUND_EVENTS: EventScriptCommandName = "stop_all_background_events"  # FD 43
...
JMP_IF_LOADED_MEMORY_IS_BELOW_0: EventScriptCommandName = "jmp_if_loaded_memory_is_below_0"  # EE
JMP_IF_LOADED_MEMORY_IS_NOT_0: EventScriptCommandName = "jmp_if_loaded_memory_is_not_0"  # EB
JMP_IF_MEM_704X_AT_7000_BIT_CLEAR: EventScriptCommandName = "jmp_if_mem_704x_at_7000_bit_clear"  # DF
JMP_IF_MEM_704X_AT_7000_BIT_SET: EventScriptCommandName = "jmp_if_mem_704x_at_7000_bit_set"  # DB
...
MOVE_7010_7015_TO_7016_701B: EventScriptCommandName = "move_7010_7015_to_7016_701B"  # BE
MOVE_7016_701B_TO_7010_7015: EventScriptCommandName = "move_7016_701B_to_7010_7015"  # BF
...
JMP_IF_COMPARISON_RESULT_IS_LESSER: EventScriptCommandName = "jmp_if_comparison_result_is_lesser"  # ED
JMP_IF_VAR_EQUALS_CONST: EventScriptCommandName = "jmp_if_var_equals_const"  # E0, E2, E4
JMP_IF_VAR_NOT_EQUALS_CONST: EventScriptCommandName = "jmp_if_var_not_equals_const"  # E1, E3, E5
...
START_EMBEDDED_ACTION_SCRIPT: EventScriptCommandName = "start_embedded_action_script"  # xx F0, xx F1
...
SET_TEMP_ACTION_SCRIPT: EventScriptCommandName = "set_temp_action_script"  # xx F4, xx F5
...
STOP_EMBEDDED_ACTION_SCRIPT: EventScriptCommandName = "stop_embedded_action_script"  # xx FE
RESET_COORDS: EventScriptCommandName = "reset_coords"  # xx FF
CREATE_PACKET_AT_NPC_COORDS: EventScriptCommandName = "create_packet_at_npc_coords"  # 3E
CREATE_PACKET_AT_7010: EventScriptCommandName = "create_packet_at_7010"  # 3F
CREATE_PACKET_AT_7010_WITH_EVENT: EventScriptCommandName = "create_packet_at_7010_with_event"  # FD 3E
FREEZE_ALL_NPCS_UNTIL_RETURN: EventScriptCommandName = "freeze_all_npcs_until_return"  # 30
...
JMP_IF_PRESENT_IN_CURRENT_LEVEL: EventScriptCommandName = "jmp_if_present_in_current_level"  # 32
JMP_IF_OBJECT_NOT_IN_LEVEL: EventScriptCommandName = "jmp_if_object_not_in_level"  # F8
JMP_IF_OBJECT_TRIGGER_ENABLED: EventScriptCommandName = "jmp_if_object_trigger_enabled"  # FD F0
JMP_IF_OBJECT_TRIGGER_DISABLED: EventScriptCommandName = "jmp_if_object_trigger_disabled"  # FD F0
...
SET_7000_TO_OBJECT_COORD: EventScriptCommandName = "set_7000_to_object_coord"  # C4, C5, C6
...
ENABLE_CONTROLS_UNTIL_RETURN: EventScriptCommandName = "enable_controls_until_return"  # 34
...
SET_EXPERIENCE_PACKET_7000: EventScriptCommandName = "set_experience_packet_7000"  # FD 64
...
STORE_7000_ITEM_QUANTITY_TO_70A7: EventScriptCommandName = "store_7000_item_quantity_to_70A7"  # FD 5E
STORE_CHARACTER_EQUIPMENT_7000: EventScriptCommandName = "store_character_equipment_7000"  # FD 5D
...
STORE_FROG_COIN_AMOUNT_7000: EventScriptCommandName = "store_frog_coin_amount_7000"  # FD 5A
...
PAUSE_SCRIPT_UNTIL_EFFECT_DONE: EventScriptCommandName = "pause_script_until_effect_done"  # 7F
...
STAR_MASK_SHRINK_TO_SCREEN_CENTER: EventScriptCommandName = "star_mask_shrink_to_screen_center"  # 7B
...
FADE_IN_FROM_BLACK_SYNC_DURATION: EventScriptCommandName = "fade_in_from_black_sync_duration"  # 72
FADE_IN_FROM_BLACK_ASYNC_DURATION: EventScriptCommandName = "fade_in_from_black_async_duration"  # 73
FADE_IN_FROM_COLOUR_DURATION: EventScriptCommandName = "fade_in_from_colour_duration"  # 78
...
FADE_OUT_TO_BLACK_SYNC_DURATION: EventScriptCommandName = "fade_out_to_black_sync_duration"  # 76
FADE_OUT_TO_BLACK_ASYNC_DURATION: EventScriptCommandName = "fade_out_to_black_async_duration"  # 77
FADE_OUT_TO_COLOUR_DURATION: EventScriptCommandName = "fade_out_to_colour_duration"  # 79
...
JMP_IF_AUDIO_MEMORY_AT_LEAST: EventScriptCommandName = "jmp_if_audio_memory_at_least"  # FD 96
JMP_IF_AUDIO_MEMORY_EQUALS: EventScriptCommandName = "jmp_if_audio_memory_equals"  # FD 97
...
JMP_IF_DIALOG_OPTION_B_OR_C: EventScriptCommandName = "jmp_if_dialog_option_b_or_c"  # 67
...
OPEN_MENU_OR_RUN_EVENT_SEQUENCE: EventScriptCommandName = "open_menu_or_run_event_sequence"  # 4F
...
RUN_LEVELUP_BONUS_SEQUENCE: EventScriptCommandName = "run_levelup_bonus_sequence"  # FD 65
...
RUN_MOLEVILLE_MOUNTAIN_SEQUENCE: EventScriptCommandName = "run_moleville_mountain_sequence"  # FD 4E
