...
from smrpgpatchbuilder.datatypes.allies.ally import (Ally as AllyBase)
...
class SpriteAnimationState(str, Enum):
    ...
    SPIN = "spin"
    SEES_GENO = "sees_geno"
    SPELL_FRAME_1 = "spell_frame_1"
    SPELL_FRAME_2 = "spell_frame_2"
    SPELL_FRAME_3 = "spell_frame_3"
    SPELL_FRAME_4 = "spell_frame_4"
    SPELL_FRAME_5 = "spell_frame_5"
