...
from randomizer.types.numbers import Int16, Int8, UInt16, UInt8, UInt4
from randomizer.types.sprites.ids import TOTAL_SPRITES
from randomizer.types.scripts_common import (
...
from randomizer.types.battle_animation_scripts.arguments import (
    BUTTON_PRESSED,
    FADE_2BPP_COMPLETE,
    FADE_4BPP_COMPLETE,
    FADE_IN_COMPLETE,
...
from randomizer.types.battle_animation_scripts.arguments.types import (
    BattleTarget,
    BonusMessage,
    FlashColour,
    MaskEffect,
