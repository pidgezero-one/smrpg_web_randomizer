...
class AdvancedPreset(Preset):
    _name: str = "Advanced"
    _description: str = "More difficult options for advanced players, requiring you to manage your equips more."
    _flags: str = (
