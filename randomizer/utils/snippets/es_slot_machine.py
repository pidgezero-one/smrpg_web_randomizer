...
def create_slot_machine_script_for_one_room(room: Room, battlefield_override_id: int, slot_start_idx: int, heal = False) -> list[UsableEventScriptCommand]:
    ...
    return [
        ...
        JmpIfVarEqualsConst(UNKNOWN_70ED, 0, [f"gen_{uniq}_jmp_if_var_equals_const_45"]),
        JmpIfVarEqualsConst(UNKNOWN_70ED, 1, [f"gen_{uniq}_jmp_if_var_equals_const_48"]),
        JmpIfVarEqualsConst(UNKNOWN_70ED, 2, [f"gen_{uniq}_jmp_if_var_equals_const_51"]),
        JmpIfVarEqualsConst(UNKNOWN_70CC, 0, [f"gen_{uniq}_jmp_if_var_equals_const_54"], identifier=f"gen_{uniq}_jmp_if_var_equals_const_45"),
        JmpIfVarEqualsConst(UNKNOWN_70CC, 1, [f"gen_{uniq}_jmp_if_var_equals_const_56"]),
        Jmp([f"gen_{uniq}_jmp_if_var_equals_const_59"]),
        JmpIfVarEqualsConst(UNKNOWN_70CC, 0, [f"gen_{uniq}_jmp_if_var_equals_const_62"], identifier=f"gen_{uniq}_jmp_if_var_equals_const_48"),
        JmpIfVarEqualsConst(UNKNOWN_70CC, 1, [f"gen_{uniq}_jmp_if_var_equals_const_65"]),
        Jmp([f"gen_{uniq}_jmp_if_var_equals_const_67"]),
        JmpIfVarEqualsConst(UNKNOWN_70CC, 0, [f"gen_{uniq}_jmp_if_var_equals_const_70"], identifier=f"gen_{uniq}_jmp_if_var_equals_const_51"),
        JmpIfVarEqualsConst(UNKNOWN_70CC, 1, [f"gen_{uniq}_jmp_if_var_equals_const_73"]),
        Jmp([f"gen_{uniq}_jmp_if_var_equals_const_76"]),
        JmpIfVarEqualsConst(UNKNOWN_70CD, 0, [f"gen_{uniq}_summon_to_current_level_78"], identifier=f"gen_{uniq}_jmp_if_var_equals_const_54"),
        Jmp([f"gen_{uniq}_play_sound_83"]),
        JmpIfVarEqualsConst(UNKNOWN_70CD, 0, [f"gen_{uniq}_play_sound_83"], identifier=f"gen_{uniq}_jmp_if_var_equals_const_56"),
        JmpIfVarEqualsConst(UNKNOWN_70CD, 1, [f"gen_{uniq}_play_sound_88"]),
        Jmp([f"gen_{uniq}_action_queue_99"]),
        JmpIfVarEqualsConst(UNKNOWN_70CD, 0, [f"gen_{uniq}_play_sound_83"], identifier=f"gen_{uniq}_jmp_if_var_equals_const_59"),
        JmpIfVarEqualsConst(UNKNOWN_70CD, 1, [f"gen_{uniq}_action_queue_99"]),
        Jmp([f"gen_{uniq}_play_sound_95"]),
        JmpIfVarEqualsConst(UNKNOWN_70CD, 0, [f"gen_{uniq}_play_sound_83"], identifier=f"gen_{uniq}_jmp_if_var_equals_const_62"),
        JmpIfVarEqualsConst(UNKNOWN_70CD, 1, [f"gen_{uniq}_play_sound_88"]),
        Jmp([f"gen_{uniq}_action_queue_99"]),
        JmpIfVarEqualsConst(UNKNOWN_70CD, 1, [f"gen_{uniq}_summon_to_current_level_78"], identifier=f"gen_{uniq}_jmp_if_var_equals_const_65"),
        Jmp([f"gen_{uniq}_play_sound_88"]),
        JmpIfVarEqualsConst(UNKNOWN_70CD, 0, [f"gen_{uniq}_action_queue_99"], identifier=f"gen_{uniq}_jmp_if_var_equals_const_67"),
        JmpIfVarEqualsConst(UNKNOWN_70CD, 1, [f"gen_{uniq}_play_sound_88"]),
        Jmp([f"gen_{uniq}_play_sound_95"]),
        JmpIfVarEqualsConst(UNKNOWN_70CD, 0, [f"gen_{uniq}_play_sound_83"], identifier=f"gen_{uniq}_jmp_if_var_equals_const_70"),
        JmpIfVarEqualsConst(UNKNOWN_70CD, 1, [f"gen_{uniq}_action_queue_99"]),
        Jmp([f"gen_{uniq}_play_sound_95"]),
        JmpIfVarEqualsConst(UNKNOWN_70CD, 0, [f"gen_{uniq}_action_queue_99"], identifier=f"gen_{uniq}_jmp_if_var_equals_const_73"),
        JmpIfVarEqualsConst(UNKNOWN_70CD, 1, [f"gen_{uniq}_play_sound_88"]),
        Jmp([f"gen_{uniq}_play_sound_95"]),
