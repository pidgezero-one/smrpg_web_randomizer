...
from randomizer.data import bosses, spells
...
def is_coin(item):
    return (
        utils.isclass_or_instance(item, Coins)
        or utils.isclass_or_instance(item, FrogCoin)
        or utils.isclass_or_instance(item, MultiFrogCoin)
        or utils.isclass_or_instance(item, RareFrogCoin)
        or utils.isclass_or_instance(item, InfiniteCoins)
    )
