...
script = [
    {
        "identifier": 'EVENT_1866_j',
        "command": 'jmp_if_bit_set',
        "args": [0x709C, 1, 'EVENT_1866_inc_7']
    },
    {
        "identifier": 'EVENT_1866_s',
        "command": 'set_bit',
        "args": [0x709C, 1]
    },
    {
        "identifier": 'EVENT_1866_priority_set_0',
    ...
    {
        "identifier": 'EVENT_1866_run_background_event_with_pause_return_on_exit_2',
        "command": 'run_background_event_with_pause_return_on_exit',
        "args": [1843, 0x701e, [12, 13]]
    },
    {
        "identifier": 'EVENT_1866_freeze_camera_6',
    ...
    },
    {
        ...
        "subscript": [
            ...
            {
                "identifier": 'EVENT_1866_action_queue_sync_7_SUBSCRIPT_shift_north_steps_1',
                "command": 'shift_north_steps',
                "args": [2]
            },
            {
                "identifier": 'EVENT_1866_action_queue_sync_7_SUBSCRIPT_set_animation_speed_2',
                "command": 'set_animation_speed',
    ...
    {
        "identifier": 'EVENT_1866_run_background_event_with_pause_return_on_exit_9',
        "command": 'run_background_event_with_pause_return_on_exit',
        "args": [1543, 0x701c, [12, 13]]
    },
    {
        "identifier": 'EVENT_1866_reactivate_trigger_if_mario_on_top_of_object_10',
        "command": 'reactivate_trigger_if_mario_on_top_of_object'
    },
    {
        "identifier": 'EVENT_1866_inc_7',
