...
script = [
    ...
    },
    {
        ...
        "command": "run_dialog",
        "args": [1941, AreaObjects.BOWSER, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC]],
    },
    {"identifier": "EVENT_1311_ret_4", "command": "ret"},
    {
        "identifier": "EVENT_1311_apply_tile_mod_5",
        "command": "apply_tile_mod",
        "args": [
            Rooms._041_BOOSTER_TOWER_8F_AREA_01_MINESWEEPER_ROOM_WCOINS_AND_HIDDEN_FIREBALLS,
            32,
    ...
    {"identifier": "EVENT_1311_ret_10", "command": "ret"},
]
