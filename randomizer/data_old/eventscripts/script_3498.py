...
script = [
    {
        ...
        "args": [0x7078, 7, "EVENT_3498_action_queue_async_5"],
    },
    {
        "identifier": "EVENT_3498_set_action_script_sync_1",
        "command": "set_action_script",
        "args": [AreaObjects.NPC_4, True, 45],
    },
    {
    ...
    {
        "identifier": "EVENT_3498_create_packet_at_npc_coords_10",
        "command": "create_packet_at_npc_coords",
        "args": [
            NPCPackets._017_SMALL_COIN_NOT_MOVING,
            AreaObjects.NPC_1,
            "EVENT_3498_pause_11",
        ],
    },
    {"identifier": "EVENT_3498_pause_11", "command": "pause", "args": [1]},
    {"identifier": "EVENT_3498_inc_short_12", "command": "inc", "args": [0x700C]},
    {"identifier": "EVENT_3498_end_loop_13", "command": "end_loop"},
    {"identifier": "EVENT_3498_pause_14", "command": "pause", "args": [30]},
    {
        "identifier": "EVENT_3498_jmp_if_bit_set_15",
        "command": "jmp_if_bit_set",
        "args": [0x7043, 1, "EVENT_3498_action_queue_async_18"],
    },
    {"identifier": "EVENT_3498_set_bit_16", "command": "set_bit", "args": [0x7043, 1]},
    {
    ...
    {"identifier": "EVENT_3498_pause_19", "command": "pause", "args": [180]},
    {
    ...
    {
        "identifier": "EVENT_3498_create_packet_at_npc_coords_25",
        "command": "create_packet_at_npc_coords",
        "args": [
            NPCPackets._017_SMALL_COIN_NOT_MOVING,
            AreaObjects.NPC_3,
    ...
    {"identifier": "EVENT_3498_pause_26", "command": "pause", "args": [1]},
    {"identifier": "EVENT_3498_inc_short_27", "command": "inc", "args": [0x700C]},
    {"identifier": "EVENT_3498_end_loop_28", "command": "end_loop"},
    {"identifier": "EVENT_3498_pause_29", "command": "pause", "args": [20]},
    {
    ...
    {"identifier": "EVENT_3498_set_bit_35", "command": "set_bit", "args": [0x7043, 2]},
    {
        "identifier": "EVENT_3498_jmp_36",
        "command": "jmp",
        "args": ["EVENT_3498_action_queue_async_20"],
    },
    {"identifier": "EVENT_3498_ret_41", "command": "ret"},
]
