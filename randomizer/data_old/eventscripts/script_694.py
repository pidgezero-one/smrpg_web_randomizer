...
script = [
    ...
    {
        "identifier": 'EVENT_694_jmp_if_7000_equals_short_1',
        "command": 'jmp_if_var_equals_const',
        'args': [0x7000, 65, 'EVENT_694_run_dialog_5']
    },
    {
        "identifier": 'EVENT_694_jmp_if_bit_set_insert',
        "command": 'jmp_if_bit_set',
        "args": [0x704c, 7, 'EVENT_694_run_dialog_insert']
    },
    {
        "identifier": 'EVENT_694_run_dialog_2',
        "command": 'run_dialog',
        "args": [2121, AreaObjects.MEM_70A8, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC, _0x60Flags.MULTILINE, _0x60Flags.USE_BACKGROUND]]
    },
    {
