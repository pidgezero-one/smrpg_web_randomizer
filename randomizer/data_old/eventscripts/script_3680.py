...
script = [
    ...
    {"identifier": "EVENT_3680_set_bit_2", "command": "set_bit", "args": [0x704A, 2]},
    {
        "identifier": "EVENT_3680_run_event_as_subroutine_3",
        "command": "run_event_as_subroutine",
        "args": [1011],
    },
    {"identifier": "EVENT_3680_set_bit_4", "command": "set_bit", "args": [0x705F, 5]},
    {"identifier": "EVENT_3680_restore_all_hp_5", "command": "restore_all_hp"},
    {"identifier": "EVENT_3680_restore_all_fp_6", "command": "restore_all_fp"},
    {
    ...
    {"identifier": "EVENT_3680_ret_160", "command": "ret"},
    {
    ...
    {"identifier": "EVENT_3680_ret_36", "command": "ret"},
]
