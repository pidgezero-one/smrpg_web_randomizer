...
script = [
    {
        ...
        "args": [0x7043, 1, "EVENT_1538_run_background_event_2"],
    },
    {"identifier": "EVENT_1538_set_bit_0", "command": "set_bit", "args": [0x7043, 1]},
    {
    ...
    {"identifier": "EVENT_1538_s", "command": "set_bit", "args": [0x709C, 1]},
    {
