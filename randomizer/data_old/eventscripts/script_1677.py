...
script = [
    {
        "identifier": "EVENT_1677_jmp_if_object_in_level_18",
        "command": "jmp_if_object_in_level",
        "args": [AreaObjects.NPC_3, 427, "EVENT_1677_ret"],
    },
    {"identifier": "EVENT_1677_set_bit_0", "command": "set_bit", "args": [0x7087, 0]},
    {
    ...
    {"identifier": "EVENT_1677_set_bit_116", "command": "set_bit", "args": [0x7067, 7]},
    {"identifier": "EVENT_1677_set_bit_118", "command": "set_bit", "args": [0x706F, 6]},
    {
        ...
        "args": [
            ...
            47,
            16,
            [_0x68Flags.SHOW_MESSAGE],
        ],
    },
    {"identifier": "EVENT_1677_set_bit_7", "command": "set_bit", "args": [0x7049, 0]},
    {
    ...
    {"identifier": "EVENT_1677_ret", "command": "ret"},
]
