...
script = [
    {
        "identifier": "EVENT_3931_play_sound_4",
        "command": "play_sound",
        "args": [Sounds._027_FOUND_AN_ITEM, 6],
    },
    {
        "identifier": "EVENT_3931_run_dialog_5",
        "command": "run_dialog",
        "args": [2096, AreaObjects.BOWSER, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC]],
    },
    {
        "identifier": "EVENT_3931_put_inventory_22",
        "command": "put_inventory",
        "args": [230],
    },
    {"identifier": "EVENT_3931_inc_7", "command": "inc", "args": [0x70B2]},
    {"identifier": "EVENT_3931_inc_7_", "command": "ret"},
]
