...
script = [
    ...
    {
        "identifier": 'EVENT_3367_jmp_if_var_equals_const_3',
        "command": 'jmp_if_var_equals_const',
        "args": [0x70af, 1, 'EVENT_3369_set_7000_to_70A0_short_mem_32']
    },
    {
        "identifier": 'EVENT_3367_jmp_if_var_equals_const_4',
        "command": 'jmp_if_var_equals_const',
        "args": [0x7026, 1, 'EVENT_3369_run_dialog_12']
    },
    {
        "identifier": 'EVENT_3367_jmp_if_var_equals_const_5',
        "command": 'jmp_if_var_equals_const',
        "args": [0x7026, 2, 'EVENT_3369_run_dialog_10']
    },
    {
        "identifier": 'EVENT_3367_jmp_if_var_equals_const_6',
        "command": 'jmp_if_var_equals_const',
        "args": [0x7026, 3, 'EVENT_3369_run_dialog_8']
    },
    {
        "identifier": 'EVENT_3367_jmp_if_var_equals_const_7',
        "command": 'jmp_if_var_equals_const',
