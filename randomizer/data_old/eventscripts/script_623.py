...
script = [
    ...
    {"identifier": "EVENT_623_pause_1", "command": "pause", "args": [90]},
    {"identifier": "EVENT_623_pause_2", "command": "pause", "args": [60]},
    {
    ...
    {"identifier": "EVENT_623_jmp_7", "command": "jmp", "args": ["EVENT_623_pause_13"]},
    {
        "identifier": "EVENT_623_set_action_script_sync_12",
        "command": "set_action_script",
        "args": [AreaObjects.NPC_6, True, 327],
    },
    {"identifier": "EVENT_623_pause_13", "command": "pause", "args": [1]},
    {
    ...
    {"identifier": "EVENT_623_ret_24", "command": "ret"},
]
