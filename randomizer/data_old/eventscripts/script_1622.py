...
script = [
    ...
    {
        "identifier": "EVENT_1622_jmp_if_7000_not_equals_short_2",
    ...
    {
        "identifier": "EVENT_1622_jmp_if_7000_not_equals_short_4",
        "command": "jmp_if_var_not_equals_const",
        "args": [0x7000, 4, "EVENT_1622_ret_10"],
    },
    {
    ...
    {"identifier": "EVENT_1622_set_bit_7", "command": "set_bit", "args": [0x7096, 5]},
    {"identifier": "EVENT_1622_clear_bit_0", "command": "set_bit", "args": [0x7087, 0]},
    {
        "identifier": "EVENT_1622_enter_area_9",
        "command": "enter_area",
        "args": [
            Rooms._069_MIDAS_RIVER_WATERFALL,
    ...
    {"identifier": "EVENT_1622_ret_10", "command": "ret"},
    {"identifier": "EVENT_1622_bucket_warp", "command": "set_bit", "args": [0x708F, 0]},
    {
