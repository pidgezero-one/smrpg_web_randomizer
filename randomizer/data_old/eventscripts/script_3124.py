...
script = [
    ...
    {
        "identifier": "EVENT_3124_play_sound_0",
        "command": "play_sound",
    ...
    },
    {
        ...
        "subscript": [
            ...
            {
                "identifier": "EVENT_3124_action_queue_sync_3_SUBSCRIPT_sequence_looping_on_1",
                "command": "sequence_looping_on",
            },
            {
                "identifier": "EVENT_3124_action_queue_sync_3_SUBSCRIPT_set_animation_speed_2",
                "command": "set_animation_speed",
                "args": [SequenceSpeeds.FAST, [_0x10Flags.SEQUENCE]],
            },
            {
                "identifier": "EVENT_3124_action_queue_sync_3_SUBSCRIPT_set_sprite_sequence_3",
                "command": "set_sprite_sequence",
                "args": [1, 0, [_0x08Flags.LOOPING_OFF, _0x08Flags.READ_AS_SEQUENCE]],
            },
            {
                "identifier": "EVENT_3124_action_queue_sync_3_SUBSCRIPT_db_4",
                "command": "db",
                "args": [0x20, 0x04],
            },
            {
                "identifier": "EVENT_3124_action_queue_sync_3_SUBSCRIPT_db_5",
                "command": "db",
                "args": [0x25, 0xC0, 0x03, 0x80, 0xFF],
            },
            {
                "identifier": "EVENT_3124_action_queue_sync_3_SUBSCRIPT_pause_6",
                "command": "pause",
                "args": [8],
            },
            {
                "identifier": "EVENT_3124_action_queue_sync_3_SUBSCRIPT_bpl_26_27_28_7",
                "command": "bpl_26_27_28",
            },
            {
                "identifier": "EVENT_3124_action_queue_sync_3_SUBSCRIPT_set_sprite_sequence_8",
                "command": "set_sprite_sequence",
    ...
    {
        "identifier": "EVENT_3124_set_7010_to_object_xyz_4",
    ...
    {
        "identifier": "EVENT_3124_play_sound_9",
        "command": "play_sound",
    ...
    {"identifier": "EVENT_3124_pause_12", "command": "pause", "args": [12]},
    {
        "identifier": "EVENT_3124_play_sound_13",
        "command": "play_sound",
    ...
    {
        "identifier": "EVENT_3124_jmp_if_bit_set_22",
        "command": "jmp_if_bit_set",
        "args": [0x7040, 0, "EVENT_3124_reset_and_choose_game_30"],
    },
    {
        "identifier": "EVENT_3124_fade_in_from_black_async_23",
    ...
    {"identifier": "EVENT_3124_set_bit_24", "command": "set_bit", "args": [0x7064, 6]},
    {
        ...
        "subscript": [
            ...
            {
                "identifier": "EVENT_3124_action_queue_sync_25_SUBSCRIPT_db_1",
                "command": "db",
                "args": [0x25, 0x40, 0x00, 0x80, 0xFF],
            },
            {
                "identifier": "EVENT_3124_action_queue_sync_25_SUBSCRIPT_pause_2",
                "command": "pause",
                "args": [8],
            },
            {
                "identifier": "EVENT_3124_action_queue_sync_25_SUBSCRIPT_bpl_26_27_28_3",
                "command": "bpl_26_27_28",
            },
            {
                "identifier": "EVENT_3124_action_queue_sync_25_SUBSCRIPT_jmp_if_bit_set_4",
                "command": "jmp_if_bit_set",
                "args": [
                    0x7040,
                    1,
                    "EVENT_3124_action_queue_sync_25_SUBSCRIPT_object_memory_clear_bit_9",
                ],
            },
            {
                "identifier": "EVENT_3124_action_queue_sync_25_SUBSCRIPT_set_sprite_sequence_5",
                "command": "set_sprite_sequence",
                "args": [4, 0, [_0x08Flags.LOOPING_OFF, _0x08Flags.READ_AS_SEQUENCE]],
            },
            {
                "identifier": "EVENT_3124_action_queue_sync_25_SUBSCRIPT_object_memory_set_bit_6",
                "command": "object_memory_set_bit",
                "args": [0x30, [4]],
            },
            {
                "identifier": "EVENT_3124_action_queue_sync_25_SUBSCRIPT_sequence_looping_off_7",
                "command": "sequence_looping_off",
            },
            {
                "identifier": "EVENT_3124_action_queue_sync_25_SUBSCRIPT_ret_8",
                "command": "ret",
            },
            {
                "identifier": "EVENT_3124_action_queue_sync_25_SUBSCRIPT_object_memory_clear_bit_9",
                "command": "object_memory_clear_bit",
                "args": [0x30, [4]],
            },
            {
                "identifier": "EVENT_3124_action_queue_sync_25_SUBSCRIPT_sequence_looping_off_10",
                "command": "sequence_looping_off",
            },
            {
                "identifier": "EVENT_3124_action_queue_sync_25_SUBSCRIPT_set_sprite_sequence_11",
                "command": "set_sprite_sequence",
                "args": [0, 0, [_0x08Flags.LOOPING_OFF, _0x08Flags.READ_AS_SEQUENCE]],
            },
            {
                "identifier": "EVENT_3124_action_queue_sync_25_SUBSCRIPT_ret_12",
                "command": "ret",
            },
        ],
    },
    {
        "identifier": "EVENT_3124_clear_bit_26",
        "command": "clear_bit",
        "args": [0x7064, 5],
    },
    {
        "identifier": "EVENT_3124_jmp_if_bit_set_27",
        "command": "jmp_if_bit_set",
        "args": [0x7040, 1, "EVENT_3124_ret_29"],
    },
    {"identifier": "EVENT_3124_set_bit_28", "command": "set_bit", "args": [0x7064, 5]},
    ...
    {"identifier": "EVENT_3124_ret_29", "command": "ret"},
    {
        "identifier": "EVENT_3124_reset_and_choose_game_30",
