...
script = [
    {
        "identifier": "EVENT_2814_clear_star",
    ...
    {"identifier": "EVENT_2814_set_4", "command": "set_var_to_const", "args": [0x70DA, 0]},
    {"identifier": "EVENT_2814_set_5", "command": "set_var_to_const", "args": [0x70DB, 0]},
    {"identifier": "EVENT_2814_set_6", "command": "set_var_to_const", "args": [0x70DC, 0]},
    {"identifier": "EVENT_2814_set_7", "command": "set_var_to_const", "args": [0x70DD, 0]},
    {"identifier": "EVENT_2814_set_9_", "command": "set_var_to_const", "args": [0x70F8, 0]},
    {"identifier": "EVENT_2814_set_9__", "command": "set_var_to_const", "args": [0x70F9, 0]},
    {
    ...
    {
        "identifier": "EVENT_2814_jmp_if_bit_clear_7",
        "command": "jmp_if_bit_clear",
        "args": [0x7087, 0, "EVENT_2814_run_background_event_13"],
    },
    {
        "identifier": "EVENT_2814_run_event_as_subroutine_25_",
        "command": "run_event_as_subroutine",
        "args": [3588],
    },
    {
        "identifier": "EVENT_2814_jmp_if_bit_clear_7_",
        "command": "jmp_if_bit_clear",
        "args": [0x7099, 7, "EVENT_2814_run_background_event_13"],
    },
    {
        "identifier": "EVENT_2814_run_event_as_subroutine_25__",
        "command": "run_event_as_subroutine",
        "args": [3888],
    },
    {
    ...
    {"identifier": "EVENT_2814_ret_15", "command": "ret"},
]
