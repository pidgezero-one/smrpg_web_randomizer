...
script = [
    {
        "identifier": 'EVENT_2245_jmp_if_bit_set__0_',
        "command": 'jmp_if_bit_set',
        "args": [0x7086, 1, 'EVENT_2245_jmp_if_bit_set_0']
    },
    {
        "identifier": 'EVENT_2245_enter_area__1_',
        "command": 'enter_area',
        "args": [Rooms._216_SEASIDE_TOWN_DURING_YARIDOVICH_MUSHROOM_BOY_SHOP_MIDDLE, RadialDirections.NORTHEAST, 24, 40, 0, [_0x68Flags.RUN_ENTRANCE_EVENT]]
    },
    {
        "identifier": 'EVENT_2245_ret__2',
        "command": 'ret'
    },
    {
