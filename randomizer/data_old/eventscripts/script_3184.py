...
script = [
    ...
    {"identifier": "EVENT_3184_set_bit_3", "command": "set_bit", "args": [0x7042, 0]},
    {
    ...
    {
        "identifier": "EVENT_3184_mines_access",  # is mines open
        "command": "jmp_if_bit_clear",
        "args": [0x707B, 3, "EVENT_3184_remove_from_current_level_62"],
    },
    {
