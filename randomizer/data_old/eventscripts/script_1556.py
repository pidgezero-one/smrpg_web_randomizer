...
script = [
    ...
    {"identifier": "EVENT_1556_set_bit_10", "command": "set_bit", "args": [0x7043, 5]},
    {
    ...
    {"identifier": "EVENT_1556_set_bit_13", "command": "set_bit", "args": [0x7043, 6]},
    {"identifier": "EVENT_1556_set_bit_14", "command": "set_bit", "args": [0x7043, 4]},
    {
    ...
    {
        "identifier": "EVENT_1556_jmp_if_bit_set_2",
        "command": "jmp_if_bit_clear",
        "args": [0x7076, 0, "EVENT_1556_start_loop_n_times_21"],
    },
    {
        "identifier": "EVENT_1556_jmp_fork_mario_on_object_25_",
        "command": "jmp_fork_mario_on_object",
        "args": [
            "EVENT_1556_start_loop_n_times_21-",
            "EVENT_1556_ret_80",
        ],
    },
    {
    ...
    {"identifier": "EVENT_1556_inc_23-", "command": "inc", "args": [0x70AA]},
    {"identifier": "EVENT_1556_end_loop_24-", "command": "end_loop"},
    {
        "identifier": "EVENT_1556_end_loop_24--",
        "command": "jmp",
        "args": ["EVENT_1556_set_7000_to_70A0_short_mem_45"],
    },
    {
        "identifier": "EVENT_1556_start_loop_n_times_21",
        "command": "start_loop_n_times",
    ...
    {"identifier": "EVENT_1556_start_battle_700E_26", "command": "start_battle_700E"},
    {
        "identifier": "EVENT_1556_jmp_if_bit_set_27",
        "command": "jmp_if_bit_set",
        "args": [0x7040, 0, "EVENT_1556_reset_and_choose_game_43"],
    },
    {"identifier": "EVENT_1556_set_28", "command": "set_var_to_const", "args": [0x70AF, 0]},
    {
    ...
    },
    {
        ...
        "args": [AreaObjects.MEM_70AA, True, 652],
    },
    {"identifier": "EVENT_1556_inc_34", "command": "inc", "args": [0x70AA]},
    {"identifier": "EVENT_1556_end_loop_35", "command": "end_loop"},
    {
    ...
    {"identifier": "EVENT_1556_ret_40", "command": "ret"},
    {
        "identifier": "EVENT_1556_clear_bit_41",
        "command": "clear_bit",
        "args": [0x7043, 6],
    },
    {"identifier": "EVENT_1556_ret_42", "command": "ret"},
    {
        "identifier": "EVENT_1556_reset_and_choose_game_43",
        "command": "reset_and_choose_game",
    },
    {"identifier": "EVENT_1556_ret_44", "command": "ret"},
    {
    ...
    {"identifier": "EVENT_1556_inc_48", "command": "inc", "args": [0x70AF]},
    {
        "identifier": "EVENT_1556_jmp_if_var_not_equals_const_49",
        "command": "jmp_if_var_not_equals_const",
        "args": [0x70AF, 10, "EVENT_1556_add_coins_57"],
    },
    {"identifier": "EVENT_1556_inc_50", "command": "inc", "args": [0x70AB]},
    {
    ...
    },
    {
        ...
        "args": [AreaObjects.MEM_70AB, True, 0xF1],
        "subscript": [
            {
    ...
    {"identifier": "EVENT_1556_dec_53", "command": "dec", "args": [0x70AB]},
    {
    ...
    {"identifier": "EVENT_1556_add_coins_57", "command": "add_coins", "args": [1]},
    {
    ...
    {"identifier": "EVENT_1556_pause_60", "command": "pause", "args": [1]},
    {
    ...
    {"identifier": "EVENT_1556_inc_65", "command": "inc", "args": [0x70AA]},
    {"identifier": "EVENT_1556_pause_66", "command": "pause", "args": [3]},
    {"identifier": "EVENT_1556_end_loop_67", "command": "end_loop"},
    {"identifier": "EVENT_1556_dec_68", "command": "dec", "args": [0x70AA]},
    {
    ...
    {"identifier": "EVENT_1556_inc_74", "command": "inc", "args": [0x70AA]},
    {"identifier": "EVENT_1556_end_loop_75", "command": "end_loop"},
    {
    ...
    {"identifier": "EVENT_1556_ret_78", "command": "ret"},
    {
        "identifier": "EVENT_1556_clear_bit_79",
        "command": "clear_bit",
        "args": [0x7043, 6],
    },
    {"identifier": "EVENT_1556_ret_80", "command": "ret"},
]
