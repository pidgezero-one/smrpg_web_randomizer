...
script = [
    ...
    },
    {
        ...
        "command": "run_dialog",
        "args": [1945, AreaObjects.BOWSER, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC]],
    },
    {"identifier": "EVENT_1340_ret_4", "command": "ret"},
    {"identifier": "EVENT_1340_pause_3", "command": "pause", "args": [5]},
    {
    ...
    {"identifier": "EVENT_1340_ret_10", "command": "ret"},
]
