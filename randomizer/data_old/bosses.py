...
class MegaSmilax(BossAndStarLocation):
    ...
    boss_locations = [
        BossModelFill(
            ...
            sequence_setter=817),  # despawn NPC 0 and move NPC 1 down one Z coordinate
    ]
...
class Chester(BossAndStarLocation):
    ...
    boss_locations = [
        BossModelFill(
            ...
            target_action_scripts=[],
            sequence_setter=846),  # remove sequence set from 2174
    ]
...
class Magikoopa(BowsersKeepLocation):
    ...
    boss_locations = [
        ...
        BossModelFill(
            ...
            sequence_setter=848),  # may need special animation when summoning
        BossModelFill(
            ...
            target_action_scripts=[1004, 1005],
            sequence_setter=849),  # may need special animation when summoning
        BossModelFill(
            ...
            target_action_scripts=[1004, 1005],
            sequence_setter=850),  # may need special animation when summoning
        BossModelFill(
            ...
            target_action_scripts=[1004, 1005],
            sequence_setter=851),  # may need special animation when summoning
        BossModelFill(
            Rooms._461_BOWSERS_KEEP_6DOOR_BATTLE_ROOM_1C_1ST_FIGHT_BOBOMB,
            0,
            MagikoopaBoss,
            ...
            target_action_scripts=[1004, 1005],
            sequence_setter=846),  # may need special animation when summoning
        BossModelFill(
            ...
            target_action_scripts=[1004, 1005],
            sequence_setter=852),  # may need special animation when summoning
        BossModelFill(
...
class Boomer(BowsersKeepLocation):
    ...
    boss_locations = [
        BossModelFill(
            ...
            target_action_scripts=[],
            sequence_setter=853),  # 2225 may need a sequence switch
    ]
    ...
    unique_henchmen = [
        [
            UniqueHenchmanFill(
                ...
                target_scripts=[2601],
                target_action_scripts=[],
                sequence_setter=858),  # hide a lot of clones if not vanilla
        ],
    ]
...
class Smithy(BossLocation):
    ...
    boss_locations = [
        BossModelFill(
            ...
            target_action_scripts=[],
            sequence_setter=859),  # hide a lot of clones if not vanilla
    ]
    repeatable_henchmen = [
        [
            RepeatableHenchmanFill(
