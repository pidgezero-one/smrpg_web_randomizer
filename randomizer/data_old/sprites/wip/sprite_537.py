...
sprite = CompleteSprite(
    animation=AnimationPack(355, length=367, unknown=0x0000,
        properties=AnimationPackProperties(vram_size=2048,
            molds=[
                Mold(0, gridplane=False,
                    tiles=[
                        Tile(mirror=False, invert=False, format=0, length=4, subtile_bytes=[
                            bytearray(b'\x00\x18\x18\x18\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'),
                            None,
                            None,
                            None,
                ...
                Mold(1, gridplane=False,
                    tiles=[
                        Tile(mirror=False, invert=False, format=0, length=4, subtile_bytes=[
                            bytearray(b'\x00\x18$<\x18\x18\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'),
                            None,
                            None,
                            None,
                ...
                Mold(2, gridplane=False,
                    tiles=[
                        Tile(mirror=False, invert=False, format=0, length=4, subtile_bytes=[
                            ...
                            None,
                            None,
                        ], is_16bit=False, y_plus=0, y_minus=0, x=128, y=148),
                        Tile(mirror=False, invert=False, format=0, length=4, subtile_bytes=[
                            bytearray(b'(\x18\nz\x16rn`\x14,\x00\x00\x00\x00\x00\x00\x1c\x00F\x00N\x00\x1e\x00\x00<\x00\x00\x00\x00\x00\x00'),
                            None,
                            None,
                            None,
                ...
                Mold(5, gridplane=False,
                    tiles=[
                        ...
                        Tile(mirror=False, invert=False, format=0, length=5, subtile_bytes=[
                            bytearray(b'hXj\x98\n\xfa\x16\xf2\xef\xe0W,\x14,\x00\x00\x1c\x00\x1e\x00\xc6\x01\xce\x01\x1f\x00\xc3<\x00<\x00\x00'),
                            None,
                            bytearray(b'\x00\x00\x00\x00\x10\x00\x00\x00\x00\x04\x00\x00\x00\x00\x00\x00$$\x00\x00\x10\x10\x00\x00\x04\x04\x00\x00\x10\x10\x00\x00'),
                            None,
                ...
                Mold(6, gridplane=False,
                    tiles=[
                        ...
                        Tile(mirror=False, invert=False, format=0, length=5, subtile_bytes=[
                            bytearray(b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x10\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x08\x08\x00\x00\x10\x10'),
                            None,
                            bytearray(b'\x00\x00\x00$\x00\x00\x00\x00\x00\x00\x04\x00\x00\x00\x00\x10\x00\x00$$\x00\x00\x10\x10\x00\x00\x04\x04\x00\x00\x10\x10'),
                            None,
                        ], is_16bit=False, y_plus=0, y_minus=0, x=118, y=120),
                    ]
                ),
                Mold(7, gridplane=False,
                    tiles=[
                        ...
                        Tile(mirror=False, invert=False, format=0, length=4, subtile_bytes=[
                            ...
                            None,
                            None,
                        ], is_16bit=False, y_plus=0, y_minus=0, x=118, y=136),
                        Tile(mirror=False, invert=False, format=0, length=5, subtile_bytes=[
                            bytearray(b'\x00\x00\x00\x00\x00\x00\x00\x04\x00\x00\x00\x00\x00\x08\x00\x00\x00\x00\x00\x00\x00\x00\x04\x04\x00\x00  \x08\x08\x00\x00'),
                            None,
                            bytearray(b'\x00\x00\x00\x00$\x00\x00\x00\x00\x10\x00\x00\x00\x00\x00\x00\x10\x10\x00\x00$$\x00\x00\x10\x10\x00\x00\x04\x04\x00\x00'),
                            None,
                        ], is_16bit=False, y_plus=0, y_minus=0, x=118, y=120),
                    ]
                ),
                Mold(8, gridplane=False,
                    tiles=[
                        ...
                        Tile(mirror=False, invert=False, format=0, length=4, subtile_bytes=[
                            bytearray(b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x10\x10\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'),
                            None,
                            None,
                            None,
                        ], is_16bit=False, y_plus=0, y_minus=0, x=118, y=136),
                        Tile(mirror=False, invert=False, format=0, length=5, subtile_bytes=[
                            bytearray(b'\x00\x00\x00\x00\x00\x00\x00\x00\x04\x00\x00\x00\x00 \x08\x00\x00\x00\x00\x00\x10\x10\x00\x00\x04\x04\x00\x00  \x08\x08'),
                            None,
                            bytearray(b'\x00\x00\x00\x10\x00\x00\x00\x00\x00\x00\x10\x00\x00\x00\x00\x04\x00\x00\x10\x10\x00\x00$$\x00\x00\x10\x10\x00\x00\x04\x04'),
                            None,
                        ], is_16bit=False, y_plus=0, y_minus=0, x=118, y=120),
                    ]
                ),
                Mold(9, gridplane=False,
                    tiles=[
                        ...
                        Tile(mirror=False, invert=False, format=0, length=4, subtile_bytes=[
                            ...
                            None,
                            None,
                        ], is_16bit=False, y_plus=0, y_minus=0, x=128, y=146),
                        Tile(mirror=False, invert=False, format=0, length=5, subtile_bytes=[
                            bytearray(b'\x00\x00\x00\x00\x00\x00\x00\x04\x00\x00\x00\x00\x00\x08\x00\x00\x00\x00\x00\x00\x00\x00\x04\x04\x00\x00  \x08\x08\x00\x00'),
                            None,
                            bytearray(b'\x00\x00\x00\x00$\x00\x00\x00\x00\x10\x00\x00\x00\x00\x00\x00\x10\x10\x00\x00$$\x00\x00\x10\x10\x00\x00\x04\x04\x00\x00'),
                        ...
                        Tile(mirror=False, invert=False, format=0, length=5, subtile_bytes=[
                            bytearray(b'\x00\x00\x08\x00\x00\x00\x00\x10\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x08\x08\x00\x00\x10\x10\x00\x00\x04\x04\x00\x00  '),
                            None,
                            bytearray(b'\x00\x00\x00\x00\x00\x00\x00\x00\x00 \x00\x00\x00\x00\x00\x00\x08\x08\x00\x00\x00\x00\x00\x00  \x00\x00\x10\x10\x00\x00'),
                            None,
                        ], is_16bit=False, y_plus=0, y_minus=0, x=118, y=120),
                    ]
                ),
                Mold(10, gridplane=False,
                    tiles=[
                        ...
                        Tile(mirror=False, invert=False, format=0, length=4, subtile_bytes=[
                            bytearray(b'\x00\x00\x00\x08\x00\x00\x00\x00\x00\x00 \x00\x00\x00\x00\x10\x00\x00\x08\x08\x00\x00\x00\x00\x00\x00  \x00\x00\x10\x10'),
                            None,
                            None,
                            None,
                ...
                Mold(11, gridplane=False,
                    tiles=[
                        ...
                        Tile(mirror=False, invert=False, format=0, length=5, subtile_bytes=[
                            ...
                            None,
                            bytearray(b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x10\x10\x00\x00\x00\x00\x00\x00'),
                            None,
                        ], is_16bit=False, y_plus=0, y_minus=0, x=118, y=128),
                        Tile(mirror=False, invert=False, format=0, length=4, subtile_bytes=[
                            bytearray(b'\x00\x18$<\x18\x18\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'),
