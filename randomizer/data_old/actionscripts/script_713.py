...
script = [
    ...
    {"identifier": "ACTION_713_set_priority_5", "command": "set_priority", "args": [3]},
    {
    ...
    {"identifier": "ACTION_713_inc_18", "command": "inc", "args": [0x700C]},
    {"identifier": "ACTION_713_load_mem_19", "command": "load_mem", "args": [0x700C]},
    {"identifier": "ACTION_713_pause_20", "command": "pause", "args": [8]},
    {"identifier": "ACTION_713_end_loop_21", "command": "end_loop"},
    {
    ...
    {"identifier": "ACTION_713_set_bit_24", "command": "set_bit", "args": [0x7043, 1]},
    {
        "identifier": "ACTION_713_clear_bit_25",
        "command": "clear_bit",
        "args": [0x7043, 4],
    },
    {"identifier": "ACTION_713_visibility_on_26", "command": "visibility_on"},
    {
    ...
    {"identifier": "ACTION_713_pause_31", "command": "pause", "args": [100]},
    {
        "identifier": "ACTION_713_jmp_32",
        "command": "jmp",
        "args": ["ACTION_713_jmp_if_bit_set_6"],
    },
    {"identifier": "ACTION_713_pause_33", "command": "pause", "args": [1]},
    {
    ...
    {"identifier": "ACTION_713_set_bit_56", "command": "set_bit", "args": [0x7044, 4]},
    {
        "identifier": "ACTION_713_set_object_memory_bits_57",
        "command": "set_object_memory_bits",
        "args": [0x0E, []],
    },
    {"identifier": "ACTION_713_db_58", "command": "db", "args": [0x97, 0x11]},
    {
    ...
    {"identifier": "ACTION_713_pause_67", "command": "pause", "args": [1]},
    {
    ...
    {"identifier": "ACTION_713_set_bit_70", "command": "set_bit", "args": [0x7043, 1]},
    {
    ...
    {"identifier": "ACTION_713_visibility_on_73", "command": "visibility_on"},
    {
    ...
    {"identifier": "ACTION_713_pause_77", "command": "pause", "args": [100]},
    {
