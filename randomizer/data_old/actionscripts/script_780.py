...
script = [
    {"identifier": "ACTION_780_fixed_f_coord_on_0", "command": "fixed_f_coord_on"},
    {
    ...
    {"identifier": "ACTION_780_pause_5", "command": "pause", "args": [1]},
    {
        "identifier": "ACTION_780_jmp_if_bit_clear_6",
        "command": "jmp_if_bit_clear",
        "args": [0x7044, 5, "ACTION_780_pause_5"],
    },
    {"identifier": "ACTION_780_set_priority_7", "command": "set_priority", "args": [3]},
    {
    ...
    {"identifier": "ACTION_780_face_north_15", "command": "face_north"},
    {
        "identifier": "ACTION_780_jmp_16",
        "command": "jmp",
        "args": ["ACTION_780_jmp_if_bit_clear_39"],
    },
    {"identifier": "ACTION_780_face_southwest_17", "command": "face_southwest"},
    {
        "identifier": "ACTION_780_jmp_18",
        "command": "jmp",
        "args": ["ACTION_780_jmp_if_bit_clear_30"],
    },
    {"identifier": "ACTION_780_face_south_19", "command": "face_south"},
    {
    ...
    {"identifier": "ACTION_780_pause_40", "command": "pause", "args": [24]},
    {
        "identifier": "ACTION_780_jmp_41",
        "command": "jmp",
        "args": ["ACTION_780_jmp_if_bit_clear_20"],
    },
    {"identifier": "ACTION_780_pause_42", "command": "pause", "args": [96]},
    {
    ...
    {
        "identifier": "ACTION_780_compare_700C_to_var_47",
    ...
    {"identifier": "ACTION_780_face_mario_54", "command": "face_mario"},
    {
    ...
    },
    {
        ...
        "args": [
            ...
            "ACTION_780_turn_clockwise_45_degrees_n_times_63",
        ],
    },
    {
    ...
    {"identifier": "ACTION_780_pause_58", "command": "pause", "args": [8]},
    {
    ...
    {"identifier": "ACTION_780_pause_61", "command": "pause", "args": [8]},
    {
    ...
    {"identifier": "ACTION_780_pause_64", "command": "pause", "args": [8]},
    {
    ...
    {"identifier": "ACTION_780_pause_71", "command": "pause", "args": [4]},
    {
        "identifier": "ACTION_780_jmp_if_random_above_66_72",
        "command": "jmp_if_random_above_66",
        "args": [
            "ACTION_780_turn_clockwise_45_degrees_n_times_75",
            "ACTION_780_turn_clockwise_45_degrees_n_times_77",
        ],
    },
    {
