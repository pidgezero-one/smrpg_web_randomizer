...
script = [
    ...
    {"identifier": "ACTION_36_db_6", "command": "db", "args": [0xC8, 0x07]},
    {
    ...
    {"identifier": "ACTION_36_db_9", "command": "transfer_to_7016_7018_701A"},
    {
        "identifier": "ACTION_36_jmp_10",
        "command": "jmp",
        "args": ["ACTION_36_visibility_on_16"],
    },
    {"identifier": "ACTION_36_load_mem_11", "command": "load_mem", "args": [0x700C]},
    {"identifier": "ACTION_36_pause_12", "command": "pause", "args": [8]},
    {"identifier": "ACTION_36_end_loop_13", "command": "end_loop"},
    {"identifier": "ACTION_36_pause_14", "command": "pause", "args": [1]},
    {
        "identifier": "ACTION_36_set_animation_speed_15",
        "command": "set_animation_speed",
        "args": [SequenceSpeeds.FAST, [_0x10Flags.SEQUENCE]],
    },
    {"identifier": "ACTION_36_visibility_on_16", "command": "visibility_on"},
    {"identifier": "ACTION_36_set_priority_17", "command": "set_priority", "args": [3]},
    {
    ...
    {"identifier": "ACTION_36_ret_20", "command": "ret"},
]
