...
script = [
    {"identifier": "ACTION_823_pause_0", "command": "pause", "args": [1]},
    {
    ...
    {"identifier": "ACTION_823_shadow_off_11", "command": "shadow_off"},
    {
    ...
    {"identifier": "ACTION_823_shadow_on_14", "command": "shadow_on"},
    {
