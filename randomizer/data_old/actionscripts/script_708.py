...
script = [
    {"identifier": "ACTION_708_set_priority_0", "command": "set_priority", "args": [2]},
    {"identifier": "ACTION_708_face_southwest_1", "command": "face_southwest"},
    {"identifier": "ACTION_708_fixed_f_coord_on_2", "command": "fixed_f_coord_on"},
    {
    ...
    {
        "identifier": "ACTION_708_set_var_to_random_7",
        "command": "set_var_to_random",
        "args": [0x700C, 30],
    },
    {"identifier": "ACTION_708_inc_short_8", "command": "inc_short", "args": [0x700C]},
    {"identifier": "ACTION_708_load_mem_9", "command": "load_mem", "args": [0x700C]},
    {"identifier": "ACTION_708_pause_10", "command": "pause", "args": [1]},
    {"identifier": "ACTION_708_end_loop_11", "command": "end_loop"},
    {
    ...
    },
    {
        ...
        "args": [AreaObjects.NPC_3, 0, 3, "ACTION_708_set_bit_19"],
    },
    {
    ...
    {"identifier": "ACTION_708_jmp_18", "command": "jmp", "args": ["ACTION_708_db_15"]},
    {"identifier": "ACTION_708_set_bit_19", "command": "set_bit", "args": [0x7043, 0]},
    {
    ...
    {"identifier": "ACTION_708_ret_25", "command": "ret"},
]
