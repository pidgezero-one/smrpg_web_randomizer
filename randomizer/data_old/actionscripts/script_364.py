...
script = [
    {"identifier": "ACTION_364_set_priority_0", "command": "set_priority", "args": [2]},
    {"identifier": "ACTION_364_fixed_f_coord_on_1", "command": "fixed_f_coord_on"},
    {
    ...
    {"identifier": "ACTION_364_visibility_on_9", "command": "visibility_on"},
    {
    ...
    {"identifier": "ACTION_364_ret_16", "command": "ret"},
]
