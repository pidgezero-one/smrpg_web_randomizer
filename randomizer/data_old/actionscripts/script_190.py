...
script = [
    ...
    },
    {
        ...
        "args": [0x700C, 7, 'ACTION_190_jmp_if_var_equals_const_18']
    },
    {
        "identifier": 'ACTION_190_jmp_if_700C_equals_short_8',
        "command": "jmp_if_var_equals_const",
        "args": [0x700C, 0, 'ACTION_190_jmp_if_var_equals_const_18']
    },
    {
        "identifier": 'ACTION_190_jmp_if_700C_equals_short_9',
        "command": "jmp_if_var_equals_const",
        "args": [0x700C, 1, 'ACTION_190_jmp_if_var_equals_const_18']
    },
    {
        "identifier": 'ACTION_190_jmp_if_700C_equals_short_10',
        "command": "jmp_if_var_equals_const",
        "args": [0x700C, 2, 'ACTION_190_jmp_if_var_equals_const_18']
    },
    {
        "identifier": 'ACTION_190_jmp_if_var_equals_const_11',
        "command": 'jmp_if_var_equals_const',
