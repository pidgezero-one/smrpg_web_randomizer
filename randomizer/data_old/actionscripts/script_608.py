...
script = [
    {"identifier": "ACTION_608_shadow_off_0", "command": "shadow_off"},
    {
        "identifier": "ACTION_608_set_vram_priority_1",
        "command": "set_vram_priority",
        "args": [VramPriority.PRIORITY_3],
    },
    {"identifier": "ACTION_608_set_priority_2", "command": "set_priority", "args": [3]},
    {
        "identifier": "ACTION_608_set_object_memory_bits_3",
        "command": "set_object_memory_bits",
        "args": [0x0E, [0, 2]],
    },
    {"identifier": "ACTION_608_face_mario_4", "command": "face_mario"},
    {"identifier": "ACTION_608_pause_5", "command": "pause", "args": [1]},
    {
    ...
    {"identifier": "ACTION_608_shadow_on_9", "command": "shadow_on"},
    {
    ...
    {"identifier": "ACTION_608_pause_24", "command": "pause", "args": [30]},
    {"identifier": "ACTION_608_reset_properties_25", "command": "reset_properties"},
    {
    ...
    {"identifier": "ACTION_608_pause_33", "command": "pause", "args": [25]},
    {
