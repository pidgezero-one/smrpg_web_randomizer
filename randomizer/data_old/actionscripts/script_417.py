...
script = [
    ...
    {"identifier": "ACTION_417_visibility_off_1", "command": "visibility_off"},
    {
    ...
    {"identifier": "ACTION_417_pause_12", "command": "pause", "args": [6]},
    {
    ...
    {"identifier": "ACTION_417_pause_15", "command": "pause", "args": [3]},
    {
        "identifier": "ACTION_417_shift_z_up_pixels_16",
        "command": "shift_z_up_pixels",
        "args": [6],
    },
    {"identifier": "ACTION_417_reset_properties_17", "command": "reset_properties"},
    {"identifier": "ACTION_417_visibility_on_18", "command": "visibility_on"},
    {
    ...
    {"identifier": "ACTION_417_pause_21", "command": "pause", "args": [40]},
    {
    ...
    {"identifier": "ACTION_417_pause_23", "command": "pause", "args": [4]},
    {
        "identifier": "ACTION_417_shift_z_down_pixels_24",
        "command": "shift_z_down_pixels",
        "args": [10],
    },
    {"identifier": "ACTION_417_visibility_off_25", "command": "visibility_off"},
    {
    ...
    {"identifier": "ACTION_417_pause_29", "command": "pause", "args": [1]},
    {"identifier": "ACTION_417_pause_30", "command": "pause", "args": [1]},
    {
    ...
    {"identifier": "ACTION_417_reset_properties_33", "command": "reset_properties"},
    {"identifier": "ACTION_417_visibility_on_34", "command": "visibility_on"},
    {
    ...
    {"identifier": "ACTION_417_pause_37", "command": "pause", "args": [28]},
    {
    ...
    {"identifier": "ACTION_417_pause_39", "command": "pause", "args": [2]},
    {
        "identifier": "ACTION_417_shift_z_down_pixels_40",
        "command": "shift_z_down_pixels",
        "args": [10],
    },
    {"identifier": "ACTION_417_visibility_off_41", "command": "visibility_off"},
    {
    ...
    {"identifier": "ACTION_417_pause_44", "command": "pause", "args": [1]},
    {"identifier": "ACTION_417_pause_45", "command": "pause", "args": [1]},
    {
    ...
    {"identifier": "ACTION_417_ret_49", "command": "ret"},
]
