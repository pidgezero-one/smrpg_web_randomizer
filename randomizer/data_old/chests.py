...
from randomizer.data import items, locations, bosses
...
class BOOSTER_PASS_FLOWER(OverworldItem):
    description = ShuffleLocationSelector.BOOSTER_PASS_FLOWER.value
    area = locations.Area.BoosterPass
    rooms = [101]
    event = 241
    npc_ids = [6]
...
class BOOSTER_PASS_SECRET_1(Chest):
    area = locations.Area.BoosterPass
    description = ShuffleLocationSelector.BOOSTER_PASS_SECRET_1.value
    rooms = [405]
    npc_ids = [10]
    event = 247
    item = items.FrogCoin
...
class BOOSTER_PASS_SECRET_2(Chest):
    area = locations.Area.BoosterPass
    description = ShuffleLocationSelector.BOOSTER_PASS_SECRET_2.value
    rooms = [405]
    npc_ids = [11]
    event = 246
    item = items.Flower
...
class BOOSTER_PASS_SECRET_3(Chest):
    area = locations.Area.BoosterPass
    description = ShuffleLocationSelector.BOOSTER_PASS_SECRET_3.value
    rooms = [405]
    npc_ids = [12]
    event = 245
    item = items.KerokeroCola
...
class BOOSTER_TOWER_SPOOKUM(Chest):
    description = ShuffleLocationSelector.BOOSTER_TOWER_SPOOKUM.value
...
class BOOSTER_TOWER_THWOMP(Chest):
    description = ShuffleLocationSelector.BOOSTER_TOWER_THWOMP.value
    area = locations.Area.BoosterTower
    item = items.RecoveryMushroom
    original_item = items.RecoveryMushroom
    rooms = [36]
...
class BOOSTER_TOWER_KNIFE_GUY(NPCReward):
    description = ShuffleLocationSelector.BOOSTER_TOWER_KNIFE_GUY.value
    area = locations.Area.BoosterTower
...
class BOOSTER_TOWER_ROOM_KEY(OverworldItem):
    description = ShuffleLocationSelector.BOOSTER_TOWER_ROOM_KEY.value
    area = locations.Area.BoosterTower
    item = items.RoomKey
...
class BOOSTER_TOWER_FROG_COIN_1(OverworldItem):
    description = ShuffleLocationSelector.BOOSTER_TOWER_FROG_COIN_1.value
    area = locations.Area.BoosterTower
    item = items.FrogCoin
    original_item = items.FrogCoin
    rooms = [41]
...
class BOOSTER_TOWER_FROG_COIN_2(OverworldItem):
    description = ShuffleLocationSelector.BOOSTER_TOWER_FROG_COIN_2.value
    area = locations.Area.BoosterTower
    item = items.FrogCoin
    original_item = items.FrogCoin
    rooms = [41]
...
class BOOSTER_TOWER_FROG_COIN_3(OverworldItem):
    description = ShuffleLocationSelector.BOOSTER_TOWER_FROG_COIN_3.value
    area = locations.Area.BoosterTower
    item = items.FrogCoin
    original_item = items.FrogCoin
    rooms = [41]
...
class BOOSTER_TOWER_FROG_COIN_4(OverworldItem):
    description = ShuffleLocationSelector.BOOSTER_TOWER_FROG_COIN_4.value
    area = locations.Area.BoosterTower
    item = items.FrogCoin
    original_item = items.FrogCoin
    rooms = [41]
...
class BOOSTER_TOWER_MASHER(OverworldItem):
    description = ShuffleLocationSelector.BOOSTER_TOWER_MASHER.value
    area = locations.Area.BoosterTower
    rooms = [197]
    event = 253
    item = items.Masher
...
class BOOSTER_TOWER_PARACHUTE(SlotsNotAllowedChest):
    description = ShuffleLocationSelector.BOOSTER_TOWER_PARACHUTE.value
    area = locations.Area.BoosterTower
    item = items.FrogCoin
    original_item = items.FrogCoin
    rooms = [35]
...
class BOOSTER_TOWER_PARACHUTE_CREVICE(NPCReward):
    description = ShuffleLocationSelector.BOOSTER_TOWER_PARACHUTE_CREVICE.value
    area = locations.Area.BoosterTower
    item = items.FrogCoin
    original_item = items.FrogCoin
    coinsanity = True
...
class BOOSTER_TOWER_ZOOM_SHOES(Chest):
    description = ShuffleLocationSelector.BOOSTER_TOWER_ZOOM_SHOES.value
    area = locations.Area.BoosterTower
...
class BOOSTER_TOWER_TOP_1(Chest):
    description = ShuffleLocationSelector.BOOSTER_TOWER_TOP_1.value
    area = locations.Area.BoosterTower
    rooms = [199]
    npc_ids = [0]
    event = 247
...
class BOOSTER_TOWER_TOP_2(Chest):
    description = ShuffleLocationSelector.BOOSTER_TOWER_TOP_2.value
    area = locations.Area.BoosterTower
    rooms = [199]
    npc_ids = [1]
    event = 246
...
class BOOSTER_TOWER_TOP_3(Chest):
    description = ShuffleLocationSelector.BOOSTER_TOWER_TOP_3.value
    area = locations.Area.BoosterTower
    rooms = [199]
    npc_ids = [9]
    event = 245
...
class BOOSTER_TOWER_RAILWAY(NPCReward):
    area = locations.Area.BoosterTower
    description = ShuffleLocationSelector.BOOSTER_TOWER_RAILWAY.value
    rooms = [194]
    event = 253
    item = items.FlowerTab
    original_item = items.FlowerTab
...
class BOOSTER_TOWER_PORTRAITS(OverworldItem):
    area = locations.Area.BoosterTower
    description = ShuffleLocationSelector.BOOSTER_TOWER_PORTRAITS.value
    rooms = [195]
    event = 241
    npc_ids = [7]
    item = items.ElderKey
...
class MARRYMORE_PRIZE_1(NPCReward):
    area = locations.Area.Marrymore
    description = ShuffleLocationSelector.MARRYMORE_PRIZE_1.value
    item = items.FlowerTab
    original_item = items.FlowerTab
    rooms = [7]
    event = 253
...
class MARRYMORE_PRIZE_2(NPCReward):
    area = locations.Area.Marrymore
    description = ShuffleLocationSelector.MARRYMORE_PRIZE_2.value
    item = items.FlowerJar
    original_item = items.FlowerJar
    rooms = [7]
    event = 252
...
class MARRYMORE_PRIZE_3(NPCReward):
    area = locations.Area.Marrymore
    item = items.MultiFrogCoin(NPCReward, 1)
    original_item = items.MultiFrogCoin(NPCReward, 1)
    description = ShuffleLocationSelector.MARRYMORE_PRIZE_3.value
    rooms = [7]
    event = 251


class MARRYMORE_PRIZE_4(NPCReward):
    area = locations.Area.Marrymore
    item = items.MultiFrogCoin(NPCReward, 2)
    original_item = items.MultiFrogCoin(NPCReward, 2)
    description = ShuffleLocationSelector.MARRYMORE_PRIZE_4.value
    rooms = [7]
    event = 250


class MARRYMORE_PRIZE_5(NPCReward):
    area = locations.Area.Marrymore
    item = items.MultiFrogCoin(NPCReward, 3)
    original_item = items.MultiFrogCoin(NPCReward, 3)
    description = ShuffleLocationSelector.MARRYMORE_PRIZE_5.value
    rooms = [7]
    event = 249


class MARRYMORE_PRIZE_6(NPCReward):
    area = locations.Area.Marrymore
    item = items.MultiFrogCoin(NPCReward, 20)
    original_item = items.MultiFrogCoin(NPCReward, 20)
    description = ShuffleLocationSelector.MARRYMORE_PRIZE_6.value
    rooms = [7]
    event = 248
...
class MARRYMORE_INN(Chest):
    area = locations.Area.Marrymore
    description = ShuffleLocationSelector.MARRYMORE_INN.value
    item = items.FrogCoin
    original_item = items.FrogCoin
    rooms = [9]
    npc_ids = [0]
...
class MARRYMORE_SNIFIT_1(NPCReward):
    area = locations.Area.Marrymore
    description = ShuffleLocationSelector.MARRYMORE_SNIFIT_1.value
    item = items.Brooch
...
class MARRYMORE_SNIFIT_2(NPCReward):
    area = locations.Area.Marrymore
    description = ShuffleLocationSelector.MARRYMORE_SNIFIT_2.value
    item = items.Ring
...
class MARRYMORE_SNIFIT_3(NPCReward):
    area = locations.Area.Marrymore
    description = ShuffleLocationSelector.MARRYMORE_SNIFIT_3.value
    item = items.Shoes
...
class MARRYMORE_ALTARHead(OverworldItem):
    area = locations.Area.Marrymore
    description = ShuffleLocationSelector.MARRYMORE_ALTAR.value
    item = items.Crown
...
class FROG_DISCIPLE_1(FrogCoinShopItem):
    description = ShuffleLocationSelector.FROG_DISCIPLE_1.value
    area = locations.Area.SeasideTown
    item = items.SeeYa
    original_item = items.SeeYa


class FROG_DISCIPLE_2(FrogCoinShopItem):
    description = ShuffleLocationSelector.FROG_DISCIPLE_2.value
    area = locations.Area.SeasideTown
    item = items.EarlierTimes
    original_item = items.EarlierTimes


class FROG_DISCIPLE_3(FrogCoinShopItem):
    description = ShuffleLocationSelector.FROG_DISCIPLE_3.value
    area = locations.Area.SeasideTown
    item = items.ExpBooster
    original_item = items.ExpBooster


class FROG_DISCIPLE_4(FrogCoinShopItem):
    description = ShuffleLocationSelector.FROG_DISCIPLE_4.value
    area = locations.Area.SeasideTown
    item = items.CoinTrick
    original_item = items.CoinTrick


class FROG_DISCIPLE_5(FrogCoinShopItem):
    description = ShuffleLocationSelector.FROG_DISCIPLE_5.value
    area = locations.Area.SeasideTown
...
class SEASIDE_TOWN_BOSS_PRIZE(OverworldItem):
    area = locations.Area.SeasideTown
    description = ShuffleLocationSelector.SEASIDE_TOWN_BOSS_PRIZE.value
    rooms = [316]
    event = 241
    npc_ids = [0]
    item = items.ShedKey
...
class SEASIDE_TOWN_RESCUE(NPCReward):
    area = locations.Area.SeasideTown
    description = ShuffleLocationSelector.SEASIDE_TOWN_RESCUE.value
    rooms = [314]
    event = 253
...
class SEA_STAR_CHEST(Chest):
    area = locations.Area.Sea
    description = ShuffleLocationSelector.SEA_STAR_CHEST.value
    rooms = [134]
    npc_ids = [0]
    event = 247
    item = items.SeaStar
...
class SEA_SAVE_ROOM_1(Chest):
    area = locations.Area.Sea
    description = ShuffleLocationSelector.SEA_SAVE_ROOM_1.value
    rooms = [132]
    npc_ids = [0]
    event = 245
    item = items.FrogCoin
...
class SEA_SAVE_ROOM_2(Chest):
    area = locations.Area.Sea
    description = ShuffleLocationSelector.SEA_SAVE_ROOM_2.value
    rooms = [132]
    npc_ids = [1]
    event = 246
    item = items.Flower
...
class SEA_SAVE_ROOM_3(Chest):
    area = locations.Area.Sea
    description = ShuffleLocationSelector.SEA_SAVE_ROOM_3.value
    rooms = [132]
    npc_ids = [2]
    event = 247
    item = items.RecoveryMushroom
...
class SEA_WHIRLPOOL_CHEST(Chest):
    description = ShuffleLocationSelector.SEA_WHIRLPOOL_CHEST.value
    area = locations.Area.Sea
    rooms = [133]
    npc_ids = [0]
    event = 247
...
class SUNKEN_SHIP_RAT_STAIRS(Chest):
    ...
    description = ShuffleLocationSelector.SUNKEN_SHIP_RAT_STAIRS.value
    rooms = [167]
    npc_ids = [0]
    event = 247
...
class SUNKEN_SHIP_RAT_STAIRS_FLOWER(PacketItem):
    area = locations.Area.SunkenShip
    description = ShuffleLocationSelector.SUNKEN_SHIP_RAT_STAIRS_FLOWER.value
    rooms = [167]
    script_id = 3385
    event = 241
    item = items.Flower
...
class SUNKEN_SHIP_SHOP(Chest):
    area = locations.Area.SunkenShip
    description = ShuffleLocationSelector.SUNKEN_SHIP_SHOP.value
    rooms = [169]
    npc_ids = [0]
    event = 247
    item = items.Coins(100)
...
class SUNKEN_SHIP_TRAMPOLINE_PUZZLE(PacketItem):
    area = locations.Area.SunkenShip
    description = ShuffleLocationSelector.SUNKEN_SHIP_TRAMPOLINE_PUZZLE.value
    rooms = [163]
    event = 241
    script_id = 3383
    item = items.Flower
...
class SUNKEN_SHIP_TROOPA_PUZZLE(PacketItem):
    area = locations.Area.SunkenShip
    description = ShuffleLocationSelector.SUNKEN_SHIP_TROOPA_PUZZLE.value
    rooms = [166]
    event = 241
    script_id = 3384
    item = items.RecoveryMushroom
...
class SUNKEN_SHIP_3D_MAZE(PacketItem):
    area = locations.Area.SunkenShip
    description = ShuffleLocationSelector.SUNKEN_SHIP_3D_MAZE.value
    rooms = [168]
    event = 241
    script_id = 3386
...
class SUNKEN_SHIP_CANNONBALL_PUZZLE(PacketItem):
    area = locations.Area.SunkenShip
    description = ShuffleLocationSelector.SUNKEN_SHIP_CANNONBALL_PUZZLE.value
    rooms = [172]
    event = 241
    script_id = 3387
    item = items.Mushroom
...
class SUNKEN_SHIP_BARREL_PUZZLE(PacketItem):
    area = locations.Area.SunkenShip
    description = ShuffleLocationSelector.SUNKEN_SHIP_BARREL_PUZZLE.value
    rooms = [176]
    event = 241
    script_id = 3389
    item = items.RecoveryMushroom
...
class SUNKEN_SHIP_COINS_1(Chest):
    area = locations.Area.SunkenShip
    description = ShuffleLocationSelector.SUNKEN_SHIP_COINS_1.value
    rooms = [175]
    npc_ids = [0]
    event = 247
    item = items.Coins(100)
...
class SUNKEN_SHIP_COINS_2(Chest):
    area = locations.Area.SunkenShip
    description = ShuffleLocationSelector.SUNKEN_SHIP_COINS_2.value
    rooms = [175]
    npc_ids = [1]
    event = 246
    item = items.Coins(100)
...
class SUNKEN_SHIP_CLONE_ROOM(Chest):
    area = locations.Area.SunkenShip
    description = ShuffleLocationSelector.SUNKEN_SHIP_CLONE_ROOM.value
    rooms = [179]
    npc_ids = [2]
    event = 247
    item = items.KerokeroCola
...
class SUNKEN_SHIP_FROG_COIN_ROOM(Chest):
    area = locations.Area.SunkenShip
    description = ShuffleLocationSelector.SUNKEN_SHIP_FROG_COIN_ROOM.value
    rooms = [183]
    npc_ids = [0]
    event = 247
    item = items.FrogCoin
...
class SUNKEN_SHIP_HIDON_MUSHROOM(Chest):
    area = locations.Area.SunkenShip
    description = ShuffleLocationSelector.SUNKEN_SHIP_HIDON_MUSHROOM.value
    rooms = [184]
    npc_ids = [1]
    event = 247
    item = items.RecoveryMushroom
...
class HIDON_CHEST(Chest):
    area = locations.Area.SunkenShip
    description = ShuffleLocationSelector.HIDON_CHEST.value
    rooms = [184]
    npc_ids = [2]
    event = 246
...
class HIDON_REWARD_1(NPCReward):
    description = ShuffleLocationSelector.HIDON_REWARD_1.value
    rooms = [513]
    event = 253
...
class HIDON_REWARD_2(Chest):
    description = ShuffleLocationSelector.HIDON_REWARD_2.value
    rooms = [513]
    event = 245
    manual_70A7 = True
    item = items.Coins(100)
...
class SUNKEN_SHIP_UNDERWATER_FROG_COIN_1(OverworldItem):
    description = ShuffleLocationSelector.SUNKEN_SHIP_UNDERWATER_FROG_COIN_1.value
    area = locations.Area.SunkenShip
    item = items.FrogCoin
    original_item = items.FrogCoin
    rooms = [187]
...
class SUNKEN_SHIP_UNDERWATER_FROG_COIN_2(OverworldItem):
    description = ShuffleLocationSelector.SUNKEN_SHIP_UNDERWATER_FROG_COIN_2.value
    area = locations.Area.SunkenShip
    item = items.FrogCoin
    original_item = items.FrogCoin
    rooms = [187]
...
class SUNKEN_SHIP_UNDERWATER_FROG_COIN_3(OverworldItem):
    description = ShuffleLocationSelector.SUNKEN_SHIP_UNDERWATER_FROG_COIN_3.value
    area = locations.Area.SunkenShip
    item = items.FrogCoin
    original_item = items.FrogCoin
    rooms = [187]
...
class SUNKEN_SHIP_UNDERWATER_FROG_COIN_4(OverworldItem):
    description = ShuffleLocationSelector.SUNKEN_SHIP_UNDERWATER_FROG_COIN_4.value
    area = locations.Area.SunkenShip
    item = items.FrogCoin
    original_item = items.FrogCoin
    rooms = [187]
...
class SUNKEN_SHIP_SAFETY_RING(Chest):
    description = ShuffleLocationSelector.SUNKEN_SHIP_SAFETY_RING.value
    area = locations.Area.SunkenShip
    rooms = [185]
    npc_ids = [0]
    event = 247
...
class SUNKEN_SHIP_BANDANA_REDS(Chest):
    description = ShuffleLocationSelector.SUNKEN_SHIP_BANDANA_REDS.value
    area = locations.Area.SunkenShip
    item = items.RecoveryMushroom
    original_item = items.RecoveryMushroom
    rooms = [24]
...
class SUNKEN_SHIP_BLOOBER_ROOM(OverworldItem):
    description = ShuffleLocationSelector.SUNKEN_SHIP_BLOOBER_ROOM.value
    area = locations.Area.SunkenShip
    item = items.FrogCoin
    original_item = items.FrogCoin
    rooms = [27]
...
class NIMBUS_LAND_BEFORE_BIRDETTA_1(Chest):
    description = ShuffleLocationSelector.NIMBUS_LAND_BEFORE_BIRDETTA_1.value
    area = locations.Area.NimbusLand
    rooms = [118]
    npc_ids = [0]
    event = 247
...
class NIMBUS_LAND_BEFORE_BIRDETTA_2(Chest):
    area = locations.Area.NimbusLand
    description = ShuffleLocationSelector.NIMBUS_LAND_BEFORE_BIRDETTA_2.value
    rooms = [111, 500]
    npc_ids = [2, 0]
    event = 247
    item = items.Flower
...
class BOWSERS_KEEP_CANNONBALL_ROOM_COIN_1(OverworldItem):
    area = locations.Area.BowsersKeep
    description = ShuffleLocationSelector.BOWSERS_KEEP_CANNONBALL_ROOM_COIN_1.value
    rooms = [457]
    event = 241
    npc_ids = [8]
    item = items.Coins10
...
class BOWSERS_KEEP_CANNONBALL_ROOM_COIN_2(OverworldItem):
    area = locations.Area.BowsersKeep
    description = ShuffleLocationSelector.BOWSERS_KEEP_CANNONBALL_ROOM_COIN_2.value
    rooms = [457]
    event = 240
    npc_ids = [9]
    item = items.Coins10
...
class BOWSERS_KEEP_CANNONBALL_ROOM_COIN_3(OverworldItem):
    area = locations.Area.BowsersKeep
    description = ShuffleLocationSelector.BOWSERS_KEEP_CANNONBALL_ROOM_COIN_3.value
    rooms = [457]
    event = 239
    npc_ids = [10]
    item = items.Coins10
...
class BOWSERS_KEEP_CANNONBALL_ROOM_COIN_4(OverworldItem):
    area = locations.Area.BowsersKeep
    description = ShuffleLocationSelector.BOWSERS_KEEP_CANNONBALL_ROOM_COIN_4.value
    rooms = [457]
    event = 238
    npc_ids = [11]
    item = items.Coins10
...
class BOWSERS_KEEP_CANNONBALL_ROOM_COIN_5(OverworldItem):
    area = locations.Area.BowsersKeep
    description = ShuffleLocationSelector.BOWSERS_KEEP_CANNONBALL_ROOM_COIN_5.value
    rooms = [457]
    event = 237
    npc_ids = [12]
    item = items.Coins10
...
class BOWSERS_KEEP_CANNONBALL_ROOM_COIN_6(OverworldItem):
    area = locations.Area.BowsersKeep
    description = ShuffleLocationSelector.BOWSERS_KEEP_CANNONBALL_ROOM_COIN_6.value
    rooms = [457]
    event = 236
    npc_ids = [13]
    item = items.Coins10
...
class BOWSERS_KEEP_CANNONBALL_ROOM_COIN_7(OverworldItem):
    area = locations.Area.BowsersKeep
    description = ShuffleLocationSelector.BOWSERS_KEEP_CANNONBALL_ROOM_COIN_7.value
    rooms = [457]
    event = 235
    npc_ids = [14]
    item = items.Coins10
...
class BOWSERS_KEEP_CANNONBALL_ROOM_COIN_8(OverworldItem):
    area = locations.Area.BowsersKeep
    description = ShuffleLocationSelector.BOWSERS_KEEP_CANNONBALL_ROOM_COIN_8.value
    rooms = [457]
    event = 234
    npc_ids = [15]
    item = items.Coins10
...
class FACTORY_TREASURE_PIT_1(Chest):
    area = locations.Area.Factory
    description = ShuffleLocationSelector.FACTORY_TREASURE_PIT_1.value
    rooms = [443]
    npc_ids = [0]
    event = 247
    item = items.RecoveryMushroom
...
class BOOSTER_TOWER_MASHERRoom(InvisibleFlagLocation):
    item = None
    original_item = None
    coords = (19, 122, 0)
    shift = (0, 8)
...
class BOOSTER_TOWER_THWOMPInvisible(InvisibleFlagLocation):
    item = None
    original_item = None
    coords = (5, 114, 12)
    area = locations.Area.BoosterTower
...
class MARRYMORE_ALTAR(InvisibleFlagLocation):
    item = None
    original_item = None
    coords = (23, 70, 1)
    area = locations.Area.Marrymore
...
def get_default_chests(world):
    ...
    chests = [
        ...
        BOOSTER_TOWER_KNIFE_GUY(world),
        BOOSTER_TOWER_ROOM_KEY(world),
        ...
        BOOSTER_TOWER_PORTRAITS(world),
        BoosterTowerChomp(world),
        BoosterTowerCurtainGame(world),
        MARRYMORE_PRIZE_1(world),
        MARRYMORE_PRIZE_2(world),
        MARRYMORE_PRIZE_3(world),
        MARRYMORE_PRIZE_4(world),
        MARRYMORE_PRIZE_5(world),
        MARRYMORE_PRIZE_6(world),
        MARRYMORE_SNIFIT_1(world),
        MARRYMORE_SNIFIT_2(world),
        MARRYMORE_SNIFIT_3(world),
        MARRYMORE_INN(world),
        SEASIDE_TOWN_BOSS_PRIZE(world),
        SEASIDE_TOWN_RESCUE(world),
        SEA_STAR_CHEST(world),
        SEA_SAVE_ROOM_1(world),
        SEA_SAVE_ROOM_2(world),
        SEA_SAVE_ROOM_3(world),
        SEA_WHIRLPOOL_CHEST(world),
        ...
        HIDON_CHEST(world),
        HIDON_REWARD_1(world),
        HIDON_REWARD_2(world),
        ...
        NIMBUS_LAND_BEFORE_BIRDETTA_1(world),
        NIMBUS_LAND_BEFORE_BIRDETTA_2(world),
        ...
        FROG_DISCIPLE_1(world),
        FROG_DISCIPLE_2(world),
        FROG_DISCIPLE_3(world),
        FROG_DISCIPLE_4(world),
        FROG_DISCIPLE_5(world),
    ]
...
def get_invisible_flag_choices(world):
    return [
        ...
        BOOSTER_TOWER_MASHERRoom(world),
        BoosterTowerCurtain(world),
        BoosterTowerBrokenFrame(world),
        BOOSTER_TOWER_THWOMPInvisible(world),
...
def get_freestanding_item_checks(world):
    ...
    return [
        ...
        BOOSTER_PASS_FLOWER(world),
        BOOSTER_TOWER_FROG_COIN_1(world),
        BOOSTER_TOWER_FROG_COIN_2(world),
        BOOSTER_TOWER_FROG_COIN_3(world),
        BOOSTER_TOWER_FROG_COIN_4(world),
        ...
        BOOSTER_TOWER_PARACHUTE_CREVICE(world),
        MARRYMORE_ALTARHead(world),
        SUNKEN_SHIP_RAT_STAIRS_FLOWER(world),
        SUNKEN_SHIP_UNDERWATER_FROG_COIN_1(world),
        SUNKEN_SHIP_UNDERWATER_FROG_COIN_2(world),
        SUNKEN_SHIP_UNDERWATER_FROG_COIN_3(world),
        SUNKEN_SHIP_UNDERWATER_FROG_COIN_4(world),
        SUNKEN_SHIP_BLOOBER_ROOM(world),
        SUNKEN_SHIP_TRAMPOLINE_PUZZLE(world),
        SUNKEN_SHIP_TROOPA_PUZZLE(world),
        SunkenShipCoinSnake(world),
        SUNKEN_SHIP_BARREL_PUZZLE(world),
        ...
        BOWSERS_KEEP_CANNONBALL_ROOM_COIN_1(world),
        BOWSERS_KEEP_CANNONBALL_ROOM_COIN_2(world),
        BOWSERS_KEEP_CANNONBALL_ROOM_COIN_3(world),
        BOWSERS_KEEP_CANNONBALL_ROOM_COIN_4(world),
        BOWSERS_KEEP_CANNONBALL_ROOM_COIN_5(world),
        BOWSERS_KEEP_CANNONBALL_ROOM_COIN_6(world),
        BOWSERS_KEEP_CANNONBALL_ROOM_COIN_7(world),
        BOWSERS_KEEP_CANNONBALL_ROOM_COIN_8(world),
    ]
