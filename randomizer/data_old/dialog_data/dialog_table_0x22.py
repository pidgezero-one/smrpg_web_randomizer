...
dialog_data[
    48
] = """ Why don't you crash for a while?[await]
...
dialog_data[
    58
] = """ `MAIN_CHARACTER_NAME`! Please, you've GOT
 to save the kingdom![await]"""
dialog_data[
    59
] = """ Our economy is booming now that
...
dialog_data[
    62
] = """ Some of the monsters out there are
...
dialog_data[
    69
] = """ My son was getting dizzy from all
...
dialog_data[
    97
] = """CHANCELLOR: It's a shame I don't
...
dialog_data[
    107
] = """ I've traveled all around the world.[await]
...
dialog_data[
    180
] = """ Huh?[delay] No, I don't have anything
 else.[delay] Why don't you go look in the
 vault?[await]"""
dialog_data[
    181
] = """ I saw the guy in the guest room
...
dialog_data[
    187
] = """ Saved by `MAIN_CHARACTER_NAME` again!
...
dialog_data[
    197
] = """ Hey, give me back my wallet![await]
...
dialog_data[
    202
] = """ Not all attacks can be blocked with
...
dialog_data[
    215
] = """ We're having an honoured guest
...
dialog_data[
    218
] = """ This guy can do more Super Jumps
 than me![await]"""
dialog_data[
    219
] = """
...
dialog_data[
    227
] = """TOAD: Good luck, `MAIN_CHARACTER_NAME`!
 Give 'em heck![await]"""
...
dialog_data[
    290
] = """ Hi `MAIN_CHARACTER_NAME`. Staying for a nap?[await]
 [select]  (Sure)
...
dialog_data[
    300
] = """ `MAIN_CHARACTER_NAME`! How are we feeling?[await]
...
dialog_data[
    312
] = """ Some jerk waltzed into the forest
...
dialog_data[
    319
] = """ There's so much treasure to be
 found in this world.
 Leave no stone unturned![await]"""
dialog_data[
    320
] = """ I'll tell you a secret.[await][pause]
...
dialog_data[
    328
] = """ The forest?[await][pause] Nah, that's more my
...
dialog_data[
    340
] = """ The last time it started raining
...
dialog_data[
    358
] = """ Listen, buddy, I admire how hard
...
dialog_data[
    382
] = """ Phew..[delay]..[delay] That was close,
...
dialog_data[
    386
] = """ When our shops rotate their stock,
...
dialog_data[
    387
] = """ There are three special invisible
...
dialog_data[
    391
] = """ There's a gardener who lives in this
...
dialog_data[
    392
] = """ Have you been to Midas River?
 There is some interesting stuff to
 find in the tunnels.[await]"""
dialog_data[
    393
] = """ People in our world love to share
...
dialog_data[
    406
] = """ Hey![delay][delay]...[delay][delay]You gave it to someone![await]
 You're gonna get it![await]"""
dialog_data[
    407
] = """YOSHI: (Looks like I need a little
...
dialog_data[
    415
] = """ (It's best to alternate A and B to
...
dialog_data[
    416
] = """ (Come see me later after you beat
...
dialog_data[
    420
] = """BOSHI: (What're YOU lookin' at?[await]
...
dialog_data[
    486
] = """ THANK YOU very much, `MAIN_CHARACTER_HONORIFIC`!
...
dialog_data[
    489
] = """ Would you like to stay longer?[await]
 [select]  (Yes)
...
dialog_data[
    499
] = """ Wait a minute[delay]...You're broke![await]
...
dialog_data[
    536
] = """ Use the coins I'm holding for you?[await]
  [select]  (Yes)
  [select]  (No)[await]"""
dialog_data[537] = """ I'll hold your [0x7000] extra coin(s).[await]"""
dialog_data[
    538
] = """ You got [0x7000] coin(s).
 But that’s not enough to cash in,
 so I'll hold them for you, okay?[await]
 Come back and try again![await]"""
dialog_data[
    539
] = """ Today you can trade in [0x7000] coins
 for [0x7024] Frog Coin![await][pause][page]
[end]"""
dialog_data[
    540
] = """ If we add your previous total...[await][pause]
[end]"""
dialog_data[
    541
] = """ You got [0x7000] coin(s), so...
[end]"""
dialog_data[
    542
] = """ You'll get [0x7000] Frog Coin for your
 trade in.[await]"""
dialog_data[
    543
] = """ [page]
...
dialog_data[
    584
] = """ It’s [0x7024] coins for a night.[await]
[end]"""
dialog_data[
    585
] = """ Ya'll staying the night?
  [select]  (Yes)
  [select]  (No)[await]"""
...
dialog_data[
    591
] = """ A couple o' jerks barged into the
...
dialog_data[
    592
] = """ Our friend up there's tryin' to drill
...
dialog_data[
    593
] = """ I reckon this'd be a heckuva lot
...
dialog_data[
    601
] = """ Hey, `MAIN_CHARACTER_NAME`! We've got
...
dialog_data[
    620
] = """ Welcome to my pur-tend store![await]
...
dialog_data[
    635
] = """ Heard the fireworks guy's workin'
...
dialog_data[
    636
] = """ Have ya met the weirdos livin' in
...
dialog_data[
    639
] = """ Hey `MAIN_CHARACTER_TITLE`, have ya ever been to
...
dialog_data[
    640
] = """ My sister's friend must be sick, or
...
dialog_data[
    641
] = """ Hey `MAIN_CHARACTER_TITLE`, didja know Land's End
...
dialog_data[
    652
] = """ I'm reading a picture book about
...
dialog_data[
    653
] = """ Hey `MAIN_CHARACTER_TITLE`! Have ya been to
...
dialog_data[
    654
] = """ You want your “Shiny Stone” back?[await]
  [select]  (Yes please)
  [select]  (No thanks)[await]"""
dialog_data[
    655
...
dialog_data[
    656
] = """ Sowwy, my pur-tend store is closed
...
dialog_data[
    667
] = """PA'MOLE: `MAIN_CHARACTER_NAME`, you're our
 only hope for those kids.
 We're countin' on ya.[await]"""
dialog_data[
    668
] = """ How about a trolley ride?[await]
...
dialog_data[
    706
] = """ You have [0x7000] points now.
[end]"""
dialog_data[
    707
] = """ Would you like to trade in an item?[await]
  [select]  (Yes)
  [select]  (No)[await]"""
dialog_data[
    708
...
dialog_data[
    716
] = """ Do you want to exit to the World
 Map?[await]
  [select] (Yes)
  [select] (No)[await]"""
dialog_data[
...
dialog_data[
    719
] = """ You want a better star?[await]
  [select] (Yes)
  [select] (No)[await]"""
dialog_data[720] = """[await]"""
dialog_data[
    721
] = """ Come back next time you're
...
dialog_data[
    729
] = """ The Sky Troopas aren't here yet.[await][page]
...
dialog_data[
    730
] = """ Give me the Temple Key, and I'll let
...
dialog_data[
    774
] = """ Wanna buy a mystery item for
 500 coins?[await]
  [select] (Okay)
  [select] (No thanks)[await]"""
dialog_data[
    775
] = """ Wanna buy some Fireworks for
 500 coins?[await]
  [select] (Okay)
  [select] (No thanks)[await]"""
...
dialog_data[
    783
] = """ Sorry, I can't sell more than one
...
dialog_data[
    785
] = """ Wanna challenge the Sky Bridge?[await]
  [select] (Sure)
  [select] (No)[await]"""
dialog_data[786] = """[await]"""
dialog_data[
    787
] = """ Need an explanation?[await]
  [select] (Yes)
  [select] (No)[await]"""
dialog_data[
    788
...
dialog_data[
    789
] = """ Which course do you want?[await]
  [select] (Normal)
  [select] (Special)
  [select] (Expert)[await]"""
dialog_data[
    790
] = """ Okay, I'll need 5 coins from you.[await][page]
[end]"""
dialog_data[
    791
...
dialog_data[
    835
] = """ There is a chest in the sewers that
...
dialog_data[
    859
] = """       “DO”n't get much sun!~[await][page]
[end]"""
dialog_data[
    860
] = """
...
dialog_data[
    861
] = """     'till my workday is “DO”ne~[await][page]
[end]"""
dialog_data[
    862
] = """
...
dialog_data[
    863
] = """        It’s “LA”bor I choose~[await][page]
[end]"""
dialog_data[
    864
] = """
...
dialog_data[
    882
] = """PA'MOLE: `MAIN_CHARACTER_NAME`! You've
...
dialog_data[
    902
] = """PA' MOLE: There ain't much left in
...
dialog_data[
    907
] = """     This is a 3-Dimensional Maze.[await]
...
dialog_data[
    911
] = """ Hey![delay_15] Have you heard?[await][pause] The bushes
...
dialog_data[
    949
] = """`MAIN_CHARACTER_NAME`’s password is....
<[end]"""
...
dialog_data[
    1014
] = """ This is 100% currant juice.[await]
...
dialog_data[
    1054
] = """DR. TOPPER: In the Moleville blues,
...
dialog_data[
    1056
] = """DR. TOPPER: Yaridovich is what?[await][page]
...
dialog_data[
    1057
] = """DR. TOPPER: The boy at the inn in
...
dialog_data[
    1058
] = """DR. TOPPER: What did Carroboscis
...
dialog_data[
    1062
] = """DR. TOPPER: Who is the leader of
...
dialog_data[
    1083
] = """DR. TOPPER: What’s the full name
...
dialog_data[
    1084
] = """DR. TOPPER: Who helped you up the
...
dialog_data[
    1093
] = """DR. TOPPER: So! How many?[await][page]
...
dialog_data[1130] = """    Need the “Room Key” to get in[await]"""
dialog_data[1131] = """    Need the “Elder Key” to get in[await]"""
