...
class Henchman:
    ...
    _pack_number: int | None = None
    _model: type[NPC]

    @property
    def pack_number(self) -> UInt8 | None:
    ...
    def set_pack_number(self, pack_number: int | None) -> None:
...
class Boss(BossFight):
    ...
    _big_model: type[NPC] | None = None
    _attack_model: type[NPC] | None = None
    _forced_background: Battlefields | None = None
    ...
    def set_big_model(self, big_model: type[NPC] | None) -> None:
        """Set the model to be drawn representing this boss in contexts where
        the model can be larger than 32x32 px, where such sprites exist.
    ...
    def set_attack_model(self, attack_model: type[NPC] | None) -> None:
        """Set the model to be drawn representing this boss in contexts where
    ...
    @property
    def forced_background(self) -> Battlefields | None:
    ...
    def set_forced_background(self, forced_background: Battlefields | None) -> None:
        """If set, launching a fight against this boss' pack will always load this battlefield.
        Otherwise, the battlefield will simply match the world area."""
