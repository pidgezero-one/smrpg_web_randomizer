...
class HammerBrosFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI4060_NEED_TO_DO_CHAPEL_CHECKS: """HAMMER BRO: You found all\n of `MARRYMORE_CHARACTER`'s things?[await] Good job, bozo, but you're still\n missing a few things in this room![await]""",
...
class Croco1BossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI4060_NEED_TO_DO_CHAPEL_CHECKS: """CROCO: What's this? You found all\n of `MARRYMORE_CHARACTER`'s things?[await] You're missing a few things in this\n room, though. Don't take another\n 50 years to find them.[await]""",
...
class MackBossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI4060_NEED_TO_DO_CHAPEL_CHECKS: """MACK: Great, you found all of\n `MARRYMORE_CHARACTER`'s stuff.[await] But we can't start the party until\n you clean up all the junk in this\n room, too.[await]""",
...
class PandoriteBossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI4060_NEED_TO_DO_CHAPEL_CHECKS: """PANDORITE: Oh, you found all of\n `MARRYMORE_CHARACTER`'s stuff. Great.[await] But you're missing a few things in\n this room. How'd you manage to\n skip that?[await]""",
    ...
    _dialog_replacements_remake = {
        ...
        DI4060_NEED_TO_DO_CHAPEL_CHECKS: """HUHWHAT: Oh, you found all of\n `MARRYMORE_CHARACTER`'s stuff. Great.[await] But you're missing a few things in\n this room. How'd you manage to\n skip that?[await]""",
...
class Belome1BossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1784_SHIP_BOSS_SIDEKICK_IN_ROOM_2: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1785_SHIP_BOSS_SIDEKICK_IN_ROOM_1: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1786_LETTER_FROM_SHIP_BOSS: """ (It's a damp, slimy, looking note.\n Did `SEASIDE_BOSS` LICK this?[await][page]\n A paw print and a crudely\n drawn image of `VOLCANO_BOSS_DESCRIPTION`\n are etched on the paper.[await\n This is probably one of \n `FINAL_BOSS_NAME`'s henchmen![await]\n `SEASIDE_BOSS` likely headed down to\n find more snacks,\n so it's time to move on.)[await]""",
        DI1792_SHIP_BOSS_SIDEKICK_IN_ROOM_3: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1793_SHIP_BOSS_SIDEKICK_IN_ROOM_4: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        ...
        DI4060_NEED_TO_DO_CHAPEL_CHECKS: """BELOME: Mmm, you've found all of\n `MARRYMORE_CHARACTER`'s things![await] But they won't bring the cake in\n here until we clean the place up.\n Go grab the leftover items, please.[await]""",
...
class BowyerBossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI4060_NEED_TO_DO_CHAPEL_CHECKS: """BOWYER: Nya, NYA!?[await]\n Found all of `MARRYMORE_CHARACTER`'s\n belongings, you did![await] But forget to retrieve some things\n in this room, you did, nya!!![await]""",
...
class HidonBossFight(BossFightPrize):
    ...
    _dialog_replacements_remake = {
        ...
        DI1786_LETTER_FROM_SHIP_BOSS: """\n Listen up interloper![await][page]\n Good job getting rid of\n `SEASIDE_BOSS`! Now \n my naval dominance is complete![await]\n The Mini Goombas' nest reported\n `VOLCANO_BOSS_DESCRIPTION`\n near the volcano.[await]\n They sail under the flag of \n `FINAL_BOSS_NAME`, I think.[await]\n If you ever touch my box again,\n I'm taking a finger... at least.[await][page]\n\n                  Lots of Carni-kisses,\n                                    Whuhoh[await]""",
...
class BoomerBossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1784_SHIP_BOSS_SIDEKICK_IN_ROOM_2: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1785_SHIP_BOSS_SIDEKICK_IN_ROOM_1: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1786_LETTER_FROM_SHIP_BOSS: """ (Origami figures sit in silent\n tableau:[await][page]\n One figure resembles\n `VOLCANO_BOSS_DESCRIPTION`[await].\n The others appear to be\nrelated to `FINAL_BOSS_NAME`.[await]\n A haiku lays near the figures:\n "Stay strong `MAIN_CHARACTER_NAME`[await]\n Show them what discipline means[await]\n Shred them throughly[await][page]\n\n                   Go in peace,\n                         Boomer")"await]""",
        DI1792_SHIP_BOSS_SIDEKICK_IN_ROOM_3: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1793_SHIP_BOSS_SIDEKICK_IN_ROOM_4: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
...
class ExorBossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1784_SHIP_BOSS_SIDEKICK_IN_ROOM_2: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1785_SHIP_BOSS_SIDEKICK_IN_ROOM_1: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1786_LETTER_FROM_SHIP_BOSS: """\n HEY![await][page]\n What did you do to\n `SEASIDE_BOSS`?![await]\n Let's see you deal with \n `VOLCANO_BOSS_DESCRIPTION`\n near the volcano![await]\n You are no match for us,\n `FINAL_BOSS_NAME`'s gang![await]\n Trespass on my ship at your own\n peril![await]\n I will devour you and expel\n your corporeal form in the\n dimmension of bombs and sledges![await]\n Mind your place, Tiny.[await][page]\n\n                                      Exor[await]""",
        DI1792_SHIP_BOSS_SIDEKICK_IN_ROOM_3: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1793_SHIP_BOSS_SIDEKICK_IN_ROOM_4: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
