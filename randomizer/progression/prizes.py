...
class HammerBrosFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1786_LETTER_FROM_SHIP_BOSS: """\n Hey `MAIN_CHARACTER_NAME`![await][page]\n My bro and I saw you squash `SEASIDE_BOSS`! Nice one![await] My bro and his hammer say they saw `VOLCANO_BOSS_DESCRIPTION` near the volcano.[await] We've nailed them down as one of `FINAL_BOSS_NAME`[await] Listen, my bro is on me about loanin' you my hammer.[await] Whaddaya say you bring me back an upgrade to pummel him with? Do me a solid![await][page]\n\n                                  Thanks!\n                         Hammer Bro #2[await]""",
        ...
        DI4060_NEED_TO_DO_CHAPEL_CHECKS: """HAMMER BRO: You found all of `MARRYMORE_CHARACTER`'s things?[await] Good job, bozo, but you're still missing a few things in this room![await]""",
...
class Croco1BossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1784_SHIP_BOSS_SIDEKICK_IN_ROOM_2: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1785_SHIP_BOSS_SIDEKICK_IN_ROOM_1: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1786_LETTER_FROM_SHIP_BOSS: """\n 'Sup Half-Wits?![await][page]\n Did it take you 500 years to beat `SEASIDE_BOSS`?[await] While chasing my next heist, I saw `VOLCANO_BOSS_DESCRIPTION` near the volcano. Seems... nice.[await] I better get a crew together with `FINAL_BOSS_NAME`[await] I'm telling you this because I want this to be a challenge this time.[await] I bet this bazooka that I lifted from that toad "guard" will be useful![await][page]\n\n                                    Seeya!\n                                     Croco[await]""",
        DI1792_SHIP_BOSS_SIDEKICK_IN_ROOM_3: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1793_SHIP_BOSS_SIDEKICK_IN_ROOM_4: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        ...
        DI4060_NEED_TO_DO_CHAPEL_CHECKS: """CROCO: What's this? You found all of `MARRYMORE_CHARACTER`'s things?[await] You're missing a few things in this room, though. Don't take another 50 years to find them.[await]""",
...
class MackBossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1786_LETTER_FROM_SHIP_BOSS: """\n Yo `MAIN_CHARACTER_NAME`![await][page]\n I heard you left and threw down with `SEASIDE_BOSS`![await] The Shysters on lookout saw `VOLCANO_BOSS_DESCRIPTION` near the volcano.[await] They got the good stuff from `FINAL_BOSS_NAME`[await] We'd better get back aboard before any other Shyster party fouls. I heard Exor might even show up![await][page]\n\n                             Hang loose!\n                                     Mack[await]""",
        ...
        DI4060_NEED_TO_DO_CHAPEL_CHECKS: """MACK: Great, you found all of `MARRYMORE_CHARACTER`'s stuff.[await] But we can't start the party until you clean up all the junk in this room, too.[await]""",
    ...
    _dialog_replacements_remake = {
        ...
        DI1786_LETTER_FROM_SHIP_BOSS: """\n Yo `MAIN_CHARACTER_NAME`![await][page]\n I heard you left and threw down with `SEASIDE_BOSS`![await] The Shymores on lookout saw `VOLCANO_BOSS_DESCRIPTION` near the volcano.[await] They got the good stuff from `FINAL_BOSS_NAME`[await] We'd better get back aboard before any other Shymore party fouls. I heard Exor might even show up![await][page]\n\n                             Hang loose!\n                               Claymorton[await]""",
...
class PandoriteBossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1784_SHIP_BOSS_SIDEKICK_IN_ROOM_2: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1785_SHIP_BOSS_SIDEKICK_IN_ROOM_1: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1786_LETTER_FROM_SHIP_BOSS: """\n Dear `MAIN_CHARACTER_NAME`,[await][page]\n Someone closed my box, and I floated up here to see your battle with `SEASIDE_BOSS`.[await] While looking for rocks, I saw `VOLCANO_BOSS_DESCRIPTION` near the volcano.[await] I think it might be one of `FINAL_BOSS_NAME`[await] I've got all the rocks in my box so I should sink near the ship. Drop by to see if I made it later.[await][page]\n\n                         Warm Regards,\n                               Pandorite[await]""",
        DI1792_SHIP_BOSS_SIDEKICK_IN_ROOM_3: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1793_SHIP_BOSS_SIDEKICK_IN_ROOM_4: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        ...
        DI4060_NEED_TO_DO_CHAPEL_CHECKS: """PANDORITE: Oh, you found all of `MARRYMORE_CHARACTER`'s stuff. Great.[await] But you're missing a few things in this room. How'd you manage to skip that?[await]""",
    ...
    _dialog_replacements_remake = {
        ...
        DI4060_NEED_TO_DO_CHAPEL_CHECKS: """HUHWHAT: Oh, you found all of `MARRYMORE_CHARACTER`'s stuff. Great.[await] But you're missing a few things in this room. How'd you manage to skip that?[await]""",
...
class BowyerBossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1786_LETTER_FROM_SHIP_BOSS: """\n Knock, knock, NYA!![await][page]\n Your battle is long and boring, even for `SEASIDE_BOSS`, nya![await] Aero #837 painted a target on `VOLCANO_BOSS_DESCRIPTION` near the volcano, nya!![await] 10,000 arrows will I fire at `FINAL_BOSS_NAME`[await] Follow me to the ship you will NOT![await][page]\n\n                                  NYA!!!![await]\n                                    Bowyer[await]""",
        ...
        DI4060_NEED_TO_DO_CHAPEL_CHECKS: """BOWYER: Nya, NYA!?[await] Found all of `MARRYMORE_CHARACTER`'s belongings, you did![await] But clear out this room, you did NOT, nya!!![await]""",
...
class Croco2BossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1786_LETTER_FROM_SHIP_BOSS: """\n 'Sup Half-Wits?![await][page]\n Did it take you 500 years to beat `SEASIDE_BOSS`?[await] While chasing my next heist, I saw `VOLCANO_BOSS_DESCRIPTION` near the volcano. Seems... nice.[await] I better get a crew together with `FINAL_BOSS_NAME`[await] I'm telling you this because I want it to be a challenge this time.[await] I bet this bazooka that I lifted from that toad "guard" will be useful![await][page]\n\n                                    Seeya!\n                                     Croco[await]""",
        DI1793_SHIP_BOSS_SIDEKICK_IN_ROOM_4: """FLUNKIE: Hop on the trampoline\n in the next room. It'll take you\n outside. Go on, now. Give it a try![await]""",
...
class PunchinelloBossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1786_LETTER_FROM_SHIP_BOSS: """\n WHAT'S UP CHAT?![await][page]\n I just watched a HYPE fight versus `SEASIDE_BOSS`.  Oh.  Em.  Gee.[await] My Bob-omb army told me about `VOLCANO_BOSS_DESCRIPTION` near the volcano. Fuse is LIT!![await] I smell a collab video with `FINAL_BOSS_NAME`[await] Don't forget to tune in for my 100 follower special, where I'll play Bob-omb roulette with watermelons![await][page]\n\n           Like, Share, and Subscribe!\n                              Punchinello[await]""",
...
class KnifeGuyGrateGuyBossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1786_LETTER_FROM_SHIP_BOSS: """\n Heya `MAIN_CHARACTER_NAME`,[await][page]\n Looks like you totally thrashed `SEASIDE_BOSS`. Whoopdy do![await] Knife Guy tells me he saw `VOLCANO_BOSS_DESCRIPTION` near the volcano.[await] They're in a traveling circus with `FINAL_BOSS_NAME`[await] I was going to open another casino, but Knife Guy dropped the ball on the building permits.[await] So now our ship is sunk. Stop by sometime, we're always down to clown.[await][page]\n\n                                    Later!\n                 Grate Guy & Knife Guy[await]""",
...
class BundtBossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1784_SHIP_BOSS_SIDEKICK_IN_ROOM_2: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1785_SHIP_BOSS_SIDEKICK_IN_ROOM_1: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1786_LETTER_FROM_SHIP_BOSS: """\n Greetings and Salutations![await][page]\n I can't get over how quickly you dispatched `SEASIDE_BOSS`![await] My dinner guests informed me of `VOLCANO_BOSS_DESCRIPTION` near the volcano.[await] I heard they're having a reunion with `FINAL_BOSS_NAME`[await] I've gotten hungry aboard this ship. You wouldn't believe how much you can miss your chefs and creams. [await] Come visit and have a slice![await][page]\n\n       Frosting my way to victory,\n                                     Bundt[await]""",
        DI1792_SHIP_BOSS_SIDEKICK_IN_ROOM_3: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1793_SHIP_BOSS_SIDEKICK_IN_ROOM_4: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
...
class KingCalamariBossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1784_SHIP_BOSS_SIDEKICK_IN_ROOM_2: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1785_SHIP_BOSS_SIDEKICK_IN_ROOM_1: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1786_LETTER_FROM_SHIP_BOSS: """\n There's a wet parchment with ink:[await][page]\n There's a surpringly great picture of your battle with `SEASIDE_BOSS`.[await][page]\n On the back is an image of\n `VOLCANO_BOSS_DESCRIPTION` near a volcano, looks like.[await] Then a bunch of ?'s next to `FINAL_BOSS_NAME`[await] Finally, there's a picture of a squid with X's for eyes falling towards the shipwreck.[await] This drawing raises more questions than it answers.[await]""",
        DI1792_SHIP_BOSS_SIDEKICK_IN_ROOM_3: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1793_SHIP_BOSS_SIDEKICK_IN_ROOM_4: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
...
class HidonBossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1786_LETTER_FROM_SHIP_BOSS: """\n Listen up interloper![await][page]\n Good job getting rid of `SEASIDE_BOSS`! Now my naval dominance is complete![await] The Goombettes' nest reported `VOLCANO_BOSS_DESCRIPTION` near the volcano.[await] They sail under the flag of `FINAL_BOSS_NAME`[await] If you ever touch my box again, I'm taking a finger... at least.[await][page]\n\n                  Lots of Carni-kisses,\n                                    Hidon[await]""",
    ...
    _dialog_replacements_remake = {
        ...
        DI1786_LETTER_FROM_SHIP_BOSS: """\n Listen up interloper![await][page]\n Good job getting rid of `SEASIDE_BOSS`! Now my naval dominance is complete![await] The Mini Goombas' nest reported `VOLCANO_BOSS_DESCRIPTION` near the volcano.[await] They sail under the flag of `FINAL_BOSS_NAME`[await] If you ever touch my box again, I'm taking a finger... at least.[await][page]\n\n                  Lots of Carni-kisses,\n                                    Whuhoh[await]""",
...
class JohnnyBossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1786_LETTER_FROM_SHIP_BOSS: """\n To `MAIN_CHARACTER_NAME`,[await][page]\n Knowin' you, it must've been a breeze knockin' down `SEASIDE_BOSS`, eh?[await] By the way, my pirates say they say `VOLCANO_BOSS_DESCRIPTION` across the sky.[await] It's probably one of `FINAL_BOSS_NAME`[await] Well, my gills are failing on me, so I'll be heading back down. Drop in when you have time, okay?[await][page]\n\n                         Your true mate,\n             Jonathan "Johnny" Jones[await]""",
...
class YaridovichBossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1786_LETTER_FROM_SHIP_BOSS: """\n To `MAIN_CHARACTER_NAME`,[await][page]\n By now, you've certainly defeated `SEASIDE_BOSS`, I think.[await] My "Toad" spies tell me they saw `VOLCANO_BOSS_DESCRIPTION` near the volcano.[await] I suspect they're one of `FINAL_BOSS_NAME`[await] Give'em "the Tickler" from me![await] My joints are starting to rust, so I'll be headin' back down.[await] Stop by whenever you need something unsavory, okay?[await][page]\n\n                   Your confidant,\n                         Yaridovich[await]""",
...
class MokuraBossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1784_SHIP_BOSS_SIDEKICK_IN_ROOM_2: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1785_SHIP_BOSS_SIDEKICK_IN_ROOM_1: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1786_LETTER_FROM_SHIP_BOSS: """\n ()...Is this invisible ink?)[await][page] "Defeated `SEASIDE_BOSS`. Good."[await]\n "Sensed... `VOLCANO_BOSS_DESCRIPTION` near volcano..."[await] "Ethereal bond with `FINAL_BOSS_NAME`"[await][page]\n (This last part just reeks of\n flatulence...) [await]""",
        DI1792_SHIP_BOSS_SIDEKICK_IN_ROOM_3: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1793_SHIP_BOSS_SIDEKICK_IN_ROOM_4: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
...
class JaggerBossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1784_SHIP_BOSS_SIDEKICK_IN_ROOM_2: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1785_SHIP_BOSS_SIDEKICK_IN_ROOM_1: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1786_LETTER_FROM_SHIP_BOSS: """\n Hi `MAIN_CHARACTER_NAME`![await][page]\n I saw you give the business to `SEASIDE_BOSS`! It was a shell of a good hit!! [await] While out training, I saw `VOLCANO_BOSS_DESCRIPTION` near the volcano.[await] I hear they run with `FINAL_BOSS_NAME`[await] I hope you've been practicing your timed blocks! I'll know the next time I use Terrapunch on you![await][page]\n\n                          You can do it!\n                                    Jagger[await]""",
        DI1792_SHIP_BOSS_SIDEKICK_IN_ROOM_3: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1793_SHIP_BOSS_SIDEKICK_IN_ROOM_4: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
...
class Jinx1BossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1784_SHIP_BOSS_SIDEKICK_IN_ROOM_2: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1785_SHIP_BOSS_SIDEKICK_IN_ROOM_1: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1786_LETTER_FROM_SHIP_BOSS: """\n `MAIN_CHARACTER_NAME`,[await][page]\n Have you mastered your training with `SEASIDE_BOSS`?[await] I sense your next challenge is `VOLCANO_BOSS_DESCRIPTION` near the volcano.[await] They battle in the old style of `FINAL_BOSS_NAME`[await] Complete this task, and you will be prepared for our rematch.[await] Fail, and you need not ever show your face on my ship again.[await][page]\n\n                       Fight with honor,\n                                      Jinx[await]""",
        DI1792_SHIP_BOSS_SIDEKICK_IN_ROOM_3: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1793_SHIP_BOSS_SIDEKICK_IN_ROOM_4: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
...
class CulexBossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1786_LETTER_FROM_SHIP_BOSS: """\n Greetings, honored Warrior.[await][page]\n I have witnessed you do battle with `SEASIDE_BOSS`. I am impressed, but not surprised.[await] In my travels of your world, I saw `VOLCANO_BOSS_DESCRIPTION` near the volcano.[await] The crystals revealed they are `FINAL_BOSS_NAME`[await] I know not your path to victory, but challenge awaits you there.[await] I must return to the sea, lest the fragile water crystal shatter.[await][page]\n\n                       Fight with honor,\n                                     Culex[await]""",
...
class BoxBoyBossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1784_SHIP_BOSS_SIDEKICK_IN_ROOM_2: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1785_SHIP_BOSS_SIDEKICK_IN_ROOM_1: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1786_LETTER_FROM_SHIP_BOSS: """\n Trespassers BEWARE:[await][page]\n Loitering Prohibited (yes, you too `SEASIDE_BOSS`!)[await] Don't think I didn't see `VOLCANO_BOSS_DESCRIPTION` either, keep to your volcano.[await] And there will be no exceptions made for `FINAL_BOSS_NAME`[await] Also, I expect SILENCE. No spells. Casting a spell is a good way to get blasted.  You've been warned.[await][page]\n\n             Now, GET OFF MY LAWN!!\n                                  Box Boy[await]""",
        DI1792_SHIP_BOSS_SIDEKICK_IN_ROOM_3: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1793_SHIP_BOSS_SIDEKICK_IN_ROOM_4: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI2061_HEAD_CHEF: """CHEF TORTE: Zees cake, ve make\n it look like mimic! It is...\n masterpiece![await]""",
...
class MegasmilaxBossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1786_LETTER_FROM_SHIP_BOSS: """\n `MAIN_CHARACTER_NAME`,[await][page]\n I'm still salivating over your battle with `SEASIDE_BOSS`.[await] I must taste its umami someday...[await] I've heard through the vine about `VOLCANO_BOSS_DESCRIPTION` near the volcano.[await] They must be part of the underground network of `FINAL_BOSS_NAME`[await] My offer to have you for dinner stands. I must return to my roots.[await][page]\n\n                             Stay hungry,\n                              Megasmilax[await]""",
...
class DodoBossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1784_SHIP_BOSS_SIDEKICK_IN_ROOM_2: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1785_SHIP_BOSS_SIDEKICK_IN_ROOM_1: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1786_LETTER_FROM_SHIP_BOSS: """\n Dear `MAIN_CHARACTER_NAME`,[await][page] I saw your incredible battle with `SEASIDE_BOSS`![await] At the "Tanning Salon", I saw `VOLCANO_BOSS_DESCRIPTION` near the volcano.[await] Valentina referred to them as `FINAL_BOSS_NAME`[await] Look, I actually think you're cool, and I'm learning my Multistrike timing from our battles... [await]But...[delay] I can't leave her. She needs me. I hope you understand.[await][page]\n\n                       Your biggest fan,\n                                      Dodo[await]""",
        DI1792_SHIP_BOSS_SIDEKICK_IN_ROOM_3: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1793_SHIP_BOSS_SIDEKICK_IN_ROOM_4: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
...
class BirdettaBossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1786_LETTER_FROM_SHIP_BOSS: """\n HI `MAIN_CHARACTER_NAME`♥![await][page] Did `SEASIDE_BOSS` submit to the power of HUGS?!♥[await] While doing some incubating, I saw `VOLCANO_BOSS_DESCRIPTION` near the volcano.[await] My eggies♥ think they scramble with `FINAL_BOSS_NAME`[await] My lovelies♪ and I have to get back to the ship, and the bouyant forces of seawater aren't helping.[await] Stop by again soon♥! [await][page]\n\n                           ♥XO♥XO♥XO♥\n                                     Birdo[await]""",
...
class ValentinaBossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1786_LETTER_FROM_SHIP_BOSS: """\n To whom it may concern,[await][page]\n Make sure that pesky `SEASIDE_BOSS` is gone by the time I get back.[await] A little birdy told me they saw `VOLCANO_BOSS_DESCRIPTION` near the volcano. Gross.[await] I cannot abide any more of `FINAL_BOSS_NAME` They're all beneath me. Literally.[await] Well, I've got a ship full of idiots to command. Don't call, I have a boyfriend. His name is...Booster.[await][page]\n\n                       NOT yours,\n                         Valentina[await]""",
...
class AxemRangersBossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1786_LETTER_FROM_SHIP_BOSS: """\n yo `MAIN_CHARACTER_NAME`,[await][page]\n hru? fite was zzz, so I went bak 2 teh ship 4 a nap. text me when ur done w/ `SEASIDE_BOSS`.[await] green would not shut up bout how he saw `VOLCANO_BOSS_DESCRIPTION` near teh volcano.[await]pink flirted w/ a dood from `FINAL_BOSS_NAME` wtf?[await] black wants 2 punk them, but yellow got the squirtz again... so we got 2 go chill 4 a bit.[await] Hit me bak l8r. [await][page]\n\n                                     peace\n                                        red[await]""",
...
class ChesterBossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1784_SHIP_BOSS_SIDEKICK_IN_ROOM_2: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1785_SHIP_BOSS_SIDEKICK_IN_ROOM_1: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1786_LETTER_FROM_SHIP_BOSS: """\n `MAIN_CHARACTER_NAME`:[await][page]\n I'm too old for this nonsense with `SEASIDE_BOSS`, good luck.[await] Just to see if I could, I summoned `VOLCANO_BOSS_DESCRIPTION` near the volcano.[await] It seems they're associated with`FINAL_BOSS_NAME`[await] I've been belching up monsters for a LONG time, and I've never seen anything this rude.[await] Fix it, and I MIGHT forget you opened my box.[await][page]\n\n    Go do something useful for once.\n                                   Chester[await]""",
        DI1792_SHIP_BOSS_SIDEKICK_IN_ROOM_3: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1793_SHIP_BOSS_SIDEKICK_IN_ROOM_4: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI2061_HEAD_CHEF: """CHEF TORTE: Zees cake, ve make\n it look like mimic! It is...\n masterpiece![await]""",
...
class KamekBossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1784_SHIP_BOSS_SIDEKICK_IN_ROOM_2: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1785_SHIP_BOSS_SIDEKICK_IN_ROOM_1: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1786_LETTER_FROM_SHIP_BOSS: """\n `MAIN_CHARACTER_NAME`![await][page]\n Before I could cast a spell, you defeated `SEASIDE_BOSS`![await] Earlier while flying around seeking vengeance, I saw `VOLCANO_BOSS_DESCRIPTION` by the volcano.[await] I remember them being one of `FINAL_BOSS_NAME`.[await] I'd better get back to the ship in case Yoshi falls into one the pits.[await][page]\n\n     Now you see me, now you don't![await]                               Magikoopa""",
        DI1792_SHIP_BOSS_SIDEKICK_IN_ROOM_3: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1793_SHIP_BOSS_SIDEKICK_IN_ROOM_4: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
...
class BoomerBossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1784_SHIP_BOSS_SIDEKICK_IN_ROOM_2: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1785_SHIP_BOSS_SIDEKICK_IN_ROOM_1: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1786_LETTER_FROM_SHIP_BOSS: """ (Origami figures sit in silent tableau:[await][page]\n One figure resembles `VOLCANO_BOSS_DESCRIPTION`[await]. The others appear to be related to `FINAL_BOSS_NAME`[await] A haiku lays near the figures: "Stay strong `MAIN_CHARACTER_NAME`[await] Show them what discipline means[await] Shred them throughly[await][page]\n\n                   Go in peace,\n                         Boomer")"await]""",
        DI1792_SHIP_BOSS_SIDEKICK_IN_ROOM_3: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1793_SHIP_BOSS_SIDEKICK_IN_ROOM_4: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
...
class ExorBossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1784_SHIP_BOSS_SIDEKICK_IN_ROOM_2: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1785_SHIP_BOSS_SIDEKICK_IN_ROOM_1: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1786_LETTER_FROM_SHIP_BOSS: """\n HEY![await][page]\n What did you do to `SEASIDE_BOSS`?![await] Let's see you deal with `VOLCANO_BOSS_DESCRIPTION` at the volcano![await] You are no match for us, `FINAL_BOSS_NAME`[await] Trespass on my ship at your own peril![await] I will devour you and expel your corporeal form in the dimmension of bombs and sledges![await]\n Mind your place, Tiny.[await][page]\n\n                                      Exor[await]""",
        DI1792_SHIP_BOSS_SIDEKICK_IN_ROOM_3: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1793_SHIP_BOSS_SIDEKICK_IN_ROOM_4: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
...
class CountdownBossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1786_LETTER_FROM_SHIP_BOSS: """ WAKE UP CALL FOR `MAIN_CHARACTER_NAME`!![await][page]\n YOU'RE LATE DEFEATING `SEASIDE_BOSS`!![await] NEWSFLASH: `VOLCANO_BOSS_DESCRIPTION` SPOTTED NEAR THE VOLCANO!![await] DING-A-LING SOURCES LINK TO `FINAL_BOSS_NAME`[await] TIME WAITS FOR NO ONE!![await] BETTER NAIL THAT MACK SKIP, ROCK CANDY MANIP, BLOCK CLIP, BACK TO SUNKEN SHIP, YIP!![await][page]\n\n Alarm off  <<<        >>>  Snooze\n                              Count Down[await]""",
    ...
    _dialog_replacements_remake = {
        ...
        DI1786_LETTER_FROM_SHIP_BOSS: """ WAKE UP CALL FOR `MAIN_CHARACTER_NAME`!![await][page]\n YOU'RE LATE DEFEATING `SEASIDE_BOSS`!![await] NEWSFLASH: `VOLCANO_BOSS_DESCRIPTION` SPOTTED NEAR THE VOLCANO!![await] RING-A-DING SOURCES LINK TO `FINAL_BOSS_NAME`[await]\n TIME WAITS FOR NO ONE!![await] BETTER NAIL THAT MACK SKIP, ROCK CANDY MANIP, BLOCK CLIP, BACK TO SUNKEN SHIP, YIP!![await][page]\n\n Alarm off  <<<        >>>  Snooze\n                              Count Down[await]""",
...
class CloakerDominoBossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1784_SHIP_BOSS_SIDEKICK_IN_ROOM_2: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1785_SHIP_BOSS_SIDEKICK_IN_ROOM_1: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1786_LETTER_FROM_SHIP_BOSS: """\n Hey `MAIN_CHARACTER_NAME`![await][page]\n We TOLD you to put your dukes up with `SEASIDE_BOSS`![await] You'd better be ready! We saw `VOLCANO_BOSS_DESCRIPTION` near the volcano![await] We think those snakes belong to `FINAL_BOSS_NAME` They sound like WEAKLINGS![await] It would be shameful if they defeated you.[await] Stop by the ship if you want to play! Or see a blockable Carni-Kiss![await][page]\n\n              IT'S CLOBBERING TIME!!\n                       Cloaker & Domino[await]""",
        DI1792_SHIP_BOSS_SIDEKICK_IN_ROOM_3: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1793_SHIP_BOSS_SIDEKICK_IN_ROOM_4: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
...
class ClerkBossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1786_LETTER_FROM_SHIP_BOSS: """\n Hey `MAIN_CHARACTER_NAME`,[await][page]\n When you can, I need a report on your the results of your battle with `SEASIDE_BOSS`.[await] On company retreat, I met `VOLCANO_BOSS_DESCRIPTION` near the volcano.[await] Mad Mallet saw them having drinks with `FINAL_BOSS_NAME`[await] I've got to get back to work. I spent my break writing this.[await] If you happen to return to the ship, could you bring me a Pick Me Up?[await][page]\n\n                                   Thanks,\n                                 the Clerk[await]""",
...
class ManagerBossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1786_LETTER_FROM_SHIP_BOSS: """\n `MAIN_CHARACTER_NAME`,[await][page]\n Have you taken care of `SEASIDE_BOSS` yet?[await] There's a report on my desk about `VOLCANO_BOSS_DESCRIPTION` near the volcano.[await] They're a priority client of `FINAL_BOSS_NAME`[await] Take care of them, pronto. All vacation time rescinded until it's done. I expect regular updates.[await][page]\n\n      Make it happen or you're fired.\n                             The Manager[await]""",
...
class DirectorBossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1786_LETTER_FROM_SHIP_BOSS: """\n To Whom It May Concern:[await][page]\n Please conclude all business with `SEASIDE_BOSS` ASAP.[await] Your next assignment involves `VOLCANO_BOSS_DESCRIPTION` at the volcano.[await] Temporary labor available from `FINAL_BOSS_NAME`[await] All changes tenured with immediate effect. Mandatory overtime until the job is complete.[await] Direct all inquiries to the Manager.[await][page]\n\n                                   Signed,\n                              the Director[await]""",
...
class GunyolkBossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1784_SHIP_BOSS_SIDEKICK_IN_ROOM_2: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1785_SHIP_BOSS_SIDEKICK_IN_ROOM_1: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1786_LETTER_FROM_SHIP_BOSS: """\n              Memorandum[await][page]\n `MAIN_CHARACTER_NAME` dispatched to handle `SEASIDE_BOSS`.[await] Real estate acquisition stalled by `VOLCANO_BOSS_DESCRIPTION` near volcano.[await] Competition associated with `FINAL_BOSS_NAME`[await] Report all conversations involving the words "union", "living wage", or "benefits" immediately.[await][page]\n\n                      Do more with less.\n                                -The Chief[await]""",
        DI1792_SHIP_BOSS_SIDEKICK_IN_ROOM_3: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1793_SHIP_BOSS_SIDEKICK_IN_ROOM_4: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
...
class SmithyBossFight(BossFightPrize):
    ...
    _dialog_replacements = {
        ...
        DI1784_SHIP_BOSS_SIDEKICK_IN_ROOM_2: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1785_SHIP_BOSS_SIDEKICK_IN_ROOM_1: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1786_LETTER_FROM_SHIP_BOSS: """\n Weakling,[await][page]\n I'll bet you had trouble with `SEASIDE_BOSS`. Pathetic.[await] A Drill Bit screamed about `VOLCANO_BOSS_DESCRIPTION` near the volcano.[await] I expected better from `FINAL_BOSS_NAME`[await] The Shyper is complaining about my blood pressure again. I have a sledge for problems like these.[await][page]\n\n You haven't seen my final form yet,\n                                    Smithy[await]""",
        DI1792_SHIP_BOSS_SIDEKICK_IN_ROOM_3: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
        DI1793_SHIP_BOSS_SIDEKICK_IN_ROOM_4: """ Hop on the trampoline in the next\n room. It'll take ya outside.\n Go on, now. Give it a try![await]""",
