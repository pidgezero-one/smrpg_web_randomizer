...
from randomizer.logic.renders import (render_volcano_exit_boss)
from randomizer.progression.prizelocations.access import (can_clear_volcano, can_damage_enemies_with_spells)
