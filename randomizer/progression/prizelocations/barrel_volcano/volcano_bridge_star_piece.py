...
from randomizer.progression.prizelocations.access import (can_clear_volcano)
from randomizer.progression.prizelocations.barrel_volcano.volcano_bridge_boss_fight import (VolcanoBridgeBossFight)
