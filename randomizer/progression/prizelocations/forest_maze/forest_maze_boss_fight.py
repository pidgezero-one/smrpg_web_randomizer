...
from randomizer.progression.prizelocations.access import (boss_slot_min_vram_cap_for_room, can_clear_forest, can_damage_enemies_with_spells)
from randomizer.progression.prizelocations.forest_maze.forest_maze_character import ForestMazeCharacter
