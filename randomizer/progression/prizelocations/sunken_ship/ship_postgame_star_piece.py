...
from randomizer.progression.prizelocations.access import (can_access_ship_postgame_boss)
from randomizer.progression.prizelocations.sunken_ship.ship_postgame_boss_fight import (ShipPostgameBossFight)
