...
from randomizer.logic.renders import (render_seaside_beach_boss)
from randomizer.progression.prizelocations.access import (can_clear_seaside_boss, can_damage_enemies_with_spells)
