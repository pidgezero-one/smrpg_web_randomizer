...
from randomizer.progression.prizelocations.access import (can_access_temple_postgame_boss)
from randomizer.progression.prizelocations.lands_end.temple_boss_fight_postgame import (TempleBossFightPostgame)
