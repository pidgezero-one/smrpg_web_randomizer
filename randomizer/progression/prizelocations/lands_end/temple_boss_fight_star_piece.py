...
from randomizer.progression.prizelocations.access import (can_clear_temple_boss)
from randomizer.progression.prizelocations.lands_end.temple_boss_fight import (TempleBossFight)
