...
from randomizer.progression.prizelocations.access import (can_access_sealed_postgame_boss)
from randomizer.progression.prizelocations.monstro_town.monstro_sealed_door_boss_fight_postgame import (MonstroSealedDoorBossFightPostgame)
