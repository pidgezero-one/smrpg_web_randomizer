...
from randomizer.progression.prizelocations.access import (can_clear_mines, can_damage_enemies_with_spells)
...
from randomizer.utils.npcs import (set_mines_punch_command)
