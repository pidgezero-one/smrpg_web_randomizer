...
from randomizer.progression.prizelocations.access import (can_access_moleville_entrance)
from randomizer.progression.prizelocations.moleville.outer_mines_boss_fight import (OuterMinesBossFight)
