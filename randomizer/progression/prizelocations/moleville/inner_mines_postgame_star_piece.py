...
from randomizer.progression.prizelocations.access import (can_access_moleville_postgame_boss)
from randomizer.progression.prizelocations.moleville.inner_mines_postgame_boss_fight import (InnerMinesPostgameBossFight)
