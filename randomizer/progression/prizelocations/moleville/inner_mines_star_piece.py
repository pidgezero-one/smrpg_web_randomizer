...
from randomizer.progression.prizelocations.access import (can_clear_mines)
from randomizer.progression.prizelocations.moleville.inner_mines_boss_fight import (InnerMinesBossFight)
