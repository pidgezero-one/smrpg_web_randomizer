...
class CrusherSpell(CharacterSpell):
    ...
    def palette_patch(self) -> dict[int, bytearray]:
        ...
        if self.element == Element.THUNDER:
            d[0x331B3F] = palette_to_bytes([0xF8F8E0, 0xF8F0C0, 0xF8F0B0, 0xF8F098, 0xF8E880, 0xF0E860, 0xF0E050, 0xF0E040, 0xF0E028, 0xF0D810, 0xC0B008, 0xB0A008, 0xA8A008, 0x989008, 0xF8F0A8])
        elif self.element == Element.ICE:
            d[0x331B3F] = palette_to_bytes([0x88D8D8, 0x70C8C8, 0x60C8C8, 0x50C0C0, 0x40B8B8, 0x30A0A0, 0x309090, 0x288888, 0x207078, 0x206060, 0x103838, 0x082830, 0x082828, 0x081818, 0x88D8D8])
        elif self.element == Element.FIRE:
            d[0x331B3F] = palette_to_bytes([0xD88888, 0xC87070, 0xC86060, 0xC05050, 0xB84040, 0xA03030, 0x903030, 0x882828, 0x782020, 0x602020, 0x381010, 0x300808, 0x280808, 0x180808, 0xD88888])
        return d
