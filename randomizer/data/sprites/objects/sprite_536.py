...
sprite = CompleteSprite(
    animation=AnimationPack(355, length=429, unknown=0x0002,
            ...
            molds=[
                ...
                Mold(6, gridplane=False,
                    tiles=[
                        ...
                        Tile(mirror=False, invert=False, format=0, length=5, subtile_bytes=[
                            bytearray(b'\x00\x00\x00\x00\x00\x00 \x00\x00   \x00\x00\xa0\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00 \x00\xa0\x00'),
                            None,
                            bytearray(b'\x00\x10  \x00\x00 \x00\x00\x00\x00\x00\x00\x00\x00 \x10\x00 \x00\x00\x88\x00 \x00\x00\x00\x00\x00\x00\x00 '),
                            None,
                        ], is_16bit=False, y_plus=0, y_minus=0, x=128, y=104),
                    ]
                ),
                Mold(7, gridplane=False,
                    tiles=[
                        ...
                        Tile(mirror=False, invert=False, format=0, length=5, subtile_bytes=[
                            bytearray(b'\x00\x00\x00\x00\x00  \x00\x00   \x00\x00\x00\x00\x00\x00\x00\x00\x00 \x00\x00\x00\x00\x00\x00 \x00\x00\x00'),
                            None,
                            bytearray(b'\x10\x00\x80\x80\x00\x00 \x00\x00\x88 \x00\x00\x00\x00\x00\x10\x00\x80\x00\x00\x10\x00 \x00\x88\x00\x00\x00\x00\x00\x00'),
                            None,
                        ], is_16bit=False, y_plus=0, y_minus=0, x=128, y=104),
                    ]
                ),
                Mold(8, gridplane=False,
                    tiles=[
                        ...
                        Tile(mirror=False, invert=False, format=0, length=5, subtile_bytes=[
                            bytearray(b'\x00\x00 \x00\x00  \x00\x00   \x00\x00\x00\x00\x00\x00\x00 \x00 \x00\x00\x00\x00\x00\x00\x10\x00\x00\x00'),
                            None,
                            bytearray(b'\x00@\x00\x00\x00\x00\x80\x00\x00\x10 \x00\x00\x88  @\x00\x00\x00\x00\x10\x00\x80\x00\x10\x00\x00\x00\x00\x00\x00'),
                            None,
                        ], is_16bit=False, y_plus=0, y_minus=0, x=128, y=104),
                    ]
                ),
                Mold(9, gridplane=False,
                    tiles=[
                        ...
                        Tile(mirror=False, invert=False, format=0, length=5, subtile_bytes=[
                            bytearray(b'\x00\x00 \x00\x00\x00\x00\x00\x00\x00 \x00\x00\x00\x00\x00\x88\x00 \x00\x00\x00\x00\x00\x00\x00\x00 \x00\x00\x00\x00'),
                            bytearray(b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00 \x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'),
                            None,
                            None,
                        ], is_16bit=False, y_plus=0, y_minus=0, x=128, y=120),
                        Tile(mirror=False, invert=False, format=0, length=7, subtile_bytes=[
                            ...
                            bytearray(b'\x00\x00\x00\x00\x00  \x00\x00   \x00\x00\x00\x00\x00\x00\x00\x00\x00 \x00\x00\x00\x00\x00\x00 \x00\x00\x00'),
                            bytearray(b'\x00\x10\x00\x00\x00\x00\x00\x00\x00\x10\x80\x00\x00\x10  \x10\x00\x00\x00\x00@\x00\x00\x00\x10\x00\x00\x00\x00\x00\x00'),
                            bytearray(b'\x10\x00\x80\x80\x00\x00 \x00\x00\x88 \x00\x00\x00\x00\x00\x10\x00\x80\x00\x00\x10\x00 \x00\x88\x00\x00\x00\x00\x00\x00'),
                        ], is_16bit=False, y_plus=0, y_minus=0, x=128, y=104),
                    ]
                ),
                Mold(10, gridplane=False,
                    tiles=[
                        ...
                        Tile(mirror=False, invert=False, format=0, length=5, subtile_bytes=[
                            bytearray(b'\x00\x00 \x00\x00\x88  \x00\x00\x00\x00\x00\x00 \x00\x10\x00 \x00\x88\x00 \x00\x00\x00\x00\x00\x00\x00\x00\x00'),
                            bytearray(b'\x00\x00\x00\x00\x00\x00  \x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00 \x00\x00\x00\x00\x00\x00\x00\x00\x00'),
                            None,
                            None,
                        ], is_16bit=False, y_plus=0, y_minus=0, x=128, y=120),
                        Tile(mirror=False, invert=False, format=0, length=7, subtile_bytes=[
                            bytearray(b'\x00\x00p\x00\x00  \x00\x00\x00\x00\x00\x00\x00\x00\x00\x00 \x00p\x00 \x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'),
                            bytearray(b'\x00\x00 \x00\x00  \x00\x00   \x00\x00\x00\x00\x00\x00\x00 \x00 \x00\x00\x00\x00\x00\x00\x10\x00\x00\x00'),
                            bytearray(b'\x00@\x00\x00\x00\x00\x00\x00\x00@\x00\x00\x00\x10\x80\x80@\x00\x00\x00\x00\x10\x00\x00\x00@\x00\x00\x00\x00\x00\x00'),
                            bytearray(b'\x00@\x00\x00\x00\x00\x80\x00\x00\x10 \x00\x00\x88  @\x00\x00\x00\x00\x10\x00\x80\x00\x10\x00\x00\x00\x00\x00\x00'),
                        ], is_16bit=False, y_plus=0, y_minus=0, x=128, y=104),
                    ]
                ),
                Mold(11, gridplane=False,
                    tiles=[
                        ...
                        Tile(mirror=False, invert=False, format=0, length=5, subtile_bytes=[
                            bytearray(b'\x00\x00\x80\x00\x00\x10\x00\x00\x00\x00 \x00\x00\x00\x00\x00\x10\x00\x80\x00\x10\x00\x00\x00\x00\x00\x00 \x00\x00\x00\x00'),
                            bytearray(b'\x00\x00 \x00\x00\x00\x00\x00\x00\x00 \x00\x00\x00\x00\x00\x88\x00 \x00\x00\x00\x00\x00\x00\x00\x00 \x00\x00\x00\x00'),
                            None,
                            None,
                        ], is_16bit=False, y_plus=0, y_minus=0, x=128, y=120),
                        Tile(mirror=False, invert=False, format=0, length=7, subtile_bytes=[
                            bytearray(b'\x00\x00 \x00\x00P\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00P\x00 \x00P\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'),
                            bytearray(b'\x00\x00 \x00\x00  \x00\x00 \x00\x00\x00\x00\x00\x00\x00 \x00 \x00 \x00\x00\x00\x00\x00\x00@\x00\x00\x00'),
                            bytearray(b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x10\x00\x00\x00@\x00\x00\x00\x00\x00\x00\x00@\x00\x00\x00\x10\x00\x00\x00\x00\x00\x00'),
                            bytearray(b'\x00\x10\x00\x00\x00\x00\x00\x00\x00\x10\x80\x00\x00\x10  \x10\x00\x00\x00\x00@\x00\x00\x00\x10\x00\x00\x00\x00\x00\x00'),
                        ], is_16bit=False, y_plus=0, y_minus=0, x=128, y=104),
                    ]
                ),
                Mold(12, gridplane=False,
                    tiles=[
                        ...
                        Tile(mirror=False, invert=False, format=0, length=5, subtile_bytes=[
                            bytearray(b'\x00\x00\x00\x00\x00\x00\x00\x80\x00\x00\x00\x00\x00\x00 \x00\x00\x00\x00\x00\x00\x00\x80\x00\x00\x00\x00\x00\x00\x00\x00 '),
                            bytearray(b'\x00\x00 \x00\x00\x88  \x00\x00\x00\x00\x00\x00 \x00\x10\x00 \x00\x88\x00 \x00\x00\x00\x00\x00\x00\x00\x00\x00'),
                            None,
                            None,
                        ], is_16bit=False, y_plus=0, y_minus=0, x=128, y=120),
                        Tile(mirror=False, invert=False, format=0, length=7, subtile_bytes=[
                            bytearray(b'\x00\x00\x88\x00\x00\x00\x88\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x88\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'),
                            bytearray(b'\x00\x00p\x00\x00  \x00\x00\x00\x00\x00\x00\x00\x00\x00\x00 \x00p\x00 \x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'),
                            bytearray(b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00@\x00\x00\x00\x00\x00\x00'),
                            bytearray(b'\x00@\x00\x00\x00\x00\x00\x00\x00@\x00\x00\x00\x10\x80\x80@\x00\x00\x00\x00\x10\x00\x00\x00@\x00\x00\x00\x00\x00\x00'),
                        ], is_16bit=False, y_plus=0, y_minus=0, x=128, y=104),
                ...
                Mold(13, gridplane=False,
                    tiles=[
                        ...
                        Tile(mirror=False, invert=False, format=0, length=6, subtile_bytes=[
                            bytearray(b'\x00\x00\x00\x00\x00\x08\x00\x00\x00\x80\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x08\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'),
                            bytearray(b'\x00\x00 \x00\x00P\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00P\x00 \x00P\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'),
                            None,
                            bytearray(b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x10\x00\x00\x00@\x00\x00\x00\x00\x00\x00\x00@\x00\x00\x00\x10\x00\x00\x00\x00\x00\x00'),
                        ], is_16bit=False, y_plus=0, y_minus=0, x=128, y=104),
                ...
                Mold(19, gridplane=False,
                    tiles=[
                        Tile(mirror=False, invert=False, format=0, length=4, subtile_bytes=[
                            ...
                            None,
                            None,
                        ], is_16bit=False, y_plus=0, y_minus=0, x=388, y=368),
                        Tile(mirror=False, invert=False, format=0, length=5, subtile_bytes=[
                            bytearray(b'\x00\x00 \x00\x00  \x00\x00 \x00\x00\x00\x00\x00\x00\x00 \x00 \x00 \x00\x00\x00\x00\x00\x00@\x00\x00\x00'),
                            None,
                            bytearray(b'\x00\x10\x00\x00\x00\x00\x00\x00\x00\x10\x80\x00\x00\x10  \x10\x00\x00\x00\x00@\x00\x00\x00\x10\x00\x00\x00\x00\x00\x00'),
                        ...
                        Tile(mirror=False, invert=False, format=0, length=4, subtile_bytes=[
                            ...
                            None,
                            None,
                        ], is_16bit=False, y_plus=0, y_minus=0, x=390, y=124),
                        Tile(mirror=False, invert=False, format=0, length=5, subtile_bytes=[
                            bytearray(b'\x00\x00\x88\x00\x00\x00\x88\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x88\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'),
                            None,
                            bytearray(b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00@\x00\x00\x00\x00\x00\x00'),
