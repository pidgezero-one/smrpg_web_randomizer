...
from randomizer.data.variables.sprite_palette_names import SPAL719_TADPOLE
sprite = CompleteSprite(
    animation=AnimationPack(419, length=140, unknown=0x0002,
