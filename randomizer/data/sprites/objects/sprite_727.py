...
from randomizer.data.variables.sprite_palette_names import SPAL000_NOTHING, SPAL453_JINX_OVERWORLD_4
sprite = CompleteSprite(
    ...
    palette_id=SPAL453_JINX_OVERWORLD_4,
    palette_offset=0,
    unknown_num=8
)
