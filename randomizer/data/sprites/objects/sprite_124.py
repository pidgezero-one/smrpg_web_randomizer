...
from randomizer.data.variables.sprite_palette_names import SPAL500_GAMEBOY_KID
sprite = CompleteSprite(
    animation=AnimationPack(397, length=116, unknown=0x0002,
    ...
    palette_id=SPAL500_GAMEBOY_KID,
    palette_offset=0,
    unknown_num=0
)
