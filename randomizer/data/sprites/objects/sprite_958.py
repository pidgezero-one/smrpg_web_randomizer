...
from randomizer.data.variables.sprite_palette_names import SPAL765_TINY_GLOWING_PIXEL
sprite = CompleteSprite(
    animation=AnimationPack(443, length=135, unknown=0x0002,
    ...
    palette_id=SPAL765_TINY_GLOWING_PIXEL,
    palette_offset=0,
    unknown_num=8
)
