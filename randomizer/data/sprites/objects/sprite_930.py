...
from randomizer.data.variables.sprite_palette_names import SPAL713_CONDUCTING_TOADOFSKY
sprite = CompleteSprite(
    animation=AnimationPack(415, length=98, unknown=0x0002,
    ...
    palette_id=SPAL713_CONDUCTING_TOADOFSKY,
    palette_offset=0,
    unknown_num=8
)
