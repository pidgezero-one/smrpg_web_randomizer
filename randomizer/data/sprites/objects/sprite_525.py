...
from randomizer.data.variables.sprite_palette_names import SPAL367_BOWYER_S_ARROW
sprite = CompleteSprite(
    animation=AnimationPack(210, length=144, unknown=0x0002,
    ...
    palette_id=SPAL367_BOWYER_S_ARROW,
    palette_offset=0,
    unknown_num=8
)
