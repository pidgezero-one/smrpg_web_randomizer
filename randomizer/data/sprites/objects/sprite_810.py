...
from randomizer.data.variables.sprite_palette_names import SPAL409_WHITE_PIXEL_DOT
sprite = CompleteSprite(
    animation=AnimationPack(235, length=28, unknown=0x0002,
    ...
    palette_id=SPAL409_WHITE_PIXEL_DOT,
    palette_offset=0,
    unknown_num=8
)
