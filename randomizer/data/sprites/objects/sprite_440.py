...
from randomizer.data.variables.sprite_palette_names import SPAL243_MICROBOMB_PACKET
sprite = CompleteSprite(
    animation=AnimationPack(127, length=90, unknown=0x0002,
    ...
    palette_id=SPAL243_MICROBOMB_PACKET,
    palette_offset=0,
    unknown_num=8
)
