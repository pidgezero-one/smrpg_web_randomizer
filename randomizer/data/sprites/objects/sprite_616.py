...
from randomizer.data.variables.sprite_palette_names import SPAL498_YELLOW_LETTER
sprite = CompleteSprite(
    animation=AnimationPack(379, length=56, unknown=0x0002,
    ...
    palette_id=SPAL498_YELLOW_LETTER,
    palette_offset=0,
    unknown_num=0
)
