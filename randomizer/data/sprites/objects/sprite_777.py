...
from randomizer.data.variables.sprite_palette_names import SPAL319_STAR_EGG_LITTLE_BROWN_BIRD
sprite = CompleteSprite(
    animation=AnimationPack(186, length=135, unknown=0x0002,
    ...
    palette_id=SPAL319_STAR_EGG_LITTLE_BROWN_BIRD,
    palette_offset=0,
    unknown_num=12
)
