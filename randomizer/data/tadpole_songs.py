...
class Song:
    ...
    def __init__(self, notes, name, submitter="Anonymous", submitter_credits="ANONYMOUS", hint_1="", hint_2="", hint_3="", scroll=""):
    ...
    def generate_starfish_hint(self, subscript):
        ...
        for index in len(subscript):
            ...
            if cmd["command"] == 'play_sound' and note_index < len(self.notes):
                output.append(
                    {
                        "identifier": 'EVENT_2061_action_queue_async_2_SUBSCRIPT_play_sound_%i' % index,
                        "command": 'play_sound',
        ...
        for index, pair in enumerate(note_variable_pairs):
            ...
            note_input = [
                ...
                },
                {
                    ...
                    "command": 'jmp',
                    "args": [prefix_command_name('set_7000_to_tapped_button_%i' % index)]
                },
                {
                    "identifier": 'jmp_if_bit_clear_%i' % index,
                    "command": 'jmp_if_bit_clear',
                    "args": [0x7044, 3, prefix_command_name('set_7000_to_tapped_button_%i' % index)]
                },
                {
            ...
            if index < len(note_variable_pairs) - 1:
                        ...
                        "subscript": [
                            {
                                ...
                                "args": [7 + index, 41 - (index * 2), 0, RadialDirections.EAST]
                            },
                            {
                ...
                note_input.extend([
                    ...
                    {
                        "identifier": 'EVENT_1082_ret_%i' % index,
                        "command": 'ret'
                    },
                ])
    ...
    def generate_playback_script(self, song_order):
        ...
        for index, pair in enumerate(note_variable_pairs):
            ...
            for item in range(len(note_check)):
                note_check[item]["identifier"] = prefix_command_name(note_check[item]["identifier"])
            ...
            for item in range(len(correctness_check)):
                correctness_check[item]["identifier"] = prefix_command_name(correctness_check[item]["identifier"])
...
all_songs = [
    ...
    Song(
        [(Mi, 20), (Re, 10), (Do, 20), (Do, 110), (Mi, 20), (Re, 10), (Do, 20), (Re, 0)],
        "Under the Sea",
        submitter="Alex.the.Riddler",
        submitter_credits="ALEX.THE.RIDDLER",
    ...
    Song(
        [(So, 60), (La, 100), (La, 60), (Ti, 60), (Re, 10), (Do, 10), (Ti, 10), (So, 0)],
