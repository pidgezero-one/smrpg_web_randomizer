...
class DefaultItem(ItemNPC):
    ...
    _static_packet_id = P020_BAG_STATIC
...
class HammerObject(ItemNPC):
    _base = HAMMER_BASE
    _chest_packet_id = P106_HAMMER_CHEST
...
class StickObject(ItemNPC):
    ...
    _chest_packet_id = P107_STICK_CHEST
...
class GreenShellObject(ItemNPC):
    ...
    _chest_packet_id = P111_GREEN_SHELL_CHEST
...
class MusicObject(ItemNPC):
    _base = MUSIC_BASE
    _chest_packet_id = P093_MUSIC_NOTE_CHEST
...
class ChompObject(ItemNPC):
    _base = CHOMP_BASE
    _chest_packet_id = P108_CHOMP_CHEST
...
class RedShellObject(ItemNPC):
    ...
    _chest_packet_id = P110_RED_SHELL_CHEST
...
class ParasolObject(ItemNPC):
    _base = PARASOL_BASE
    _chest_packet_id = P112_PARASOL_CHEST
...
class FanObject(ItemNPC):
    _base = FAN_BASE
    _chest_packet_id = P109_FAN_CHEST
...
class TinyStarObject(ItemNPC):
    ...
    _chest_packet_id = P007_STAR_PIECE_CHEST
    _static_packet_id = P011_STAR_PIECE_STATIC
    _falling_packet_id = P009_STAR_PIECE_FALL
    _chest_event_id = E0885_CHEST_STAR_PIECE_PACKET


class FryingPanObject(ItemNPC):
    _base = PAN_BASE
    _chest_packet_id = P105_FRYING_PAN_CHEST
...
class CrownObject(ItemNPC):
    _base = CROWN_BASE
    _chest_packet_id = P053_CROWN_CHEST
    _static_packet_id = P058_CROWN_STATIC
    _falling_packet_id = P057_CROWN_FALL
    _chest_event_id = E0890_CHEST_CROWN_PACKET


class ShoesObject(ItemNPC):
    _base = SHOES_BASE
    _chest_packet_id = P043_SHOES_CHEST
    _static_packet_id = P041_SHOES_STATIC
    _falling_packet_id = P042_SHOES_FALL
    _chest_event_id = E0888_CHEST_SHOES_PACKET


class BroochObject(ItemNPC):
    _base = BROOCH_BASE
    _chest_packet_id = P040_BROOCH_CHEST
    _static_packet_id = P029_BROOCH_STATIC
    _falling_packet_id = P039_BROOCH_FALL
    _chest_event_id = E0887_CHEST_BROOCH_PACKET


class RingObject(ItemNPC):
    _base = RING_BASE
    _chest_packet_id = P025_RING_CHEST
    _static_packet_id = P027_RING_STATIC
    _falling_packet_id = P026_RING_FALL
    _chest_event_id = E0886_CHEST_RING_PACKET


class FeatherObject(ItemNPC):
    _base = FEATHER_BASE
    _chest_packet_id = P006_FEATHER_CHEST
    _chest_event_id = E0884_CHEST_FEATHER_PACKET
    _static_packet_id = P010_FEATHER_STATIC
    _falling_packet_id = P008_FEATHER_FALL


class RedMushroomObject(ItemNPC):
    _base = RED_MUSHROOM_BASE
    _chest_packet_id = P102_RED_MUSHROOM_CHEST
...
class GreenMushroomObject(ItemNPC):
    ...
    _chest_packet_id = P103_GREEN_MUSHROOM_CHEST
...
class YellowMushroomObject(ItemNPC):
    ...
    _chest_packet_id = P104_YELLOW_MUSHROOM_CHEST
...
class RedSyrupObject(ItemNPC):
    ...
    _chest_packet_id = P081_RED_SYRUP_CHEST
...
class GreenSyrupObject(ItemNPC):
    ...
    _chest_packet_id = P080_GREEN_SYRUP_CHEST
...
class YellowSyrupObject(ItemNPC):
    ...
    _chest_packet_id = P083_YELLOW_SYRUP_CHEST
...
class BlueSyrupObject(ItemNPC):
    ...
    _chest_packet_id = P082_BLUE_SYRUP_CHEST
...
class StarDrinkObject(ItemNPC):
    ...
    _chest_packet_id = P094_STAR_DRINK_CHEST
...
class RDrinkObject(ItemNPC):
    _base = R_DRINK_BASE
    _chest_packet_id = P092_R_DRINK_CHEST
...
class DDrinkObject(ItemNPC):
    _base = D_DRINK_BASE
    _chest_packet_id = P087_D_DRINK_CHEST
...
class PDrinkObject(ItemNPC):
    _base = P_DRINK_BASE
    _chest_packet_id = P086_P_DRINK_CHEST
...
class GreenJuiceObject(ItemNPC):
    ...
    _chest_packet_id = P084_GREEN_JUICE_CHEST
...
class YellowJuiceObject(ItemNPC):
    ...
    _chest_packet_id = P113_YELLOW_JUICE_CHEST
...
class RedJuiceObject(ItemNPC):
    ...
    _chest_packet_id = P070_EGG_CHEST
    _static_packet_id = P068_EGG_STATIC
    _falling_packet_id = P069_EGG_FALLING
    _chest_event_id = E0892_CHEST_EGG_PACKET


class FrogDrinkObject(ItemNPC):
    _base = FROG_DRINK_BASE
    _chest_packet_id = P090_FROG_DRINK_CHEST
...
class CookieObject(ItemNPC):
    _base = COOKIE_BASE
    _chest_packet_id = P073_COOKIE_CHEST
    _chest_event_id = E0893_CHEST_COOKIE_PACKET
    _static_packet_id = P071_COOKIE_STATIC
    _falling_packet_id = P072_COOKIE_FALL


class YellowBombObject(ItemNPC):
    _base = YELLOW_BOMB_BASE
    _chest_packet_id = P100_YELLOW_BOMB_CHEST
...
class RedBombObject(ItemNPC):
    _base = RED_BOMB_BASE
    _chest_packet_id = P098_RED_BOMB_CHEST
...
class BlueBombObject(ItemNPC):
    ...
    _chest_packet_id = P099_BLUE_BOMB_CHEST
...
class GreenCandyObject(ItemNPC):
    ...
    _chest_packet_id = P095_GREEN_CANDY_CHEST
...
class YellowMusicDrinkObject(ItemNPC):
    ...
    _chest_packet_id = P088_YELLOW_MUSIC_DRINK_CHEST
...
class BlueMusicDrinkObject(ItemNPC):
    ...
    _chest_packet_id = P089_BLUE_MUSIC_DRINK_CHEST
...
class RedMusicDrinkObject(ItemNPC):
    ...
    _chest_packet_id = P091_RED_MUSIC_DRINK_CHEST
...
class KeyObject(ItemNPC):
    ...
    _static_packet_id = P014_KEY_STATIC
    _falling_packet_id = P015_KEY_FALLING
...
class SmallCoinObject(ItemNPC):
    ...
    _static_packet_id = P063_SMALL_COIN_STATIC
    _falling_packet_id = P060_SMALL_COIN_FALL


class SmallFrogCoinObject(ItemNPC):
    _base = SMALL_FROG_COIN_BASE
    _chest_packet_id = P019_FROG_COIN_BEING_COLLECTED
    _static_packet_id = P064_FROG_COIN_STATIC
    _falling_packet_id = P061_FROG_COIN_FALL
    _chest_70a7_upper = 3


class BlueCandyObject(ItemNPC):
    _base = BLUE_CANDY_BASE
    _chest_packet_id = P096_BLUE_CANDY_CHEST
...
class MicrobombObject(ItemNPC):
    ...
    _chest_packet_id = P067_BOMB_CHEST
    _static_packet_id = P065_BOMB_STATIC
    _falling_packet_id = P066_BOMB_FALL
...
class GreenBombObject(ItemNPC):
    ...
    _chest_packet_id = P097_GREEN_BOMB_CHEST
...
class CardObject(ItemNPC):
    _base = CARD_BASE
    _chest_packet_id = P079_CARD_CHEST
    _chest_event_id = E0895_CHEST_CARD_PACKET
    _static_packet_id = P077_CARD_STATIC
    _falling_packet_id = P078_CARD_FALL


class BananaObject(ItemNPC):
    _base = BANANA_BASE
    _chest_packet_id = P048_BANANA_CHEST
    _static_packet_id = P044_BANANA_STATIC
    _falling_packet_id = P046_BANANA_FALL
    _chest_event_id = E0889_CHEST_BANANA_PEEL_PACKET


class BerryObject(ItemNPC):
    _base = BERRY_BASE
    _chest_packet_id = P076_BERRY_CHEST
    _chest_event_id = E0894_CHEST_BERRY_PACKET
    _static_packet_id = P074_BERRY_STATIC
    _falling_packet_id = P075_BERRY_FALL


class BigCoinObject(ItemNPC):
    _base = BIG_COIN_BASE
    _chest_packet_id = P016_BIG_COIN_BEING_COLLECTED
    _static_packet_id = P062_COIN_STILL
    _falling_packet_id = P059_COIN_FALL


class BeetleObject(ItemNPC):
    _base = BEETLE_BASE
    _chest_packet_id = P101_BEETLE_CHEST
...
class FlowerObject(ItemNPC):
    ...
    _static_packet_id = P012_FLOWER_STATIC
...
class RecoveryMushroomObject(ItemNPC):
    ...
    _static_packet_id = P013_MUSHROOM_STATIC
...
class GloveObject(ItemNPC):
    _base = GLOVE_BASE
    _chest_packet_id = P114_GLOVE_CHEST
...
class ProgressiveFireworksObject(ItemNPC):
    _base = ITEM_BAG_NPC
    _chest_packet_id = P115_CRYSTAL_CHEST
    _static_packet_id = P020_BAG_STATIC
    _falling_packet_id = P037_ITEM_BAG_FALL
