...
script = AnimationScriptBlock(expected_size=3221, expected_beginning=0x351493, script=[
	...
	DrawSpriteAtAMEM32Coords(sprite_id=SPR0018_BOWSER_CLAW_ATTACK, sequence=3, store_to_vram=True, store_palette=True, overlap_all_sprites=True),
	PauseScriptUntilSpriteSequenceDone(),
	RunSubroutine(["command_0x352F2F"]),
	PauseScriptUntil(condition=FRAMES_ELAPSED, frames=4),
	DrawSpriteAtAMEM32Coords(sprite_id=SPR0014_BOWSER_WALKING_DOWN_LEFT, sequence=0, store_to_vram=True, store_palette=True, overlap_all_sprites=True),
	ResetSpriteSequence(),
	RunSubroutine(["command_0x3523C4"]),
	RunSubroutine(["command_0x3577F2"]),
	ReturnSubroutine(),
	RunSubroutine(["command_0x357B83"], identifier="DUMMYAttack4"),
	DrawSpriteAtAMEM32Coords(sprite_id=SPR0016_BOWSER_WALKING_UP_RIGHT, sequence=2, store_to_vram=True, looping=True, store_palette=True, overlap_all_sprites=True),
	PauseScriptUntil(condition=FRAMES_ELAPSED, frames=4),
