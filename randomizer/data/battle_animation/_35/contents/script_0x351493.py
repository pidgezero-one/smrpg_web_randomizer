...
script = AnimationScriptBlock(expected_size=3221, expected_beginning=0x351493, script=[
	...
	RunSubroutine(["command_0x35241B"]),
	ReturnSubroutine(),
	UseSpriteQueue(field_object=0, destinations=["ATKDEF100Attack_sprq"], bit_2=True, bit_4=True, identifier="ATKDEF100Attack"),
	Jmp(["ValorUpAttack"]),
	SetAMEM16BitTo7E1x(0x62, 0x7E0070, identifier="ATKDEF100Attack_sprq"),
    IncAMEM16BitByConst(0x62, 5),
    Set7E1xToAMEM16Bit(0x7E0070, 0x62),
    ReturnSpriteQueue(),
	...
	RunSubroutine(["command_0x3577F2"]),
	ReturnSubroutine(),
	RunSubroutine(["command_0x357F07"], identifier="ValorForceAttack"),
	...
	DrawSpriteAtAMEM32Coords(sprite_id=SPR0451_JINX_2, sequence=4, store_to_vram=True, store_palette=True, behind_all_sprites=True, overlap_all_sprites=True),
