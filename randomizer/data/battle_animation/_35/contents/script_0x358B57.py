...
script = AnimationScriptBlock(expected_size=149, expected_beginning=0x358B57, script=[
	...
	DrawSpriteAtAMEM32Coords(sprite_id=SPR0030_GENO_WALKING_UP_RIGHT, sequence=0, store_to_vram=True, overlap_all_sprites=True, bit_4=True),
	...
	DrawSpriteAtAMEM32Coords(sprite_id=SPR0034_GENO_MORPH_INTO_CANNON, sequence=1, store_to_vram=True, overlap_all_sprites=True),
