...
script = AnimationScriptBlock(expected_size=191, expected_beginning=0x358916, script=[
	...
	JmpIfAMEM8BitEqualsConst(0x66, NokNokShellItem().index, ["command_0x358936"]),
	JmpIfAMEM8BitEqualsConst(0x66, TroopaShellItem().index, ["command_0x358936"]),
	JmpIfAMEM8BitEqualsConst(0x66, LazyShellItem().index, ["command_0x358936"]),
	ClearAMEM8Bit(0x66),
