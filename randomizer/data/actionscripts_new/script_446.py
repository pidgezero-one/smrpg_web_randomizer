...
script = ActionScript([
	...
	CreatePacketAtNPCCoords(packet_id=P023_LOOPING_SINGLE_SPARKLE, object=MARIO, destinations=["ACTION_446_start_loop_n_times_19"]),
	...
	CreatePacketAtNPCCoords(packet_id=P022_RECURSIVE_SPARKLES, object=MARIO, destinations=["ACTION_446_start_loop_n_times_26"]),
