...
script = ActionScript([
	...
	ShiftSouthwestPixels(8, identifier="ACTION_710_shift_southwest_pixels_14"),
	JmpIfObjectWithinRange(object=NPC_5, usually=0, tiles=3, destinations=["ACTION_710_set_bit_19"], identifier="ACTION_710_db_15"),
	JumpToHeight(24),
	Walk1StepSoutheast(),
