...
script = ActionScript([
	JmpIfRandom1of2(["ACTION_123_jmp_to_subroutine_4"], identifier="ACTION_123_jmp_if_random_above_128_0"),
	...
	JmpToSubroutine(["ACTION_105_set_animation_speed_0"], identifier="ACTION_123_jmp_to_subroutine_4"),
