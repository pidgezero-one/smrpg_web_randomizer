...
script = ActionScript([
	...
	JmpIfBitSet(MINES_BOSS_1_DEFEATED, ["ACTION_730_clear_solidity_bits_54"], identifier="ACTION_734_jmp_if_bit_set_3"),
	VisibilityOff(),
	ObjectMemorySetBit(arg_1=0x30, bits=[4]),
	ClearSolidityBits(bit_4=True, cant_pass_npcs=True, cant_walk_through=True, bit_7=True),
	JmpIfVarEqualsConst(MINES_MIDBOSS_POSITION, 19, ["ACTION_734_transfer_to_xyzf_29"]),
	SetBit(TEMP_7044_6),
	...
	Jmp(["ACTION_734_jmp_if_bit_set_3"]),
	TransferToXYZF(x=4, y=118, z=0, direction=EAST, identifier="ACTION_734_transfer_to_xyzf_29"),
	...
	VisibilityOn(),
	ShiftSoutheastSteps(2),
	ObjectMemoryClearBit(arg_1=0x30, bits=[4], identifier="ACTION_734_object_memory_clear_bit_40"),
