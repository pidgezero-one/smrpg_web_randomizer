...
script = ActionScript([
	...
	SetWalkingSpeed(speed=FAST, identifier="ACTION_419_set_animation_speed_14"),
	Pause(3),
	...
	TransferXYZFPixels(x=254, y=0, z=0, direction=EAST, identifier="ACTION_419_transfer_xyzf_pixels_28"),
	...
	Jmp(["ACTION_419_transfer_to_xyzf_47"]),
	TransferToXYZF(x=8, y=60, z=0, direction=EAST, identifier="ACTION_419_transfer_to_xyzf_47"),
