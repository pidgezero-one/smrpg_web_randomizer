...
script = ActionScript([
	...
	SetSpriteSequence(index=4, is_mold=True, is_sequence=True, identifier="ACTION_445_set_sprite_sequence_71"),
	Pause(256),
	...
	SetSpriteSequence(index=5, is_mold=True, is_sequence=True),
	Pause(48),
	CreatePacketAtNPCCoords(packet_id=P030_WATER_SPLASH_DROPS_SFX, object=DUMMY_0X07, destinations=["ACTION_445_set_sprite_sequence_84"]),
	SetSpriteSequence(index=5, is_sequence=True, identifier="ACTION_445_set_sprite_sequence_84"),
	SetPriority(3),
	IncPaletteRowBy(15),
	Set700CToPressedButton(),
	...
	SetSpriteSequence(index=6, is_mold=True, is_sequence=True, identifier="ACTION_445_set_sprite_sequence_102"),
	...
	CreatePacketAtNPCCoords(packet_id=P030_WATER_SPLASH_DROPS_SFX, object=DUMMY_0X07, destinations=["ACTION_445_jmp_116"], identifier="ACTION_445_create_packet_at_npc_coords_115"),
