...
from smrpgpatchbuilder.datatypes.levels.classes import (EventInitiator, EdgeDirection, BufferType, BufferSpace, Buffer, Partition, RoomExit, RegularNPC, EffectsNpc)
...
room = Room(
    ...
    effects_npc=EffectsNpc.UNKNOWN_21,
)
