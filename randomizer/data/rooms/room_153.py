...
from smrpgpatchbuilder.datatypes.levels.classes import (EventInitiator, EdgeDirection, BufferType, BufferSpace, Buffer, Partition, Event, RegularNPC, EffectsNpc)
...
room = Room(
    ...
    events=[
        Event(
            ...
            byte_8_bit_4=False),
        Event(
            event=E2124_CHOOSE_MARRYMORE_SANCTUARY_STATE,
            x=21,
            y=14,
            z=0,
            f=EdgeDirection.SOUTHWEST,
