...
from smrpgpatchbuilder.datatypes.levels.classes import (EventInitiator, EdgeDirection, BufferType, BufferSpace, Buffer, Partition, RoomExit, Event, RegularNPC, ChestNPC)
...
room = Room(
    ...
    objects=[
        ...
        ChestNPC( # 1
            ...
            event_script=E0582_ROSE_TOWN_OCCUPIED_TREASURE_HOUSE_BEDROOM_CHEST,
