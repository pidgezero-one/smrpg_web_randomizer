...
room = Room(
    ...
    npc_expected_animations={
        19: [SpriteAnimationState.DISTRACTED, SpriteAnimationState.LOOKING_DOWN_AWAY, SpriteAnimationState.SHOCKED_SHADOW_BACKWARDS, ],
        20: [SpriteAnimationState.LOOK_TO_DOWN, SpriteAnimationState.LOOKING_DOWN, SpriteAnimationState.SHOCKED_SHADOW],
        21: [SpriteAnimationState.SPELL_FRAME_3, SpriteAnimationState.SPELL_FRAME_4, SpriteAnimationState.SPELL_FRAME_5, SpriteAnimationState.SPELL_FRAME_6, SpriteAnimationState.LOOKING_DOWN_AWAY, SpriteAnimationState.VICTORY_POSE],
        23: [SpriteAnimationState.LOOK_TO_SIDE_BEHIND, SpriteAnimationState.LOOKING_DOWN_AWAY, SpriteAnimationState.SHOCKED_SHADOW_BACKWARDS],
    },
