...
world_map_locations[OW00_UNUSED] = WorldMapLocation(
    index=0,
    name="To Mario's Pad",
    x=208,
    y=176,
...
world_map_locations[OW01_INNER_FACTORY] = WorldMapLocation(
    ...
    x=120,
    y=37,
    show_check_flag=MAP_INNER_FACTORY,
    go_location=False,
...
world_map_locations[OW03_VISTA_HILL] = WorldMapLocation(
    ...
    enabled_to_west=True,
    check_flag_to_west=MAP_DIRECTIONAL_NIMBUS_LAND_VISTA_HILL,
...
world_map_locations[OW06_TO_NIMBUS_LAND] = WorldMapLocation(
    ...
    enabled_to_east=True,
    check_flag_to_east=MAP_DIRECTIONAL_NIMBUS_LAND_VISTA_HILL,
    location_to_east=OW03_VISTA_HILL,
    enabled_to_south=True,
    check_flag_to_south=MAP_VISTA_HILL,
    location_to_south=OW04_BOWSERS_KEEP)
...
world_map_locations[OW07_TO_BOWSERS_KEEP] = WorldMapLocation(
    ...
    go_location=True,
    which_location_check_flag=MAP_VISTA_HILL,
...
world_map_locations[OW09_MUSHROOM_WAY] = WorldMapLocation(
    ...
    go_location=False,
    run_event=E3818_WORLD_MAP_MUSHROOM_WAY,
    enabled_to_east=True,
...
world_map_locations[OW37_UNUSED] = WorldMapLocation(
    index=37,
    name="Land's End",
    x=96,
    y=124,
...
world_map_locations[OW38_UNUSED] = WorldMapLocation(
    index=38,
    name="Monstro Town",
    x=68,
    y=140,
...
world_map_locations[OW39_UNUSED] = WorldMapLocation(
    index=39,
    name="Bean Valley",
    x=96,
    y=92,
...
world_map_locations[OW40_UNUSED] = WorldMapLocation(
    index=40,
...
world_map_locations[OW41_UNUSED] = WorldMapLocation(
    index=41,
    name="To Nimbus Land",
    x=96,
    y=40,
...
world_map_locations[OW54_COAL_MINES_NAME_ONLY] = WorldMapLocation(
    index=54,
    x=0,
    y=0,
...
world_map_locations[OW55_UNUSED] = WorldMapLocation(
    index=55,
    x=0,
    y=0,
    show_check_flag=MAP_UNUSED_DOTS,
