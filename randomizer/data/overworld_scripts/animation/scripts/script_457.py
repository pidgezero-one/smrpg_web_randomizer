...
script = ActionScript([
	...
	A_UnknownCommand(bytearray([0x24, 0x00, 0x00, 0x80, 0x01])),
	A_UnknownCommand(bytearray([0x25, 0xC0, 0x06, 0x80, 0xFF])),
	A_Pause(30),
	A_UnknownCommand(bytearray([0x24, 0x80, 0xFE, 0x00, 0x00]), identifier="ACTION_457_db_15"),
	A_UnknownCommand(bytearray([0x25, 0xC0, 0x06, 0x80, 0xFF])),
	A_Pause(30),
	A_UnknownCommand(bytearray([0x24, 0x00, 0xFF, 0x00, 0x01])),
	A_UnknownCommand(bytearray([0x25, 0xC0, 0x06, 0x80, 0xFF])),
	A_Pause(30),
	A_BPL262728(),
	A_Pause(16),
	...
	A_UnknownCommand(bytearray([0x20, 0x07])),
	A_UnknownCommand(bytearray([0x24, 0x30, 0x01, 0x00, 0x00])),
	A_UnknownCommand(bytearray([0x25, 0xC0, 0x06, 0x80, 0xFF])),
	A_Pause(30),
	A_UnknownCommand(bytearray([0x24, 0x00, 0x01, 0x00, 0xFF])),
	A_UnknownCommand(bytearray([0x25, 0xC0, 0x06, 0x80, 0xFF])),
	A_Pause(30),
	A_BPL262728(),
	A_Pause(16),
