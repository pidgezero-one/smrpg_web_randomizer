...
script = ActionScript([
	...
	A_SetSubroutineXTargets(slot_26_x=0x0000, slot_27_x=0x0180),
	A_UnknownCommand(bytearray([0x25, 0xC0, 0x06, 0x80, 0xFF])),
	A_Pause(30),
	A_SetSubroutineXTargets(slot_26_x=0xFE80, slot_27_x=0x0000, identifier="ACTION_457_db_15"),
	A_UnknownCommand(bytearray([0x25, 0xC0, 0x06, 0x80, 0xFF])),
	A_Pause(30),
	A_SetSubroutineXTargets(slot_26_x=0xFF00, slot_27_x=0x0100),
	A_UnknownCommand(bytearray([0x25, 0xC0, 0x06, 0x80, 0xFF])),
	A_Pause(30),
	...
	A_ToggleSubroutineSlots(mask=0x07),
	A_SetSubroutineXTargets(slot_26_x=0x0130, slot_27_x=0x0000),
	A_UnknownCommand(bytearray([0x25, 0xC0, 0x06, 0x80, 0xFF])),
	A_Pause(30),
	A_SetSubroutineXTargets(slot_26_x=0x0100, slot_27_x=0xFF00),
	A_UnknownCommand(bytearray([0x25, 0xC0, 0x06, 0x80, 0xFF])),
	A_Pause(30),
	A_KillAllSubroutineSlots(),
	A_Pause(16),
