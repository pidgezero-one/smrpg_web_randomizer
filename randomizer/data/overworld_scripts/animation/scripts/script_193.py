...
script = ActionScript([
	...
	A_JmpIfObjectWithinRange(comparing_npc=MARIO, usually=0, tiles=5, destinations=["ACTION_193_set_sprite_sequence_4"]),
	...
	A_JmpIfObjectWithinRange(comparing_npc=MARIO, usually=0, tiles=5, destinations=["ACTION_193_pause_5"]),
