...
script = ActionScript([
	...
	A_ToggleSubroutineSlots(mask=0x00),
	...
	A_ToggleSubroutineSlots(mask=0x00, identifier="ACTION_711_db_16"),
	...
	A_ToggleSubroutineSlots(mask=0x00, identifier="ACTION_711_db_25"),
