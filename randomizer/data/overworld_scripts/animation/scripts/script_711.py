...
script = ActionScript([
	...
	A_UnknownCommand(bytearray([0x20, 0x00])),
	...
	A_UnknownCommand(bytearray([0x20, 0x00]), identifier="ACTION_711_db_16"),
	...
	A_UnknownCommand(bytearray([0x20, 0x00]), identifier="ACTION_711_db_25"),
