...
script = ActionScript([
	...
	A_JmpIfRandom2of3(["ACTION_364_transfer_to_xyzf_6", "ACTION_364_transfer_to_xyzf_8"]),
	...
	A_Jmp(["ACTION_364_visibility_on_9"]),
	A_TransferToXYZF(x=3, y=46, z=0, direction=EAST, identifier="ACTION_364_transfer_to_xyzf_8"),
