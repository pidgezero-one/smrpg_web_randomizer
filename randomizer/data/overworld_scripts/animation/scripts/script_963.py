...
script = ActionScript([
	...
	A_SetSpriteSequence(index=3, looping=False, identifier="factory_3rd_boss_mid_hammer_attack"),
	A_Pause(32, identifier="factory_3rd_boss_mid_hammer_attack_pause_32"),
