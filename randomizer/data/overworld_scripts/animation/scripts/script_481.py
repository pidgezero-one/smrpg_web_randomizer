...
script = ActionScript([
	...
	A_StartLoopNTimes(2),
	A_SetSubroutineXTargets(slot_26_x=0x00C0, slot_27_x=0x00A0),
	A_UnknownCommand(bytearray([0x25, 0xC0, 0x06, 0x80, 0xFF])),
	A_Pause(30),
	A_EndLoop(),
	A_StartLoopNTimes(1, identifier="ACTION_481_start_loop_n_times_21"),
	A_SetSubroutineXTargets(slot_26_x=0xFFA0, slot_27_x=0x0040),
	A_UnknownCommand(bytearray([0x25, 0xC0, 0x06, 0x80, 0xFF])),
	A_Pause(30),
	A_EndLoop(),
	A_StartLoopNTimes(1),
	A_SetSubroutineXTargets(slot_26_x=0xFFA0, slot_27_x=0xFFC0),
	A_UnknownCommand(bytearray([0x25, 0xC0, 0x06, 0x80, 0xFF])),
	A_Pause(30),
	A_EndLoop(),
	A_StartLoopNTimes(1),
	A_SetSubroutineXTargets(slot_26_x=0x0060, slot_27_x=0xFFC0),
	A_UnknownCommand(bytearray([0x25, 0xC0, 0x06, 0x80, 0xFF])),
	A_Pause(30),
	A_EndLoop(),
	A_StartLoopNTimes(1),
	A_SetSubroutineXTargets(slot_26_x=0x0060, slot_27_x=0x0040),
	A_UnknownCommand(bytearray([0x25, 0xC0, 0x06, 0x80, 0xFF])),
	A_Pause(30),
	A_EndLoop(),
