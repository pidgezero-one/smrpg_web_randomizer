...
script = ActionScript([
	...
	A_UnknownCommand(bytearray([0x24, 0x80, 0xFB, 0x00, 0x02])),
	A_UnknownCommand(bytearray([0x25, 0x00, 0x00, 0x60, 0xFF])),
	A_Pause(16),
	A_UnknownCommand(bytearray([0x24, 0xE0, 0xFF, 0x00, 0x01])),
	A_Pause(9),
	A_BPL262728(),
	A_OverwriteSolidity(),
	...
	A_OverwriteSolidity(bit_4=True, cant_walk_through=True),
	A_UnknownCommand(bytearray([0x20, 0x07])),
	A_UnknownCommand(bytearray([0x24, 0x80, 0x04, 0x50, 0x02])),
	A_UnknownCommand(bytearray([0x25, 0x00, 0x00, 0x60, 0xFF])),
	A_Pause(16),
	A_UnknownCommand(bytearray([0x24, 0x20, 0x00, 0x00, 0x01])),
	A_Pause(9),
	A_BPL262728(),
	A_OverwriteSolidity(),
	A_Jmp(["ACTION_177_play_sound_42"]),
	...
	A_OverwriteSolidity(bit_4=True, cant_walk_through=True),
	A_UnknownCommand(bytearray([0x20, 0x07])),
	A_UnknownCommand(bytearray([0x24, 0x80, 0xFE, 0x50, 0xFE])),
	A_UnknownCommand(bytearray([0x25, 0x00, 0x00, 0x60, 0xFF])),
	A_Pause(38),
