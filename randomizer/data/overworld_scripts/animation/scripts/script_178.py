...
script = ActionScript([
	...
	A_SetSubroutineXTargets(slot_26_x=0xFB80, slot_27_x=0x0100),
	A_UnknownCommand(bytearray([0x25, 0x00, 0x00, 0x60, 0xFF])),
	A_Pause(16),
	A_SetSubroutineXTargets(slot_26_x=0xFFE0, slot_27_x=0x0080),
	A_Pause(9),
	...
	A_OverwriteSolidity(bit_4=True, cant_walk_through=True),
	A_ToggleSubroutineSlots(mask=0x07),
	A_SetSubroutineXTargets(slot_26_x=0x0380, slot_27_x=0x0400),
	A_UnknownCommand(bytearray([0x25, 0x00, 0x00, 0x60, 0xFF])),
	A_Pause(16),
	A_SetSubroutineXTargets(slot_26_x=0x0020, slot_27_x=0x0080),
	A_Pause(9),
	A_KillAllSubroutineSlots(),
	A_OverwriteSolidity(),
	A_Jmp(["ACTION_178_play_sound_42"]),
	...
	A_OverwriteSolidity(bit_4=True, cant_walk_through=True),
	A_ToggleSubroutineSlots(mask=0x07),
	A_SetSubroutineXTargets(slot_26_x=0xFE80, slot_27_x=0xFE80),
	A_UnknownCommand(bytearray([0x25, 0x00, 0x00, 0x60, 0xFF])),
	A_Pause(38),
