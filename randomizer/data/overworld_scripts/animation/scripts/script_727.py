...
script = ActionScript([
	A_JmpIfVarEqualsConst(CURRENT_OVERWORLD_MARKER_ID, OW50_BARREL_VOLCANO, ["ACTION_727_set_animation_speed_11"], identifier="ACTION_727_jmp_if_var_equals_const_0"),
