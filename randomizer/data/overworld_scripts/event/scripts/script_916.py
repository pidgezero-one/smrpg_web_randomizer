...
script = EventScript([
	...
	CreatePacketAt7010(packet=P098_GRAY_SPELL_CHEST, destinations=["spell_17_character"], identifier="spell_17_elemental_packet"),
	LearnSpell(GENO, GenoFlashSpell, identifier="spell_17_character"),
