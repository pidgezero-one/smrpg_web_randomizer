...
script = EventScript([
    ...
    JmpIfBitClear(GAME_OVER, ["EVENT_593_set_bit_8"]),
	ResetAndChooseGame(),
	RemoveObjectFromSpecificLevel(NPC_0, R289_MOLEVILLE_MINES_AREA_17_PUNCHINELLOS_ROOM_BEFORE_BATTLE, identifier="EVENT_593_set_bit_8"),
	...
	RestoreAllHP(identifier="E0593_heal_hp"),
	RestoreAllFP(identifier="E0593_heal_fp"),
