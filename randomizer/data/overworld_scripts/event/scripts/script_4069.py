# E4069_PACKET_OF_E1015 (auto: spell E1015 minus FD F2 + RemoveObj)
...
script = EventScript([
	...
	JmpIfBitClear(SHIP_PACKET_AUTOTERM_DIALOG, ["e4069_await"]),
	...
	Return(),
	RunDialog(dialog_id=DI1987_LEARN_SPELL_21, above_object=MARIO, closable=True, sync=False, multiline=False, use_background=False, identifier="e4069_await"),
	Return()
])