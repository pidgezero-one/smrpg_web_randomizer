...
script = EventScript([
	...
	ResetAndChooseGame(),
	SetBit(TOAD_IN_MUSHROOM_WAY_3, identifier="EVENT_2808_restore_all_hp_7"),
	RestoreAllHP(identifier="E2808_heal_hp"),
	RestoreAllFP(identifier="E2808_heal_fp"),
	...
	Set7000ToPartySize(),
	CompareVarToConst(PRIMARY_TEMP_7000, 4, identifier="party_size_switcher_5"),
	JmpIfComparisonResultIsLesser(["EVENT_2808_j_24"]),
	SetBit(SWITCH_MENU_UNLOCKED),
    RunEventAsSubroutine(E1194_MUSHROOM_WAY_BOSS_UNLOCKS, identifier="EVENT_2808_j_24"),
	...
	JmpIfBitSet(TOAD_IN_MUSHROOM_WAY_2, ["grant_star_piece"], identifier="grant_toad_2_rescue_if_not_done"),
	...
	JmpToEvent(E0168_BOSS_GRANT_STAR_PIECE_CONTAINER, identifier="grant_star_piece"),
