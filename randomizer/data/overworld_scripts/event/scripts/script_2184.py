...
script = EventScript([
	JmpIfBitSet(TEMP_7043_4, ["EVENT_2184_ret_25"]),
	SetBit(TEMP_7043_4),
	...
	JmpIfBitSet(KEEP_BOSS_1_DEFEATED, ["EVENT_2184_create_packet_at_npc_coords_6"]),
	RunEventAsSubroutine(E0941_KEEP_FIRST_BOSS_SET_SCRIPT),
	CreatePacketAtObjectCoords(packet=P034_GREY_EXPLOSION_SFX, target_npc=NPC_4, destinations=["EVENT_2184_create_packet_at_npc_coords_6"], identifier="EVENT_2184_create_packet_at_npc_coords_6"),
	...
	JmpIfBitClear(GAME_OVER, ["EVENT_2184_action_queue_16"]),
	RestoreAllHP(),
	RestoreAllFP(),
	...
	ActionQueueSync(target=NPC_0, subscript=[
		...
		A_VisibilityOff()
	], identifier="EVENT_2184_action_queue_16"),
	ActionQueueAsync(target=NPC_4, subscript=[
	...
	CreatePacketAtObjectCoords(packet=P034_GREY_EXPLOSION_SFX, target_npc=NPC_0, destinations=["EVENT_2184_create_packet_at_npc_coords_23"], identifier="EVENT_2184_create_packet_at_npc_coords_23"),
	CreatePacketAtObjectCoords(packet=P034_GREY_EXPLOSION_SFX, target_npc=NPC_4, destinations=["EVENT_2184_create_packet_at_npc_coords_23"]),
	Return(identifier="EVENT_2184_ret_25")
])
