...
script = EventScript([
	JmpIfBitSet(TEMP_7044_7, ["EVENT_3616_stop_sound_3"]),
	FadeInFromBlack(sync=False),
	Return(),
	StopSound(identifier="EVENT_3616_stop_sound_3"),
	FadeOutMusicToVolume(duration=1, volume=96),
	RunEventAsSubroutine(E0081_MARIO_LANDS_SUBROUTINE),
	RunEventAsSubroutine(E3588_SIGNAL_RING_ACTIVATOR),
	JmpIfBitClear(SIGNAL_RING_BIT, ["EVENT_3616_ret_9"]),
	RunEventAsSubroutine(E3912_NIMBUS_STAR_PIECE_SIGNAL),
	Return(identifier="EVENT_3616_ret_9")
])
