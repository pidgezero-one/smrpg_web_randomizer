...
script = EventScript([
	...
	JmpIfVarEqualsConst(PRIMARY_TEMP_7000, 255, ["EVENT_2672_set_var_to_const_68"]),
	...
	Jmp(["EVENT_2672_clear_bit_75"]),
	SetVarToConst(ITEM_ID, RedEssenceItem, identifier="EVENT_2672_set_var_to_const_68"),
