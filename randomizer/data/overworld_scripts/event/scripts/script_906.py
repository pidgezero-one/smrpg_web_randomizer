...
script = EventScript([
	...
	CreatePacketAt7010(packet=P097_YELLOW_SPELL_CHEST, destinations=["spell_7_character"], identifier="spell_7_elemental_packet"),
	LearnSpell(MALLOW, ThunderboltSpell, identifier="spell_7_character"),
