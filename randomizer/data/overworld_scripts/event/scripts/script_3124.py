...
script = EventScript([
	...
	Set7000ToCurrentLevel(identifier="EVENT_3124_reset_and_choose_game_36"),
	JmpIfVarEqualsConst(PRIMARY_TEMP_7000, R144_BOWSERS_KEEP_6DOOR_TREASURE_AFTER_EACH_ROOM, ["EVENT_3124_keep_reset"]),
	JmpIfVarEqualsConst(PRIMARY_TEMP_7000, R321_BOWSERS_KEEP_6DOOR_ACTION_ROOM_2A_SLOW_ELEVATING_PLATFORMS, ["EVENT_3124_keep_reset"]),
	JmpIfVarEqualsConst(PRIMARY_TEMP_7000, R322_BOWSERS_KEEP_6DOOR_ACTION_ROOM_1A_JUMPING_TERRAPIN, ["EVENT_3124_keep_reset"]),
	JmpIfVarEqualsConst(PRIMARY_TEMP_7000, R446_BOWSERS_KEEP_6DOOR_EXIT_ROOM_AFTER_FINISHING_4_DOORS, ["EVENT_3124_keep_reset"]),
	JmpIfVarEqualsConst(PRIMARY_TEMP_7000, R455_BOWSERS_KEEP_6DOOR_ACTION_ROOM_2C_VERY_SLOW_MOVING_CIRCLING_PLATFORMS, ["EVENT_3124_keep_reset"]),
	JmpIfVarEqualsConst(PRIMARY_TEMP_7000, R457_BOWSERS_KEEP_6DOOR_ACTION_ROOM_2B_CANNONBALL_RIDING, ["EVENT_3124_keep_reset"]),
	JmpIfVarEqualsConst(PRIMARY_TEMP_7000, R458_BOWSERS_KEEP_6DOOR_ACTION_ROOM_1B_MOVING_PLATFORMS, ["EVENT_3124_keep_reset"]),
	SetVarToConst(PRIMARY_TEMP_7000, 0),
	ResetAndChooseGame(),
	Return(),
	SetVarToConst(KEEP_DOOR_LIVES, 0, identifier="EVENT_3124_keep_reset"),
