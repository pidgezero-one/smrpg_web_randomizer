...
script = EventScript([
	...
	JmpIfDialogOptionBOrCSelected(['bomb_shop_item_2', 'bomb_shop_item_3']),
	SetVarToConst(ITEM_ID, FrightBombItem, identifier="bomb_shop_item_1"),
	Jmp(["EVENT_1636_play_sound_184"]),
	SetVarToConst(ITEM_ID, FireBombItem, identifier="bomb_shop_item_2"),
	Jmp(["EVENT_1636_play_sound_184"]),
	SetVarToConst(ITEM_ID, IceBombItem, identifier="bomb_shop_item_3"),
