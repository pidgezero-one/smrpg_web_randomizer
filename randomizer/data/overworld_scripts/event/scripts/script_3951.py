...
script = EventScript([
	...
	PaletteSetMorphs(palette_type=FADE_TO, duration=12, palette_set=EPAL0085_MALLOW_ENDING, row=NPC_PALETTE_ROW_2),
	PaletteSetMorphs(palette_type=FADE_TO, duration=12, palette_set=EPAL0086_GENO_ENDING, row=NPC_PALETTE_ROW_3),
	PaletteSetMorphs(palette_type=FADE_TO, duration=12, palette_set=EPAL0141_TOADSTOOL_ENDING, row=NPC_PALETTE_ROW_1),
	PaletteSetMorphs(palette_type=FADE_TO, duration=12, palette_set=EPAL0140_BOWSER_ENDING, row=NPC_PALETTE_ROW_5),
	PauseScriptUntilEffectDone(),
	Pause(216),
