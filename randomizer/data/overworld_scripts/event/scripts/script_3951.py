...
script = EventScript([
	...
	PaletteSet(palette_set_starts_at=EPAL0166_MALLOW_ENDING_DARK, from_row=NPC_PALETTE_ROW_2, identifier="ending_mushroom_way_char_palette_dark"),
	PaletteSet(palette_set_starts_at=EPAL0167_GENO_ENDING_DARK, from_row=NPC_PALETTE_ROW_3, identifier="ending_forest_character_dark"),
	PaletteSet(palette_set_starts_at=EPAL0165_BOWSER_ENDING_DARK, from_row=NPC_PALETTE_ROW_5, identifier="ending_inner_mines_palette_dark"),
	...
	PaletteSetMorphs(palette_type=FADE_TO, duration=12, palette_set=EPAL0084_MARIO_ENDING, row=MARIO_PALETTE, identifier="ending_protagonist_palette"),
	PaletteSetMorphs(palette_type=FADE_TO, duration=12, palette_set=EPAL0085_MALLOW_ENDING, row=NPC_PALETTE_ROW_2, identifier="ending_mushroom_way_char_palette"),
	PaletteSetMorphs(palette_type=FADE_TO, duration=12, palette_set=EPAL0086_GENO_ENDING, row=NPC_PALETTE_ROW_3, identifier="ending_forest_maze_char_palette"),
	PaletteSetMorphs(palette_type=FADE_TO, duration=12, palette_set=EPAL0141_TOADSTOOL_ENDING, row=NPC_PALETTE_ROW_1, identifier="ending_marrymore_char_palette"),
	PaletteSetMorphs(palette_type=FADE_TO, duration=12, palette_set=EPAL0140_BOWSER_ENDING, row=NPC_PALETTE_ROW_5, identifier="ending_inner_mines_char_palette"),
	PauseScriptUntilEffectDone(),
	Pause(216),
