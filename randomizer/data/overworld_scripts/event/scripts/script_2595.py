...
script = EventScript([
	...
	JmpIfBitClear(TEMP_7044_7, ["EVENT_2595_fade_in_from_black_async_7"]),
	...
	Jmp(["EVENT_2595_ret_8"]),
	FadeInFromBlack(sync=False, identifier="EVENT_2595_fade_in_from_black_async_7"),
	Return(identifier="EVENT_2595_ret_8")
])
