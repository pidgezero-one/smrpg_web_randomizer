...
script = EventScript([
	...
	JmpIfBitSet(SEWER_BOSS_DEFEATED, ["EVENT_3142_set_bit_12"]),
	...
	Pause(1, identifier="EVENT_3142_pause_9"),
	JmpIfMarioInAir(["EVENT_3142_pause_9"]),
	Return(),
	SetBit(UNKNOWN_MIDAS_RIVER_704D_6, identifier="EVENT_3142_set_bit_12"),
