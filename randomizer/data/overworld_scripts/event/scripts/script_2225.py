...
script = EventScript([
	...
	ActionQueueAsync(target=MARIO, subscript=[
		...
		A_SetSubroutineXTargets(slot_26_x=0xFDE0, slot_27_x=0xFF00),
	...
	ResetAndChooseGame(),
	SetBit(KEEP_BOSS_2_DEFEATED, identifier="EVENT_2225_restore_all_hp_14"),
	RestoreAllHP(identifier="E2225_heal_hp"),
	RestoreAllFP(identifier="E2225_heal_fp"),
	SetVarToConst(PRIMARY_TEMP_7000, 521),
