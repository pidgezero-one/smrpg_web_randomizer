...
script = EventScript([
	...
	Jmp(["EVENT_2490_play_sound_95"]),
	Set70107015ToObjectXYZ(target=NPC_5, identifier="EVENT_2490_summon_to_current_level_78"),
	CreatePacketAt7010(packet=P064_FROG_COIN_CHEST_STILL, destinations=["EVENT_2490_fc_sound"]),
	PlaySound(sound=SO094_FROG_COIN, channel=6, identifier="EVENT_2490_fc_sound"),
	AddFrogCoins(1),
	...
	RestoreAllHP(identifier="E2490_heal_hp"),
	RestoreAllFP(identifier="E2490_heal_fp"),
