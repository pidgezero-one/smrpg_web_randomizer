...
script = EventScript([
	...
	CreatePacketAt7010(packet=P001_FLASHING_POOF_MUSHROOM, destinations=["EVENT_3072_restore_all_hp_17"]),
	RestoreAllHP(identifier="EVENT_3072_restore_all_hp_17"),
	RestoreAllFP(),
	...
	CreatePacketAt7010(packet=P003_BRIEF_STAR, destinations=["EVENT_3072_exp_star_summon"]),
	#StopMusicFDA0(identifier="EVENT_3072_exp_star_summon"),
	SetVarToConst(TIMER_7022, 550, identifier="EVENT_3072_exp_star_summon"),
	...
	SetVarToConst(ITEM_ID, 16, identifier="EVENT_3072_set_var_to_const_60"),
	Jmp(["EVENT_3072_copy_var_to_var_81"]),
	Return(),
	SetVarToConst(ITEM_ID, 17, identifier="EVENT_3072_set_var_to_const_63"),
	Jmp(["EVENT_3072_copy_var_to_var_81"]),
	Return(),
	SetVarToConst(ITEM_ID, 18, identifier="EVENT_3072_set_var_to_const_66"),
	Jmp(["EVENT_3072_copy_var_to_var_81"]),
	Return(),
	SetVarToConst(ITEM_ID, 19, identifier="EVENT_3072_set_var_to_const_69"),
	Jmp(["EVENT_3072_copy_var_to_var_81"]),
	Return(),
	SetVarToConst(ITEM_ID, 20, identifier="EVENT_3072_set_var_to_const_72"),
	Jmp(["EVENT_3072_copy_var_to_var_81"]),
	Return(),
	SetVarToConst(ITEM_ID, 21, identifier="EVENT_3072_set_var_to_const_75"),
	Jmp(["EVENT_3072_copy_var_to_var_81"]),
	Return(),
	SetVarToConst(ITEM_ID, 23, identifier="EVENT_3072_set_var_to_const_78"),
	Jmp(["EVENT_3072_copy_var_to_var_81"]),
	Return(),
	...
	SetVarToConst(PRIMARY_TEMP_7000, 1, identifier="EVENT_3072_increase_fp"),
	Add7000ToMaxFP(),
	Jmp(["EVENT_3072_ret_98"]),
	PlaySound(sound=SO094_FROG_COIN, channel=6, identifier="EVENT_3072_play_sound_95"),
	CreatePacketAt7010(packet=P019_FROG_COIN_BEING_COLLECTED, destinations=["EVENT_3072_add_frog_coins_96"]),
	AddFrogCoins(1, identifier="EVENT_3072_add_frog_coins_96"),
