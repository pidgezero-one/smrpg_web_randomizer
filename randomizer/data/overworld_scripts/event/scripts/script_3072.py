...
script = EventScript([
	...
	JmpIfVarEqualsConst(EXP_STAR_70D5, 0, ["EVENT_3072_set_var_to_const_60"]),
	JmpIfVarEqualsConst(EXP_STAR_70D5, 1, ["EVENT_3072_set_var_to_const_63"]),
	JmpIfVarEqualsConst(EXP_STAR_70D5, 2, ["EVENT_3072_set_var_to_const_66"]),
	JmpIfVarEqualsConst(EXP_STAR_70D5, 3, ["EVENT_3072_set_var_to_const_69"]),
	JmpIfVarEqualsConst(EXP_STAR_70D5, 4, ["EVENT_3072_set_var_to_const_72"]),
	JmpIfVarEqualsConst(EXP_STAR_70D5, 5, ["EVENT_3072_set_var_to_const_75"]),
	JmpIfVarEqualsConst(EXP_STAR_70D5, 6, ["EVENT_3072_set_var_to_const_78"]),
	JmpIfVarEqualsConst(EXP_STAR_70D5, 7, ["EVENT_3072_set_var_to_const_78"]),
	Return(),
	JmpIfBitClear(PROGRESSIVE_BOSS_EXP_ENABLED, ["EVENT_3072_copy_var_to_var_81"], identifier="EVENT_3072_jmp_if_bit_clear_47"),
	CompareVarToConst(APPRENTICE_LOSS_COUNTER, 21),
	JmpIfComparisonResultIsGreaterOrEqual(["EVENT_3072_set_var_to_const_78"]),
	CompareVarToConst(APPRENTICE_LOSS_COUNTER, 15),
	JmpIfComparisonResultIsGreaterOrEqual(["EVENT_3072_set_var_to_const_75"]),
	CompareVarToConst(APPRENTICE_LOSS_COUNTER, 10),
	JmpIfComparisonResultIsGreaterOrEqual(["EVENT_3072_set_var_to_const_72"]),
	CompareVarToConst(APPRENTICE_LOSS_COUNTER, 6),
	JmpIfComparisonResultIsGreaterOrEqual(["EVENT_3072_set_var_to_const_69"]),
	CompareVarToConst(APPRENTICE_LOSS_COUNTER, 3),
	JmpIfComparisonResultIsGreaterOrEqual(["EVENT_3072_set_var_to_const_66"]),
	CompareVarToConst(APPRENTICE_LOSS_COUNTER, 1),
