...
script = EventScript([
	...
	ActionQueueSync(target=MARIO, subscript=[
		...
		A_PlaySound(sound=SO096_SWINGING_FIST, channel=6),
		A_Pause(30)
	], identifier="EVENT_2076_player_challenge_aq"),
	...
	RestoreAllHP(identifier="E2076_heal_hp"),
	RestoreAllFP(identifier="E2076_heal_fp"),
	Pause(1),
	StopMusicFDA2(),
	...
	ActionQueueSync(target=NPC_2, subscript=[
		...
		A_ResetProperties(),
		A_FaceSouthwest(),
	], identifier="EVENT_2076_fade_in_from_black_async_26"),
