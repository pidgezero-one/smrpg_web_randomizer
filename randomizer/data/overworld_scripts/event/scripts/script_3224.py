...
script = EventScript([
	...
	JmpIfBitClear(TEMP_7042_6, ["EVENT_3224_run_event_as_subroutine_25"]),
	...
	RunEventAsSubroutine(E0015_STANDARD_ROOM_LOADER, identifier="EVENT_3224_run_event_as_subroutine_25"),
