...
script = EventScript([
	...
	CreatePacketAt7010(packet=P094_FIRE_SPELL_CHEST, destinations=["spell_6_character"], identifier="spell_6_elemental_packet"),
	LearnSpell(MARIO, UltraFlameSpell, identifier="spell_6_character"),
