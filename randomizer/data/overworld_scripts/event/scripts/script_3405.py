...
script = EventScript([
	...
	JmpIfVarNotEqualsConst(CURRENT_OVERWORLD_MARKER_ID, OW01_INNER_FACTORY, ["EVENT_3405_set_temp_action_script_21"], identifier="EVENT_3405_jmp_if_var_not_equals_const_16"),
