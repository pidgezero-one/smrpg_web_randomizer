...
script = EventScript([
	...
	CreatePacketAt7010(packet=P098_GRAY_SPELL_CHEST, destinations=["spell_27_character"], identifier="spell_27_elemental_packet"),
	LearnSpell(TOADSTOOL, PsychBombSpell, identifier="spell_27_character"),
