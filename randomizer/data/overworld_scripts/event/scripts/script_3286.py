...
script = EventScript([
	...
	Return(),
	RunDialog(dialog_id=DI1780_DUPLICATE, above_object=NPC_12, closable=True, sync=False, multiline=True, use_background=False, identifier="EVENT_3286_run_dialog_4"),
	Return(),
