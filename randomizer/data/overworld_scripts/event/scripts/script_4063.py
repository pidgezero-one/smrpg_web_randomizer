# E4063_PACKET_OF_E1005 (auto: spell E1005 minus FD F2 + RemoveObj)
...
script = EventScript([
	...
	JmpIfBitClear(SHIP_PACKET_AUTOTERM_DIALOG, ["e4063_await"]),
	...
	Return(),
	RunDialog(dialog_id=DI1973_LEARN_SPELL_14, above_object=MARIO, closable=True, sync=False, multiline=False, use_background=False, identifier="e4063_await"),
	Return()
])