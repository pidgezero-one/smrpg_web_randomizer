...
script = EventScript([
	...
	CreatePacketAt7010(packet=P098_GRAY_SPELL_CHEST, destinations=["spell_15_character"], identifier="spell_15_elemental_packet"),
	LearnSpell(GENO, GenoWhirlSpell, identifier="spell_15_character"),
