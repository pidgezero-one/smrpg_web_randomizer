...
script = EventScript([
	...
	JmpIfBitClear(GAME_OVER, ["EVENT_1369_action_queue_5"]),
	ResetAndChooseGame(),
	ActionQueueSync(target=MARIO, subscript=[
		...
		A_FaceNortheast()
	], identifier="EVENT_1369_action_queue_5"),
	...
	RestoreAllHP(identifier="E1369_heal_hp"),
	RestoreAllFP(identifier="E1369_heal_fp"),
