...
script = EventScript([
	...
	CreatePacketAt7010(packet=P098_GRAY_SPELL_CHEST, destinations=["spell_21_character"], identifier="spell_21_elemental_packet"),
	LearnSpell(BOWSER, BowserCrushSpell, identifier="spell_21_character"),
