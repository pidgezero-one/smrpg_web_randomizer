...
script = EventScript([
	...
	CreatePacketAt7010(packet=P098_GRAY_SPELL_CHEST, destinations=["spell_24_character"], identifier="spell_24_elemental_packet"),
	LearnSpell(TOADSTOOL, SleepyTimeSpell, identifier="spell_24_character"),
