...
script = EventScript([
	...
	CreatePacketAt7010(packet=P098_GRAY_SPELL_CHEST, destinations=["spell_26_character"], identifier="spell_26_elemental_packet"),
	LearnSpell(TOADSTOOL, MuteSpell, identifier="spell_26_character"),
