...
script = EventScript([
	...
	ActionQueueAsync(target=NPC_0, subscript=[
		...
		A_PlaySound(sound=SO038_TADPOLE_POND_STAFF_LA, channel=6),
		A_Pause(20),
		A_SetSpriteSequence(index=9, is_mold=True, is_sequence=True, looping=True, mirror_sprite=True),
		A_Pause(5),
		A_WalkSoutheastPixels(3),
		A_PlaySound(sound=SO039_TADPOLE_POND_STAFF_TI, channel=6),
		A_Pause(10),
		...
		A_WalkNorthwestPixels(3),
		A_PlaySound(sound=SO040_TADPOLE_POND_STAFF_DO, channel=6),
		A_Pause(20),
		A_SetSpriteSequence(index=9, is_mold=True, is_sequence=True, looping=True, mirror_sprite=True),
		A_Pause(5),
		A_WalkSoutheastPixels(3),
		A_PlaySound(sound=SO041_TADPOLE_POND_STAFF_RE, channel=6),
		A_Pause(10),
		...
		A_JumpToHeight(37),
		A_Pause(5),
		A_PlaySound(sound=SO037_TADPOLE_POND_STAFF_SO, channel=6),
		A_Pause(24),
		A_SetSpriteSequence(index=9, is_mold=True, is_sequence=True, looping=True, mirror_sprite=True),
		A_Pause(8),
		A_PlaySound(sound=SO040_TADPOLE_POND_STAFF_DO, channel=6),
		...
		A_PlaySound(sound=SO042_TADPOLE_POND_STAFF_MI, channel=6),
		A_Pause(30)
