...
script = EventScript([
	...
	EnterArea(room_id=R294_MARRYMORE_CHAPEL_CLONE_BOSS_LAUNCHER, face_direction=NORTHEAST, x=22, y=74, z=1, run_entrance_event=False),
	...
	RemoveObjectFromSpecificLevel(NPC_0, R294_MARRYMORE_CHAPEL_CLONE_BOSS_LAUNCHER),
	RemoveObjectFromSpecificLevel(NPC_1, R294_MARRYMORE_CHAPEL_CLONE_BOSS_LAUNCHER),
	RemoveObjectFromSpecificLevel(NPC_2, R294_MARRYMORE_CHAPEL_CLONE_BOSS_LAUNCHER),
	RemoveObjectFromSpecificLevel(NPC_3, R294_MARRYMORE_CHAPEL_CLONE_BOSS_LAUNCHER),
	RemoveObjectFromSpecificLevel(NPC_4, R294_MARRYMORE_CHAPEL_CLONE_BOSS_LAUNCHER),
	RemoveObjectFromSpecificLevel(NPC_7, R294_MARRYMORE_CHAPEL_CLONE_BOSS_LAUNCHER),
	RemoveObjectFromSpecificLevel(NPC_8, R294_MARRYMORE_CHAPEL_CLONE_BOSS_LAUNCHER),
	RemoveObjectFromSpecificLevel(NPC_9, R294_MARRYMORE_CHAPEL_CLONE_BOSS_LAUNCHER),
	RemoveObjectFromSpecificLevel(NPC_10, R294_MARRYMORE_CHAPEL_CLONE_BOSS_LAUNCHER),
	RemoveObjectFromSpecificLevel(NPC_11, R294_MARRYMORE_CHAPEL_CLONE_BOSS_LAUNCHER),
