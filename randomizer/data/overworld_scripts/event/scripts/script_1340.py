...
script = EventScript([
	...
	ApplyTileModToLevel(use_alternate=True, room_id=R195_BOOSTER_TOWER_6F_AREA_02_BOOSTERS_ANCESTOR_GAME_ROOM, mod_id=33, identifier="EVENT_1340_apply_tile_mod_6"),
