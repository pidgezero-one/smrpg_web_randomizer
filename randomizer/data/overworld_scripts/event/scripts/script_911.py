...
script = EventScript([
	...
	CreatePacketAt7010(packet=P098_GRAY_SPELL_CHEST, destinations=["spell_12_character"], identifier="spell_12_elemental_packet"),
	LearnSpell(MALLOW, StarRainSpell, identifier="spell_12_character"),
