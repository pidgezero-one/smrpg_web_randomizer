...
script = EventScript([
	...
	EnableObjectTriggerInSpecificLevel(NPC_0, R031_MUSHROOM_KINGDOM_CASTLE_VAULT),
	EnableObjectTriggerInSpecificLevel(NPC_1, R031_MUSHROOM_KINGDOM_CASTLE_VAULT),
	EnableObjectTriggerInSpecificLevel(NPC_2, R031_MUSHROOM_KINGDOM_CASTLE_VAULT),
	EnableObjectTriggerInSpecificLevel(NPC_0, R331_MUSHROOM_KINGDOM_CASTLE_DURING_MACK_VAULT_UNUSED),
	EnableObjectTriggerInSpecificLevel(NPC_1, R331_MUSHROOM_KINGDOM_CASTLE_DURING_MACK_VAULT_UNUSED),
	EnableObjectTriggerInSpecificLevel(NPC_2, R331_MUSHROOM_KINGDOM_CASTLE_DURING_MACK_VAULT_UNUSED),
