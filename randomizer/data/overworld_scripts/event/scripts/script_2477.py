...
script = EventScript([
	...
	SetBit(TEMP_7044_1),
	SetSyncActionScript(NPC_7, A0843_ACTIVATE_PIRANHA_PLANT_IN_PIPE),
	SummonObjectToCurrentLevel(NPC_1),
	Jmp(["EVENT_2477_pause_0"]),
	JmpIfBitSet(TEMP_7044_3, ["EVENT_2477_pause_0"], identifier="EVENT_2477_jmp_if_bit_set_13"),
	SetBit(TEMP_7044_3),
	SetSyncActionScript(NPC_8, A0843_ACTIVATE_PIRANHA_PLANT_IN_PIPE),
	...
	SetBit(TEMP_7044_0),
	SetSyncActionScript(NPC_9, A0843_ACTIVATE_PIRANHA_PLANT_IN_PIPE),
	...
	SetBit(TEMP_7044_2),
	SetSyncActionScript(NPC_10, A0843_ACTIVATE_PIRANHA_PLANT_IN_PIPE),
	...
	SetBit(TEMP_7043_6),
	SetSyncActionScript(NPC_11, A0843_ACTIVATE_PIRANHA_PLANT_IN_PIPE),
	...
	SetBit(TEMP_7043_7),
	SetSyncActionScript(NPC_12, A0843_ACTIVATE_PIRANHA_PLANT_IN_PIPE),
