...
script = EventScript([
	...
	RestoreAllHP(identifier="E2174_heal_hp"),
	RestoreAllFP(identifier="E2174_heal_fp"),
	...
	JmpIfBitSet(BATTLE_DOOR_BOSS_BIT, ["EVENT_2174_ret_28"], identifier="EVENT_2174_no_softlock"),
