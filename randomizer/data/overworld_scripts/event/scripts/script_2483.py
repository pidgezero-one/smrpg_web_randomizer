...
script = EventScript([
	...
	RemoveObjectFromSpecificLevel(NPC_12, R251_BEAN_VALLEY_PIRANHA_PIPE_AREA),
	RemoveObjectFromCurrentLevel(NPC_6),
	RemoveObjectFromCurrentLevel(NPC_12),
	FadeInFromBlack(sync=False),
	Return(),
	SetTempSyncActionScript(NPC_12, A0002_FLASH_AFTER_RUNNING_AWAY_IFRAMES, identifier="EVENT_2483_set_temp_action_script_12"),
	FadeInFromBlack(sync=False),
	Return(),
