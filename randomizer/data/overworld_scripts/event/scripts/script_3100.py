...
script = EventScript([
    ...
    JmpIfVarNotEqualsConst(PRIMARY_TEMP_7000, R324_MONSTRO_TOWN_OUTSIDE, ["E3100_unlock_culex_door_if_current_lvl"]),
	RemoveObjectFromCurrentLevel(NPC_2),
	JmpToEvent(E0893_CHEST_COOKIE_PACKET, identifier="E3100_unlock_culex_door_if_current_lvl"),
	Return(),
