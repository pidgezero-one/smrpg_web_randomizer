...
script = EventScript([
	...
	Pause(5),
	RunEventAsSubroutine(E0053_HENCHMAN_CONTAINER_3),
	JmpIfBitClear(GAME_OVER, ["EVENT_1323_remove_from_current_level_6"]),
	ResetAndChooseGame(),
	RemoveObjectFromCurrentLevel(NPC_4, identifier="EVENT_1323_remove_from_current_level_6"),
