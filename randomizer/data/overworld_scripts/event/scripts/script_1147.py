...
script = EventScript([
	...
	PaletteSetMorphs(palette_type=NOTHING, duration=2, palette_set=EPAL0214_SEASIDE_BOSS_TRANSFORMS, row=NPC_PALETTE_ROW_3, identifier="seaside_palette_morph_1"),
	Pause(60),
