...
script = EventScript([
	...
	CreatePacketAt7010(packet=P097_YELLOW_SPELL_CHEST, destinations=["spell_10_character"], identifier="spell_10_elemental_packet"),
	LearnSpell(MALLOW, ShockerSpell, identifier="spell_10_character"),
