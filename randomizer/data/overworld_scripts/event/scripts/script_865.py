...
script = EventScript([
	...
	ActionQueueAsync(target=MARIO, subscript=[
		A_SetSpriteSequence(index=0, sprite_offset=0, is_mold=True, is_sequence=True, looping=False, identifier="dojo_fight_3_mario_challenge_mold")
	], identifier="dojo_fight_3_mario_challenge_mold_aq"),
	Return()
])
