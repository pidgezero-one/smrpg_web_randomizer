...
script = EventScript([
	...
	JmpIfBitClear(SHIP_PACKET_AUTOTERM_DIALOG, ["e4067_await"]),
	...
	Return(),
	RunDialog(dialog_id=DI1983_LEARN_SPELL_19, above_object=MARIO, closable=True, sync=False, multiline=False, use_background=False, identifier="e4067_await"),
	Return()
])