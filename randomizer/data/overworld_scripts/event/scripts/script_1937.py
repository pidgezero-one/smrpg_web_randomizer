...
script = EventScript([
    JmpIfBitSet(BK_OBSTACLE_2_PRIZE_RETRIEVED, ["bke2"]),
    SetBit(BK_OBSTACLE_2_PRIZE_RETRIEVED),
	JmpIfBitSet(UNIVERSAL_CHEST_ANIMATION_BIT, ["EVENT_1937_jmp_to_event_7"]),
	...
	JmpToEvent(E0173_CHEST_2_CONTAINER, identifier="EVENT_1937_jmp_to_event_7"),
	Return(identifier="bke2")
])
