...
script = EventScript([
	JmpIfVarEqualsConst(MINECART_COINS, 200, ["EVENT_1394_copy_var_to_var_6"]),
	StoreCoinCountTo7000(),
	Dec7000FromCoins(),
	CopyVarToVar(from_var=PRIMARY_TEMP_7000, to_var=OLD_STAR_PIECE_ID),
	SetVarToConst(MINECART_COINS, 200),
	Return(),
	CopyVarToVar(from_var=OLD_STAR_PIECE_ID, to_var=PRIMARY_TEMP_7000, identifier="EVENT_1394_copy_var_to_var_6"),
