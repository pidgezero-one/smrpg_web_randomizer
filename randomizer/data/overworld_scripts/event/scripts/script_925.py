...
script = EventScript([
	...
	CreatePacketAt7010(packet=P098_GRAY_SPELL_CHEST, destinations=["spell_25_character"], identifier="spell_25_elemental_packet"),
	LearnSpell(TOADSTOOL, ComeBackSpell, identifier="spell_25_character"),
