...
script = EventScript([
	...
	CopyVarToVar(from_var=PRIMARY_TEMP_7000, to_var=SECONDARY_TEMP_7024),
	CopyVarToVar(from_var=WEDDING_GEAR_COUNTER, to_var=PRIMARY_TEMP_7000),
	RunDialog(dialog_id=DI2503_NEED_X_MORE_ITEMS_MARRYMORE, above_object=MEM_70A8, closable=True, sync=False, multiline=True, use_background=True),
	...
	RunDialog(dialog_id=DI4060_NEED_TO_DO_CHAPEL_CHECKS, above_object=MEM_70A8, closable=True, sync=False, multiline=True, use_background=True, identifier="EVENT_663_checks_dialog"),
	Return(),
])
