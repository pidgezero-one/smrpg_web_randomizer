...
script = EventScript([
	...
	JmpIfBitClear(SHIP_PACKET_AUTOTERM_DIALOG, ["e4061_await"]),
	...
	Return(),
	RunDialog(dialog_id=DI1969_LEARN_SPELL_12, above_object=MARIO, closable=True, sync=False, multiline=False, use_background=False, identifier="e4061_await"),
	Return()
])