...
script = EventScript([
	...
	RemoveObjectFromSpecificLevel(NPC_2, R251_BEAN_VALLEY_PIRANHA_PIPE_AREA),
	RemoveObjectFromSpecificLevel(NPC_8, R251_BEAN_VALLEY_PIRANHA_PIPE_AREA),
	RemoveObjectFromCurrentLevel(NPC_2),
	RemoveObjectFromCurrentLevel(NPC_8),
	FadeInFromBlack(sync=False),
	Return(),
	SetTempSyncActionScript(NPC_8, A0002_FLASH_AFTER_RUNNING_AWAY_IFRAMES, identifier="EVENT_2480_set_temp_action_script_12"),
	FadeInFromBlack(sync=False),
	Return(),
