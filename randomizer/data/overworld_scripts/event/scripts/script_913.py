...
script = EventScript([
	...
	CreatePacketAt7010(packet=P098_GRAY_SPELL_CHEST, destinations=["spell_14_character"], identifier="spell_14_elemental_packet"),
	LearnSpell(GENO, GenoBoostSpell, identifier="spell_14_character"),
