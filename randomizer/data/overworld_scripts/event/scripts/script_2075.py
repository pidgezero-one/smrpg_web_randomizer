...
script = EventScript([
	...
	Return(),
	RunDialog(dialog_id=DI3328_NEED_SHINY_STONE, above_object=BOWSER, closable=True, sync=False, multiline=False, use_background=False, identifier="EVENT_2075_run_dialog_10"),
	Return(),
	SetVarToConst(ITEM_ID, ExtraShinyStoneItem, identifier="EVENT_2075_ess"),
	StoreItemAt70A7QuantityTo7000(),
	JmpIfVarEqualsConst(PRIMARY_TEMP_7000, 0, ["EVENT_2075_run_dialog_11"]),
    Jmp(["open_monstro_town_door"]),
	RunDialog(dialog_id=DI4063_NEED_EXTRASHINY, above_object=BOWSER, closable=True, sync=False, multiline=False, use_background=False, identifier="EVENT_2075_run_dialog_11"),
    Return(),
])
