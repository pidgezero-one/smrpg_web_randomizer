...
script = EventScript([
	...
	ActionQueueAsync(target=MARIO, subscript=[
		...
		A_ResetProperties(),
		A_Pause(10),
		A_SetSpriteSequence(index=23, sprite_offset=2, is_mold=True, is_sequence=True, looping=True, mirror_sprite=True, identifier="EVENT_3717_fan_lean_back_1"),
		A_Pause(2),
		A_SetSpriteSequence(index=24, sprite_offset=2, is_mold=True, is_sequence=True, looping=True, mirror_sprite=True, identifier="EVENT_3717_fan_lean_back_full"),
		A_Pause(4),
		A_SetSpriteSequence(index=23, sprite_offset=2, is_mold=True, is_sequence=True, looping=True, mirror_sprite=True, identifier="EVENT_3717_fan_lean_back_2"),
		A_Pause(2),
		A_ResetProperties(),
		A_Pause(2),
		A_SetSpriteSequence(index=22, sprite_offset=2, is_mold=True, is_sequence=True, looping=True, mirror_sprite=True, identifier="EVENT_3717_fan_lean_forward_1"),
		A_Pause(2),
	...
	], identifier="EVENT_3717_action_queue_6"),
	Pause(10),
