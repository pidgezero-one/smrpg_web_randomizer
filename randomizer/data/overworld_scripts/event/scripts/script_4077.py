...
script = EventScript([
	...
	# default 'a' article
	JmpIfBitClear(SHIP_PACKET_AUTOTERM_DIALOG, ["e4077_a_await"]),
	RunDialog(dialog_id=DI0525_GOT_A_70A7_AUTO_TERMINATE, above_object=MARIO, closable=False, sync=True, multiline=False, use_background=False, bit_6=True),
	AddToInventory(ITEM_ID),
	Return(),
	RunDialog(dialog_id=DI0524_GOT_A_70A7_AWAIT_TERMINATE, above_object=MARIO, closable=True, sync=False, multiline=False, use_background=False, identifier="e4077_a_await"),
	AddToInventory(ITEM_ID),
	Return(),
	# 'an' vowel article
	JmpIfBitClear(SHIP_PACKET_AUTOTERM_DIALOG, ["e4077_an_await"], identifier="EVENT_4077L_165_run_dialog_17"),
	RunDialog(dialog_id=DI0064_GOT_AN_70A7_AUTO_TERMINATE, above_object=MARIO, closable=False, sync=True, multiline=False, use_background=False, bit_6=True),
	AddToInventory(ITEM_ID),
	Return(),
	RunDialog(dialog_id=DI0065_GOT_AN_70A7_AWAIT_TERMINATE, above_object=MARIO, closable=True, sync=False, multiline=False, use_background=False, identifier="e4077_an_await"),
	AddToInventory(ITEM_ID),
	Return(),
	# no-article (plural) items
	JmpIfBitClear(SHIP_PACKET_AUTOTERM_DIALOG, ["e4077_no_await"], identifier="EVENT_4077L_165_no_article"),
	RunDialog(dialog_id=DI2014_GOT_70A7_AUTO_TERMINATE, above_object=MARIO, closable=False, sync=True, multiline=False, use_background=False, bit_6=True),
	AddToInventory(ITEM_ID),
	Return(),
	RunDialog(dialog_id=DI2015_GOT_70A7_AWAIT_TERMINATE, above_object=MARIO, closable=True, sync=False, multiline=False, use_background=False, identifier="e4077_no_await"),
	AddToInventory(ITEM_ID),
	Return(),
	# 'the' (key items)
	JmpIfBitClear(SHIP_PACKET_AUTOTERM_DIALOG, ["e4077_the_await"], identifier="EVENT_4077L_165_the_article"),
	RunDialog(dialog_id=DI2017_GOT_THE_70A7_AUTO_TERMINATE, above_object=MARIO, closable=False, sync=True, multiline=False, use_background=False, bit_6=True),
	AddToInventory(ITEM_ID),
	Return(),
	RunDialog(dialog_id=DI2018_GOT_THE_70A7_AWAIT_TERMINATE, above_object=MARIO, closable=True, sync=False, multiline=False, use_background=False, identifier="e4077_the_await"),
	AddToInventory(ITEM_ID),
	Return(),
	# lambs lure
	JmpIfBitClear(SHIP_PACKET_AUTOTERM_DIALOG, ["e4077_lambs_await"], identifier="EVENT_4077L_165_lambs_lure"),
	RunDialog(dialog_id=DI2006_FOUND_A_LAMBS_LURE_AUTO_TERMINATE, above_object=MARIO, closable=False, sync=True, multiline=False, use_background=False, bit_6=True),
	AddToInventory(ITEM_ID),
	Return(),
	RunDialog(dialog_id=DI2008_GOT_A_LAMBS_LURE_AWAIT_TERMINATE, above_object=MARIO, closable=True, sync=False, multiline=False, use_background=False, identifier="e4077_lambs_await"),
	AddToInventory(ITEM_ID),
	Return(),
	# btub ring
	JmpIfBitClear(SHIP_PACKET_AUTOTERM_DIALOG, ["e4077_btub_await"], identifier="EVENT_4077L_165_btub_ring"),
	RunDialog(dialog_id=DI2007_FOUND_A_BTUB_RING_AUTO_TERMINATE, above_object=MARIO, closable=False, sync=True, multiline=False, use_background=False, bit_6=True),
	AddToInventory(ITEM_ID),
	Return(),
	RunDialog(dialog_id=DI2009_GOT_A_BTUB_RING_AWAIT_TERMINATE, above_object=MARIO, closable=True, sync=False, multiline=False, use_background=False, identifier="e4077_btub_await"),
	AddToInventory(ITEM_ID),
	Return(),
	# yoshi ade (sound already fired up top)
	JmpIfBitClear(SHIP_PACKET_AUTOTERM_DIALOG, ["e4077_yoshi_await"], identifier="EVENT_4077L_165_yoshi_ade"),
	RunDialog(dialog_id=DI2013_GOT_A_YOSHI_ADE_AUTO_TERMINATE, above_object=MARIO, closable=False, sync=True, multiline=False, use_background=False),
	AddToInventory(ITEM_ID),
	Return(),
	RunDialog(dialog_id=DI2012_GOT_A_YOSHI_ADE_AWAIT_TERMINATE, above_object=MARIO, closable=True, sync=False, multiline=False, use_background=False, identifier="e4077_yoshi_await"),
	AddToInventory(ITEM_ID),
	Return(),
])