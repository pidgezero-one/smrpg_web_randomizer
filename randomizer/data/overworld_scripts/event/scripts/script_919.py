...
script = EventScript([
	...
	CreatePacketAt7010(packet=P098_GRAY_SPELL_CHEST, destinations=["spell_19_character"], identifier="spell_19_elemental_packet"),
	LearnSpell(BOWSER, PoisonGasSpell, identifier="spell_19_character"),
