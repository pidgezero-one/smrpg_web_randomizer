...
script = EventScript([
    ...
    Return(),
    SetVarToConst(X_COORD_1, 8, identifier="summon_flower_floor_2"),
    SetVarToConst(Y_COORD_1, 0),
    SetVarToConst(Z_COORD_1, 5),
	PlaySoundBalance(sound=SO014_FLOWER, balance=40),
    ...
    Return(),
    SetVarToConst(X_COORD_1, 8, identifier="summon_flower_floor_4"),
    SetVarToConst(Y_COORD_1, 0),
    SetVarToConst(Z_COORD_1, 5),
	PlaySoundBalance(sound=SO014_FLOWER, balance=40),
    ...
    Return(),
    SetVarToConst(X_COORD_1, 8, identifier="summon_flower_floor_6"),
    SetVarToConst(Y_COORD_1, 0),
    SetVarToConst(Z_COORD_1, 5),
	PlaySoundBalance(sound=SO014_FLOWER, balance=40),
    ...
    Return(),
    SetVarToConst(X_COORD_1, 8, identifier="summon_flower_floor_8"),
    SetVarToConst(Y_COORD_1, 0),
    SetVarToConst(Z_COORD_1, 5),
	PlaySoundBalance(sound=SO014_FLOWER, balance=40),
    ...
    Return(),
    SetVarToConst(X_COORD_1, 8, identifier="summon_flower_floor_10"),
    SetVarToConst(Y_COORD_1, 0),
    SetVarToConst(Z_COORD_1, 5),
	PlaySoundBalance(sound=SO014_FLOWER, balance=40),
    ...
    Return(),
    SetVarToConst(X_COORD_1, 8, identifier="summon_flower_floor_12"),
    SetVarToConst(Y_COORD_1, 0),
    SetVarToConst(Z_COORD_1, 5),
	PlaySoundBalance(sound=SO014_FLOWER, balance=40),
    ...
    Return(),
    SetVarToConst(X_COORD_1, 8, identifier="summon_flower_floor_14"),
    SetVarToConst(Y_COORD_1, 0),
    SetVarToConst(Z_COORD_1, 5),
	PlaySoundBalance(sound=SO014_FLOWER, balance=40),
    ...
    Return(),
    SetVarToConst(X_COORD_1, 8, identifier="summon_flower_floor_16"),
    SetVarToConst(Y_COORD_1, 0),
    SetVarToConst(Z_COORD_1, 5),
	PlaySoundBalance(sound=SO014_FLOWER, balance=40),
