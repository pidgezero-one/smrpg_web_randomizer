...
script = EventScript([
	...
	JmpIfComparisonResultIsLesser(["EVENT_512_fade_out_music_to_volume_5"]),
	JmpToEvent(E0261_FADE_MUSIC_ROOM_LOADER),
	FadeOutMusicToVolume(duration=1, volume=96, identifier="EVENT_512_fade_out_music_to_volume_5"),
