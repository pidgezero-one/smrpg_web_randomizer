...
script = EventScript([
	...
	JmpIfDialogOptionBOrCSelected(['EVENT_602_run_dialog_10', "mm_inkeeper_exit"]),
	CloseDialog(),
    ...
    CloseDialog(identifier="mm_inkeeper_exit"),
	Return(),
	RunDialog(dialog_id=DI0974_ENJOY_YOUR_STAY, above_object=MEM_70A8, closable=True, sync=False, multiline=True, use_background=True, identifier="EVENT_602_run_dialog_50"),
	Return(),
	RunDialog(dialog_id=DI0970_ENJOY_YOUR_STAY, above_object=MEM_70A8, closable=True, sync=False, multiline=True, use_background=True, identifier="EVENT_602_run_dialog_52"),
	Return(),
