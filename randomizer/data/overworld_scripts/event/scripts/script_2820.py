...
script = EventScript([
	...
	JmpIfVarEqualsConst(ITEM_ID, CymbalsItem, ["EVENT_2820_no_article"]),
	...
	JmpIfVarEqualsConst(ITEM_ID, TempleKeyItem, ["EVENT_2820_the_article"]),
	JmpIfVarEqualsConst(ITEM_ID, RareFrogCoinItem, ["EVENT_2820_the_article"]),
	JmpIfVarEqualsConst(ITEM_ID, WalletItem, ["EVENT_2820_the_article"]),
	JmpIfVarEqualsConst(ITEM_ID, CricketPieItem, ["EVENT_2820_the_article"]),
	JmpIfVarEqualsConst(ITEM_ID, CricketJamItem, ["EVENT_2820_the_article"]),
	JmpIfVarEqualsConst(ITEM_ID, CastleKey1Item, ["EVENT_2820_the_article"]),
	JmpIfVarEqualsConst(ITEM_ID, CastleKey2Item, ["EVENT_2820_the_article"]),
	JmpIfVarEqualsConst(ITEM_ID, BambinoBombItem, ["EVENT_2820_the_article"]),
	JmpIfVarEqualsConst(ITEM_ID, AltoCardItem, ["EVENT_2820_the_article"]),
	JmpIfVarEqualsConst(ITEM_ID, TenorCardItem, ["EVENT_2820_the_article"]),
	JmpIfVarEqualsConst(ITEM_ID, SopranoCardItem, ["EVENT_2820_the_article"]),
	JmpIfVarEqualsConst(ITEM_ID, ExtraShinyStoneItem, ["EVENT_2820_the_article"]),
	JmpIfVarEqualsConst(ITEM_ID, CrystalShardItem, ["EVENT_2820_the_article"]),
	JmpIfVarEqualsConst(ITEM_ID, RoomKeyItem, ["EVENT_2820_the_article"]),
	JmpIfVarEqualsConst(ITEM_ID, ShedKeyItem, ["EVENT_2820_the_article"]),
	JmpIfVarEqualsConst(ITEM_ID, ElderKeyItem, ["EVENT_2820_the_article"]),
	JmpIfVarEqualsConst(ITEM_ID, SeedItem, ["EVENT_2820_the_article"]),
	JmpIfVarEqualsConst(ITEM_ID, FertilizerItem, ["EVENT_2820_the_article"]),
	JmpIfVarEqualsConst(ITEM_ID, DryBonesFlagItem, ["EVENT_2820_the_article"]),
	JmpIfVarEqualsConst(ITEM_ID, GreaperFlagItem, ["EVENT_2820_the_article"]),
	JmpIfVarEqualsConst(ITEM_ID, BigBooFlagItem, ["EVENT_2820_the_article"]),
	JmpIfVarEqualsConst(ITEM_ID, FireworksItem, ["EVENT_2820_the_article"]),
	JmpIfVarEqualsConst(ITEM_ID, ShinyStoneItem, ["EVENT_2820_the_article"]),
	JmpIfVarEqualsConst(ITEM_ID, CarboCookieItem, ["EVENT_2820_the_article"]),
	JmpIfVarEqualsConst(ITEM_ID, BrightCardItem, ["EVENT_2820_the_article"]),
	JmpIfVarEqualsConst(ITEM_ID, ShoesItem, ["EVENT_2820_the_article"]),
	JmpIfVarEqualsConst(ITEM_ID, BroochItem, ["EVENT_2820_the_article"]),
	JmpIfVarEqualsConst(ITEM_ID, RingItem, ["EVENT_2820_the_article"]),
	JmpIfVarEqualsConst(ITEM_ID, CrownItem, ["EVENT_2820_the_article"]),
	JmpIfVarEqualsConst(ITEM_ID, GoldPaintItem, ["EVENT_2820_the_article"]),
	JmpIfVarEqualsConst(ITEM_ID, CookiesItem, ["EVENT_2820_the_article"]),
	JmpIfVarEqualsConst(ITEM_ID, MarioDollItem, ["EVENT_2820_the_article"]),
	...
	JmpIfVarEqualsConst(ITEM_ID, TempleKeyItem, ["river_key_item_sound"], identifier="EVENT_2820_choose_sound"),
	...
	JmpIfVarEqualsConst(ITEM_ID, CricketJamItem, ["river_key_item_sound"]),
