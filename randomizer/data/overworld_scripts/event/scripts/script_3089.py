...
script = EventScript([
	...
	JmpIfVarEqualsConst(ITEM_ID, AmuletItem, ["EVENT_3089_run_dialog_16"]),
	...
	JmpIfVarEqualsConst(ITEM_ID, AbleJuiceItem, ["EVENT_3089_run_dialog_16"]),
	...
	JmpIfVarEqualsConst(ITEM_ID, ElixirItem, ["EVENT_3089_run_dialog_16"]),
