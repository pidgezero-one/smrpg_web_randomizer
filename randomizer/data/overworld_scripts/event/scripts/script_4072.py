...
script = EventScript([
	...
	JmpIfBitClear(SHIP_PACKET_AUTOTERM_DIALOG, ["e4072_await"]),
	...
	Return(),
	RunDialog(dialog_id=DI1993_LEARN_SPELL_24, above_object=MARIO, closable=True, sync=False, multiline=False, use_background=False, identifier="e4072_await"),
	Return()
])