...
script = EventScript([
	JmpIfBitSet(TEMP_7043_1, ["EVENT_1587_run_background_event_3"], identifier="EVENT_1587_jmp_to_event_1"),
	SetBit(TEMP_7043_1),
	...
	JmpToEvent(E0173_CHEST_2_CONTAINER, identifier="EVENT_1587_jmp_to_event_7")
])
