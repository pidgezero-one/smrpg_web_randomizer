...
script = EventScript([
	JmpIfBitSet(TEMP_7044_5, ["EVENT_3597_run_event_as_subroutine_4"]),
	...
	Return(),
	RunEventAsSubroutine(E0456_YOSHI_TALKS_TO_OTHER_YOSHI, identifier="EVENT_3597_run_event_as_subroutine_4"),
