...
dialog_data[360] = ''' Have you tried the Dream Cushion
 at our Inn yet? It seems kinda
 weird to me.[await]'''
dialog_data[361] = ''' If you have both keys to the castle,
...
dialog_data[365] = ''' I heard a rumour about a giant egg
 in the castle.[delay_30] I wonder what's
 going to hatch from it?![await]'''
dialog_data[366] = ''' Looking for special items? I think
...
dialog_data[367] = ''' The statues in the castle look
 shinier than they used to. Maybe
 Garro stocked up on gold paint.[await]'''
dialog_data[368] = ''' You might find something nice if
...
dialog_data[369] = ''' Garro lives in the north part of
...
dialog_data[418] = '''   (Oops[delay][delay]...[delay][delay]I've lost my dentures)[await][pause][end]'''
dialog_data[419] = ''' Now[delay][delay]...[delay][delay]PARTY TIME!![await]'''
dialog_data[420] = ''' Hello.
...
dialog_data[424] = ''' Oh, hello there! Are you visiting?[await]
...
dialog_data[453] = '''BOOSTER: Found something, huh?[await]
 But wait a sec...I've only
 counted [0x7000] thing(s).
 You need to find [0x7024] more![await]'''
dialog_data[454] = '''[await]'''
dialog_data[455] = ''' Have you heard about the Casino?[await]
...
dialog_data[458] = ''' `MAIN_CHARACTER_HONORIFIC_CAP`![await]
...
dialog_data[459] = ''' (I can only store 200 cookies.[await][page]
...
dialog_data[495] = '''[await]'''
dialog_data[496] = '''KNIFE GUY: So which hand is
...
dialog_data[506] = '''SNIFIT 1: Hello there.[await]
...
dialog_data[531] = ''' I heard your record for jumping
 stands at [0x7000] right now.[await]'''
dialog_data[532] = ''' Think you can do `SUPER_JUMP_PRIZE_1_CAP` in a row?[await]'''
dialog_data[533] = ''' Wow, you did it!
 You made over `SUPER_JUMP_PRIZE_1_CAP` jumps.[await][page]
 All right, here's your prize.[await]'''
dialog_data[534] = '''[await]'''
dialog_data[535] = ''' According to my source, it's
...
dialog_data[536] = ''' I've got no more prizes for you.
 Well done![await]'''
dialog_data[537] = '''[await]'''
dialog_data[538] = '''[await]'''
dialog_data[539] = '''[await]'''
dialog_data[540] = ''' Some of my friends are hiding away
...
dialog_data[547] = ''' Are you looking for Toadofsky?[delay_15]
...
dialog_data[549] = ''' Are you looking for Toadofsky?[delay_15]
...
dialog_data[550] = ''' My favorite song?[await]'''
...
dialog_data[598] = '''[await]'''
dialog_data[599] = ''' You're on your way to composing![await]'''
dialog_data[600] = '''
       So La Mi Re Do Re Do Re [await]'''
dialog_data[601] = '''TOADOFSKY: You want a music
 lesson from MOI?[await]
  [select] (Yes)
  [select] (Nope)[await]'''
dialog_data[602] = ''' Let's start by reading “notes”.
...
dialog_data[603] = ''' Well, be that way![await]'''
dialog_data[604] = '''[await]'''
dialog_data[605] = '''[await]'''
dialog_data[606] = '''[await]'''
dialog_data[607] = ''' It's not what I'm looking for.
 It won't do at all.[await]'''
dialog_data[608] = ''' No, that's not the right melody.[await]'''
dialog_data[609] = ''' That sort of resembles the melody
 I'm thinking of.[await]'''
dialog_data[610] = ''' That's remarkably similar to what
 I have in mind.[await]'''
dialog_data[611] = ''' Now that is amazingly close to my
 dream composition![await]'''
dialog_data[612] = '''FROGFUCIUS: Are you stuck?[await]
[end]'''
dialog_data[613] = ''' An item awaits you in your home.[await]'''
dialog_data[614] = ''' Unfinished business awaits you
 in Bandit's Way.[await]'''
dialog_data[615] = ''' Have you visited the Mushroom
 Kingdom lately?[await]'''
dialog_data[616] = ''' Have you traversed through the
 secret tunnel in Land's End?[await]'''
dialog_data[617] = ''' My contemporary, Toadofsky,
 awaits a visit from you.[await]'''
dialog_data[618] = ''' Treasure awaits you in Rose Town.[await]'''
dialog_data[619] = ''' It may prove worth your while to
 visit Yo'ster Isle.[await]'''
dialog_data[620] = ''' There seems to be some unclaimed
 treasure in the town of Moleville.[await]'''
dialog_data[621] = ''' When was the last time you
 ventured into the Mines?[await]'''
dialog_data[622] = ''' Have you visited the tall tower
 to the west yet?[await]'''
dialog_data[623] = ''' Something awaits you in Seaside
 Town.[await]'''
dialog_data[624] = ''' The ever-friendly Monstro Town
 may have something for you
 to find.[await]'''
dialog_data[625] = ''' Bean Valley may have some tasks
 for you to take care of.[await]'''
dialog_data[626] = ''' It may help to pay a visit to
 the Nimbus Land town square.[await]'''
dialog_data[627] = ''' There may be some secrets left
 to uncover in Nimbus Castle.[await]'''
dialog_data[628] = ''' There may be something of interest
 to you in Mushroom Way.[await]'''
dialog_data[629] = ''' You are likely to find more treasure
 in the Sunken Ship.[await]'''
dialog_data[630] = ''' You may find something new if you
 venture into the Kero Sewers.[await]'''
dialog_data[631] = ''' The Forest Maze has much to
 discover.[await]'''
dialog_data[632] = ''' It may be worthwhile to pay a
 visit to Marrymore.[await]'''
dialog_data[633] = ''' Land's End may have something of
 interest to you.[await]'''
dialog_data[634] = ''' Belome Temple may have something
 for you to investigate.[await]'''
dialog_data[635] = ''' It would be wise to pay a visit
 to Booster Hill.[await]'''
dialog_data[636] = ''' Something awaits you in Barrel
 Volcano.[await]'''
dialog_data[637] = ''' You may find something to do in
 Bowser's Keep.[await]'''
dialog_data[638] = ''' There is still work to be done in
 the Factory.[await]'''
dialog_data[639] = ''' Try your luck in Grate Guy's
 Casino.[await]'''
dialog_data[640] = ''' Try double-checking whatever
 you can. I may have more advice
 for you later.[await]'''
dialog_data[641] = '''FROGFUCIUS: Eh!?[await]
 That delicious smell!
 You have some Cricket Jam, yes?[await][page]
 Oh, but I have no pie to eat it
 with...[await]'''
dialog_data[642] = ''' You may find something new in
 Midas River.[await]'''
dialog_data[643] = ''' Rose Way may be small, but it may
 have something new for you to
 find.[await]'''
dialog_data[644] = ''' Treasure awaits you in the Pipe
 Vault.[await]'''
dialog_data[645] = ''' Unclaimed items remain in
 Booster Pass.[await]'''
dialog_data[646] = ''' Check at the top of Star Hill.
 It is worth checking to see if a
 star piece is there or not.[await]'''
dialog_data[647] = ''' Perhaps take some time to rest
 in Marrymore, and something may
 come to you.[await]'''
dialog_data[648] = ''' An amphibian salesman in Seaside
 Town may be seeking your business.[await]'''
dialog_data[649] = ''' There are some unopened chests
 remaining in the Sea.[await]'''
dialog_data[650] = ''' The beanstalks may bring you some
 new fortune.[await]'''
dialog_data[651] = ''' I haven't heard much news about
 new treasures lately.[await][pause] Say... Have
 you been practicing Super Jumps?[await]'''
dialog_data[652] = ''' I recommend exploring the obstacle
...
dialog_data[677] = '''         Need the key to get in[await]'''
dialog_data[678] = '''
...
dialog_data[686] = '''               It's locked[await]'''
dialog_data[687] = '''      Tried saying the password:[delay]
              [filename][await]'''
dialog_data[688] = '''                  No luck...[delay]
...
dialog_data[696] = '''      Take a look at Booster's
   family portraits in order from
     the oldest to the youngest.[await]'''
dialog_data[697] = '''  Remember to respect your elders.[await]'''
...
dialog_data[705] = '''YARIDOVICH: Finally![await]
 It took you long enough to get
 here![await]'''
dialog_data[706] = ''' This is...the inn.
 You may stay...for free.[await]
  [select] (Thanks)
  [select] (I'll pass)[await]'''
dialog_data[707] = '''[await]'''
dialog_data[708] = ''' The workers...in the left
...
dialog_data[712] = ''' You will find Yaridovich...
 in his house. He is...the most
 respected person here.[await]'''
dialog_data[713] = ''' It would be wise... to avoid
 the shed. It's...a scary place.[await]'''
dialog_data[714] = '''[await]'''
dialog_data[715] = ''' In the middle...of the ocean is a
 pirate...ship.[await]
 You'll find a...I mean, there's a...[await]'''
dialog_data[716] = ''' A treasure chest...behind some...
 boxes. It's very easy...to miss it.[await]'''
dialog_data[717] = ''' If you...survive...the pirate
 ship...we will...we will...[await]'''
dialog_data[718] = ''' We will...make it...worth your
 while.[await]'''
dialog_data[719] = ''' I'm...just a...customer.[await]'''
dialog_data[720] = '''[await]'''
dialog_data[721] = ''' You...may not enter here.
 This is...a restricted area.[await]'''
dialog_data[722] = ''' There is nothing of interest here.
 Don't...bother looking inside.[await]'''
dialog_data[723] = '''                   Hey![await]
...
dialog_data[740] = '''               It's locked[await]'''
...
dialog_data[760] = '''DR. TOPPER: Give up?[await]
...
dialog_data[772] = ''' I don't think I'm going to find any
...
dialog_data[775] = ''' Check back with me after you kill
 some time by... I don't know,
 exploring a volcano, or something.[await]'''
dialog_data[776] = '''[await]'''
dialog_data[777] = ''' I'm all out of inventory, and won't
 be selling any more.[await][pause] Thanks for
 your business![await]'''
dialog_data[778] = ''' Item #2: A “Mystery Egg”.
 I have no idea what it does!
 It sort of grows on ya, huh?[await]
 It's yours for 200 coins.
  [select] (Okay)
  [select] (No thanks)[await]'''
dialog_data[779] = ''' That's all I've got for now.[await]'''
dialog_data[780] = ''' You need more coins![await]
 I gotta eat, you know![await]'''
dialog_data[781] = ''' Item #1: A “Lucky Jewel”!
 It's sure to bring you plenty of
 good luck.[await]
 I'll sell it to you for 100 coins.
  [select] (It's a deal)
  [select] (I'll pass)[await]'''
dialog_data[782] = ''' Nice doing business with you.
 Here you go![await]'''
dialog_data[783] = ''' Oops, I didn't realize I was out
 of inventory.[await]'''
dialog_data[784] = ''' Item #3: A “Metal Plate”.[await]
 Don't know what it's used for,
 but I'll sell it for 300 coins.
  [select] (I'll take it)
  [select] (No thanks)[await]'''
dialog_data[785] = ''' Check back with me after you kill
 some time by... I don't know,
 liberating a beach, or something.[await]'''
dialog_data[786] = ''' Please rest up before you go.
 It'll only cost you 15 coins.[await]
  [select] (Okay)
  [select] (No)[await]'''
dialog_data[787] = ''' Okay, some other time then.
 Have a safe trip.[await]'''
dialog_data[788] = ''' You don't have enough coins?[await][page]
...
dialog_data[793] = '''ELDER: Hello, `MAIN_CHARACTER_NAME`![await][pause]
...
dialog_data[798] = ''' Hey, hey, HEY!![await]
...
dialog_data[799] = ''' You have any mushrooms?
  [select] (Yes)
  [select] (Nope)[await]'''
dialog_data[800] = ''' Hey, far out!
...
dialog_data[807] = '''      Received a “Maple Syrup”[await]'''
dialog_data[808] = '''      Received a “Rock Candy”[await]'''
dialog_data[809] = '''       Received a “Flower Tab”[await]'''
...
dialog_data[826] = ''' Don't you dig these vibes?[await]'''
...
dialog_data[836] = ''' There's no hidden chests in this
...
dialog_data[902] = '''JAGGER: Now this should be
