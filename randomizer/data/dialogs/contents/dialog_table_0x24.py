...
dialog_data[19] = '''GARDENER: Oops, maybe not, huh?[await]'''
dialog_data[20] = '''GARDENER: This will get me in
...
dialog_data[48] = '''GARDENER: Well, that's my story.[await]
 Say...will you give me the “Seed”?
  [select]  (Sure)
  [select]  (Nope)[await]'''
dialog_data[49] = '''GARDENER: Yes, you might say I
 have fertilizer on the brain.[await]
 Will you give it to me?
  [select]  (Sure)
  [select]  (Sorry)[await]'''
dialog_data[50] = '''GARDENER: You changed your mind?[await]
  [select]  (Yes)
  [select]  (No)[await]'''
dialog_data[51] = '''GARDENER: Well, `MAIN_CHARACTER_NAME`?[await]
 Will you give me the fertilizer?
  [select]  (Yes)
  [select]  (No)[await]'''
dialog_data[52] = '''GARDENER: I finally have it![await][page]
 This is extraordinary![await]'''
dialog_data[53] = ''' May I have the fertilizer?
  [select]  (Yes)
  [select]  (No)[await]'''
...
dialog_data[78] = '''DEALER: 
 ...
 Play a round with me, `MAIN_CHARACTER_HONORIFIC`?
  [select] (Yes)
  [select] (No)[await]'''
dialog_data[79] = ''' Another game, `MAIN_CHARACTER_HONORIFIC`?
  [select] (Sure)
  [select] (No)[await]'''
dialog_data[80] = '''DEALER: If you would like to play,
...
dialog_data[87] = ''' Wanna try it again?
  [select] (Yes)
  [select] (No)[await]'''
dialog_data[88] = ''' Welcome to the Grate Guy Casino![await]
...
dialog_data[112] = ''' A couple of the chests in the
 castle have been refilled. Have you
 found them all?[await]'''
dialog_data[113] = ''' There might be some new things you
...
dialog_data[139] = ''' Have you found any rare Frog
 ...
 item.[await]'''
dialog_data[140] = ''' The world around us is always
