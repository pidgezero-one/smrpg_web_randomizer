...
script = [
    ...
    },
    {
        ...
        "subscript": [
            ...
            {
                "identifier": 'EVENT_1138_action_queue_async_1_SUBSCRIPT_bounce_to_xy_with_height_4',
    ...
    {
        "identifier": 'EVENT_1138_action_queue_async_2',
        "command": 'action_queue_async',
        "args": [AreaObjects.NPC_1],
        "subscript": [
            {
                "identifier": 'EVENT_1138_action_queue_async_2_SUBSCRIPT_pause_0',
                "command": 'pause',
                "args": [20]
            },
            {
    ...
    {
        "identifier": 'EVENT_1138_action_queue_async_3',
        "command": 'action_queue_async',
        "args": [AreaObjects.NPC_0],
        "subscript": [
            {
                "identifier": 'EVENT_1138_action_queue_async_3_SUBSCRIPT_set_animation_speed_0',
                "command": 'set_animation_speed',
                "args": [SequenceSpeeds.VERY_FAST, [_0x10Flags.WALKING, _0x10Flags.SEQUENCE]]
            },
            {
                "identifier": 'EVENT_1138_action_queue_async_3_SUBSCRIPT_bounce_to_xy_with_height_1',
                "command": 'bounce_to_xy_with_height',
                "args": [13, 69, 0]
            },
            {
