...
script = [
    {
        "identifier": 'EVENT_1885_set_7000_to_70A0_short_mem_0',
        "command": 'set_7000_to_70A0_short_mem',
        "args": [0x70a8]
    },
    {
        "identifier": 'EVENT_1885_set_70A0_short_mem_to_7000_1',
    ...
    },
    {
        ...
        "subscript": [
            {
                "identifier": 'EVENT_1885_action_queue_sync_10_SUBSCRIPT_pause_0',
                "command": 'pause',
                "args": [90]
            },
            {
                "identifier": 'EVENT_1885_action_queue_sync_10_SUBSCRIPT_summon_to_level_1',
                "command": 'summon_to_level',
                "args": [AreaObjects.NPC_2, Rooms._403_LANDS_END_DESERT_AREA_05]
            },
            {
                "identifier": 'EVENT_1885_action_queue_sync_10_SUBSCRIPT_object_memory_clear_bit_2',
