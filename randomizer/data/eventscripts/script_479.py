...
script = [
    ...
    {
        "identifier": 'EVENT_479_start_embedded_action_script_async_F1_6',
        "command": 'start_embedded_action_script_async_F1',
        "args": [AreaObjects.NPC_9],
        "subscript": [
            {
                "identifier": 'EVENT_479_start_embedded_action_script_async_F1_6_SUBSCRIPT_set_animation_speed_0',
                "command": 'set_animation_speed',
                "args": [SequenceSpeeds.SLOW, [_0x10Flags.SEQUENCE]]
            },
            {
                "identifier": 'EVENT_479_start_embedded_action_script_async_F1_6_SUBSCRIPT_set_object_memory_bits_1',
                "command": 'set_object_memory_bits',
                "args": [0x0e, []]
            },
            {
                "identifier": 'EVENT_479_start_embedded_action_script_async_F1_6_SUBSCRIPT_set_solidity_bits_2',
