...
script = [
    ...
    },
    {
        ...
        "command": 'jmp_if_7000_equals_short',
        "args": [1, 'EVENT_1111_remove_one_from_inventory_15__']
    },
    {
        "identifier": 'EVENT_1111_run_dialog_6',
        "command": 'run_dialog',
        "args": [39, AreaObjects.MEM_70A8, [_0x60Flags.CLOSABLE, _0x60Flags.ASYNC, _0x60Flags.MULTILINE, _0x60Flags.USE_BACKGROUND]]
    },
    {
