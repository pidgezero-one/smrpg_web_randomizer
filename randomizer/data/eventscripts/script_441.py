...
script = [
    ...
    },
    {
        ...
        "subscript": [
            ...
            {
                "identifier": 'EVENT_441_action_queue_sync_4_SUBSCRIPT_set_animation_speed_5',
                "command": 'set_animation_speed',
                "args": [SequenceSpeeds.NORMAL, [_0x10Flags.WALKING]]
            },
            {
                "identifier": 'EVENT_441_action_queue_sync_4_SUBSCRIPT_shift_f_direction_pixels_6',
    ...
    },
    {
        ...
        "subscript": [
            ...
            {
                "identifier": 'EVENT_441_action_queue_sync_6_SUBSCRIPT_set_animation_speed_5',
                "command": 'set_animation_speed',
                "args": [SequenceSpeeds.NORMAL, [_0x10Flags.WALKING]]
            },
            {
                "identifier": 'EVENT_441_action_queue_sync_6_SUBSCRIPT_shift_f_direction_pixels_6',
                "command": 'shift_f_direction_pixels',
                "args": [12]
            },
            {
    ...
    },
    {
        ...
        "subscript": [
            ...
            {
                "identifier": 'EVENT_441_action_queue_sync_10_SUBSCRIPT_jump_to_height_silent_1',
                "command": 'jump_to_height_silent',
                "args": [108]
            },
            {
                "identifier": 'EVENT_441_action_queue_sync_10_SUBSCRIPT_pause_2',
                "command": 'pause',
                "args": [15]
            },
            {
