...
script = [
    {
        "identifier": 'EVENT_2099_jmp_if_bit_set_0',
        "command": 'jmp_if_bit_set',
        "args": [0x7043, 3, 'EVENT_2099_ret_6'],
        "subscript": []
    },
    {
        "identifier": 'EVENT_2099_jmp_if_bit_set_1',
        "command": 'jmp_if_bit_set',
        "args": [0x7043, 2, 'EVENT_2099_set_action_script_sync_4'],
        "subscript": []
    },
    {
