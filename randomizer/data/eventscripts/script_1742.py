...
script = [
    ...
    {"identifier": "EVENT_1742_ret_15", "command": "ret"},
    {
        "identifier": "EVENT_1742_resume_background_event_16",
        "command": "resume_background_event",
        "args": [0x701C],
    },
    {"identifier": "EVENT_1742_ret_17", "command": "ret"},
    {
    ...
    },
    {
        ...
        "args": [0x7024, 0x700C]
            ...
            },
            {
                ...
                "args": [
                    "EVENT_1742_action_queue_async_21_SUBSCRIPT_set_700C_to_7000_short_mem_6"
                ],
            },
            {
        ...
        "args": [0x7028, 0x700C]
            },
            {
                ...
                "command": "jmp",
                "args": [
                    "EVENT_1742_action_queue_async_21_SUBSCRIPT_set_animation_speed_15"
                ],
            },
            {
            ...
            },
            {
                ...
                "command": "jmp",
                "args": [
                    "EVENT_1742_action_queue_async_21_SUBSCRIPT_set_solidity_bits_23"
                ],
            },
            {
    ...
    {"identifier": "EVENT_1742_ret_27", "command": "ret"},
]
