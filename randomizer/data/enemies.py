...
class Clerk(Enemy):
    ...
    dialog_replacements = [
        ...
        (3057, ''' Are you here for a fight?[await]\n  [select] (Yes)\n  [select] (Uh...)[await]'''),
...
class Gunyolk(Enemy):
    ...
    dialog_replacements = [
        ...
        (3057, ''' Did you come here to fight me?[await]\n  [select] (Yes)\n  [select] (Uh...)[await]'''),
...
class Boomer(Enemy):
    ...
    dialog_replacements = [
        ...
        (3057, ''' Gahahaha! Is it a fight you seek?[await]\n  [select] (Yes)\n  [select] (Uh...)[await]'''),
...
class Hidon(Enemy):
    ...
    dialog_replacements = [
        ...
        (3057, ''' Ugh... What'd you wake me up for?[await]\n  [select] (I want to fight)\n  [select] (Uh...)[await]'''),
...
class Director(Enemy):
    ...
    dialog_replacements = [
        ...
        (3057, ''' State your business.[await]\n  [select] (Fight me)\n  [select] (Uh...)[await]'''),
...
class BoxBoy(Enemy):
    ...
    dialog_replacements = [
        ...
        (3057, ''' This'd BETTER be important![await]\n  [select] (I want to fight)\n  [select] (Uh...)[await]'''),
        (3338, ''' It's really weird.\n Sometimes I hear the guy next door.[await][page]\n He's always mumbling about\n Treasure-this and Ghost-that.[await]'''),
...
class Chester(Enemy):
    ...
    dialog_replacements = [
        ...
        (3057, ''' You're interrupting my sleep.[await]\n  [select] (I want to fight)\n  [select] (Uh...)[await]'''),
...
class Jagger(Enemy):
    ...
    dialog_replacements = [
        ...
        (3057, ''' Hello. May I help you?[await]\n  [select] (Let's fight)\n  [select] (Uh...)[await]'''),
...
class GrateGuy(Enemy):
    ...
    dialog_replacements = [
        ...
        (3057, ''' Welcome! What brings you here?[await]\n  [select] (I want to fight)\n  [select] (Uh...)[await]'''),
...
class Jinx1(Enemy):
    ...
    dialog_replacements = [
        ...
        (3057, ''' You have come to challenge me?[await]\n  [select] (Yes)\n  [select] (Uh...)[await]'''),
...
class CountDown(Enemy):
    ...
    dialog_replacements = [
        ...
        (3057, ''' Uh-oh! Are you looking for trouble?[await]\n  [select] (Yes)\n  [select] (Uh...)[await]'''),
...
class Megasmilax(Enemy):
    ...
    dialog_replacements = [
        ...
        (3057, ''' You don't look like the gardener...[await]\n  [select] (I'm here to fight you)\n  [select] (Oops, my mistake)[await]'''),
...
class Punchinello(Enemy):
    ...
    dialog_replacements = [
        ...
        (3057, ''' Hello. Are you with the press?[await]\n  [select] (I'm here to fight you)\n  [select] (Sorry, wrong number)[await]'''),
...
class Cloaker(Enemy):
    ...
    dialog_replacements = [
        ...
        (3057, ''' Hee hee hee... Wanna fight?[await]\n  [select] (Yes)\n  [select] (Uh...)[await]'''),
...
class Mack(Enemy):
    ...
    dialog_replacements = [
        ...
        (3057, ''' You come to crash my party?[await]\n  [select] (Yes)\n  [select] (Uh...)[await]'''),
...
class Yaridovich(Enemy):
    ...
    dialog_replacements = [
        ...
        (3057, ''' Eee hee...! You want to fight?[await]\n  [select] (Yes)\n  [select] (Uh...)[await]'''),
...
class Bowyer(Enemy):
    ...
    dialog_replacements = [
        ...
        (3057, ''' Fight me, you will, nya?[await]\n  [select] (Yes)\n  [select] (Uh...)[await]'''),
...
class Exor(Enemy):
    ...
    dialog_replacements = [
        ...
        (3057, ''' Halt! What do you want?[await]\n  [select] (Fight me)\n  [select] (Uh...)[await]'''),
...
class Smithy1(Enemy):
    ...
    dialog_replacements = [
        ...
        (3057, ''' Grr... What do you want?[await]\n  [select] (Fight me!)\n  [select] (Uh...)[await]'''),
...
class AxemRangers(Enemy):
    ...
    dialog_replacements = [
        ...
        (3057, ''' Yo! What do you want?![await]\n  [select] (A fight)\n  [select] (Uh...)[await]'''),
...
class Booster(Enemy):
    ...
    dialog_replacements = [
        ...
        (3057, ''' Eh? What'd you come here for?[await]\n  [select] (I want a fight)\n  [select] (Uh...)[await]'''),
...
class Johnny(Enemy):
    ...
    dialog_replacements = [
        ...
        (3057, ''' Arr, what brings ye here?[await]\n  [select] (I want a fight)\n  [select] (Uh...)[await]'''),
