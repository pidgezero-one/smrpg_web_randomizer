...
:mod:`randomizer.patches.asm.dialog_font_item_punctuation`, which paints both.
...
here, the glyphs in :mod:`randomizer.patches.asm.dialog_font_item_punctuation`, and
