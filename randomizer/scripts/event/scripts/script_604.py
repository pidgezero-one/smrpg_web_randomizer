...
script = EventScript([
	...
	AddCoins(100),
	RemoveOneOfItemFromInventory(BrightCard, identifier="EVENT_604_remove_one_from_inventory_11"),
	...
	Return(),
	SetAsyncActionScript(MARIO, A0671_SHAKE_HEAD_NO, identifier="EVENT_604_set_action_script_async_17"),
	Pause(10),
	...
	SetAsyncActionScript(MARIO, A0671_SHAKE_HEAD_NO, identifier="EVENT_604_set_action_script_async_26"),
	Pause(10),
	...
	AddFrogCoins(10),
	Jmp(["EVENT_604_remove_one_from_inventory_11"]),
	SetAsyncActionScript(MARIO, A0671_SHAKE_HEAD_NO, identifier="EVENT_604_set_action_script_async_35"),
	Pause(10),
