...
script = EventScript([
	...
	CopyVarToVar(from_var=UNKNOWN_70B0, to_var=PRIMARY_TEMP_7000, identifier="EVENT_1636_set_7000_to_70A0_short_mem_17"),
	RunDialogForDuration(dialog_id=DI1211_SWAP_SHOP_POINTS, duration=0, sync=False),
	JmpToSubroutine(["EVENT_1636_store_empty_inventory_slot_count_7000_193"]),
	...
	JmpToSubroutine(["EVENT_1636_store_empty_inventory_slot_count_7000_193"]),
	JmpIfBitClear(TEMP_7043_2, ["EVENT_1636_run_dialog_12"]),
	JmpIfBitSet(TEMP_7042_4, ["EVENT_1636_set_29"]),
	...
	SetVarToConst(ITEM_ID, Mushroom, identifier="EVENT_1636_set_29"),
	...
	JmpIf7000AnyBitsSet(destinations=["EVENT_1636_set_bit_70"]),
	JmpIf7000AnyBitsSet(destinations=["EVENT_1636_play_sound_45"]),
	JmpIf7000AnyBitsSet(destinations=["EVENT_1636_dec_48"]),
	JmpIf7000AnyBitsSet(destinations=["EVENT_1636_inc_59"]),
	Pause(1),
	...
	JmpIfVarNotEqualsConst(ITEM_ID, YoshiCookie, ["EVENT_1636_store_7000_item_quantity_to_70A7_55"]),
	Dec(ITEM_ID),
	...
	Mem7000OrConst(0x0060),
	CopyVarToVar(from_var=PRIMARY_TEMP_7000, to_var=ITEM_ID),
	JmpIfVarNotEqualsConst(ITEM_ID, YoshiCookie, ["EVENT_1636_store_7000_item_quantity_to_70A7_66"]),
	Inc(ITEM_ID),
	...
	PlaySound(sound=SO087_CORRECT_SIGNAL, channel=6),
	CopyVarToVar(from_var=TEMP_7026, to_var=PRIMARY_TEMP_7000, identifier="EVENT_1636_set_7000_to_7000_short_mem_81"),
	...
	JmpIf7000AnyBitsSet(destinations=["EVENT_1636_set_bit_109"]),
	JmpIf7000AnyBitsSet(destinations=["EVENT_1636_play_sound_90"]),
	JmpIf7000AnyBitsSet(destinations=["EVENT_1636_set_7000_to_7000_short_mem_93"]),
	JmpIf7000AnyBitsSet(destinations=["EVENT_1636_jmp_if_var_not_equals_const_102"]),
	Pause(1),
	...
	CloseDialog(),
	Jmp(["EVENT_1636_run_dialog_21"]),
	CopyVarToVar(from_var=TEMP_7026, to_var=PRIMARY_TEMP_7000, identifier="EVENT_1636_set_7000_to_7000_short_mem_93"),
	Compare7000ToVar(TEMP_7028),
	JmpIfLoadedMemoryIsNot0(["EVENT_1636_inc_short_99"]),
	PlaySound(sound=SO088_WRONG_SIGNAL, channel=6),
	Pause(10),
	Jmp(["EVENT_1636_set_7000_to_tapped_button_83"]),
	Inc(TEMP_7026, identifier="EVENT_1636_inc_short_99"),
	PlaySound(sound=SO003_MENU_SCROLL, channel=6),
	Jmp(["EVENT_1636_set_7000_to_7000_short_mem_81"]),
	JmpIfVarNotEqualsConst(TEMP_7026, 1, ["EVENT_1636_dec_short_106"], identifier="EVENT_1636_jmp_if_var_not_equals_const_102"),
	PlaySound(sound=SO088_WRONG_SIGNAL, channel=6),
	Pause(10),
	Jmp(["EVENT_1636_set_7000_to_tapped_button_83"]),
	Dec(TEMP_7026, identifier="EVENT_1636_dec_short_106"),
	PlaySound(sound=SO003_MENU_SCROLL, channel=6),
	Jmp(["EVENT_1636_set_7000_to_7000_short_mem_81"]),
	...
	CopyVarToVar(from_var=ITEM_ID, to_var=PRIMARY_TEMP_7000),
	JmpIfVarNotEqualsConst(PRIMARY_TEMP_7000, 96, ["EVENT_1636_jmp_if_7000_not_equals_short_118"]),
	SetVarToConst(X_COORD_1, 2),
	Jmp(["EVENT_1636_set_7000_to_70A0_short_mem_166"]),
	JmpIfVarNotEqualsConst(PRIMARY_TEMP_7000, 97, ["EVENT_1636_jmp_if_7000_not_equals_short_121"], identifier="EVENT_1636_jmp_if_7000_not_equals_short_118"),
	SetVarToConst(X_COORD_1, 10),
	Jmp(["EVENT_1636_set_7000_to_70A0_short_mem_166"]),
	JmpIfVarNotEqualsConst(PRIMARY_TEMP_7000, 98, ["EVENT_1636_jmp_if_7000_not_equals_short_124"], identifier="EVENT_1636_jmp_if_7000_not_equals_short_121"),
	SetVarToConst(X_COORD_1, 30),
	Jmp(["EVENT_1636_set_7000_to_70A0_short_mem_166"]),
	JmpIfVarNotEqualsConst(PRIMARY_TEMP_7000, 99, ["EVENT_1636_jmp_if_7000_not_equals_short_127"], identifier="EVENT_1636_jmp_if_7000_not_equals_short_124"),
	SetVarToConst(X_COORD_1, 4),
	Jmp(["EVENT_1636_set_7000_to_70A0_short_mem_166"]),
	JmpIfVarNotEqualsConst(PRIMARY_TEMP_7000, 100, ["EVENT_1636_jmp_if_7000_not_equals_short_130"], identifier="EVENT_1636_jmp_if_7000_not_equals_short_127"),
	SetVarToConst(X_COORD_1, 12),
	Jmp(["EVENT_1636_set_7000_to_70A0_short_mem_166"]),
	JmpIfVarNotEqualsConst(PRIMARY_TEMP_7000, 101, ["EVENT_1636_jmp_if_7000_not_equals_short_133"], identifier="EVENT_1636_jmp_if_7000_not_equals_short_130"),
	SetVarToConst(X_COORD_1, 30),
	Jmp(["EVENT_1636_set_7000_to_70A0_short_mem_166"]),
	JmpIfVarNotEqualsConst(PRIMARY_TEMP_7000, 102, ["EVENT_1636_jmp_if_7000_not_equals_short_136"], identifier="EVENT_1636_jmp_if_7000_not_equals_short_133"),
	SetVarToConst(X_COORD_1, 2),
	Jmp(["EVENT_1636_set_7000_to_70A0_short_mem_166"]),
	JmpIfVarNotEqualsConst(PRIMARY_TEMP_7000, 103, ["EVENT_1636_jmp_if_7000_not_equals_short_139"], identifier="EVENT_1636_jmp_if_7000_not_equals_short_136"),
	SetVarToConst(X_COORD_1, 2),
	Jmp(["EVENT_1636_set_7000_to_70A0_short_mem_166"]),
	JmpIfVarNotEqualsConst(PRIMARY_TEMP_7000, 104, ["EVENT_1636_jmp_if_7000_not_equals_short_142"], identifier="EVENT_1636_jmp_if_7000_not_equals_short_139"),
	SetVarToConst(X_COORD_1, 15),
	Jmp(["EVENT_1636_set_7000_to_70A0_short_mem_166"]),
	JmpIfVarNotEqualsConst(PRIMARY_TEMP_7000, 105, ["EVENT_1636_jmp_if_7000_not_equals_short_145"], identifier="EVENT_1636_jmp_if_7000_not_equals_short_142"),
	SetVarToConst(X_COORD_1, 20),
	Jmp(["EVENT_1636_set_7000_to_70A0_short_mem_166"]),
	JmpIfVarNotEqualsConst(PRIMARY_TEMP_7000, 106, ["EVENT_1636_jmp_if_7000_not_equals_short_148"], identifier="EVENT_1636_jmp_if_7000_not_equals_short_145"),
	SetVarToConst(X_COORD_1, 40),
	Jmp(["EVENT_1636_set_7000_to_70A0_short_mem_166"]),
	JmpIfVarNotEqualsConst(PRIMARY_TEMP_7000, 107, ["EVENT_1636_jmp_if_7000_not_equals_short_151"], identifier="EVENT_1636_jmp_if_7000_not_equals_short_148"),
	SetVarToConst(X_COORD_1, 50),
	Jmp(["EVENT_1636_set_7000_to_70A0_short_mem_166"]),
	JmpIfVarNotEqualsConst(PRIMARY_TEMP_7000, 108, ["EVENT_1636_jmp_if_7000_not_equals_short_154"], identifier="EVENT_1636_jmp_if_7000_not_equals_short_151"),
	SetVarToConst(X_COORD_1, 40),
	Jmp(["EVENT_1636_set_7000_to_70A0_short_mem_166"]),
	JmpIfVarNotEqualsConst(PRIMARY_TEMP_7000, 110, ["EVENT_1636_jmp_if_7000_not_equals_short_157"], identifier="EVENT_1636_jmp_if_7000_not_equals_short_154"),
	SetVarToConst(X_COORD_1, 25),
	Jmp(["EVENT_1636_set_7000_to_70A0_short_mem_166"]),
	JmpIfVarNotEqualsConst(PRIMARY_TEMP_7000, 111, ["EVENT_1636_start_loop_n_times_160"], identifier="EVENT_1636_jmp_if_7000_not_equals_short_157"),
	...
	CloseDialog(),
	Return(),
	CopyVarToVar(from_var=UNKNOWN_70B0, to_var=PRIMARY_TEMP_7000, identifier="EVENT_1636_set_7000_to_70A0_short_mem_166"),
	SetObjectMemoryToVar(TEMP_7026),
	AddVarTo7000(X_COORD_1),
	Store70A7ToEquipsInventory(),
	EndLoop(),
	CopyVarToVar(from_var=PRIMARY_TEMP_7000, to_var=TEMP_702A, identifier="EVENT_1636_set_7000_short_mem_to_7000_171"),
	...
	Jmp(["EVENT_1636_set_7000_to_70A0_short_mem_17"]),
	...
	JmpIfDialogOptionBOrCSelected(['EVENT_1636_set_181', 'EVENT_1636_set_183']),
	SetVarToConst(ITEM_ID, FrightBomb),
	Jmp(["EVENT_1636_play_sound_184"]),
	SetVarToConst(ITEM_ID, FireBomb, identifier="EVENT_1636_set_181"),
	Jmp(["EVENT_1636_play_sound_184"]),
	SetVarToConst(ITEM_ID, IceBomb, identifier="EVENT_1636_set_183"),
	...
	Jmp(["EVENT_1636_set_7000_short_mem_to_7000_171"]),
	...
	JmpIfVarEqualsConst(ITEM_ID, YoshiCookie, ["EVENT_1636_inc_202"]),
	EndLoop(),
