...
script = EventScript(
    [
        ...
        CreatePacketAtObjectCoords(
            ...
            target_npc=NPC_2,
            destinations=["EVENT_2172_create_packet_at_npc_coords_7"],
        ...
        ActionQueueAsync(
            ...
            subscript=[
                ...
                ASSetSpriteSequence(index=8, is_sequence=True, looping=False),
                ASPause(60),
            ],
        ),
        StartBattleAtBattlefield(233, BF07_BOWSERS_KEEP),
        JmpIfBitClear(GAME_OVER, ["EVENT_2172_action_queue_sync_17"]),
        RestoreAllHP(),
        RestoreAllFP(),
        ...
        CreatePacketAtObjectCoords(
            packet=P034_GREY_EXPLOSION_SFX,
            target_npc=NPC_0,
            destinations=["EVENT_2172_create_packet_at_npc_coords_24"],
