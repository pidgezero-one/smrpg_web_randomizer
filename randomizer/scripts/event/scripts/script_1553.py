...
script = EventScript(
    [
        ...
        JmpIfVarNotEqualsConst(TEMP_702E, 20, ["EVENT_1553_set_short_10"]),
        SetVarToConst(TEMP_70AF, 0),
        SetVarToConst(TEMP_702A, 20, identifier="EVENT_1553_set_short_10"),
        ...
        JmpIfVarNotEqualsConst(TEMP_702E, 24, ["EVENT_1553_set_short_20"]),
        SetVarToConst(TEMP_70AF, 0),
        SetVarToConst(TEMP_702A, 24, identifier="EVENT_1553_set_short_20"),
        ...
        JmpIfBitClear(
            TEMP_7044_4,
            ["EVENT_1553_set_7000_to_7000_short_mem_51"],
            identifier="EVENT_1553_jmp_if_bit_clear_39",
        ),
        JmpIfBitClear(TEMP_7044_3, ["EVENT_1553_set_7000_to_7000_short_mem_46"]),
        ...
        ActionQueueAsync(
            ...
            subscript=[
                ...
                ASJmpIfBitSet(TEMP_7044_1, ["EVENT_1553_inc_63"]),
                ASShiftXYPixels(x=160, y=48),
            ],
        ),
        Inc(TEMP_70A9, identifier="EVENT_1553_inc_63"),
        EndLoop(),
        JmpIfBitClear(TEMP_7044_7, ["EVENT_1553_set_7000_to_7000_short_mem_74"]),
        JmpIfRandom1of2(["EVENT_1553_set_7000_to_7000_short_mem_74"]),
        ...
        CopyVarToVar(from_var=PRIMARY_TEMP_7000, to_var=TEMP_70A9),
        StartLoopNTimes(3),
        JmpIfBitSet(TEMP_7044_1, ["EVENT_1553_set_action_script_sync_80"]),
