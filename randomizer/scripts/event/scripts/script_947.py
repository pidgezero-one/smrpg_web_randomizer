...
script = EventScript([
	...
	JmpIfBitClear(MAP_BANDITS_WAY, ["EVENT_947_pando"], identifier="EVENT_947_croco1"),
	JmpIfBitClear(BANDITS_WAY_LIBERATED, ["EVENT_991_bandits"]),
	RunEventAsSubroutine(E0989_FROGFUCIUS_HINT_OPTIONAL_9, identifier="EVENT_947_pando"),
	...
	JmpIfBitClear(MOLEVILLE_MINES_ENTRANCE_GATING, ["EVENT_947_rk+"], identifier="EVENT_947_mines_access"),
	...
	JmpIfBitClear(TOWER_OPENED, ["EVENT_947_booster_recruit+"], identifier="EVENT_947_rk+"),
	JmpIfBitClear(CURTAIN_MINIGAME_COMPLETED, ["EVENT_991_tower"]),
	JmpIfObjectInSpecificLevel(NPC_7, R192_BOOSTER_TOWER_9F_AREA_02_BOOSTERS_CURTAIN_GAME_ROOM, ["EVENT_991_tower"]),
	Jmp(["EVENT_947_bundt"]),
	JmpIfBitSet(TOWER_CHARACTER_RECRUITED, ["EVENT_991_tower"], identifier="EVENT_947_booster_recruit+"),
	JmpIfBitSet(MARRYMORE_LIBERATED, ["EVENT_947_star_hill"], identifier="EVENT_947_bundt"),
	JmpIfBitClear(MARRYMORE_BACKDOOR_OPEN, ["EVENT_947_bundt_2"]),
	RunEventAsSubroutine(E0979_FROGFUCIUS_HINT_OPTIONAL_MARRYMORE),
	RunEventAsSubroutine(E0985_FROGFUCIUS_HINT_OPTIONAL_5, identifier="EVENT_947_bundt_2"),
	JmpIfBitClear(STAR_HILL_CHECKED, ["EVENT_991_star_hill"], identifier="EVENT_947_star_hill"),
	...
	JmpIfBitSet(SEASIDE_LIBERATED, ["EVENT_947_mokura"], identifier="EVENT_947_yarid"),
	JmpIfBitSet(SEASIDE_BOSS_AVAILABLE, ["EVENT_991_seaside"]),
	JmpIfBitClear(LANDS_END_CLOUD_STAR_PIECE, ["EVENT_991_lands_end"], identifier="EVENT_947_mokura"),
	JmpIfBitClear(BELOME_TEMPLE_OPEN, ["EVENT_947_mtown_open"]),
	JmpIfBitClear(TEMPLE_BOSS_DEFEATED, ["EVENT_991_temple"]),
	JmpIfBitClear(MAP_MONSTRO_TOWN, ["EVENT_947_megasmilax"], identifier="EVENT_947_mtown_open"),
	...
	JmpIfObjectNotInSpecificLevel(NPC_2, R324_MONSTRO_TOWN_OUTSIDE, ["EVENT_991_monstro"]),
	...
	JmpIfBitClear(BEAN_VALLEY_BOSS_DEFEATED, ["EVENT_991_bean"], identifier="EVENT_947_megasmilax"),
	RunEventAsSubroutine(E0987_FROGFUCIUS_HINT_OPTIONAL_7),
	JmpIfObjectInSpecificLevel(NPC_1, R112_NIMBUS_CASTLE_AREA_17_RIGHT_OF_4WAY_PATH_SAVE_POINT, ["EVENT_991_nimbus_castle"]),
	...
	JmpIfObjectInSpecificLevel(NPC_10, R118_NIMBUS_CASTLE_AREA_05_LONG_5EXIT_ROOM_DURING_VALENTINA, ["EVENT_947_is_volcano_open"]),
	JmpIfBitClear(NIMBUS_MID_BOSS_COMPLETED, ["EVENT_991_nimbus_castle"]),
	StoreItemAmountTo7000(CastleKey2),
	JmpIfVarEqualsConst(PRIMARY_TEMP_7000, 1, ["EVENT_991_nimbus_castle"]),
	JmpIfObjectInSpecificLevel(NPC_6, R409_NIMBUS_CASTLE_AREA_09_BIRDOS_ROOM, ["EVENT_947_is_volcano_open"]),
	JmpIfBitClear(NIMBUS_LAND_LIBERATED, ["EVENT_991_nimbus_castle"]),
	JmpIfBitClear(MAP_BARREL_VOLCANO, ["EVENT_947_is_keep_open"], identifier="EVENT_947_is_volcano_open"),
	JmpIfBitClear(VOLCANO_LIBERATED, ["EVENT_991_volcano"]),
	JmpIfBitClear(MAP_VISTA_HILL, ["EVENT_947_smithy"], identifier="EVENT_947_is_keep_open"),
	...
	RunEventAsSubroutine(E0984_FROGFUCIUS_HINT_OPTIONAL_4, identifier="EVENT_947_smithy"),
	JmpIfObjectInSpecificLevel(NPC_1, R189_MARIOS_PIPEHOUSE, ["EVENT_991_marios_pad"]),
	...
	JmpIfBitClear(LANDS_END_GROTTO_BARREL_FLIPPED, ["EVENT_991_lands_end_secret"], identifier="EVENT_947_barrel"),
	...
	JmpIfObjectInSpecificLevel(NPC_13, R084_ROSE_TOWN_OUTSIDE, ["EVENT_991_rose_town"], identifier="EVENT_947_rose_town_flower"),
	JmpIfBitClear(PIPE_VAULT_GATED, ["EVENT_947_fw"]),
	JmpIfObjectInSpecificLevel(NPC_16, R034_YOSTER_ISLE, ["EVENT_991_yoster"]),
	RunEventAsSubroutine(E0990_FROGFUCIUS_HINT_OPTIONAL_10, identifier="EVENT_947_fw"),
	...
	Jmp(["EVENT_991_tower"]),
	JmpIfBitSet(TOWER_CHARACTER_RECRUITED, ["EVENT_991_tower"], identifier="EVENT_947_booster_recruit"),
	JmpIfBitClear(MAP_MONSTRO_TOWN, ["EVENT_947_-seed"], identifier="EVENT_947_templekey"),
	...
	JmpIfObjectInSpecificLevel(NPC_3, R254_BEAN_VALLEY_SMILAX_AREA, ["EVENT_991_bean"], identifier="EVENT_947_-seed"),
	JmpIfBitClear(RED_CELLAR_GUARD_ITEM_GRANTED, ["EVENT_991_nimbus_castle"]),
	StoreItemAmountTo7000(CastleKey1),
	JmpIfVarEqualsConst(PRIMARY_TEMP_7000, 1, ["EVENT_991_nimbus_castle"]),
	JmpIfObjectInSpecificLevel(NPC_10, R118_NIMBUS_CASTLE_AREA_05_LONG_5EXIT_ROOM_DURING_VALENTINA, ["EVENT_947_end"]),
	JmpIfBitClear(NIMBUS_MID_BOSS_COMPLETED, ["EVENT_991_nimbus_castle"]),
	StoreItemAmountTo7000(CastleKey2),
	JmpIfVarEqualsConst(PRIMARY_TEMP_7000, 1, ["EVENT_991_nimbus_castle"]),
	JmpIfObjectInSpecificLevel(NPC_6, R409_NIMBUS_CASTLE_AREA_09_BIRDOS_ROOM, ["EVENT_947_end"]),
	JmpIfBitClear(NIMBUS_LAND_LIBERATED, ["EVENT_991_nimbus_castle"]),
	JmpIfObjectInSpecificLevel(NPC_9, R438_NIMBUS_LAND_OUTSIDE_AFTER_VALENTINA, ["EVENT_991_nimbus_proper"]),
