...
script = EventScript([
	...
	Pause(10),
	PlaySound(sound=SO063_YOSHI_TALK, channel=6),
	RunBackgroundEvent(event_id=E0469_YOSTER_ISLE_BACKGROUND, return_on_level_exit=True, bit_7=True, identifier="EVENT_463_run_background_event_14"),
	Return(),
	EnableControlsUntilReturn([LEFT, RIGHT, DOWN, UP, A, Y, B], identifier="EVENT_463_enable_controls_until_return_16"),
	Pause(32),
	Return(),
	StoreItemAmountTo7000(YoshiCookie, identifier="EVENT_463_store_item_amount_7000_21"),
	...
	Return(),
	PlaySound(sound=SO027_FOUND_AN_ITEM, channel=6, identifier="EVENT_463_play_sound_30"),
