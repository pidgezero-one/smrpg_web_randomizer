...
script = EventScript([
	...
	Return(),
	RunDialog(dialog_id=DI2112_RAZ_OCCUPIED, above_object=MEM_70A8, closable=True, sync=False, multiline=True, use_background=True, identifier="EVENT_688_run_dialog__2"),
