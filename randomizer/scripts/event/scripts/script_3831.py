...
script = EventScript([
	JmpIfObjectTriggerDisabledInSpecificLevel(NPC_0, R492_MUSHROOM_KINGDOM_ITEM_SHOP_BASEMENT, ["EVENT_3831_apply_tile_mod_32"]),
	JmpIfObjectTriggerDisabledInSpecificLevel(NPC_1, R492_MUSHROOM_KINGDOM_ITEM_SHOP_BASEMENT, ["EVENT_3831_apply_tile_mod_41"], identifier="EVENT_3831_jmp_if_object_trigger_disabled_6"),
