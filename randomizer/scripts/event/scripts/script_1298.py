...
script = EventScript(
    [
        JmpIfBitSet(
            TEMP_7043_2, ["EVENT_1298_ret_11"], identifier="EVENT_1298_jmp_if_bit_set_0"
        ),
        Pause(1),
        CreatePacketAtObjectCoords(
            packet=P034_GREY_EXPLOSION_SFX,
            target_npc=MARIO,
            destinations=["EVENT_1298_jmp_if_bit_set_0"]),
        ActionQueueSync(
            target=NPC_4,
            subscript=[
                ASTransferToXYZF(x=22, y=23, z=0, direction=EAST),
