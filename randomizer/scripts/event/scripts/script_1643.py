...
script = EventScript(
    [
        ...
        RunDialog(
            dialog_id=DI1160_PURTEND_STORE_DISABLED,
        ...
        Return(),
        RunDialog(
            dialog_id=DI1124_PURTEND_STORE,
            above_object=MEM_70A8,
            closable=True,
            sync=False,
            multiline=True,
        ...
        RunDialog(
            dialog_id=DI1295_PURTEND_STORE_PROMPT_TO_TRADE_FIREWORKS,
            above_object=MEM_70A8,
            closable=True,
            sync=False,
            multiline=True,
        ...
        RunDialog(
            dialog_id=DI1154_PURTEND_STORE_THANKS,
            above_object=MEM_70A8,
            closable=True,
            sync=False,
            multiline=True,
        ...
        Return(),
        RunDialog(
            dialog_id=DI1153_PURTEND_STORE_SOLD_OUT,
            above_object=MEM_70A8,
            closable=False,
            sync=False,
            multiline=True,
        ...
        RunDialogForDuration(
            dialog_id=DI1154_PURTEND_STORE_THANKS, duration=1, sync=False
        ),
        Return(),
        ...
        Return(),
        RunDialog(
            dialog_id=DI1296_PURTEND_STORE_NEED_FIREWORKS,
            above_object=MEM_70A8,
            closable=True,
            sync=False,
            multiline=True,
