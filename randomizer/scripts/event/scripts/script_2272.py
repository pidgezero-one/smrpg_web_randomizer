...
script = EventScript([
	...
	Jmp(["EVENT_2272_jmp_if_bit_set_47"]),
	JmpIfBitSet(TREASURE_SHOP_ITEM_2_PURCHASED, ["EVENT_2272_jmp_if_bit_set_"], identifier="EVENT_2272_jmp_if_bit_set_47"),
	...
	Jmp(["EVENT_2272_jmp_if_bit_set_97"]),
	JmpIfBitSet(TREASURE_SHOP_ITEM_3_PURCHASED, ["EVENT_2272_jmp_if_bit_set_"], identifier="EVENT_2272_jmp_if_bit_set_97"),
	...
	Jmp(["EVENT_2272_jmp_if_bit_set_"]),
	JmpIfBitSet(TREASURE_SHOP_ITEM_3_PURCHASED, ["EVENT_2272_run_dialog_112"], identifier="EVENT_2272_jmp_if_bit_set_"),
	...
	RunDialog(dialog_id=DI2915_TREASURE_SELLER_2ND_UNLOCK_HINT, above_object=MEM_70A8, closable=True, sync=False, multiline=True, use_background=True),
	Return(),
	RunDialog(dialog_id=DI2902_TREASURE_SELLER_ALL_ITEMS_UNLOCKED, above_object=MEM_70A8, closable=True, sync=False, multiline=True, use_background=True, identifier="EVENT_2272_run_dialog_has_3"),
	Return(),
	RunDialog(dialog_id=DI2905_TREASURE_SELLER_3RD_UNLOCK_HINT, above_object=MEM_70A8, closable=True, sync=False, multiline=True, use_background=True, identifier="EVENT_2272_run_dialog_has_2"),
	Return()
])
