...
script = EventScript(
    [
        ...
        JmpIfRandom2of3(
            [
                "EVENT_2431_jmp_if_random_above_66_7",
                "EVENT_2431_jmp_if_random_above_66_7",
            ]
        ),
        ...
        RemoveObjectFromCurrentLevel(
            NPC_3, identifier="EVENT_2431_remove_from_current_level_18"
        ),
        JmpIfRandom1of2(["EVENT_2431_summon_to_current_level_22"]),
        RemoveObjectFromCurrentLevel(NPC_5),
        Jmp(["EVENT_2431_jmp_if_random_above_128_24"]),
        SummonObjectToCurrentLevel(
            NPC_5, identifier="EVENT_2431_summon_to_current_level_22"
        ),
        ActionQueueAsync(
            target=NPC_5,
            subscript=[
        ...
        RemoveObjectFromCurrentLevel(
            NPC_4, identifier="EVENT_2431_remove_from_current_level_29"
        ),
        JmpIfRandom1of2(["EVENT_2431_summon_to_current_level_33"]),
        RemoveObjectFromCurrentLevel(NPC_6),
        Jmp(["EVENT_2431_jmp_if_random_above_128_35"]),
        SummonObjectToCurrentLevel(
            NPC_6, identifier="EVENT_2431_summon_to_current_level_33"
        ),
        ActionQueueAsync(
            target=NPC_6,
            subscript=[
        ...
        FadeInFromBlack(
            sync=False, identifier="EVENT_2431_fade_in_from_black_async_47"
        ),
        Return(),
    ]
)
