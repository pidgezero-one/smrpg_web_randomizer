...
script = EventScript([
	...
	Return(),
	CompareVarToConst(PRIMARY_TEMP_7000, 15, identifier="EVENT_1700_mem_compare_val_14"),
	JmpIfComparisonResultIsLesser(["EVENT_1700_set_7000_to_7000_short_mem_17"]),
	Return(),
	CopyVarToVar(from_var=ROSE_WAY_703E, to_var=PRIMARY_TEMP_7000, identifier="EVENT_1700_set_7000_to_7000_short_mem_17"),
