...
script = EventScript(
    [
        ...
        RunDialog(
            dialog_id=DI0669_ASKS_FOR_WALLET_BACK,
        ...
        Pause(10),
        RunDialog(
            dialog_id=DI0671_THANKS_FOR_RETURNING_WALLET,
            above_object=MEM_70A8,
            closable=True,
            sync=False,
            multiline=True,
        ...
        Pause(10),
        RunDialog(
            dialog_id=DI0670_YOURE_TERRIBLE,
            above_object=MEM_70A8,
            closable=True,
            sync=False,
            multiline=True,
        ...
        RunDialog(
            dialog_id=DI0672_DEMANDS_WALLET_BACK_AGAIN,
            above_object=MEM_70A8,
            closable=True,
            sync=False,
            multiline=True,
        ...
        RunDialog(
            dialog_id=DI0889_WALLET_THREAT,
            above_object=MEM_70A8,
            closable=False,
            sync=False,
            multiline=True,
