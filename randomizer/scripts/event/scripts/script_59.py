...
script = EventScript([
	...
	JmpToEvent(E0044_GRANT_ANY_CONSUMABLE_OR_EQUIP_TIER_2_CAP, identifier="EVENT_59_tier2"),
	JmpToEvent(E0039_GRANT_ANY_CONSUMABLE_OR_EQUIP_TIER_3_CAP, identifier="EVENT_59_tier3"),
