...
script = EventScript(
    [
        ...
        CreatePacketAtObjectCoords(
            ...
            object=NPC_3,
            destinations=["EVENT_2188_create_packet_at_npc_coords_7"],
        ...
        StartBattleAtBattlefield(246, BF07_BOWSERS_KEEP),
        JmpIfBitClear(GAME_OVER, ["EVENT_2188_action_queue_sync_17"]),
        RestoreAllHP(),
        RestoreAllFP(),
        ...
        CreatePacketAtObjectCoords(
            packet=P034_GREY_EXPLOSION_SFX,
            object=NPC_0,
            destinations=["EVENT_2188_create_packet_at_npc_coords_24"],
