...
script = EventScript(
    [
        ...
        StartBattleAtBattlefield(
            11, BF28_MUSHROOM_KINGDOM, identifier="EVENT_1187_room_190_logic"
        ),
        Return(),
        StartBattleAtBattlefield(
            10, BF15_MUSHROOM_KINGDOM_CASTLE, identifier="EVENT_1187_room_325_logic"
        ),
        Return(),
        StartBattleAtBattlefield(
            10, BF11_MUSHROOM_KINGDOM_HOUSE, identifier="EVENT_1187_room_480_logic"
        ),
        Return(),
    ]
)
