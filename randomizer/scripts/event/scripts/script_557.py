...
script = EventScript([
	...
	SetSyncActionScript(NPC_2, A0672_ROSE_TOWN_LIBERATED_WATER_KID, identifier="EVENT_557_set_action_script_sync_8"),
	...
	SetSyncActionScript(NPC_5, A0663_ROSE_TOWN_LIBERATED_WATER_GUY, identifier="EVENT_557_set_action_script_sync_14"),
