...
script = EventScript([
	...
	CopyVarToVar(from_var=TEMP_7026, to_var=PRIMARY_TEMP_7000, identifier="EVENT_1573_set_7000_to_7000_short_mem_4"),
	...
	SetSyncActionScript(MEM_70A8, A0594_MIDAS_BARREL_RIGHT_LANE_TO_LEFT, identifier="EVENT_1573_set_action_script_sync_19"),
