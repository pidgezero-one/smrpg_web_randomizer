...
script = EventScript(
    [
        ...
        RunDialog(
            dialog_id=DI2627_SUPERJUMP_RECORD,
            above_object=MARIO,
            closable=True,
            sync=False,
            multiline=True,
        ...
        RunDialog(
            dialog_id=DI2628_SUPERJUMP_CHALLENGE,
            above_object=MARIO,
            closable=True,
            sync=False,
            multiline=True,
        ...
        Return(),
        RunDialog(
            dialog_id=DI2629_SUPER_JUMP_PRIZE_1,
            above_object=MARIO,
            closable=True,
            sync=False,
            multiline=True,
        ...
        Return(),
        RunDialog(
            dialog_id=DI2631_SUPER_JUMP_PRIZE_2,
            above_object=MARIO,
            closable=True,
            sync=False,
            multiline=True,
        ...
        Return(),
        RunDialog(
            dialog_id=DI2632_DOG_OUT_OF_PRIZES,
            above_object=MARIO,
            closable=True,
            sync=False,
            multiline=True,
