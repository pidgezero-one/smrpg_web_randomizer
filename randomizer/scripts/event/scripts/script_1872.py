...
script = EventScript(
    [
        ...
        RunDialog(
            dialog_id=DI1297_CANT_SELL_MORE_THAN_ONE_FIREWORKS,
        ...
        JmpIfBitSet(
            ...
            ["EVENT_1872_run_dialog_8"],
            identifier="EVENT_1872_jmp_if_bit_set_6"),
        RunDialog(
            dialog_id=DI1289_FIREWORKS_GUY_FIREWORKS,
            above_object=MEM_70A8,
            closable=True,
            sync=False,
            multiline=True,
        ...
        RunDialog(
            dialog_id=DI1293_FIREWORKS_GUY_INSUFFICIENT_COINS,
            above_object=MEM_70A8,
            closable=True,
            sync=False,
            multiline=True,
        ...
        Return(),
        RunDialog(
            dialog_id=DI1288_FIREWORKS_GUY_MYSTERY_ITEM,
            above_object=MEM_70A8,
            closable=True,
            sync=False,
            multiline=True,
