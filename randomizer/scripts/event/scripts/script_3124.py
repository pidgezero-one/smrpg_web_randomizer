...
script = EventScript(
    [
        JmpIfBitSet(TEMP_7076_0, ["EVENT_3124_ret_12"]),
        JmpIfBitSet(MIMIC_1_CLEARED, ["EVENT_3124_special_val"]),
        ActionQueueSync(
            target=SCREEN_FOCUS,
            subscript=[
        ...
        CreatePacketAt7010(
            packet=P004_MIMIC_POOF_ON_DEFEAT, destinations=["EVENT_3124_pause_11"]
        ),
        Pause(8, identifier="EVENT_3124_pause_11"),
        Pause(12),
        PlaySound(sound=SO000_SILENCE, channel=6),
        SetVarToConst(PRIMARY_TEMP_7000, 512),
        RunEventAsSubroutine(E0353_BOSS_BATTLE),
        JmpIfBitSet(GAME_OVER, ["EVENT_3124_reset_and_choose_game_30"]),
        ...
        JmpIfBitSet(RUN_AWAY, ["EVENT_3124_ret_29"]),
        ...
        Return(identifier="EVENT_3124_ret_12"),
        SetVarToConst(PRIMARY_TEMP_7000, 512, identifier="EVENT_3124_special_val"),
        JmpToEvent(E0245_CHEST_3_GRANT),
        Return(identifier="EVENT_3124_ret_29"),
        ResetAndChooseGame(identifier="EVENT_3124_reset_and_choose_game_30"),
    ]
)
