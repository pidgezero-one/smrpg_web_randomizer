...
script = EventScript([
	...
	SetMem704XAt7000Bit(),
	JmpIfVarEqualsConst(PRIMARY_TEMP_7000, 25, ["EVENT_3375_set_7000_to_70A0_short_mem_28"]),
	JmpIfVarEqualsConst(PRIMARY_TEMP_7000, 26, ["EVENT_3375_set_7000_to_70A0_short_mem_33"]),
	JmpIfVarEqualsConst(PRIMARY_TEMP_7000, 27, ["EVENT_3375_set_7000_to_70A0_short_mem_39"]),
	JmpIfVarEqualsConst(PRIMARY_TEMP_7000, 28, ["EVENT_3375_set_7000_to_70A0_short_mem_44"]),
	JmpIfVarEqualsConst(PRIMARY_TEMP_7000, 29, ["EVENT_3375_set_7000_to_70A0_short_mem_50"]),
	...
	CopyVarToVar(from_var=UNKNOWN_70E7, to_var=PRIMARY_TEMP_7000, identifier="EVENT_3375_set_7000_to_70A0_short_mem_28"),
	CopyVarToVar(from_var=ROSE_WAY_703C, to_var=ROSE_WAY_703E),
	Mem7000OrVar(ROSE_WAY_703E),
	CopyVarToVar(from_var=PRIMARY_TEMP_7000, to_var=UNKNOWN_70E7),
	Jmp(["EVENT_3375_inc_short_54"]),
	CopyVarToVar(from_var=UNKNOWN_70E8, to_var=PRIMARY_TEMP_7000, identifier="EVENT_3375_set_7000_to_70A0_short_mem_33"),
	CopyVarToVar(from_var=ROSE_WAY_703C, to_var=ROSE_WAY_703E),
	VarShiftLeft(ROSE_WAY_703E, 252),
	Mem7000OrVar(ROSE_WAY_703E),
	CopyVarToVar(from_var=PRIMARY_TEMP_7000, to_var=UNKNOWN_70E8),
	Jmp(["EVENT_3375_inc_short_54"]),
	CopyVarToVar(from_var=UNKNOWN_70E8, to_var=PRIMARY_TEMP_7000, identifier="EVENT_3375_set_7000_to_70A0_short_mem_39"),
	CopyVarToVar(from_var=ROSE_WAY_703C, to_var=ROSE_WAY_703E),
	Mem7000OrVar(ROSE_WAY_703E),
	CopyVarToVar(from_var=PRIMARY_TEMP_7000, to_var=UNKNOWN_70E8),
	Jmp(["EVENT_3375_inc_short_54"]),
	CopyVarToVar(from_var=UNKNOWN_70E9, to_var=PRIMARY_TEMP_7000, identifier="EVENT_3375_set_7000_to_70A0_short_mem_44"),
	CopyVarToVar(from_var=ROSE_WAY_703C, to_var=ROSE_WAY_703E),
	VarShiftLeft(ROSE_WAY_703E, 252),
	Mem7000OrVar(ROSE_WAY_703E),
	CopyVarToVar(from_var=PRIMARY_TEMP_7000, to_var=UNKNOWN_70E9),
	Jmp(["EVENT_3375_inc_short_54"]),
	CopyVarToVar(from_var=UNKNOWN_70E9, to_var=PRIMARY_TEMP_7000, identifier="EVENT_3375_set_7000_to_70A0_short_mem_50"),
	CopyVarToVar(from_var=ROSE_WAY_703C, to_var=ROSE_WAY_703E),
	Mem7000OrVar(ROSE_WAY_703E),
	CopyVarToVar(from_var=PRIMARY_TEMP_7000, to_var=UNKNOWN_70E9),
