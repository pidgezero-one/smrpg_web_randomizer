...
script = EventScript(
    [
        ...
        StoreItemAmountTo7000(
            ShinyStone, identifier="EVENT_1626_store_item_amount_7000_7"
        ),
        JmpIfVarNotEqualsConst(PRIMARY_TEMP_7000, 0, ["EVENT_1626_run_dialog_11"]),
        RunDialog(
            dialog_id=DI1156_BEAN_VALLEY_PLATFORM_HINT,
        ...
        Return(),
        RunDialog(
            dialog_id=DI1159_ASK_TO_TRADE_COOKIE_FOR_STONE,
            above_object=MEM_70A8,
            closable=True,
            sync=False,
            multiline=True,
        ...
        RunDialog(
            dialog_id=DI1158_OFFER_TO_RETURN_SHINY_STONE,
            above_object=MEM_70A8,
            closable=True,
            sync=False,
            multiline=True,
