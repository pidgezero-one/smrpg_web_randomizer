...
script = EventScript(
    [
        ...
        RunEventAsSubroutine(
            E0015_STANDARD_ROOM_LOADER, identifier="EVENT_3226_jmp_to_event_13"
        ),
        ...
        ApplyTileModToLevel(
            use_alternate=True,
            room_id=R163_SUNKEN_SHIP_PUZZLE_ROOM_2,
            mod_id=32,
        ...
        ApplyTileModToLevel(
            use_alternate=True,
            room_id=R167_SUNKEN_SHIP_AREA_05_LONG_STAIRWELL_WITH_RUNNING_ALLEY_RATS,
            mod_id=32,
        ...
        ApplyTileModToLevel(
            use_alternate=True,
            room_id=R172_SUNKEN_SHIP_PUZZLE_ROOM_5,
            mod_id=32,
