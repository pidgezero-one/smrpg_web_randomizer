...
script = EventScript(
    [
        JmpIfBitSet(TEMP_7044_2, ["EVENT_2305_jmp_if_bit_set_15"]),
        SetBit(TEMP_7044_2),
        ...
        JmpIfVarEqualsConst(
            FACTORY_FALL_1, 0, ["EVENT_2305_jmp_if_var_equals_const_38"]
        ),
        JmpIfVarEqualsConst(
            FACTORY_FALL_1, 1, ["EVENT_2305_jmp_if_var_equals_const_41"]
        ),
        JmpIfVarEqualsConst(
            FACTORY_FALL_1, 2, ["EVENT_2305_jmp_if_var_equals_const_44"]
        ),
        JmpIfVarEqualsConst(
            FACTORY_FALL_2,
            0,
            ["EVENT_2305_jmp_if_var_equals_const_47"],
            identifier="EVENT_2305_jmp_if_var_equals_const_38",
        ),
        JmpIfVarEqualsConst(
            FACTORY_FALL_2, 1, ["EVENT_2305_jmp_if_var_equals_const_49"]
        ),
        Jmp(["EVENT_2305_jmp_if_var_equals_const_52"]),
        JmpIfVarEqualsConst(
            FACTORY_FALL_2,
            0,
            ["EVENT_2305_jmp_if_var_equals_const_55"],
            identifier="EVENT_2305_jmp_if_var_equals_const_41",
        ),
        JmpIfVarEqualsConst(
            FACTORY_FALL_2, 1, ["EVENT_2305_jmp_if_var_equals_const_58"]
        ),
        Jmp(["EVENT_2305_jmp_if_var_equals_const_60"]),
        JmpIfVarEqualsConst(
            FACTORY_FALL_2,
            0,
            ["EVENT_2305_jmp_if_var_equals_const_63"],
            identifier="EVENT_2305_jmp_if_var_equals_const_44",
        ),
        JmpIfVarEqualsConst(
            FACTORY_FALL_2, 1, ["EVENT_2305_jmp_if_var_equals_const_66"]
        ),
        Jmp(["EVENT_2305_jmp_if_var_equals_const_69"]),
        JmpIfVarEqualsConst(
            FACTORY_FALL_3,
            0,
            ["EVENT_2305_summon_to_current_level_71"],
        ...
        JmpIfVarEqualsConst(FACTORY_FALL_3, 1, ["EVENT_2305_action_queue_async_92"]),
        ...
        JmpIfVarEqualsConst(
            FACTORY_FALL_3,
            0,
            ["EVENT_2305_action_queue_async_92"],
        ...
        SummonObjectToCurrentLevel(
            NPC_4, identifier="EVENT_2305_summon_to_current_level_71"
        ),
        ...
        Jmp(["EVENT_2305_action_queue_sync_99"]),
        PlaySound(
            sound=SO071_MUSHROOM_CURE, channel=6, identifier="EVENT_2305_play_sound_81"
        ),
        ActionQueueSync(
            target=NPC_1,
            subscript=[
        ...
        Jmp(["EVENT_2305_action_queue_sync_99"]),
        PlaySound(
            sound=SO027_FOUND_AN_ITEM, channel=6, identifier="EVENT_2305_play_sound_88"
        ),
        ActionQueueSync(
            target=NPC_1,
            subscript=[
        ...
        RemoveObjectFromCurrentLevel(
            NPC_1, identifier="EVENT_2305_remove_from_current_level_97"
        ),
