...
script = EventScript([
	...
	JmpToEvent(E3097_JUICE_BAR_CARD_NPC_GRANT, identifier="EVENT_251_room_74_logic"),
	JmpToEvent(E3931_GET_SHOES, identifier="EVENT_251_room_154_logic"),
	JmpToEvent(E0157_NPC_QUEST_GRANT_1_FROG_COIN, identifier="EVENT_251_room_190_191_logic"),
