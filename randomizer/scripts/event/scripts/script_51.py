...
script = EventScript([
	...
	JmpToEvent(E0006_SET_70A7_TO_RANDOM_TIER_2_CONSUMABLE, identifier="EVENT_51_tier2"),
	JmpToEvent(E0048_GRANT_ANY_CONSUMABLE_EXCLUDE_WORST_TIER_3_CAP, identifier="EVENT_51_tier3"),
	JmpToEvent(E0045_GRANT_ANY_CONSUMABLE_EXCLUDE_WORST, identifier="EVENT_51_tier4")
])
