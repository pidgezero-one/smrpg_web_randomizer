...
script = EventScript(
    [
        ...
        JmpIfVarEqualsConst(STAR_PIECE_COUNTER, 5, ["EVENT_720_inc_463"]),
        JmpIfVarEqualsConst(STAR_PIECE_COUNTER, 4, ["EVENT_720_inc_452"]),
        JmpIfVarEqualsConst(STAR_PIECE_COUNTER, 3, ["EVENT_720_inc_441"]),
        JmpIfVarEqualsConst(STAR_PIECE_COUNTER, 2, ["EVENT_720_inc_430"]),
        JmpIfVarEqualsConst(STAR_PIECE_COUNTER, 1, ["EVENT_720_inc_419"]),
        JmpIfVarEqualsConst(STAR_PIECE_COUNTER, 0, ["EVENT_720_inc_408"]),
        Return(),
        Inc(STAR_PIECE_COUNTER, identifier="EVENT_720_inc_408"),
        ...
        Return(),
        Inc(STAR_PIECE_COUNTER, identifier="EVENT_720_inc_419"),
        PlayMusicAtCurrentVolume(M24_GOT_A_STAR_PIECE_PART_2),
        Db(bytearray(b"\xfd\x8e\x80\x07\x01")),
        PauseScriptUntilEffectDone(),
        ...
        Jmp(["EVENT_720_jmp_if_var_equals_const_520"]),
        Return(),
        Inc(STAR_PIECE_COUNTER, identifier="EVENT_720_inc_430"),
        PlayMusicAtCurrentVolume(M24_GOT_A_STAR_PIECE_PART_2),
        Db(bytearray(b"\xfd\x8e\x80\x07\x01")),
        PauseScriptUntilEffectDone(),
        ...
        Jmp(["EVENT_720_jmp_if_var_equals_const_520"]),
        Return(),
        Inc(STAR_PIECE_COUNTER, identifier="EVENT_720_inc_441"),
        PlayMusicAtCurrentVolume(M24_GOT_A_STAR_PIECE_PART_2),
        Db(bytearray(b"\xfd\x8e\x80\x07\x01")),
        PauseScriptUntilEffectDone(),
        ...
        Jmp(["EVENT_720_jmp_if_var_equals_const_520"]),
        Return(),
        Inc(STAR_PIECE_COUNTER, identifier="EVENT_720_inc_452"),
        PlayMusicAtCurrentVolume(M24_GOT_A_STAR_PIECE_PART_2),
        Db(bytearray(b"\xfd\x8e\x80\x07\x01")),
        PauseScriptUntilEffectDone(),
        ...
        Jmp(["EVENT_720_jmp_if_var_equals_const_520"]),
        Return(),
        Inc(STAR_PIECE_COUNTER, identifier="EVENT_720_inc_463"),
        PlayMusicAtCurrentVolume(M24_GOT_A_STAR_PIECE_PART_2),
        Db(bytearray(b"\xfd\x8e\x80\x07\x01")),
        PauseScriptUntilEffectDone(),
        ...
        Db(bytearray(b"\xfd\x8e\xb2\x07\x01")),
        PauseScriptUntilEffectDone(),
        JmpIfBitSet(INVISIBLE_FLAG_1_FOUND, ["EVENT_720_jmp_if_bit_clear_499"]),
        ...
        Db(bytearray(b"\xfd\x8e\xb2\x07\x01")),
        PauseScriptUntilEffectDone(),
        JmpIfBitSet(INVISIBLE_FLAG_1_FOUND, ["EVENT_720_set_bit_493"]),
        SetBit(MAP_DIRECTIONAL_NIMBUS_LAND_BOWSERS_KEEP),
        SetBit(MAP_DIRECTIONAL_BOWSERS_KEEP_VISTA_HILL),
        FadeInFromBlack(sync=False),
        JmpIfVarEqualsConst(OLD_STAR_PIECE_ID, 223, ["EVENT_720_set_short_327"]),
