...
script = EventScript(
    [
        ...
        JmpIfVarEqualsConst(PRIMARY_TEMP_7000, 354, ["EVENT_3333_set_0"]),
        ...
        ApplyTileModToLevel(
            use_alternate=True, room_id=R390_VOLCANO_AREA_16_ERUPTING_STUMPET, mod_id=0
        ),
        ApplyTileModToLevel(
            use_alternate=True, room_id=R390_VOLCANO_AREA_16_ERUPTING_STUMPET, mod_id=1
        ),
        Return(),
    ]
)
