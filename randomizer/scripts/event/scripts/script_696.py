...
script = EventScript([
	...
	Return(),
	RunDialog(dialog_id=DI2115_MARRYMORE_SHITPOST, above_object=MEM_70A8, closable=True, sync=False, multiline=True, use_background=True, identifier="EVENT_696_run_dialog_insert"),
