...
script = EventScript(
    [
        ...
        JmpIf7000AllBitsClear(bits=[], destinations=["EVENT_1541_pause_2"]),
        JmpIf7000AnyBitsSet(bits=[], destinations=["EVENT_1541_set_bit_8"]),
        JmpIf7000AnyBitsSet(bits=[], destinations=["EVENT_1541_set_bit_10"]),
        Return(),
