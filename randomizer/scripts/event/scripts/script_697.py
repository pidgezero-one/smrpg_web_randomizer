...
script = EventScript([
	...
	Return(),
	RunDialog(dialog_id=DI2158_MARRYMORE_FIELD_NPC, above_object=MEM_70A8, closable=True, sync=False, multiline=True, use_background=True, identifier="EVENT_697_run_dialog_3"),
	Return(),
