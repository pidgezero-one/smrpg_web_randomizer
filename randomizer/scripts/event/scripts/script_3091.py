...
script = EventScript([
	...
	JmpIfVarEqualsConst(COIN_CHEST_MULTIPLIER, 0, ["EVENT_3091_store_multiplier"], identifier="EVENT_3091_check_multiplier"),
	AddConstToVar(PRIMARY_TEMP_7000, 15),
	Dec(COIN_CHEST_MULTIPLIER),
	Jmp(["EVENT_3091_check_multiplier"]),
	CopyVarToVar(from_var=PRIMARY_TEMP_7000, to_var=COIN_CHEST_MULTIPLIER, identifier="EVENT_3091_store_multiplier"),
	CopyVarToVar(from_var=ITEM_ID, to_var=PRIMARY_TEMP_7000),
	...
	SetVarToConst(PRIMARY_TEMP_7000, 0),
	JmpIfVarEqualsConst(COIN_CHEST_MULTIPLIER, 0, ["EVENT_3091_add_coins_260"], identifier="EVENT_3091_use_multiplier"),
	...
	CreatePacketAt7010(packet=P019_FROG_COIN_BEING_COLLECTED, destinations=["EVENT_3091_ret"]),
