...
script = EventScript([
	...
	Return(),
	CopyVarToVar(from_var=TEMP_70AE, to_var=PRIMARY_TEMP_7000, identifier="EVENT_3369_set_7000_to_70A0_short_mem_32"),
	...
	JmpIfVarEqualsConst(ACTIVE_NPC, 21, ["EVENT_3369_set_7000_short_mem_to_7000_45"]),
	JmpIfVarEqualsConst(ACTIVE_NPC, 23, ["EVENT_3369_set_7000_short_mem_to_7000_47"]),
	JmpIfVarEqualsConst(ACTIVE_NPC, 22, ["EVENT_3369_set_7000_short_mem_to_7000_49"]),
	JmpIfVarEqualsConst(ACTIVE_NPC, 24, ["EVENT_3369_set_7000_short_mem_to_7000_51"]),
	CopyVarToVar(from_var=PRIMARY_TEMP_7000, to_var=TEMP_702C, identifier="EVENT_3369_set_7000_short_mem_to_7000_45"),
	Return(),
	CopyVarToVar(from_var=PRIMARY_TEMP_7000, to_var=TEMP_702E, identifier="EVENT_3369_set_7000_short_mem_to_7000_47"),
	Return(),
	CopyVarToVar(from_var=PRIMARY_TEMP_7000, to_var=TEMP_7030, identifier="EVENT_3369_set_7000_short_mem_to_7000_49"),
	Return(),
	CopyVarToVar(from_var=PRIMARY_TEMP_7000, to_var=TEMP_7032, identifier="EVENT_3369_set_7000_short_mem_to_7000_51"),
	Return()
])
