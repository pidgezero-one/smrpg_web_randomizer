...
script = EventScript(
    [
        JmpIfBitSet(
            TEMP_7044_4, ["EVENT_1308_ret_11"], identifier="EVENT_1308_jmp_if_bit_set_0"
        ),
        Pause(1),
        CreatePacketAtObjectCoords(
            packet=P034_GREY_EXPLOSION_SFX,
            object=MARIO,
            destinations=["EVENT_1308_jmp_if_bit_set_0"],
        ),
        ActionQueueSync(
            target=NPC_4,
            subscript=[
                ASTransferToXYZF(x=27, y=29, z=0, direction=EAST),
