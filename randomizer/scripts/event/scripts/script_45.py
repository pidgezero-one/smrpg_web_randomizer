...
script = EventScript([
	...
	JmpToEvent(E0007_SET_70A7_TO_RANDOM_TIER_3_CONSUMABLE, identifier="EVENT_45__2"),
	JmpToEvent(E0008_SET_70A7_TO_RANDOM_TIER_4_CONSUMABLE, identifier="EVENT_45___2")
])
