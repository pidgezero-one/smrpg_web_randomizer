...
script = EventScript([
	...
	JmpToEvent(E0007_SET_70A7_TO_RANDOM_TIER_3_CONSUMABLE, identifier="EVENT_36__2"),
	JmpToEvent(E0006_SET_70A7_TO_RANDOM_TIER_2_CONSUMABLE, identifier="EVENT_36___2"),
	JmpToEvent(E0005_SET_70A7_TO_RANDOM_TIER_1_CONSUMABLE, identifier="EVENT_36____2")
])
