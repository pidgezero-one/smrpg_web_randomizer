...
script = EventScript(
    [
        ...
        CopyVarToVar(from_var=UNUSED_70B2, to_var=PRIMARY_TEMP_7000),
        ...
        ActionQueueSync(
            target=NPC_0, subscript=[TransferToXYZF(x=23, y=117, z=0, direction=EAST)]
        ),
        ActionQueueSync(
            target=NPC_1, subscript=[TransferToXYZF(x=23, y=117, z=0, direction=EAST)]
        ),
        ActionQueueAsync(
            target=NPC_2, subscript=[TransferToXYZF(x=23, y=117, z=0, direction=EAST)]
        ),
