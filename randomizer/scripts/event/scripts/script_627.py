...
script = EventScript([
	...
	EnterArea(room_id=R153_MARRYMORE_CHAPEL_ENTRANCE_TO_SANCTUARY, face_direction=SOUTHWEST, x=20, y=16, z=0, run_entrance_event=True, identifier="EVENT_627_enter_area_1"),
