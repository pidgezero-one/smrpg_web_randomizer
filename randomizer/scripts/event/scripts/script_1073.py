...
script = EventScript(
    [
        ...
        JmpIfBitClear(
            TEMP_7044_3,
            ["EVENT_1073_set_7000_to_tapped_button_0"],
        ...
        JmpToSubroutine(["EVENT_1073_jmp_if_7000_equals_short_147"]),
        ...
        JmpIfBitClear(
            TEMP_7044_3,
            ["EVENT_1073_set_7000_to_tapped_button_18"],
        ...
        JmpIfBitClear(
            TEMP_7044_3,
            ["EVENT_1073_set_7000_to_tapped_button_36"],
        ...
        JmpIfBitClear(
            TEMP_7044_3,
            ["EVENT_1073_set_7000_to_tapped_button_54"],
        ...
        JmpIfBitClear(
            TEMP_7044_3,
            ["EVENT_1073_set_7000_to_tapped_button_72"],
        ...
        JmpIfBitClear(
            TEMP_7044_3,
            ["EVENT_1073_set_7000_to_tapped_button_90"],
        ...
        Mem7000AndConst(0x0080),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_7000, 128, ["EVENT_1073_jmp_if_bit_clear_113"]
        ),
        Jmp(["EVENT_1073_set_7000_to_tapped_button_108"]),
        JmpIfBitClear(
            TEMP_7044_3,
            ["EVENT_1073_set_7000_to_tapped_button_108"],
        ...
        Mem7000AndConst(0x0080),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_7000, 128, ["EVENT_1073_jmp_if_bit_clear_131"]
        ),
        Jmp(["EVENT_1073_set_7000_to_tapped_button_126"]),
        JmpIfBitClear(
            TEMP_7044_3,
            ["EVENT_1073_set_7000_to_tapped_button_126"],
        ...
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_7000,
            0,
            ["EVENT_1073_pause_action_script_160"],
            identifier="EVENT_1073_jmp_if_7000_equals_short_147"),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_7000, 1, ["EVENT_1073_pause_action_script_163"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_7000, 2, ["EVENT_1073_pause_action_script_166"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_7000, 3, ["EVENT_1073_pause_action_script_169"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_7000, 4, ["EVENT_1073_pause_action_script_172"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_7000, 5, ["EVENT_1073_pause_action_script_175"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_7000, 6, ["EVENT_1073_pause_action_script_178"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_7000, 65535, ["EVENT_1073_pause_action_script_181"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_7000, 65534, ["EVENT_1073_pause_action_script_184"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_7000, 65533, ["EVENT_1073_pause_action_script_187"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_7000, 65532, ["EVENT_1073_pause_action_script_190"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_7000, 65531, ["EVENT_1073_pause_action_script_193"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_7000, 65530, ["EVENT_1073_pause_action_script_196"]
        ),
