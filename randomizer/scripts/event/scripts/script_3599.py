...
script = EventScript([
	...
	JmpIfVarEqualsConst(PRIMARY_TEMP_7000, 0, ["EVENT_3599_set_7000_to_70A0_short_mem_33"]),
	...
	CopyVarToVar(from_var=TEMP_70B8, to_var=PRIMARY_TEMP_7000, identifier="EVENT_3599_set_7000_to_70A0_short_mem_13"),
	CopyVarToVar(from_var=PRIMARY_TEMP_7000, to_var=SECONDARY_TEMP_7024),
	CopyVarToVar(from_var=SECONDARY_TEMP_7024, to_var=PRIMARY_TEMP_7000, identifier="EVENT_3599_set_7000_to_7000_short_mem_15"),
	SetObjectMemoryToVar(SECONDARY_TEMP_7024),
	AddToInventory(YoshiCookie),
	EndLoop(),
	JmpIfVarEqualsConst(TEMP_7026, 0, ["EVENT_3599_set_48"]),
	CopyVarToVar(from_var=UNKNOWN_70D8, to_var=PRIMARY_TEMP_7000, identifier="EVENT_3599_set_7000_to_70A0_short_mem_20"),
	...
	CopyVarToVar(from_var=SECONDARY_TEMP_7024, to_var=PRIMARY_TEMP_7000, identifier="EVENT_3599_set_7000_to_7000_short_mem_28"),
	...
	CopyVarToVar(from_var=TEMP_70B8, to_var=PRIMARY_TEMP_7000, identifier="EVENT_3599_set_7000_to_70A0_short_mem_33"),
	CopyVarToVar(from_var=PRIMARY_TEMP_7000, to_var=TEMP_7026),
