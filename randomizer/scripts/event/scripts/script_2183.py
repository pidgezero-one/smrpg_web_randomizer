...
script = EventScript(
    [
        ...
        CreatePacketAtObjectCoords(
            ...
            target_npc=NPC_3,
            destinations=["EVENT_2183_create_packet_at_npc_coords_7"],
        ...
        StartBattleAtBattlefield(242, BF07_BOWSERS_KEEP),
        JmpIfBitClear(GAME_OVER, ["EVENT_2183_action_queue_sync_17"]),
        RestoreAllHP(),
        RestoreAllFP(),
        ...
        CreatePacketAtObjectCoords(
            packet=P034_GREY_EXPLOSION_SFX,
            target_npc=NPC_0,
            destinations=["EVENT_2183_create_packet_at_npc_coords_24"],
