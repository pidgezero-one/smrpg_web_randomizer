...
script = EventScript(
    [
        ...
        PlaySound(
            sound=SO005_BLOCK_SWITCH, channel=6, identifier="EVENT_3402_play_sound_3"
        ),
        CopyVarToVar(from_var=ACTIVE_NPC, to_var=PRIMARY_TEMP_7000),
        CopyVarToVar(from_var=PRIMARY_TEMP_7000, to_var=TEMP_70AA),
        SetVarToConst(PRIMARY_TEMP_7000, 290),
        JmpIfMem704XAt7000BitSet(["EVENT_3402_jmp_if_var_not_equals_const_26"]),
        SetMem704XAt7000Bit(),
        ...
        JmpIfVarNotEqualsConst(
            COIN_COUNTER_3,
            1,
            ["EVENT_3402_set_temp_action_script_sync_35"],
        ...
        Jmp(["EVENT_3402_set_7010_to_object_xyz_36"]),
        ...
        Set70107015ToObjectXYZ(
            MEM_70AA, identifier="EVENT_3402_set_7010_to_object_xyz_36"
        ),
        ...
        JmpIfVarEqualsConst(PRIMARY_TEMP_7000, 240, ["EVENT_3402_add_coins_79"]),
        JmpIfVarEqualsConst(PRIMARY_TEMP_7000, 160, ["EVENT_3402_dec_53"]),
        JmpIfVarEqualsConst(PRIMARY_TEMP_7000, 128, ["EVENT_3402_dec_68"]),
        Jmp(["EVENT_3402_ret_80"]),
        Dec(COIN_COUNTER_3, identifier="EVENT_3402_dec_53"),
        AddCoins(10),
        PlaySound(sound=SO013_COIN, channel=6),
        CreatePacketAt7010(
            packet=P016_BIG_COIN_BEING_COLLECTED, destinations=["EVENT_3402_ret_80"]
        ),
        SetSyncActionScript(MEM_70A9, A0906_COIN_CHEST),
        Jmp(["EVENT_3402_ret_80"]),
        Dec(COIN_COUNTER_3, identifier="EVENT_3402_dec_68"),
        AddCoins(1),
        PlaySound(sound=SO013_COIN, channel=6),
        CreatePacketAt7010(
            packet=P018_SMALL_COIN_BEING_COLLECTED, destinations=["EVENT_3402_ret_80"]
        ),
        SetSyncActionScript(MEM_70A9, A0906_COIN_CHEST),
        Jmp(["EVENT_3402_ret_80"]),
        AddCoins(1, identifier="EVENT_3402_add_coins_79"),
        PlaySound(sound=SO013_COIN, channel=6),
        CreatePacketAt7010(
            packet=P018_SMALL_COIN_BEING_COLLECTED, destinations=["EVENT_3402_ret_80"]
        ),
        ...
        Return(identifier="EVENT_3402_ret_80"),
    ]
)
