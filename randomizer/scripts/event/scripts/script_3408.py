...
script = EventScript(
    [
        ...
        PlaySound(
            sound=SO005_BLOCK_SWITCH, channel=6, identifier="EVENT_3408_play_sound_3"
        ),
        ...
        JmpIfVarEqualsConst(
            ...
            0,
            ["EVENT_3408_set_70A0_short_mem_to_7000_16"],
        ...
        JmpIfVarNotEqualsConst(
            COIN_COUNTER_4,
            1,
            ["EVENT_3408_set_temp_action_script_sync_35"],
        ...
        Set70107015ToObjectXYZ(
            MEM_70AA, identifier="EVENT_3408_set_7010_to_object_xyz_36"
        ),
        ...
        CreatePacketAt7010(
            packet=P019_FROG_COIN_BEING_COLLECTED, destinations=["EVENT_3408_ret_80"]
        ),
