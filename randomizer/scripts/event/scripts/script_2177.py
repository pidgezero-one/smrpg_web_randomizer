...
script = EventScript(
    [
        ...
        CreatePacketAtObjectCoords(
            ...
            target_npc=NPC_2,
            destinations=["EVENT_2177_create_packet_at_npc_coords_7"],
        ...
        StartBattleAtBattlefield(237, BF07_BOWSERS_KEEP),
        JmpIfBitClear(GAME_OVER, ["EVENT_2177_action_queue_sync_17"]),
        RestoreAllHP(),
        RestoreAllFP(),
        ...
        CreatePacketAtObjectCoords(
            packet=P034_GREY_EXPLOSION_SFX,
            target_npc=NPC_0,
            destinations=["EVENT_2177_create_packet_at_npc_coords_24"],
