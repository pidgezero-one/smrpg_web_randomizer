...
script = EventScript([
	...
	Return(),
	SetSyncActionScript(MEM_70A8, A0002_FLASH_AFTER_RUNNING_AWAY_IFRAMES, identifier="EVENT_3705_set_temp_action_script_sync_7"),
	Set7000ToCurrentLevel(),
	JmpIfVarEqualsConst(PRIMARY_TEMP_7000, 410, ["EVENT_3705_set_temp_action_script_sync_14"]),
	...
	FadeInFromBlack(sync=False),
	Return(),
	SetSyncActionScript(NPC_6, A0002_FLASH_AFTER_RUNNING_AWAY_IFRAMES, identifier="EVENT_3705_set_temp_action_script_sync_14"),
