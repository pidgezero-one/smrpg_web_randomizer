...
script = EventScript(
    [
        ...
        SetVarToRandom(
            PRIMARY_TEMP_7000, 4, identifier="EVENT_447_set_var_to_random_6"
        ),
        ...
        JmpToEvent(E0447_GOOMBA_THUMPIN_SPAWNS),
        JmpIfRandom2of3(
            ["EVENT_447_jmp_if_bit_clear_0", "EVENT_447_jmp_if_random_above_128_51"],
