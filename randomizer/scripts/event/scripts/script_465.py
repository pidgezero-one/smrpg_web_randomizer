...
script = EventScript(
    [
        ...
        JmpIfBitClear(YOSTER_ISLE_LIBERATED_2, ["EVENT_465_set_short_50"]),
        SetVarToConst(TEMP_7026, 20),
        SetVarToConst(TEMP_702E, 20),
        SetVarToConst(TEMP_702A, 20),
        ...
        JmpIfVarEqualsConst(PRIMARY_TEMP_7000, 3, ["EVENT_465_set_short_53"]),
        JmpIfVarEqualsConst(PRIMARY_TEMP_7000, 4, ["EVENT_465_set_short_60"]),
        JmpIfVarEqualsConst(PRIMARY_TEMP_7000, 5, ["EVENT_465_set_short_70"]),
        JmpIfVarEqualsConst(PRIMARY_TEMP_7000, 6, ["EVENT_465_set_short_77"]),
        JmpIfVarEqualsConst(PRIMARY_TEMP_7000, 8, ["EVENT_465_set_short_87"]),
        JmpIfVarEqualsConst(PRIMARY_TEMP_7000, 10, ["EVENT_465_set_short_97"]),
        ...
        SetVarToConst(X_COORD_2, 79, identifier="EVENT_465_set_short_53"),
        ...
        Jmp(["EVENT_465_jmp_if_bit_clear_114"]),
        SetVarToConst(X_COORD_2, 77, identifier="EVENT_465_set_short_60"),
        ...
        SetVarToConst(X_COORD_2, 74, identifier="EVENT_465_set_short_70"),
        ...
        Jmp(["EVENT_465_jmp_if_bit_clear_114"]),
        SetVarToConst(X_COORD_2, 70, identifier="EVENT_465_set_short_77"),
        ...
        Jmp(["EVENT_465_fade_out_music_to_volume_123"]),
        SetVarToConst(X_COORD_2, 68, identifier="EVENT_465_set_short_87"),
        ...
        Jmp(["EVENT_465_fade_out_music_to_volume_123"]),
        SetVarToConst(X_COORD_2, 66, identifier="EVENT_465_set_short_97"),
        ...
        Jmp(["EVENT_465_fade_out_music_to_volume_123"]),
        SetVarToConst(X_COORD_2, 56, identifier="EVENT_465_set_short_107"),
        ...
        Jmp(["EVENT_465_fade_out_music_to_volume_123"]),
        SetVarToConst(UNKNOWN_70EB, 5, identifier="EVENT_465_set_120"),
        Jmp(["EVENT_465_fade_out_music_to_volume_123"]),
        SetVarToConst(UNKNOWN_70EB, 3, identifier="EVENT_465_set_122"),
        FadeOutMusicToVolume(
            duration=2, volume=0, identifier="EVENT_465_fade_out_music_to_volume_123"
        ),
        Pause(60),
        RememberLastObject(),
        PlayMusicAtDefaultVolume(M16_LETS_RACE),
