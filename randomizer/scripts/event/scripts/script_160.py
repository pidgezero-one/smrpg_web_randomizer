...
script = EventScript([
	...
	Return(),
	RunDialog(dialog_id=DI0065_GOT_AN_70A7_AWAIT_TERMINATE, above_object=BOWSER, closable=True, sync=False, multiline=False, use_background=False, identifier="EVENT_160_run_dialog_104_"),
	AddToInventory(ITEM_ID),
	Return()
])
