...
script = EventScript([
	...
	Return(),
	JmpIfObjectNotInSpecificLevel(NPC_1, R481_MUSHROOM_KINGDOM_DURING_MACK_JUMPING_KIDS_HOUSE_2F, ["EVENT_261_1"], identifier="EVENT_409_jmp_if_object_not_in_level_4"),
