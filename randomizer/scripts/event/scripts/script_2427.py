...
script = EventScript(
    [
        ...
        SetBit(TEMP_7044_6),
        JmpIfRandom2of3(
            ["EVENT_2427_summon_to_level_6", "EVENT_2427_remove_from_level_9"]
        ),
        ...
        SummonObjectToSpecificLevel(
            NPC_1, R224_FOREST_MAZE_AREA_01, identifier="EVENT_2427_summon_to_level_6"
        ),
        RemoveObjectFromSpecificLevel(NPC_0, R224_FOREST_MAZE_AREA_01),
        Jmp(["EVENT_2427_jmp_if_random_above_66_11"]),
        RemoveObjectFromSpecificLevel(
            NPC_0, R224_FOREST_MAZE_AREA_01, identifier="EVENT_2427_remove_from_level_9"
        ),
        RemoveObjectFromSpecificLevel(NPC_1, R224_FOREST_MAZE_AREA_01),
        JmpIfRandom2of3(
            ["EVENT_2427_summon_to_level_15", "EVENT_2427_remove_from_level_18"],
        ...
        SummonObjectToSpecificLevel(
            NPC_6, R226_FOREST_MAZE_AREA_02, identifier="EVENT_2427_summon_to_level_15"
        ),
        RemoveObjectFromSpecificLevel(NPC_7, R226_FOREST_MAZE_AREA_02),
        Jmp(["EVENT_2427_jmp_if_random_above_66_20"]),
        RemoveObjectFromSpecificLevel(
        ...
        RemoveObjectFromSpecificLevel(NPC_7, R226_FOREST_MAZE_AREA_02),
        JmpIfRandom2of3(
            ["EVENT_2427_summon_to_level_24", "EVENT_2427_remove_from_level_27"],
        ...
        RemoveObjectFromSpecificLevel(NPC_6, R233_FOREST_MAZE_AREA_03_UNDERGROUND),
        JmpIfRandom2of3(
            ["EVENT_2427_summon_to_level_33", "EVENT_2427_summon_to_level_36"],
        ...
        RemoveObjectFromSpecificLevel(NPC_7, R233_FOREST_MAZE_AREA_03_UNDERGROUND),
        JmpIfRandom2of3(
            ["EVENT_2427_summon_to_level_42", "EVENT_2427_summon_to_level_45"],
        ...
        RemoveObjectFromSpecificLevel(NPC_8, R233_FOREST_MAZE_AREA_03_UNDERGROUND),
        JmpIfRandom2of3(
            ["EVENT_2427_summon_to_level_51", "EVENT_2427_summon_to_level_54"],
        ...
        RemoveObjectFromSpecificLevel(NPC_9, R233_FOREST_MAZE_AREA_03_UNDERGROUND),
        JmpIfRandom2of3(
            ["EVENT_2427_remove_from_level_59", "EVENT_2427_remove_from_level_59"],
