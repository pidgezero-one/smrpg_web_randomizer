...
script = EventScript([
	JmpIfObjectInSpecificLevel(NPC_2, R319_LANDS_END_DESERT_AREA_06, ["EVENT_1753_set_7000_to_7000_short_mem_9"]),
	...
	CopyVarToVar(from_var=TEMP_7026, to_var=PRIMARY_TEMP_7000, identifier="EVENT_1753_set_7000_to_7000_short_mem_9"),
