...
script = EventScript([
	...
	JmpIfVarEqualsConst(PRIMARY_TEMP_7000, 32, ["EVENT_3350_set_7000_to_70A0_short_mem_14"]),
	JmpIfVarEqualsConst(PRIMARY_TEMP_7000, 48, ["EVENT_3350_set_7000_to_70A0_short_mem_18"]),
	JmpIfVarEqualsConst(PRIMARY_TEMP_7000, 64, ["EVENT_3350_set_7000_to_70A0_short_mem_22"]),
	JmpIfVarEqualsConst(PRIMARY_TEMP_7000, 80, ["EVENT_3350_set_7000_to_70A0_short_mem_26"]),
	JmpIfVarEqualsConst(PRIMARY_TEMP_7000, 96, ["EVENT_3350_set_7000_to_70A0_short_mem_30"]),
	...
	CopyVarToVar(from_var=UNKNOWN_70E7, to_var=PRIMARY_TEMP_7000, identifier="EVENT_3350_set_7000_to_70A0_short_mem_14"),
	Mem7000OrConst(0x0008),
	CopyVarToVar(from_var=PRIMARY_TEMP_7000, to_var=UNKNOWN_70E7),
	Jmp(["EVENT_3350_set_7000_to_70A0_short_mem_33"]),
	CopyVarToVar(from_var=UNKNOWN_70E8, to_var=PRIMARY_TEMP_7000, identifier="EVENT_3350_set_7000_to_70A0_short_mem_18"),
	Mem7000OrConst(0x0080),
	CopyVarToVar(from_var=PRIMARY_TEMP_7000, to_var=UNKNOWN_70E8),
	Jmp(["EVENT_3350_set_7000_to_70A0_short_mem_33"]),
	CopyVarToVar(from_var=UNKNOWN_70E8, to_var=PRIMARY_TEMP_7000, identifier="EVENT_3350_set_7000_to_70A0_short_mem_22"),
	Mem7000OrConst(0x0008),
	CopyVarToVar(from_var=PRIMARY_TEMP_7000, to_var=UNKNOWN_70E8),
	Jmp(["EVENT_3350_set_7000_to_70A0_short_mem_33"]),
	CopyVarToVar(from_var=UNKNOWN_70E9, to_var=PRIMARY_TEMP_7000, identifier="EVENT_3350_set_7000_to_70A0_short_mem_26"),
	Mem7000OrConst(0x0080),
	CopyVarToVar(from_var=PRIMARY_TEMP_7000, to_var=UNKNOWN_70E9),
	Jmp(["EVENT_3350_set_7000_to_70A0_short_mem_33"]),
	CopyVarToVar(from_var=UNKNOWN_70E9, to_var=PRIMARY_TEMP_7000, identifier="EVENT_3350_set_7000_to_70A0_short_mem_30"),
	Mem7000OrConst(0x0008),
	CopyVarToVar(from_var=PRIMARY_TEMP_7000, to_var=UNKNOWN_70E9),
	CopyVarToVar(from_var=KEEP_DOORS_EXIT_TYPE_2, to_var=PRIMARY_TEMP_7000, identifier="EVENT_3350_set_7000_to_70A0_short_mem_33"),
