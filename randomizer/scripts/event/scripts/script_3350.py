...
script = EventScript(
    [
        ...
        EnableObjectTriggerInSpecificLevel(
            NPC_0, R144_BOWSERS_KEEP_6DOOR_TREASURE_AFTER_EACH_ROOM
        ),
        EnableObjectTriggerInSpecificLevel(
            NPC_0, R446_BOWSERS_KEEP_6DOOR_EXIT_ROOM_AFTER_FINISHING_4_DOORS
        ),
        CopyVarToVar(from_var=KEEP_DOORS_EXIT_TYPE_2, to_var=PRIMARY_TEMP_7000),
        Mem7000AndConst(0x0070),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_7000, 32, ["EVENT_3350_set_7000_to_70A0_short_mem_14"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_7000, 48, ["EVENT_3350_set_7000_to_70A0_short_mem_18"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_7000, 64, ["EVENT_3350_set_7000_to_70A0_short_mem_22"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_7000, 80, ["EVENT_3350_set_7000_to_70A0_short_mem_26"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_7000, 96, ["EVENT_3350_set_7000_to_70A0_short_mem_30"]
        ),
        ...
        Jmp(["EVENT_3350_set_7000_to_70A0_short_mem_33"]),
        CopyVarToVar(
        ...
        CopyVarToVar(from_var=PRIMARY_TEMP_7000, to_var=UNKNOWN_70E9),
        CopyVarToVar(
            from_var=KEEP_DOORS_EXIT_TYPE_2,
            to_var=PRIMARY_TEMP_7000,
        ...
        EnterArea(
            room_id=R144_BOWSERS_KEEP_6DOOR_TREASURE_AFTER_EACH_ROOM,
        ...
        Return(),
        EnterArea(
            room_id=R446_BOWSERS_KEEP_6DOOR_EXIT_ROOM_AFTER_FINISHING_4_DOORS,
            face_direction=NORTHEAST,
            x=16,
            y=79,
            z=0,
