...
script = EventScript([
	...
	Jmp(["EVENT_2670_play_sound_104"]),
	PlaySound(sound=SO027_FOUND_AN_ITEM, channel=6, identifier="EVENT_2670_play_sound_104"),
	...
	Return(),
	PlaySound(sound=SO027_FOUND_AN_ITEM, channel=6, identifier="EVENT_2670_play_sound_114"),
	RunDialog(dialog_id=DI0524_GOT_A_70A7_AWAIT_TERMINATE, above_object=BOWSER, closable=True, sync=False, multiline=False, use_background=False),
	...
	Return(),
	JmpIfBitSet(TEMP_7043_7, ["EVENT_2670_set_128"], identifier="EVENT_2670_jmp_if_bit_set_124"),
