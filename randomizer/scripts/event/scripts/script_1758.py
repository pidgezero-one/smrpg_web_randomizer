...
script = EventScript([
	JmpIfObjectInSpecificLevel(NPC_2, R403_LANDS_END_DESERT_AREA_05, ["EVENT_1758_set_7000_to_7000_short_mem_9"]),
	...
	CopyVarToVar(from_var=TEMP_7026, to_var=PRIMARY_TEMP_7000, identifier="EVENT_1758_set_7000_to_7000_short_mem_9"),
	JmpIfVarNotEqualsConst(PRIMARY_TEMP_7000, 20, ["EVENT_1759_run_event_as_subroutine_3"]),
