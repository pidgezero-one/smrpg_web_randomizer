...
script = EventScript([
	...
	RunEventAsSubroutine(E0015_STANDARD_ROOM_LOADER, identifier="EVENT_3925_jmp_to_event_13"),
	...
	JmpToEvent(E0168_BOSS_GRANT_STAR_PIECE_CONTAINER, identifier="EVENT_3925_star_grant"),
