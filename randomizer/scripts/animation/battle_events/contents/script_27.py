...
script = BattleAnimationScript(
    script=[
        ...
        SpriteQueue(
            field_object=0,
            destinations=["queuestart_0x3ac5b0"],
            character_slot=True,
            bit_4=True,
        ),
        SpriteQueue(
            field_object=1,
            destinations=["queuestart_0x3ac5f8"],
            character_slot=True,
            bit_4=True,
        ),
        SpriteQueue(
            field_object=2,
            destinations=["queuestart_0x3ac604"],
            character_slot=True,
            bit_4=True,
        ),
        Jmp(["command_0x3a6444"]),
        JmpIfAMEM8BitNotEqualsConst(
            0x68, 1, ["command_0x3a643f"], identifier="command_0x3a642c"
        ),
        SpriteQueue(
            field_object=0,
            destinations=["queuestart_0x3ac5b0"],
        ...
        Pause1Frame(),
        SpriteQueue(
            field_object=3, destinations=["queuestart_0x3ac556"], bit_2=True, bit_4=True
        ),
        SpriteQueue(
            field_object=4, destinations=["queuestart_0x3ac573"], bit_2=True, bit_4=True
        ),
        SpriteQueue(
            field_object=5, destinations=["queuestart_0x3ac590"], bit_2=True, bit_4=True
        ),
