...
script = BattleAnimationScript(
    script=[
        ...
        SpriteQueue(
            field_object=1, destinations=["queuestart_0x3ad869"], bit_2=True, bit_4=True
        ),
        SpriteQueue(
            field_object=2, destinations=["queuestart_0x3ad883"], bit_2=True, bit_4=True
        ),
        SpriteQueue(
            field_object=5, destinations=["queuestart_0x3ad89d"], bit_2=True, bit_4=True
        ),
