...
script = BattleAnimationScript(script=[
	...
	SpriteQueue(field_object=0, destinations=["queuestart_0x3ad4bb"], bit_2=True, bit_4=True),
	RunSubroutine(["command_0x3a7734"]),
	PauseScriptUntil(condition=FRAMES_ELAPSED, frames=16),
	SpriteQueue(field_object=0, destinations=["queuestart_0x3ad65a"], bit_2=True, bit_4=True),
	SpriteQueue(field_object=2, destinations=["queuestart_0x3ad576"], bit_2=True, bit_4=True),
	Pause1Frame(),
