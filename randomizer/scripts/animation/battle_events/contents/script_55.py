...
script = BattleAnimationScript(script=[
	...
	SpriteQueue(field_object=1, destinations=["queuestart_0x3ad7e7"], bit_2=True, bit_4=True),
	SpriteQueue(field_object=2, destinations=["queuestart_0x3ad801"], bit_2=True, bit_4=True),
