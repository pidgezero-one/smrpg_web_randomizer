...
script = BattleAnimationScript(
    script=[
        ...
        SpriteQueue(
            field_object=0,
            destinations=["queuestart_0x3ac64c"],
            character_slot=True,
            bit_4=True),
        SpriteQueue(
            field_object=1,
            destinations=["queuestart_0x3ac69e"],
            character_slot=True,
            bit_4=True),
        SpriteQueue(
            field_object=2,
            destinations=["queuestart_0x3ac729"],
            character_slot=True,
            bit_4=True),
        Jmp(["command_0x3a64a6"]),
        JmpIfAMEM8BitNotEqualsConst(
            0x68, 1, ["command_0x3a64a1"], identifier="command_0x3a648e"
        ),
        SpriteQueue(
            field_object=0,
            destinations=["queuestart_0x3ac64c"],
        ...
        SpriteQueue(
            ...
            character_slot=True,
            bit_4=True,
            identifier="command_0x3a64a1"),
        Pause1Frame(identifier="command_0x3a64a6"),
        ClearAMEM8Bit(0x68),
        SetAMEM8BitToConst(0x68, 1),
        Set7E1xToAMEM8Bit(0x7EE007, 0x68),
        SpriteQueue(
            field_object=0, destinations=["queuestart_0x3ac795"], bit_2=True, bit_4=True
        ),
        SpriteQueue(
            field_object=1, destinations=["queuestart_0x3ac7cf"], bit_2=True, bit_4=True
        ),
        SpriteQueue(
            field_object=2, destinations=["queuestart_0x3ac7ec"], bit_2=True, bit_4=True
        ),
