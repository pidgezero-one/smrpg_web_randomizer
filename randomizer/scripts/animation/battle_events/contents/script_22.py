...
script = BattleAnimationScript(header=["command_0x3a6352"], script = [
	...
	JmpIfAMEM8BitLessThanConst(0x68, 3, ["99"]),
	...
	SpriteQueue(field_object=1, destinations=["queuestart_0x3ac345"], bit_2=True, bit_4=True, identifier="command_0x3a6352"),
