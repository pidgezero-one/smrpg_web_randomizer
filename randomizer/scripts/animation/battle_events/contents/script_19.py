...
script = BattleAnimationScript(script=[
	...
	SpriteQueue(field_object=0, destinations=["queuestart_0x3abf91"], bit_2=True, bit_4=True),
	SpriteQueue(field_object=1, destinations=["queuestart_0x3abfca"], bit_2=True, bit_4=True),
