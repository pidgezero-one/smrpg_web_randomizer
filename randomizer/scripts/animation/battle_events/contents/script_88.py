...
script = BattleAnimationScript(script=[
	...
	SpriteQueue(field_object=1, destinations=["queuestart_0x3ae254"], bit_2=True, bit_4=True, identifier="command_0x3a6e1c"),
	Jmp(["command_0x3a6e3f"]),
	SpriteQueue(field_object=1, destinations=["queuestart_0x3ae231"], bit_2=True, bit_4=True, identifier="command_0x3a6e24"),
	Jmp(["command_0x3a6e3f"]),
	SpriteQueue(field_object=1, destinations=["queuestart_0x3ae231"], bit_2=True, bit_4=True, identifier="command_0x3a6e2c"),
	Jmp(["command_0x3a6e3f"]),
	SpriteQueue(field_object=1, destinations=["queuestart_0x3ae277"], bit_2=True, bit_4=True, identifier="command_0x3a6e34"),
	ClearAMEM8Bit(0x60),
	Set7E1xToAMEM8Bit(0x7EE009, 0x60),
