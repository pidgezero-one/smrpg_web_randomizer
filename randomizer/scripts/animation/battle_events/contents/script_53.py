...
script = BattleAnimationScript(
    script=[
        ...
        SpriteQueue(
            field_object=1, destinations=["queuestart_0x3ad456"], bit_2=True, bit_4=True
        ),
        RunSubroutine(["command_0x3a7734"]),
        PauseScriptUntil(condition=FRAMES_ELAPSED, frames=16),
        SpriteQueue(
            field_object=1, destinations=["queuestart_0x3ad5c1"], bit_2=True, bit_4=True
        ),
        SpriteQueue(
            field_object=2, destinations=["queuestart_0x3ad52b"], bit_2=True, bit_4=True
        ),
        Pause1Frame(),
        SpriteQueue(
            field_object=0,
