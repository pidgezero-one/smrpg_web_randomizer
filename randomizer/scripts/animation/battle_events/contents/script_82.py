...
script = BattleAnimationScript(
    script=[
        ...
        SpriteQueue(
            field_object=0, destinations=["queuestart_0x3ae6a0"], bit_2=True, bit_4=True
        ),
        SpriteQueue(
            field_object=1, destinations=["queuestart_0x3ae857"], bit_2=True, bit_4=True
        ),
        SpriteQueue(
            field_object=2, destinations=["queuestart_0x3ae8ce"], bit_2=True, bit_4=True
        ),
        SpriteQueue(
            field_object=3, destinations=["queuestart_0x3ae93b"], bit_2=True, bit_4=True
        ),
        SpriteQueue(
            field_object=0,
            destinations=["queuestart_0x3ae966"],
            character_slot=True,
            bit_4=True,
        ),
        ...
        SpriteQueue(
            field_object=1,
            destinations=["queuestart_0x3aea25"],
            character_slot=True,
            bit_4=True,
        ),
        ...
        SpriteQueue(
            field_object=2,
            destinations=["queuestart_0x3aeaf0"],
            character_slot=True,
            bit_4=True,
        ),
