...
script = BattleAnimationScript(
    script=[
        ...
        SpriteQueue(
            field_object=0, destinations=["queuestart_0x3acf5b"], bit_2=True, bit_4=True
        ),
        SpriteQueue(
            field_object=1, destinations=["queuestart_0x3acf74"], bit_2=True, bit_4=True
        ),
        SpriteQueue(
            field_object=0,
            destinations=["queuestart_0x3ad040"],
            character_slot=True,
            bit_4=True,
        ),
        SpriteQueue(
            field_object=1,
            destinations=["queuestart_0x3ad07e"],
            character_slot=True,
            bit_4=True,
        ),
        ...
        SpriteQueue(
            field_object=2,
            destinations=["queuestart_0x3ad11c"],
            character_slot=True,
            bit_4=True,
        ),
