...
script = SubroutineOrBanklessScript(expected_size = 89, script = [
	SetAMEM32ToXYZCoords(origin=CASTER_CURRENT_POSITION, x=0, y=256, z=0, set_x=True, set_y=True, set_z=True, identifier="queuestart_0x3583e1"),
	...
	Db(bytearray(b'\x81')),
	ReturnObjectQueue(),
	PauseScriptUntil(condition=FRAMES_ELAPSED, frames=5, identifier="queuestart_0x35840f"),
