...
script = ActionScript([
	...
	JmpIf700CAnyBitsSet(destinations=["ACTION_671_jmp_if_bit_set_4"]),
	...
	SetSpriteSequence(index=8, is_sequence=True, looping=True, mirror_sprite=True, identifier="ACTION_671_set_sprite_sequence_19"),
	Jmp(["ACTION_671_set_bit_26"]),
	SetSpriteSequence(index=8, is_sequence=True, looping=True, identifier="ACTION_671_set_sprite_sequence_21"),
	Jmp(["ACTION_671_set_bit_26"]),
	SetSpriteSequence(index=9, is_sequence=True, looping=True, identifier="ACTION_671_set_sprite_sequence_23"),
	Jmp(["ACTION_671_set_bit_26"]),
	SetSpriteSequence(index=9, is_sequence=True, looping=True, mirror_sprite=True, identifier="ACTION_671_set_sprite_sequence_25"),
