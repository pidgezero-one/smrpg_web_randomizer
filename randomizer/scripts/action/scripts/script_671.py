...
script = ActionScript(
    [
        ...
        JmpIf700CAnyBitsSet(bits=[], destinations=["ACTION_671_jmp_if_bit_set_4"]),
        SetBit(YOSTER_ISLE_LIBERATED_1),
        JmpIfBitSet(
            TEMP_7049_2,
            ["ACTION_671_jmp_if_bit_set_6"],
            identifier="ACTION_671_jmp_if_bit_set_4",
        ),
        SetSequenceSpeed(VERY_FAST),
        JmpIfBitSet(
            YOSTER_ISLE_LIBERATED_1,
            ["ACTION_671_set_700C_to_70A0_short_mem_11"],
        ...
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 0, ["ACTION_671_set_sprite_sequence_19"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 64, ["ACTION_671_set_sprite_sequence_21"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 128, ["ACTION_671_set_sprite_sequence_23"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 192, ["ACTION_671_set_sprite_sequence_25"]
        ),
        SetSpriteSequence(
            index=8,
            is_sequence=True,
