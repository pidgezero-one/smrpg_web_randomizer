...
script = ActionScript(
    [
        ...
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 20, ["ACTION_693_set_700C_to_object_coord_31"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 21, ["ACTION_693_set_700C_to_object_coord_38"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 22, ["ACTION_693_set_700C_to_object_coord_45"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 23, ["ACTION_693_set_700C_to_object_coord_52"]
        ),
        Return(),
