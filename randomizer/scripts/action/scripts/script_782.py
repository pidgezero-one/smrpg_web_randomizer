...
script = ActionScript([
	SetBit(TEMP_7043_0),
	SetBit(TEMP_7044_6),
	SetSpriteSequence(index=0, is_sequence=True, looping=True, identifier="ACTION_782_set_sprite_sequence_2"),
	...
	SetSpriteSequence(index=2, is_sequence=True, looping=True, identifier="ACTION_782_set_sprite_sequence_17"),
	...
	SetSpriteSequence(index=0, is_sequence=True, looping=True, identifier="ACTION_782_set_sprite_sequence_28"),
	JmpIfBitClear(TEMP_7043_0, ["ACTION_783_clear_bit_61"]),
	SetVarToConst(TEMP_7032, 0),
	...
	PlaySound(sound=SO144_CLICK, channel=4),
	SetSpriteSequence(index=1, is_sequence=True, looping=True, identifier="ACTION_782_set_sprite_sequence_43"),
