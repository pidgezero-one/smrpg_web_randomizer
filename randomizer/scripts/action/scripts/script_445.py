...
script = ActionScript([
	...
	ShiftZUpSteps(3),
	Db(bytearray(b' \x03')),
	EmbeddedAnimationRoutine(bytearray(b'&\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01 \x00\x00\x02\x80')),
	EmbeddedAnimationRoutine(bytearray(b"\'\x00\x00\x00\x00\x00@\x00\x00\x00\x01 \x00\x00\x02\x80")),
	Pause(512),
	EmbeddedAnimationRoutine(bytearray(b'&\x00\x00\x00\x00\x00\x00\x00@\x00\x01\xe0\xff\x00\x02\x80')),
	EmbeddedAnimationRoutine(bytearray(b"\'\x00\x00\x00\x00\x00@\x00@\x00\x01\xe0\xff\x00\x02\x80")),
	Pause(512),
	BPL262728(),
	Set700CToPressedButton(),
	CopyVarToVar(from_var=PRIMARY_TEMP_700C, to_var=TEMP_70AF),
	...
	Jmp(["ACTION_445_set_priority_0"]),
	SetObjectMemoryBits(arg_1=0x0E, bits=[2], identifier="ACTION_445_set_object_memory_bits_51"),
	IncPaletteRowBy(1),
	...
	SetSpriteSequence(index=4, is_mold=True, is_sequence=True, looping=True, identifier="ACTION_445_set_sprite_sequence_71"),
	Pause(256),
	...
	SetSpriteSequence(index=5, is_mold=True, is_sequence=True, looping=True),
	Pause(48),
	CreatePacketAtObjectCoords(packet=P030_WATER_SPLASH_DROPS_SFX, object=DUMMY_0X07, destinations=["ACTION_445_set_sprite_sequence_84"]),
	SetSpriteSequence(index=5, is_sequence=True, looping=True, identifier="ACTION_445_set_sprite_sequence_84"),
	SetPriority(3),
	IncPaletteRowBy(15),
	Set700CToPressedButton(),
	...
	SetSpriteSequence(index=6, is_mold=True, is_sequence=True, looping=True, identifier="ACTION_445_set_sprite_sequence_102"),
	SetObjectMemoryBits(arg_1=0x0E, bits=[]),
	Set700CToPressedButton(),
	JmpIfVarEqualsConst(PRIMARY_TEMP_700C, 34, ["ACTION_445_bounce_to_xy_with_height_110"]),
	JmpIfVarEqualsConst(PRIMARY_TEMP_700C, 35, ["ACTION_445_bounce_to_xy_with_height_112"]),
	JmpIfVarEqualsConst(PRIMARY_TEMP_700C, 36, ["ACTION_445_bounce_to_xy_with_height_114"]),
	BounceToXYWithHeight(x=8, y=40, height=0),
	Jmp(["ACTION_445_create_packet_at_npc_coords_115"]),
	BounceToXYWithHeight(x=17, y=42, height=0, identifier="ACTION_445_bounce_to_xy_with_height_110"),
	Jmp(["ACTION_445_create_packet_at_npc_coords_115"]),
	BounceToXYWithHeight(x=14, y=26, height=0, identifier="ACTION_445_bounce_to_xy_with_height_112"),
	Jmp(["ACTION_445_create_packet_at_npc_coords_115"]),
	BounceToXYWithHeight(x=23, y=38, height=0, identifier="ACTION_445_bounce_to_xy_with_height_114"),
	CreatePacketAtObjectCoords(packet=P030_WATER_SPLASH_DROPS_SFX, object=DUMMY_0X07, destinations=["ACTION_445_jmp_116"], identifier="ACTION_445_create_packet_at_npc_coords_115"),
