...
script = ActionScript(
    [
        ...
        TransferToXYZF(
            x=17, y=47, z=0, direction=EAST, identifier="ACTION_471_transfer_to_xyzf_18"
        ),
        FaceNorthwest(),
        Jmp(["ACTION_471_visibility_on_26"]),
        TransferToXYZF(
            x=3, y=36, z=0, direction=EAST, identifier="ACTION_471_transfer_to_xyzf_21"
        ),
        FaceNortheast(),
        Jmp(["ACTION_471_visibility_on_26"]),
        TransferToXYZF(
            x=3, y=37, z=0, direction=EAST, identifier="ACTION_471_transfer_to_xyzf_24"
        ),
        FaceNortheast(),
        VisibilityOn(identifier="ACTION_471_visibility_on_26"),
        WalkFDirectionSteps(15),
