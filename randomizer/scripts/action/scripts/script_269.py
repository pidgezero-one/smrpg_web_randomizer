...
script = ActionScript(
    [
        ...
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 1, ["ACTION_269_set_sprite_sequence_12"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 0, ["ACTION_269_set_sprite_sequence_12"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 7, ["ACTION_269_set_sprite_sequence_12"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 2, ["ACTION_269_set_sprite_sequence_12"]
        ),
        ...
        FaceEast7C(),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 1, ["ACTION_269_set_sprite_sequence_22"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 0, ["ACTION_269_set_sprite_sequence_22"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 7, ["ACTION_269_set_sprite_sequence_22"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 2, ["ACTION_269_set_sprite_sequence_22"]
        ),
        SetSpriteSequence(index=8, is_sequence=True, looping=True),
