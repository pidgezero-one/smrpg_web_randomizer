...
script = ActionScript([
	...
	VisibilityOn(),
	Db(bytearray(b' \x03')),
	EmbeddedAnimationRoutine(bytearray(b'&\x00\x00\x00\x00\x00\x00\x000\x00\x01\x00\x00\x00\x04\x80')),
	EmbeddedAnimationRoutine(bytearray(b"\'\x00\x00\x00\x00\x00\xc0\x00 \x00\x01\x00\x00\x00\x04\x80")),
