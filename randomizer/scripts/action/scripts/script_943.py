...
script = ActionScript([
	...
	SetSpriteSequence(index=1, is_sequence=True, looping=True, identifier="ACTION_943_set_sprite_sequence_4"),
	...
	CreatePacketAtObjectCoords(packet=P047_BLUE_FIRE_TRAIL, object=MARIO, destinations=["ACTION_943_pause_18"]),
	Pause(6, identifier="ACTION_943_pause_18"),
	JmpIfBitSet(TEMP_7044_4, ["ACTION_943_visibility_off_21"]),
	CreatePacketAtObjectCoords(packet=P047_BLUE_FIRE_TRAIL, object=MARIO, destinations=["ACTION_943_visibility_off_21"]),
	VisibilityOff(identifier="ACTION_943_visibility_off_21"),
	Return(),
	SetSpriteSequence(index=1, is_sequence=True, looping=True, identifier="ACTION_943_set_sprite_sequence_23"),
	Inc(TEMP_70AE),
	...
	CreatePacketAtObjectCoords(packet=P047_BLUE_FIRE_TRAIL, object=NPC_2, destinations=["ACTION_943_pause_31"]),
	Pause(6, identifier="ACTION_943_pause_31"),
	JmpIfBitSet(TEMP_7043_0, ["ACTION_943_visibility_off_21"]),
	CreatePacketAtObjectCoords(packet=P047_BLUE_FIRE_TRAIL, object=NPC_2, destinations=["ACTION_943_visibility_off_34"]),
	VisibilityOff(identifier="ACTION_943_visibility_off_34"),
	Return(),
	Pause(6, identifier="ACTION_943_pause_36"),
	JmpIfBitSet(TEMP_7043_0, ["ACTION_943_visibility_off_21"]),
	CreatePacketAtObjectCoords(packet=P047_BLUE_FIRE_TRAIL, object=NPC_3, destinations=["ACTION_943_pause_39"]),
	Pause(6, identifier="ACTION_943_pause_39"),
	JmpIfBitSet(TEMP_7043_0, ["ACTION_943_visibility_off_21"]),
	CreatePacketAtObjectCoords(packet=P047_BLUE_FIRE_TRAIL, object=NPC_3, destinations=["ACTION_943_visibility_off_42"]),
	VisibilityOff(identifier="ACTION_943_visibility_off_42"),
	Return(),
	SetVarToConst(TEMP_70AE, 0, identifier="ACTION_943_set_44"),
	Pause(6),
	JmpIfBitSet(TEMP_7043_0, ["ACTION_943_visibility_off_21"]),
	CreatePacketAtObjectCoords(packet=P047_BLUE_FIRE_TRAIL, object=NPC_4, destinations=["ACTION_943_pause_48"]),
	Pause(6, identifier="ACTION_943_pause_48"),
	JmpIfBitSet(TEMP_7043_0, ["ACTION_943_visibility_off_21"]),
	CreatePacketAtObjectCoords(packet=P047_BLUE_FIRE_TRAIL, object=NPC_4, destinations=["ACTION_943_visibility_off_51"]),
