...
script = ActionScript([
	SetSpriteSequence(index=0, is_sequence=True, looping=True, mirror_sprite=True, identifier="ACTION_194_set_sprite_sequence_0"),
	...
	SetSpriteSequence(index=3, is_sequence=True, looping=True, mirror_sprite=True, identifier="ACTION_194_set_sprite_sequence_4"),
