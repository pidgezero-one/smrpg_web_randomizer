...
script = ActionScript([
	...
	SetSpriteSequence(index=3, is_sequence=True, looping=False, mirror_sprite=True, identifier="ACTION_60_set_sprite_sequence_50"),
	Jmp(["ACTION_60_set_animation_speed_53"]),
	SetSpriteSequence(index=3, is_sequence=True, looping=False, identifier="ACTION_60_set_sprite_sequence_52"),
