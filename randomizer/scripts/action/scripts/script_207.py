...
script = ActionScript([
	...
	SetPriority(3),
	SetSpriteSequence(index=1, is_sequence=True, looping=True, identifier="ACTION_207_set_sprite_sequence_2"),
	...
	SetSpriteSequence(index=0, is_sequence=True, looping=True, identifier="ACTION_207_set_sprite_sequence_11"),
	...
	SetSpriteSequence(index=3, is_sequence=True, looping=True, identifier="ACTION_207_set_sprite_sequence_20"),
