...
script = ActionScript([
	...
	PlaySound(sound=SO117_SPINNING_MONSTER, channel=4, identifier="ACTION_272_play_sound_17"),
	...
	SetSpriteSequence(index=6, is_mold=True, is_sequence=True, looping=True, mirror_sprite=True, identifier="ACTION_272_set_sprite_sequence_30"),
	ObjectMemorySetBit(arg_1=0x30, bits=[4]),
	ClearSolidityBits(bit_4=True, cant_walk_through=True),
	Set700CToPressedButton(),
	Mem700CAndConst(0x0003),
	...
	PlaySound(sound=SO117_SPINNING_MONSTER, channel=4, identifier="ACTION_272_play_sound_42"),
	SetSpriteSequence(index=8, looping=False),
	Pause(18),
	ObjectMemoryClearBit(arg_1=0x30, bits=[4]),
	SetSolidityBits(bit_4=True, cant_walk_through=True),
