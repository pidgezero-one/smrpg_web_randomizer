...
script = ActionScript([
	...
	SetSpriteSequence(index=0, sprite_offset=3, is_mold=True, is_sequence=True, looping=True, mirror_sprite=True),
	ShiftToXYCoords(x=3, y=74),
	SetWalkingSpeed(FASTEST),
	ShiftSoutheastPixels(4),
	ShiftNorthPixels(8),
	SetSpriteSequence(index=0, sprite_offset=3, is_mold=True, is_sequence=True, looping=True, identifier="ACTION_485_set_sprite_sequence_6"),
	Pause(10),
	SetSpriteSequence(index=0, sprite_offset=3, is_mold=True, is_sequence=True, looping=True, mirror_sprite=True),
	Pause(10),
