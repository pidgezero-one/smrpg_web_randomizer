...
script = ActionScript(
    [
        ...
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 4, ["ACTION_187_jmp_if_var_equals_const_18"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 3, ["ACTION_187_jmp_if_var_equals_const_18"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 2, ["ACTION_187_jmp_if_var_equals_const_18"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 1, ["ACTION_187_jmp_if_var_equals_const_18"]
        ),
