...
script = ActionScript([
	...
	SetBit(TEMP_7044_7),
	Pause(48),
	CreatePacketAt7010WithEvent(packet=P028_MUSHROOM_THROWN_SOUTHWEST, event_id=E3077_SHIP_PUZZLE_MUSHROOM, destinations=["ACTION_439_reset_properties_37"]),
	...
	Db(bytearray(b'\xc7\x07')),
	Pause(48),
	CreatePacketAt7010WithEvent(packet=P028_MUSHROOM_THROWN_SOUTHWEST, event_id=E3077_SHIP_PUZZLE_MUSHROOM, destinations=["ACTION_439_reset_properties_50"]),
