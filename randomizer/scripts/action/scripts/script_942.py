...
script = ActionScript(
    [
        ...
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 13, ["ACTION_942_set_700C_to_pressed_button_37"]
        ),
        ClearSolidityBits(bit_4=True, cant_walk_through=True),
        ObjectMemorySetBit(arg_1=0x30, bits=[4]),
        VisibilityOff(),
        ClearSolidityBits(cant_pass_walls=True),
        WalkSoutheastPixels(7),
        ...
        EmbeddedAnimationRoutine(
            bytearray(b"(\x00\x00\x00\x00\x00\x00\x00\x03\x00\x01\x00\x00\x00\x03\x80")
        ),
        Pause(1, identifier="ACTION_942_pause_41"),
        Jmp(["ACTION_942_pause_41"]),
        Db(bytearray(b" \x04"), identifier="ACTION_942_db_43"),
        EmbeddedAnimationRoutine(
            bytearray(b"(\x00\x00\x00\x00\x00\x80\x00\x03\x00\x01\x00\x00\x00\x03\x80")
        ),
