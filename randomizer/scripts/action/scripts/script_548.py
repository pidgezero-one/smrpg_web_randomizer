...
script = ActionScript(
    [
        ...
        Pause(1),
        EndLoop(),
        WalkNorthwestPixels(37, identifier="ACTION_548_shift_northwest_pixels_7"),
        ...
        WalkNorthwestPixels(37, identifier="ACTION_548_shift_northwest_pixels_30"),
        Pause(8),
        FaceNortheast(),
        Pause(8),
        FaceSoutheast(),
