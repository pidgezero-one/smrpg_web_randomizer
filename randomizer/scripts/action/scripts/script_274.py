...
script = ActionScript([
	...
	Set700CToObjectCoord(object=MARIO, coord=COORD_Y, pixel=True, identifier="ACTION_274_set_700C_to_object_coord_13"),
	CopyVarToVar(from_var=PRIMARY_TEMP_700C, to_var=TEMP_7028),
	Set700CToObjectCoord(object=DUMMY_0X07, coord=COORD_Y, pixel=True),
	DecVarFrom700C(TEMP_7028),
	AddConstToVar(PRIMARY_TEMP_700C, 256),
	...
	Set700CToObjectCoord(object=MARIO, coord=COORD_Z, pixel=True, identifier="ACTION_274_set_700C_to_object_coord_25"),
	AddConstToVar(PRIMARY_TEMP_700C, 192),
	CopyVarToVar(from_var=PRIMARY_TEMP_700C, to_var=TEMP_7028),
	Set700CToObjectCoord(object=DUMMY_0X07, coord=COORD_Z, pixel=True),
	...
	Set700CToObjectCoord(object=MARIO, coord=COORD_F, pixel=True, identifier="ACTION_274_set_700C_to_object_coord_53"),
	CopyVarToVar(from_var=PRIMARY_TEMP_700C, to_var=TEMP_7028),
	Set700CToObjectCoord(object=DUMMY_0X07, coord=COORD_F, pixel=True),
	DecVarFrom700C(TEMP_7028),
	Mem700CAndConst(0x0007),
	...
	Jmp(["ACTION_274_pause_38"]),
	SetSpriteSequence(index=8, looping=False, mirror_sprite=True, identifier="ACTION_274_set_sprite_sequence_70"),
	Jmp(["ACTION_274_pause_38"]),
	SetSpriteSequence(index=8, looping=False, identifier="ACTION_274_set_sprite_sequence_72"),
	Jmp(["ACTION_274_pause_38"]),
	SetSpriteSequence(index=9, looping=False, identifier="ACTION_274_set_sprite_sequence_74"),
	Jmp(["ACTION_274_pause_38"])
])
