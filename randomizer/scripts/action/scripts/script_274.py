...
script = ActionScript(
    [
        SetSequenceSpeed(SLOW, identifier="ACTION_274_set_animation_speed_0"),
        SequenceLoopingOn(),
        ...
        JmpIfComparisonResultIsGreaterOrEqual(
            ["ACTION_274_set_700C_to_object_coord_13"]
        ),
        ...
        CopyVarToVar(from_var=PRIMARY_TEMP_700C, to_var=TEMP_7028),
        Set700CToObjectCoord(target_npc=DUMMY_0X07, coord=COORD_Y, pixel=True),
        DecVarFrom700C(TEMP_7028),
        AddConstToVar(PRIMARY_TEMP_700C, 256),
        ...
        WalkFDirectionPixels(1, identifier="ACTION_274_shift_f_direction_pixels_24"),
        Set700CToObjectCoord(
            target_npc=MARIO,
            coord=COORD_Z,
            pixel=True,
        ...
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 0, ["ACTION_274_set_700C_to_object_coord_53"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 1, ["ACTION_274_set_700C_to_object_coord_53"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 7, ["ACTION_274_set_700C_to_object_coord_53"]
        ),
        ...
        Mem700CAndConst(0x0007),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 3, ["ACTION_274_sequence_looping_off_63"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 4, ["ACTION_274_sequence_looping_off_63"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 5, ["ACTION_274_sequence_looping_off_63"]
        ),
        JmpIfObjectWithinRangeSameZ(
            comparing_npc=MARIO,
            usually=80,
            tiles=0,
            destinations=["ACTION_274_set_700C_to_object_coord_25"],
        ),
        Jmp(["ACTION_274_set_animation_speed_0"]),
        SequenceLoopingOff(identifier="ACTION_274_sequence_looping_off_63"),
        Set700CToObjectCoord(target_npc=DUMMY_0X07, coord=COORD_F, pixel=True),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 1, ["ACTION_274_set_sprite_sequence_70"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 3, ["ACTION_274_set_sprite_sequence_72"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 5, ["ACTION_274_set_sprite_sequence_74"]
        ),
        ...
        Jmp(["ACTION_274_pause_38"]),
        SetSpriteSequence(
            index=8, looping=False, identifier="ACTION_274_set_sprite_sequence_72"
        ),
        Jmp(["ACTION_274_pause_38"]),
        SetSpriteSequence(
            index=9, looping=False, identifier="ACTION_274_set_sprite_sequence_74"
        ),
        Jmp(["ACTION_274_pause_38"]),
    ]
)
