...
script = ActionScript(
    [
        ...
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 20, ["ACTION_691_set_700C_to_object_coord_30"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 21, ["ACTION_691_set_700C_to_object_coord_37"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 22, ["ACTION_691_set_700C_to_object_coord_44"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 23, ["ACTION_691_set_700C_to_object_coord_51"]
        ),
        Return(),
