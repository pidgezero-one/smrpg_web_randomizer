...
script = ActionScript(
    [
        ...
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 319, ["ACTION_780_object_memory_modify_bits_44"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 403, ["ACTION_780_object_memory_modify_bits_44"]
        ),
        ...
        SetWalkingSpeed(SLOW, identifier="ACTION_780_set_animation_speed_24"),
        ...
        SetWalkingSpeed(SLOW, identifier="ACTION_780_set_animation_speed_34"),
        SetSolidityBits(cant_jump_through=True, bit_4=True, cant_walk_through=True),
        WalkFDirectionSteps(2, identifier="ACTION_780_shift_f_direction_steps_36"),
        TurnClockwise45DegreesNTimes(7),
        Walk1StepFDirection(),
        JmpIfBitClear(
            TEMP_7043_2,
        ...
        SetWalkingSpeed(NORMAL, identifier="ACTION_780_set_animation_speed_53"),
        FaceMario(),
        ...
        TurnClockwise45DegreesNTimes(
            4, identifier="ACTION_780_turn_clockwise_45_degrees_n_times_60"
        ),
        Pause(8),
        Jmp(["ACTION_780_walk_1_step_f_direction_65"]),
        TurnClockwise45DegreesNTimes(
            6, identifier="ACTION_780_turn_clockwise_45_degrees_n_times_63"
        ),
        Pause(8),
        Walk1StepFDirection(identifier="ACTION_780_walk_1_step_f_direction_65"),
        Jmp(["ACTION_780_object_memory_modify_bits_44"]),
        SetWalkingSpeed(FAST, identifier="ACTION_780_set_animation_speed_67"),
        ...
        TurnClockwise45DegreesNTimes(
            4, identifier="ACTION_780_turn_clockwise_45_degrees_n_times_75"
        ),
        Jmp(["ACTION_780_walk_1_step_f_direction_78"]),
        TurnClockwise45DegreesNTimes(
            5, identifier="ACTION_780_turn_clockwise_45_degrees_n_times_77"
        ),
