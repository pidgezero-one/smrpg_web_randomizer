...
script = ActionScript([
	...
	Pause(46),
	EndLoop(),
	SetSpriteSequence(index=13, sprite_offset=2, is_mold=True, is_sequence=True, looping=True),
	Pause(32),
	SetSpriteSequence(index=18, is_mold=True, is_sequence=True, looping=True, mirror_sprite=True),
	Pause(56),
	ResetProperties(),
