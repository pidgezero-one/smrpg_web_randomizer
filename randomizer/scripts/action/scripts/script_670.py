...
script = ActionScript(
    [
        ...
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 64, ["ACTION_670_start_loop_n_times_22"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 128, ["ACTION_670_start_loop_n_times_29"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 192, ["ACTION_670_start_loop_n_times_36"]
        ),
