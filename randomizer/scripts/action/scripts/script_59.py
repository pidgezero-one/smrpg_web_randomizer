...
script = ActionScript([
	...
	Set700CToObjectCoord(object=DUMMY_0X07, coord=COORD_F, pixel=True, identifier="ACTION_59_set_700C_to_object_coord_23"),
	...
	Return(),
	SetSpriteSequence(index=21, is_mold=True, is_sequence=True, looping=True, mirror_sprite=True, identifier="ACTION_59_set_sprite_sequence_32"),
	Pause(8),
	SetSpriteSequence(index=22, is_mold=True, is_sequence=True, looping=True, mirror_sprite=True),
	Pause(8),
	JmpIfBitClear(TEMP_7044_7, ["ACTION_59_set_700C_to_object_coord_23"]),
