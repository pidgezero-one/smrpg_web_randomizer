...
script = ActionScript(
    [
        ...
        JmpIfVarEqualsConst(
            MINES_MIDBOSS_POSITION, 17, ["ACTION_730_transfer_to_xyzf_29"]
        ),
        SetBit(TEMP_7044_6),
        ...
        Jmp(["ACTION_730_jmp_if_bit_set_3"]),
        TransferToXYZF(
            x=3, y=48, z=0, direction=EAST, identifier="ACTION_730_transfer_to_xyzf_29"
        ),
        ...
        ObjectMemoryClearBit(
            arg_1=0x30, bits=[4], identifier="ACTION_730_object_memory_clear_bit_40"
        ),
