...
script = ActionScript([
	...
	ShadowOn(),
	VisibilityOn(),
	SetSpriteSequence(index=9, is_mold=True, is_sequence=True, looping=True, mirror_sprite=True),
	Pause(6),
	SetSpriteSequence(index=8, is_mold=True, is_sequence=True, looping=True, mirror_sprite=True),
	Pause(6),
	SetSpriteSequence(index=7, is_mold=True, is_sequence=True, looping=True, mirror_sprite=True),
	Pause(6),
