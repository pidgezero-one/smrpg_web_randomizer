...
script = ActionScript(
    [
        ...
        Pause(80),
        JmpToSubroutine(
            ["ACTION_306_visibility_on_9"], identifier="ACTION_306_jmp_to_subroutine_5"
        ),
        ...
        EmbeddedAnimationRoutine(
            bytearray(b"&\x00\x00\x00\x00\x00\x80\x00\x08\x00\x01\xf0\xff\x00\x10\x80")
        ),
        EmbeddedAnimationRoutine(
            bytearray(b"'\x00\x00\x00\x00\x00@\x00\x04\x00\x01\xf8\xff\x00\x10\x80")
        ),
        ShiftZDownSteps(5),
        BPL262728(),
        VisibilityOff(),
