...
script = ActionScript([
	...
	CreatePacketAt7010(packet=P032_BLUE_CLOUD, destinations=["ACTION_976_end_loop_7"]),
	Pause(2),
	...
	AddConstToVar(TEMP_7034, 1),
	AddConstToVar(Z_COORD_1, 8),
	CreatePacketAt7010(packet=P032_BLUE_CLOUD, destinations=["ACTION_976_end_loop_15"]),
	Pause(2),
