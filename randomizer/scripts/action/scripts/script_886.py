...
script = ActionScript([
	...
	Pause(2),
	SetSpriteSequence(index=11, is_mold=True, is_sequence=True, looping=True, mirror_sprite=True),
	Pause(2),
	SetSpriteSequence(index=12, is_mold=True, is_sequence=True, looping=True, mirror_sprite=True),
	Pause(6),
	SetSpriteSequence(index=13, is_mold=True, is_sequence=True, looping=True, mirror_sprite=True),
	Pause(2),
	SetBit(TEMP_7043_0),
	Pause(2),
	JmpIfRandom1of2(["ACTION_886_set_sprite_sequence_29"]),
	Pause(4),
	SetSpriteSequence(index=14, is_mold=True, is_sequence=True, looping=True, mirror_sprite=True, identifier="ACTION_886_set_sprite_sequence_29"),
	Pause(30),
	...
	Pause(4),
	SetSpriteSequence(index=14, is_mold=True, is_sequence=True, looping=True, identifier="ACTION_886_set_sprite_sequence_61"),
	Pause(2),
	Pause(10),
