...
script = ActionScript(
    [
        JmpIfRandom2of3(
            [
                "ACTION_703_set_700C_to_pressed_button_18",
                "ACTION_703_set_700C_to_pressed_button_18",
            ],
        ...
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 20, ["ACTION_703_set_sprite_sequence_7"]
        ),
        ...
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 20, ["ACTION_703_set_sprite_sequence_15"]
        ),
        ...
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 20, ["ACTION_703_set_sprite_sequence_23"]
        ),
