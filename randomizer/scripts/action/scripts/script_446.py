...
script = ActionScript([
	...
	CreatePacketAtObjectCoords(packet=P023_LOOPING_SINGLE_SPARKLE, object=MARIO, destinations=["ACTION_446_start_loop_n_times_19"]),
	...
	CreatePacketAtObjectCoords(packet=P022_RECURSIVE_SPARKLES, object=MARIO, destinations=["ACTION_446_start_loop_n_times_26"]),
