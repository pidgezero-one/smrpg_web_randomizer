...
script = ActionScript(
    [
        ...
        JmpIfVarEqualsConst(
            MINES_MIDBOSS_POSITION, 21, ["ACTION_735_transfer_to_xyzf_29"]
        ),
        SetBit(TEMP_7044_6),
        ...
        Jmp(["ACTION_735_jmp_if_bit_set_3"]),
        TransferToXYZF(
            x=16, y=58, z=4, direction=EAST, identifier="ACTION_735_transfer_to_xyzf_29"
        ),
        ...
        ObjectMemoryClearBit(
            arg_1=0x30, bits=[4], identifier="ACTION_735_object_memory_clear_bit_40"
        ),
