...
script = ActionScript(
    [
        ...
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 4, ["ACTION_859_jmp_if_var_equals_const_19"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 3, ["ACTION_859_jmp_if_var_equals_const_19"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 2, ["ACTION_859_jmp_if_var_equals_const_19"]
        ),
        JmpIfVarEqualsConst(
            PRIMARY_TEMP_700C, 1, ["ACTION_859_jmp_if_var_equals_const_19"]
        ),
