...
script = ActionScript([
	JmpIfRandom1of2(["ACTION_122_jmp_to_subroutine_4"], identifier="ACTION_122_jmp_if_random_above_128_0"),
	...
	JmpToSubroutine(["ACTION_107_set_animation_speed_0"], identifier="ACTION_122_jmp_to_subroutine_4"),
