...
from randomizer.logic.progression.prizelocations.access import (can_access_hill, expect_good_movement, not_earlygame, expect_halfway_decent_movement, almost_earlygame, is_midgame, expect_ok_movement, lategame)
...
__all__ = ["BoosterHillGuaranteedItem12"]
