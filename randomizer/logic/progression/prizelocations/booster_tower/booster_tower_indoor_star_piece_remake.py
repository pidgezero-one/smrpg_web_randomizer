...
from randomizer.logic.progression.prizelocations.access import (can_access_tower_postgame_boss, expect_good_movement, not_earlygame, expect_halfway_decent_movement, almost_earlygame, is_midgame, expect_ok_movement, lategame)
...
class BoosterTowerIndoorStarPieceRemake(StarPieceLocation):
    ...
    def can_access(self, inventory: Inventory, world: GameWorld) -> bool:
        return super().can_access(inventory, world) and can_access_tower_postgame_boss(
            world, inventory
        )
