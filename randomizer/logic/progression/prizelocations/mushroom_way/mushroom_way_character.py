...
from randomizer.logic.progression.prizelocations.access import (is_all_starting_chars_set, expect_good_movement, not_earlygame, expect_halfway_decent_movement, almost_earlygame, is_midgame, expect_ok_movement, lategame)
