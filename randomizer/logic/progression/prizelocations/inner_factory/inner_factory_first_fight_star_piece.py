...
from randomizer.logic.progression.prizelocations.inner_factory.inner_factory_first_fight import (InnerFactoryFirstFight)
...
__all__ = ["InnerFactoryFirstFightStarPiece"]
