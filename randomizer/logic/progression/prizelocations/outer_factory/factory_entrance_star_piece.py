...
from randomizer.logic.progression.prizelocations.outer_factory.factory_entrance_boss_fight import (FactoryEntranceBossFight)
...
__all__ = ["FactoryEntranceStarPiece"]
