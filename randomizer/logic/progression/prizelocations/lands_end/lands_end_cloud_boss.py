...
from randomizer.logic.progression.prizelocations.access import (can_damage_enemies_with_spells, almost_earlygame, is_early_midgame, is_late_midgame, is_lategame, expect_good_movement, not_earlygame, expect_halfway_decent_movement, is_midgame, expect_ok_movement, lategame, can_dodge_lands_end_enemies, can_pass_whirlpools, can_access_temple)
