...
from randomizer.types.prizelocation import (ShuffleLocationSelector, StandingLocationRow9, WorldAreaEnum)
...
__all__ = ["BelomeTempleTreasuryInnerUpperRightItemLocation"]
