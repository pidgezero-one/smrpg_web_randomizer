...
from randomizer.logic.progression.prizelocations.access import (can_access_sealed_door_boss)
from randomizer.logic.progression.prizelocations.monstro_town.monstro_sealed_door_boss_fight import (MonstroSealedDoorBossFight)
