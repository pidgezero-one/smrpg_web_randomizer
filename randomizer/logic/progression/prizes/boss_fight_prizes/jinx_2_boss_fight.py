...
from randomizer.data.enemies.enemies import (JINX2Enemy)
from randomizer.data.packs.pack_collection import (FORM0297_ONE_JINX2)
from randomizer.data.physical_objects.bosses import (Jinx2SmallObject, JinxStatueObject)
from randomizer.data.variables.battle_event_names import (BE0072_JINX_USES_QUICKSILVER)
