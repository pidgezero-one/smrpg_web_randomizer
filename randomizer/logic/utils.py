    ...
    for _, command in enumerate(script):
        ...
        if cmd["command"] == 'set_sprite_sequence':
            ...
            if _0x08Flags.READ_AS_MOLD in cmd["args"][2]:
                if spr == 2 and seq == 16:
                    key = "defend"
                elif spr == 2 and seq == 8:
                    key = "shocked_shadow_backwards"
                elif spr == 2 and seq == 23:
                    key = "look_up_slightly"
                elif spr == 2 and seq == 24:
                    key = "look_way_up"
            else:
                if spr == 2 and seq == 10:
                    key = "victory_pose"
    ...
    for _, command in enumerate(script):
        ...
        if cmd["command"] == 'set_sprite_sequence':
            ...
            if _0x08Flags.READ_AS_MOLD in cmd["args"][2]:
                ...
                elif spr == 0 and seq == 16:
                    key = "look_to_side"
                elif spr == 0 and seq == 17:
                    key = "look_to_down"
                elif spr == 0 and seq == 18:
                    key = "distracted"
                elif spr == 0 and seq == 19:
                    key = "look_to_side_behind"
                elif spr == 0 and seq == 20:
                    key = "south"
                elif spr == 1 and seq == 12:
                    key = "cast_frame_1"
                elif spr == 1 and seq == 13:
                    key = "cast_frame_2"
                elif spr == 1 and seq == 14:
                    key = "cast_frame_3"
                elif spr == 1 and seq == 15:
                    key = "cast_frame_4"
                elif spr == 1 and seq == 17:
                    key = "defend"
                elif spr == 1 and seq == 22:
                    key = "look_up_slightly"
                elif spr == 1 and seq == 23:
                    key = "look_way_up"
                elif spr == 2 and seq == 1:
                    key = "floored"
                elif spr == 1 and seq == 8:
                    key = "shocked_shadow_backwards"
                elif spr == 2 and seq == 13:
                    key = "hammer_static"
                elif spr == 2 and seq == 14:
                    key = "prince_neutral"
                elif spr == 2 and seq == 15:
                    key = "prince_left"
                elif spr == 2 and seq == 16:
                    key = "prince_down"
                elif spr == 2 and seq == 17:
                    key = "salute"
                elif spr == 5 and seq == 0:
                    key = "hurt"
            else:
                if spr == 0 and seq == 0:
                    key = "face_south"
                    ...
                    key = "looking_down"
                elif spr == 0 and seq == 7:
                    key = "looking_down_away"
                    ...
                    key = "sleeping"
                elif spr == 1 and seq == 9:
                    key = "joy"
                elif spr == 1 and seq == 10:
                    key = "victory_pose"
                elif spr == 2 and seq == 0:
                    key = "shocked_shadow"
                elif spr == 2 and seq == 2:
                    key = "joy_behind"
                elif spr == 2 and seq == 3:
                    key = "shocked_loop"
                elif spr == 2 and seq == 4 and room_id != 435:
                    key = "shocked_loop_backwards"
                elif spr == 2 and seq == 4:
                    key = "hammer"
                elif spr == 2 and seq == 5:
                    key = "joy_jump"
