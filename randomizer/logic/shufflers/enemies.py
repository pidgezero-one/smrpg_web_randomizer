...
from randomizer.data.packs.pack_collection import (
    ...
    FORM0004_TWO_SPIKEY_ONE_FROGOG,
    FORM0005_ONE_SKYTROOPA,
    FORM0006_TWO_SKYTROOPA,
    FORM0007_TWO_SKYTROOPA_ONE_GOOMBA,
    FORM0008_TWO_SKYTROOPA_ONE_FROGOG,
    FORM0009_TWO_GOOMBA,
    FORM0010_THREE_GOOMBA,
    FORM0011_ONE_GOOMBA_ONE_FROGOG_ONE_SPIKEY,
    FORM0012_TWO_GOOMBA_ONE_SPIKEY,
    FORM0014_TWO_K9,
    FORM0015_TWO_K9_ONE_SPIKEY,
    FORM0016_ONE_K9_TWO_FROGOG,
    FORM0017_TWO_SHYSTER,
    FORM0018_THREE_SHYSTER,
    FORM0019_TWO_RATFUNK,
    FORM0020_TWO_RATFUNK_ONE_SHADOW,
    FORM0021_TWO_RATFUNK_ONE_HOBGOBLIN,
    FORM0022_ONE_RATFUNK_TWO_HOBGOBLIN,
    FORM0023_ONE_THEBIGBOO_ONE_SHADOW,
    FORM0024_ONE_THEBIGBOO_ONE_SHADOW_ONE_HOBGOBLIN,
    FORM0025_THREE_THEBIGBOO_ONE_SHADOW,
    FORM0028_TWO_CROOK,
    FORM0029_TWO_CROOK_ONE_SHYGUY,
    FORM0030_ONE_CROOK_TWO_SNAPDRAGON,
    FORM0031_ONE_CROOK_ONE_STARSLAP_ONE_ARACHNE,
    FORM0032_ONE_SHYGUY_ONE_STARSLAP,
    FORM0033_TWO_SHYGUY_ONE_SNAPDRAGON,
    FORM0034_ONE_SHYGUY_ONE_CROOK_ONE_ARACHNE,
    FORM0035_ONE_STARSLAP_ONE_SHYGUY,
    FORM0036_ONE_STARSLAP_ONE_ARACHNE,
    FORM0037_ONE_STARSLAP_TWO_SNAPDRAGON,
    FORM0038_FOUR_STARSLAP,
    FORM0043_TWO_AMANITA,
    FORM0044_TWO_AMANITA_ONE_BUZZER,
    FORM0045_TWO_AMANITA_ONE_OCTOLOT,
    FORM0046_ONE_AMANITA_ONE_GUERRILLA_ONE_BUZZER,
    FORM0047_ONE_BUZZER_ONE_OCTOLOT,
    FORM0048_TWO_BUZZER_ONE_AMANITA,
    FORM0049_ONE_BUZZER_ONE_GUERRILLA,
    FORM0050_ONE_BUZZER_ONE_GUERRILLA,
    FORM0060_ONE_BOBOMB,
    FORM0061_TWO_BOBOMB_ONE_CLUSTER,
    FORM0062_FOUR_BOBOMB,
    FORM0063_TWO_BOBOMB_ONE_ENIGMA_ONE_CLUSTER,
    FORM0064_ONE_SPARKY_ONE_ENIGMA,
    FORM0065_TWO_SPARKY_ONE_BOBOMB,
    FORM0066_ONE_SPARKY_TWO_CLUSTER,
    FORM0067_TWO_SPARKY_TWO_ENIGMA,
    FORM0068_TWO_MAGMITE,
    FORM0069_ONE_MAGMITE_ONE_BOBOMB_ONE_SPARKY,
    FORM0070_TWO_MAGMITE_TWO_CLUSTER,
    FORM0071_TWO_MAGMITE_ONE_BOBOMB_ONE_CLUSTER,
    FORM0073_ONE_LAKITU_ONE_SPIKESTER_ONE_ARTICHOKER,
    FORM0074_THREE_LAKITU,
    FORM0075_TWO_LAKITU_ONE_ARTICHOKER,
    FORM0076_ONE_SPIKESTER_ONE_CARROBOSCIS,
    FORM0077_TWO_SPIKESTER_ONE_ARTICHOKER,
    FORM0078_ONE_SPIKESTER_TWO_CARROBOSCIS,
    FORM0079_FOUR_SPIKESTER_ONE_CARROBOSCIS,
    FORM0080_ONE_SPOOKUM_ONE_ORBUSER,
    FORM0081_TWO_SPOOKUM_ONE_JESTER,
    FORM0082_ONE_SPOOKUM_ONE_REMOCON_ONE_ORBUSER,
    FORM0083_TWO_SPOOKUM_ONE_REMOCON,
    FORM0084_ONE_ROBOMB,
    FORM0085_THREE_ROBOMB,
    FORM0086_TWO_ROBOMB_ONE_REMOCON,
    FORM0087_FOUR_ROBOMB_ONE_ORBUSER,
    FORM0088_ONE_CHOMP_ONE_JESTER,
    FORM0089_ONE_CHOMP_ONE_ROBOMB_ONE_REMOCON,
    FORM0090_TWO_CHOMP_ONE_ORBUSER,
    FORM0097_ONE_MUKUMUKU,
    FORM0098_TWO_MUKUMUKU,
    FORM0099_TWO_MUKUMUKU_ONE_PULSAR,
    FORM0100_ONE_MUKUMUKU_ONE_PULSAR_ONE_GECKO,
    FORM0101_TWO_SACKIT,
    FORM0102_TWO_SACKIT_ONE_MUKUMUKU_ONE_GECKO,
    FORM0103_ONE_SACKIT_TWO_PULSAR,
    FORM0104_ONE_SACKIT_ONE_MASTADOOM,
    FORM0105_ONE_GECKO_ONE_SACKIT,
    FORM0106_ONE_GECKO_ONE_MASTADOOM,
    FORM0107_TWO_GECKO_TWO_MUKUMUKU_TWO_SACKIT,
    FORM0108_TWO_GECKO_ONE_MASTADOOM,
    FORM0109_TWO_ZEOSTAR,
    FORM0110_TWO_ZEOSTAR_ONE_BLOOBER,
    FORM0111_TWO_ZEOSTAR_TWO_LEUKO,
    FORM0112_ONE_ZEOSTAR_ONE_LEUKO_ONE_CRUSTY,
    FORM0113_ONE_BLOOBER_ONE_MRKIPPER,
    FORM0114_THREE_BLOOBER,
    FORM0115_TWO_BLOOBER_ONE_MRKIPPER_ONE_CRUSTY,
    FORM0116_TWO_BLOOBER_TWO_ZEOSTAR_ONE_LEUKO,
    FORM0117_THREE_MRKIPPER,
    ...
    FORM0132_ONE_ALLEYRAT_ONE_REACHER_ONE_GORGON,
    FORM0133_ONE_GREAPER,
    FORM0134_TWO_GREAPER_ONE_REACHER,
    FORM0135_ONE_GREAPER_ONE_STRAWHEAD_ONE_REACHER,
    FORM0140_ONE_STINGER_ONE_FINKFLOWER,
    FORM0141_TWO_STINGER_ONE_OCTOVADER,
    FORM0142_ONE_STINGER_TWO_FINKFLOWER,
    FORM0143_FOUR_STINGER,
    FORM0144_ONE_CHOW_ONE_OCTOVADER,
    FORM0145_ONE_CHOW_ONE_SHOGUN,
    FORM0146_ONE_CHOW_ONE_SHOGUN_ONE_OCTOVADER,
    FORM0147_ONE_CHOW_ONE_FINKFLOWER_TWO_SHOGUN,
    FORM0152_ONE_SHYAWAY,
    FORM0153_TWO_SHYAWAY_ONE_KRIFFID,
    FORM0154_TWO_SHYAWAY_ONE_RIBBITE,
    FORM0155_ONE_SHYAWAY_ONE_GECKIT_ONE_RIBBITE,
    FORM0156_TWO_CHEWY,
    FORM0159_TWO_CHEWY_TWO_GECKIT_ONE_KRIFFID,
    FORM0160_ONE_GECKIT_ONE_SPINTHRA,
    FORM0161_TWO_GECKIT_ONE_SPINTHRA,
    FORM0162_TWO_GECKIT_TWO_CHEWY_ONE_SHYAWAY,
    FORM0163_TWO_GECKIT_ONE_SPINTHRA_ONE_KRIFFID,
    FORM0164_ONE_BIRDY_ONE_HEAVYTROOPA,
    FORM0165_THREE_BIRDY,
    FORM0166_TWO_BIRDY_ONE_HEAVYTROOPA,
    FORM0167_FIVE_BIRDY,
    FORM0169_TWO_BLUEBIRD_ONE_HEAVYTROOPA,
    FORM0170_FOUR_BLUEBIRD,
    FORM0171_TWO_BLUEBIRD_ONE_HEAVYTROOPA,
    FORM0172_ONE_PINWHEEL,
    FORM0173_ONE_PINWHEEL_ONE_MUCKLE,
    FORM0174_TWO_PINWHEEL_TWO_MUCKLE,
    FORM0176_TWO_SHAMAN,
    FORM0177_ONE_SHAMAN_ONE_ORBISON_ONE_JAWFUL,
    FORM0178_TWO_SHAMAN_ONE_JAWFUL,
    FORM0179_TWO_SHAMAN_TWO_SLINGSHY_ONE_JAWFUL,
    FORM0180_ONE_SLINGSHY_ONE_ORBISON,
    FORM0181_ONE_SLINGSHY_TWO_ORBISON,
    FORM0182_ONE_SLINGSHY_TWO_ORBISON_ONE_JAWFUL,
    FORM0183_TWO_SLINGSHY_TWO_PINWHEEL_ONE_MUCKLE,
    FORM0184_ONE_MAGMUS,
    FORM0185_TWO_MAGMUS_ONE_ARMOREDANT,
    FORM0186_THREE_MAGMUS_TWO_OERLIKON,
    FORM0187_TWO_MAGMUS_TWO_ARMOREDANT,
    FORM0188_ONE_OERLIKON_ONE_VOMER,
    FORM0189_THREE_OERLIKON,
    FORM0190_ONE_OERLIKON_ONE_CHAINEDKONG_ONE_ARMOREDANT,
    FORM0191_TWO_OERLIKON_ONE_CHAINEDKONG,
    FORM0192_THREE_PYROSPHERE,
    FORM0193_TWO_PYROSPHERE_ONE_CHAINEDKONG,
    FORM0194_ONE_CORKPEDITE_ONE_BODY_ONE_PYROSPHERE,
    FORM0196_ONE_VOMER_ONE_CHAINEDKONG,
    FORM0197_THREE_VOMER,
    FORM0198_ONE_CORKPEDITE_ONE_BODY_ONE_VOMER,
    FORM0200_ONE_TERRACOTTA,
    FORM0201_THREE_TERRACOTTA,
    FORM0202_ONE_TERRACOTTA_TWO_FORKIES,
    FORM0204_ONE_MALAKOOPA_ONE_TUBOTROOPA,
    FORM0205_TWO_MALAKOOPA_ONE_TUBOTROOPA,
    FORM0206_TWO_MALAKOOPA_ONE_TERRACOTTA_ONE_TUBOTROOPA,
    FORM0207_ONE_MALAKOOPA_TWO_TUBOTROOPA,
    FORM0208_TWO_GUGOOMBA,
    FORM0209_TWO_GUGOOMBA_ONE_STARCRUSTER,
    FORM0210_ONE_GUGOOMBA_ONE_FORKIES_ONE_STARCRUSTER,
    FORM0211_TWO_GUGOOMBA_TWO_MALAKOOPA_TWO_TERRACOTTA,
    FORM0218_ONE_NINJA,
    FORM0219_ONE_NINJA_ONE_DOPPEL,
    FORM0220_TWO_NINJA_ONE_HIPPOPO,
    FORM0221_FIVE_NINJA,
    FORM0234_FIVE_AMEBOID,
    FORM0235_THREE_GLUMREAPER,
    FORM0236_ONE_GLUMREAPER_ONE_HIPPOPO,
    FORM0237_TWO_GLUMREAPER_TWO_DOPPEL,
    FORM0238_TWO_GLUMREAPER_TWO_LILBOO,
    FORM0239_ONE_LILBOO,
    FORM0240_TWO_LILBOO_ONE_HIPPOPO,
    FORM0241_TWO_LILBOO_ONE_PUPPOX_ONE_DOPPEL,
    FORM0242_FOUR_LILBOO,
    FORM0247_THREE_RATFUNK,
    FORM0248_FIVE_RATFUNK,
    FORM0300_THREE_HEAVYTROOPA,
    FORM0310_ONE_MACHINEMADEAXEMPINK_ONE_MACHINEMADEAXEMRED_ONE_MACHINEMADEAXEMGREEN,
    FORM0311_TWO_MACHINEMADEAXEMBLACK_TWO_MACHINEMADEAXEMYELLOW,
    FORM0331_FOUR_TERRACOTTA,
    FORM0332_TWO_OERLIKON_ONE_STARCRUSTER,
    FORM0333_ONE_SACKIT_TWO_BIGBERTHA,
    FORM0334_TWO_CHOW_ONE_FORKIES,
    FORM0335_ONE_ALLEYRAT_TWO_ARMOREDANT,
    FORM0336_THREE_BLOOBER_ONE_STARCRUSTER,
    FORM0337_FOUR_STINGER,
    FORM0338_TWO_GECKIT_ONE_CHAINEDKONG,
    FORM0339_ONE_ROBOMB_TWO_BIGBERTHA,
    FORM0340_FOUR_VOMER,
    FORM0341_TWO_MAGMUS_TWO_PULSAR,
    FORM0343_FIVE_GUGOOMBA,
    FORM0344_TWO_MALAKOOPA_ONE_TUBOTROOPA,
    FORM0345_TWO_THEBIGBOO_TWO_ORBISON,
    FORM0346_FIVE_SLINGSHY,
    FORM0347_TWO_CHEWY_TWO_SHYAWAY,
    FORM0348_ONE_MRKIPPER_TWO_MUCKLE,
    FORM0349_TWO_AMANITA_ONE_ORBISON,
    FORM0350_TWO_GREAPER_ONE_GLUMREAPER,
    FORM0351_THREE_PYROSPHERE,
    FORM0352_THREE_LAKITU,
    FORM0353_TWO_ZEOSTAR_TWO_SHAMAN,
    FORM0354_SIX_SHAMAN,
    FORM0362_TWO_BOBOMB_ONE_CLUSTER,
    FORM0363_FOUR_BOBOMB,
)
...
FORMATION_FORCED_ENEMIES: dict[Formation, list[type]] = {
    ...
    FORM0017_TWO_SHYSTER: [SHYSTEREnemy],
    FORM0018_THREE_SHYSTER: [SHYSTEREnemy],
    ...
    FORM0194_ONE_CORKPEDITE_ONE_BODY_ONE_PYROSPHERE: [SPARKYEnemy],
    FORM0196_ONE_VOMER_ONE_CHAINEDKONG: [BIRDYEnemyStatic],
    FORM0197_THREE_VOMER: [BIRDYEnemyStatic],
    FORM0198_ONE_CORKPEDITE_ONE_BODY_ONE_VOMER: [BIRDYEnemyStatic],
