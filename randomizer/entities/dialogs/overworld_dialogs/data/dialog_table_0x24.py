...
dialog_data[
    48
] = """MALLOW: This one’s private![delay]
...
dialog_data[
    51
] = """MALLOW: Why, this wish is...[await][page]
...
dialog_data[
    144
] = """GARDENER: Hi, I'm the gardener.[delay][delay][delay]
...
dialog_data[
    147
] = """GARDENER: Well, that’s my story.[await]
...
dialog_data[
    149
] = """GARDENER: You changed your mind?[await]
  [select]  (Yes)
  [select]  (No)[await]"""
dialog_data[
    150
] = """GARDENER: Well, `MAIN_CHARACTER_NAME`?[await]
 Will you give me the fertilizer?
  [select]  (Yes)
  [select]  (No)[await]"""
dialog_data[
    151
] = """GARDENER: I finally have it![await][page]
...
dialog_data[
    156
] = """GARDENER: I finally have it![await]
...
dialog_data[
    214
] = """DEALER: I broke 21, so you won![await]
 Here’s your Frog Coin.[await]"""
dialog_data[
    215
] = """DEALER: You won this round.[await]
 Here is your Frog Coin.[await]"""
dialog_data[
    216
] = """DEALER: You lost this round.[await]
 I'll take your Frog Coin.[await]"""
dialog_data[
    217
] = """DEALER: It’s a tie.[await]
 I'll keep your Frog Coin.[await]"""
dialog_data[
    218
] = """DEALER: No Frog Coins?[await]
...
dialog_data[
    222
] = """ Another game, `MAIN_CHARACTER_HONORIFIC`?
  [select] (Sure)
  [select] (No)[await]"""
...
dialog_data[
    236
] = """ Okay, `MAIN_CHARACTER_NAME`, this is in
...
dialog_data[
    325
] = """ Have you ever visited the tower in
...
dialog_data[
    326
] = """ Some of the monsters in this world
...
dialog_data[
    334
] = """ If you find an invincibility star in
...
dialog_data[
    398
] = """ The statues in the castle were
...
dialog_data[
    402
] = """ The guy in the left corner will give
...
dialog_data[
    458
] = """ It's the bus driver's day off today,
...
dialog_data[
    490
] = """ Looks like you found our missing
...
dialog_data[
    554
] = """ If you see Samus, tell her I need her
...
dialog_data[
    599
] = """ If you see Link, tell him I need him
